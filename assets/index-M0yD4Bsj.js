...
#define LOW_PRECISION`),t}function jg(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===lu?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===cu?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===ei&&(t="SHADOWMAP_TYPE_VSM"),t}function Qg(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case dr:case fr:t="ENVMAP_TYPE_CUBE";break;case fa:t="ENVMAP_TYPE_CUBE_UV";break}return t}function t_(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case fr:t="ENVMAP_MODE_REFRACTION";break}return t}function e_(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case hu:t="ENVMAP_BLENDING_MULTIPLY";break;case $d:t="ENVMAP_BLENDING_MIX";break;case Kd:t="ENVMAP_BLENDING_ADD";break}return t}function n_(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function i_(s,t,e,n){const i=s.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=jg(e),c=Qg(e),h=t_(e),u=e_(e),d=n_(e),f=Wg(e),g=Xg(r),_=i.createProgram();let m,p,E=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
    ...
    `}}function hx(s){return s.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const Al="sw_id_v1",Rl=s=>Array.from(s).map(t=>t.toString(16).padStart(2,"0")).join(""),nu=s=>{const t=s.replace(/-/g,"+").replace(/_/g,"/"),e=atob(t);return Uint8Array.from(e,n=>n.charCodeAt(0))};class iu{constructor(t,e,n,i){this.peerId=t,this.displayName=e,this.isNew=i,this._priv=n}get shortId(){return this.peerId.slice(-8)}setName(t){this.displayName=t,sd()}async sign(t){const e=new TextEncoder().encode(t),n=await crypto.subtle.sign({name:"Ed25519"},this._priv,e);return Rl(new Uint8Array(n))}}let si=null,zr=null;function sd(){if(!(!si||!zr))try{localStorage.setItem(Al,JSON.stringify({privJwk:zr,displayName:si.displayName}))}catch{}}async function ux(){if(si)return si;const s=localStorage.getItem(Al);if(s)try{const{privJwk:n,displayName:i}=JSON.parse(s),r=await crypto.subtle.importKey("jwk",n,{name:"Ed25519"},!1,["sign"]),o=Rl(nu(n.x));return zr=n,si=new iu(o,i||"",r,!1),si}catch{localStorage.removeItem(Al)}const t=await crypto.subtle.generateKey({name:"Ed25519"},!0,["sign","verify"]);zr=await crypto.subtle.exportKey("jwk",t.privateKey);const e=Rl(nu(zr.x));return si=new iu(e,"",t.privateKey,!0),sd(),si}function rc(){return si}const Cl="xn_",rd="xn_known_peers";async function od(s){const t=new TextEncoder().encode(s),e=await crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(e)).map(n=>n.toString(16).padStart(2,"0")).join("")}async function kr(s,t=""){return od(s.toLowerCase().trim()+":"+t.trim())}function dx(s){return btoa(s).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"")}function fx(s){const t=s.length%4,e=t?s+"=".repeat(4-t):s;return atob(e.replace(/-/g,"+").replace(/_/g,"/"))}async function oc({roomId:s,lockCode:t="",node:e}={}){if(!(s!=null&&s.trim()))throw new Error("roomId is required");const n=await kr(s,t),i=cd(n),r={r:s.trim(),h:n};e&&(r.n=e),i.length&&(r.p=i.slice(0,8));const o=dx(JSON.stringify(r));return{link:`${window.location.origin+window.location.pathname}#${Cl}${o}`,roomHash:n}}async function ad(){const s=window.location.hash.slice(1);if(s.startsWith(Cl))try{const e=JSON.parse(fx(s.slice(Cl.length))),n=e.r||"main",i=e.h||await kr(n);return{type:"link",roomId:n,roomHash:i,node:e.n||null,peers:e.p||[]}}catch{console.warn("[roomLink] failed to decode link — falling back to main")}if(s){const e=s.trim().toLowerCase(),n=await kr(e);return{type:"plain",roomId:e,roomHash:n,node:null,peers:[]}}return{type:"default",roomId:"main",roomHash:await kr("main"),node:null,peers:[]}}function ac(){try{return JSON.parse(localStorage.getItem(rd)||"{}")}catch{return{}}}function ld(s){try{localStorage.setItem(rd,JSON.stringify(s))}catch{}}function cd(s){return ac()[s]||[]}function lc(s,t){const e=ac(),n=e[s]||[];n.includes(t)||(n.unshift(t),n.length>20&&(n.length=20),e[s]=n,ld(e))}function px(s,t){const e=ac(),n=e[s];if(!n)return;const i=n.indexOf(t);i!==-1&&(n.splice(i,1),e[s]=n,ld(e))}function hd(s){const t=s.trim().toLowerCase().replace(/[^a-z0-9-]/g,"-").replace(/-{2,}/g,"-").replace(/^-+|-+$/g,"")||"main";window.location.hash=t}const Pl=Object.freeze(Object.defineProperty({__proto__:null,createRoomLink:oc,deriveRoomHash:kr,forgetPeer:px,getKnownPeers:cd,parseCurrentLink:ad,recordPeer:lc,setRoomNameInUrl:hd,sha256hex:od},Symbol.toStringTag,{value:"Module"}));var Qi,ts,Ti;class mx extends EventTarget{constructor(){super(...arguments);at(this,Qi,[]);at(this,ts,null);at(this,Ti,!1)}push(e,n="pending",i=""){const r=`s${Date.now()}-${Math.random().toString(36).slice(2,6)}`,o={id:r,text:e,status:n,detail:i,ts:Date.now()};return b(this,Qi).push(o),this.dispatchEvent(new CustomEvent("step",{detail:{...o,action:"add"}})),r}update(e,n,i=""){const r=b(this,Qi).find(o=>o.id===e);r&&(r.status=n,i!==""&&(r.detail=i),this.dispatchEvent(new CustomEvent("step",{detail:{...r,action:"update"}})))}ok(e,n=""){this.update(e,"ok",n)}fail(e,n=""){this.update(e,"fail",n)}warn(e,n=""){this.update(e,"warn",n)}info(e,n=""){return this.push(e,"info",n)}startFirstTimer(e=12e3){ft(this,Ti,!1),clearTimeout(b(this,ts)),ft(this,ts,setTimeout(()=>{b(this,Ti)||(this.push("You're the first here — your device is the anchor","host","Share your invite link to let others find you"),this.dispatchEvent(new CustomEvent("first-in-room")))},e))}peerJoined(e){ft(this,Ti,!0),clearTimeout(b(this,ts)),this.info(`${e||"Someone"} joined`)}get steps(){return[...b(this,Qi)]}get hasHost(){return b(this,Ti)===!1}clear(){ft(this,Qi,[]),clearTimeout(b(this,ts)),ft(this,Ti,!1),this.dispatchEvent(new CustomEvent("clear"))}}Qi=new WeakMap,ts=new WeakMap,Ti=new WeakMap;const he=new mx,su=6e4,gx=20;var Ze,Cn,Vn,Ll,Or;class _x extends EventTarget{constructor(){super(...arguments);at(this,Vn);at(this,Ze,new Map);at(this,Cn,new Map)}get hotSize(){return b(this,Ze).size}getPeer(e){return b(this,Ze).get(e)}getSnapshot(){const e={};for(const[n,i]of b(this,Ze)){const{ttlTimer:r,...o}=i;e[n]=o}return e}upsertPeer(e,n){const i=b(this,Ze).get(e),r=n.v??0,o=(i==null?void 0:i.v)??-1;if(r<=o)return!1;i!=null&&i.ttlTimer&&clearTimeout(i.ttlTimer);const a=setTimeout(()=>lt(this,Vn,Ll).call(this,e),su),l={username:"",presetId:0,status:"available",pos:void 0,...i??{},...n,peerId:e,v:r,ttlTimer:a};return b(this,Ze).set(e,l),lt(this,Vn,Or).call(this,"peer:updated",{peerId:e,entry:l}),!0}patchPeer(e,n){const i=b(this,Ze).get(e);i&&Object.assign(i,n)}updatePos(e,n){const i=b(this,Ze).get(e);i&&(i.pos=n)}heartbeat(e){const n=b(this,Ze).get(e);n&&(clearTimeout(n.ttlTimer),n.ttlTimer=setTimeout(()=>lt(this,Vn,Ll).call(this,e),su))}removePeer(e){const n=b(this,Ze).get(e);n&&(clearTimeout(n.ttlTimer),b(this,Ze).delete(e),lt(this,Vn,Or).call(this,"peer:removed",{peerId:e}))}clearHot(){for(const e of b(this,Ze).values())clearTimeout(e.ttlTimer);b(this,Ze).clear()}updateColdRoom(e,n){if(!b(this,Cn).has(e)&&b(this,Cn).size>=gx){const i=b(this,Cn).keys().next().value;b(this,Cn).delete(i)}b(this,Cn).set(e,{roomHash:e,peerCount:n,lastSeen:Date.now()}),lt(this,Vn,Or).call(this,"cold:updated",{roomHash:e,peerCount:n})}pruneCold(e=6e5){const n=Date.now()-e;for(const[i,r]of b(this,Cn))r.lastSeen<n&&b(this,Cn).delete(i)}getColdRooms(){return[...b(this,Cn).values()]}}Ze=new WeakMap,Cn=new WeakMap,Vn=new WeakSet,Ll=function(e){b(this,Ze).has(e)&&(b(this,Ze).delete(e),lt(this,Vn,Or).call(this,"peer:expired",{peerId:e}))},Or=function(e,n){this.dispatchEvent(new CustomEvent(e,{detail:n}))};const Be=new _x,vx=50,xx=5;var yn,js,Fi,Il,Dl;class yx{constructor(){at(this,Fi);at(this,yn,[]);at(this,js,!1)}schedule(t,e=""){b(this,yn).length>=vx&&b(this,yn).shift(),b(this,yn).push({task:t,label:e}),lt(this,Fi,Il).call(this)}get queueSize(){return b(this,yn).length}clear(){b(this,yn).length=0}}yn=new WeakMap,js=new WeakMap,Fi=new WeakSet,Il=function(){b(this,js)||b(this,yn).length===0||(ft(this,js,!0),typeof requestIdleCallback=="function"?requestIdleCallback(t=>lt(this,Fi,Dl).call(this,t),{timeout:2e3}):setTimeout(()=>lt(this,Fi,Dl).call(this,null),100))},Dl=function(t){for(ft(this,js,!1);b(this,yn).length>0&&!(t&&!t.didTimeout&&t.timeRemaining()<xx);){const{task:e,label:n}=b(this,yn).shift();try{e()}catch(i){console.warn(`[IdleScheduler] task "${n}" threw:`,i)}}b(this,yn).length>0&&lt(this,Fi,Il).call(this)};const Nl=new yx,Ks={};function ud(s){if(s)return s;const t=new URLSearchParams(window.location.search).get("node");if(t)return t;if(!(Ks!=null&&Ks.VITE_XPACENODE_URL))return null}function Nr(s){hd(s)}const Mx=[{urls:"stun:stun.l.google.com:19302"},{urls:"stun:stun1.l.google.com:19302"},{urls:"turn:openrelay.metered.ca:80",username:"openrelayproject",credential:"openrelayproject"},{urls:"turn:openrelay.metered.ca:80?transport=tcp",username:"openrelayproject",credential:"openrelayproject"}];var es,Xr,ns,is,Qs,Zr,Yr,vr,dd,fd;class Sx{constructor(){at(this,vr);at(this,es,null);at(this,Xr,"");at(this,ns,new Map);at(this,is,!1);at(this,Qs,!1);at(this,Zr,[]);at(this,Yr,0)}async connect(t){return ft(this,Xr,t),new Promise((e,n)=>{const i=new WebSocket(t);ft(this,es,i);const r=setTimeout(()=>n(new Error("xpacenode connect timeout")),1e4);i.onopen=()=>{clearTimeout(r),ft(this,is,!0),ft(this,Yr,0),b(this,Zr).splice(0).forEach(a=>i.send(a)),e()},i.onmessage=({data:o})=>{try{const a=JSON.parse(o);lt(this,vr,dd).call(this,a)}catch{}},i.onerror=o=>{clearTimeout(r),n(o)},i.onclose=()=>{ft(this,is,!1),lt(this,vr,fd).call(this)}})}send(t){var n;const e=JSON.stringify(t);b(this,is)&&((n=b(this,es))==null?void 0:n.readyState)===WebSocket.OPEN?b(this,es).send(e):b(this,Zr).push(e)}on(t,e){b(this,ns).has(t)||b(this,ns).set(t,[]),b(this,ns).get(t).push(e)}close(){var t;ft(this,Qs,!0),ft(this,is,!1),(t=b(this,es))==null||t.close()}}es=new WeakMap,Xr=new WeakMap,ns=new WeakMap,is=new WeakMap,Qs=new WeakMap,Zr=new WeakMap,Yr=new WeakMap,vr=new WeakSet,dd=function(t){const e=b(this,ns).get(t.t);e==null||e.forEach(n=>n(t))},fd=function(){if(b(this,Qs))return;const t=Math.min(1e3*2**us(this,Yr)._++,3e4);console.warn(`[xpacenode] disconnected — reconnecting in ${t}ms`),setTimeout(()=>{b(this,Qs)||this.connect(b(this,Xr)).catch(()=>{})},t)};var ye,oi,tr,ss,er,qr,$r,Kr,nr,Jr,Bi,Ul,Ol;class Ex extends EventTarget{constructor(e){super();at(this,Bi);at(this,ye);at(this,oi,null);at(this,tr,!1);at(this,ss,!1);at(this,er,!1);at(this,qr,null);at(this,$r,null);at(this,Kr,[]);at(this,nr,!1);at(this,Jr,async()=>{if(!b(this,ss)&&b(this,ye).signalingState==="stable")try{ft(this,ss,!0),await b(this,ye).setLocalDescription(),this.dispatchEvent(new CustomEvent("signal",{detail:{type:"offer",sdp:b(this,ye).localDescription.sdp}}))}catch(e){console.warn("[RTCPeer] negotiate error",e)}finally{ft(this,ss,!1)}});ft(this,tr,e),ft(this,ye,new RTCPeerConnection({iceServers:Mx})),e||(ft(this,oi,b(this,ye).createDataChannel("sw",{ordered:!0})),lt(this,Bi,Ul).call(this,b(this,oi))),b(this,ye).ondatachannel=({channel:n})=>{ft(this,oi,n),lt(this,Bi,Ul).call(this,n)},b(this,ye).onicecandidate=({candidate:n})=>{n&&this.dispatchEvent(new CustomEvent("signal",{detail:{type:"ice",candidate:n.toJSON()}}))},b(this,ye).onnegotiationneeded=b(this,Jr),b(this,ye).ontrack=({track:n,streams:i})=>{var o;const r=i[0]??new MediaStream([n]);(o=b(this,$r))==null||o.call(this,n,r)},b(this,ye).onconnectionstatechange=()=>{b(this,ye).connectionState==="failed"&&this.dispatchEvent(new CustomEvent("failed"))}}async handleSignal({type:e,sdp:n,candidate:i}){try{if(e==="offer"){const r=b(this,ye).signalingState==="have-local-offer",o=b(this,ss)||r;if(ft(this,er,!b(this,tr)&&o),b(this,er))return;await b(this,ye).setRemoteDescription({type:"offer",sdp:n}),ft(this,nr,!0),await b(this,ye).setLocalDescription(),this.dispatchEvent(new CustomEvent("signal",{detail:{type:"answer",sdp:b(this,ye).localDescription.sdp}})),await lt(this,Bi,Ol).call(this),b(this,tr)&&r&&setTimeout(b(this,Jr),200)}else if(e==="answer")b(this,ye).signalingState==="have-local-offer"&&(await b(this,ye).setRemoteDescription({type:"answer",sdp:n}),ft(this,nr,!0),await lt(this,Bi,Ol).call(this));else if(e==="ice")if(!b(this,nr))b(this,Kr).push(i);else try{await b(this,ye).addIceCandidate(i)}catch(r){b(this,er)||console.warn("[RTCPeer] addIceCandidate",r)}}catch(r){console.warn("[RTCPeer] handleSignal",e,r)}}send(e){var n;((n=b(this,oi))==null?void 0:n.readyState)==="open"&&b(this,oi).send(JSON.stringify(e))}addTrack(e,n){try{b(this,ye).addTrack(e,n)}catch{}}onMessage(e){ft(this,qr,e)}onTrack(e){ft(this,$r,e)}get pc(){return b(this,ye)}get connected(){var e;return((e=b(this,oi))==null?void 0:e.readyState)==="open"}close(){try{b(this,ye).close()}catch{}}}ye=new WeakMap,oi=new WeakMap,tr=new WeakMap,ss=new WeakMap,er=new WeakMap,qr=new WeakMap,$r=new WeakMap,Kr=new WeakMap,nr=new WeakMap,Jr=new WeakMap,Bi=new WeakSet,Ul=function(e){e.onopen=()=>this.dispatchEvent(new CustomEvent("open")),e.onclose=()=>this.dispatchEvent(new CustomEvent("close")),e.onmessage=({data:n})=>{var i;try{(i=b(this,qr))==null||i.call(this,JSON.parse(n))}catch{}}},Ol=async function(){const e=b(this,Kr).splice(0);for(const n of e)try{await b(this,ye).addIceCandidate(n)}catch{}};var sn,Me,ai,rs,os,as,Pn,Ai,li,ci,ir,jr,Qr,to,eo,Qt,Fl,Bl,pd,tn,vn;class wx{constructor(t,e=0,n="available"){at(this,Qt);at(this,sn,null);at(this,Me,new Map);at(this,ai,{});at(this,rs,"");at(this,os,0);at(this,as,"available");at(this,Pn,"");at(this,Ai,"main");at(this,li,"");at(this,ci,[]);at(this,ir,null);at(this,jr,[]);at(this,Qr,[]);at(this,to,null);at(this,eo,0);ft(this,rs,t),ft(this,os,e),ft(this,as,n)}async start(){const t=he.push("Reading link…"),e=await ad();if(ft(this,Pn,e.roomHash),ft(this,Ai,e.roomId),ft(this,ci,e.peers??[]),e.type==="link"?(he.ok(t,`Invite link decoded → room: ${b(this,Ai)}`),he.info("Room address is hashed — connection is private"),e.node&&he.info("Preferred node found in link",e.node)):e.type==="plain"?he.ok(t,`Room: ${b(this,Ai)}`):he.ok(t,"Using default room"),b(this,ci).length){const i=e.type==="link"?"invite link":"previous session";he.info(`${b(this,ci).length} known peer${b(this,ci).length>1?"s":""} from ${i}`,"Will reconnect directly if they are online")}if(ft(this,li,ud(e.node)),!b(this,li))throw he.info("No xpacenode — trying public DHT route"),Object.assign(new Error("NO_NODE"),{roomHash:b(this,Pn),roomName:b(this,Ai),linkType:e.type,knownPeers:b(this,ci)});ft(this,sn,new Sx);const n=he.push("Connecting to xpacenode…","pending",b(this,li));try{await b(this,sn).connect(b(this,li)),he.ok(n,b(this,li))}catch(i){throw he.fail(n,"xpacenode unreachable — trying public DHT route"),i}he.info("Searching for peers in room…"),he.startFirstTimer(12e3),b(this,sn).on("peer_join",async i=>{const{peerId:r,username:o="",presetId:a=0,status:l="available"}=i;if(r===lt(this,Qt,tn).call(this))return;const c=b(this,ci).includes(r);if(he.peerJoined(o||r.slice(0,10)),c&&he.info(`✓ ${o||r.slice(0,10)} — known peer (reconnected)`),lt(this,Qt,vn).call(this,"HELLO",{from:r,username:o,presetId:a,status:l}),!b(this,Me).has(r)){const h=lt(this,Qt,tn).call(this)<r;await lt(this,Qt,Fl).call(this,r,h)}}),b(this,sn).on("peer_leave",i=>{lt(this,Qt,Bl).call(this,i.peerId)}),b(this,sn).on("signal",async i=>{var a;const{from:r,payload:o}=i;if(!(!r||!o)){if(!b(this,Me).has(r)){const l=lt(this,Qt,tn).call(this)<r;await lt(this,Qt,Fl).call(this,r,l)}await((a=b(this,Me).get(r))==null?void 0:a.peer.handleSignal(o))}}),b(this,sn).send({t:"hello",roomId:b(this,Pn),peerId:lt(this,Qt,tn).call(this),username:b(this,rs),presetId:b(this,os),status:b(this,as)}),ft(this,to,setInterval(()=>{b(this,sn).send({t:"hb",roomId:b(this,Pn)});const i={type:"hb",identityId:lt(this,Qt,tn).call(this)};for(const{peer:r}of b(this,Me).values())r.send(i)},3e4)),Nl.schedule(()=>Be.pruneCold(),"prune-cold-rooms")}stop(){var t,e;clearInterval(b(this,to)),(t=b(this,sn))==null||t.send({t:"leave",roomId:b(this,Pn)}),(e=b(this,sn))==null||e.close();for(const{peer:n}of b(this,Me).values())n.close();b(this,Me).clear(),ft(this,sn,null)}move(t,e,n,i=0){const r={type:"move",identityId:lt(this,Qt,tn).call(this),pos:{x:t,y:e,z:n,ry:i}};for(const{peer:o}of b(this,Me).values())o.send(r)}chat(t){const e={type:"chat",identityId:lt(this,Qt,tn).call(this),username:b(this,rs),text:t,ts:Date.now()};for(const{peer:n}of b(this,Me).values())n.send(e)}setAvatar(t){ft(this,os,t);const e=lt(this,Qt,tn).call(this),n={type:"avatar",identityId:e,presetId:t};for(const{peer:r}of b(this,Me).values())r.send(n);const i={type:"delta",identityId:e,presetId:t,v:++us(this,eo)._};for(const{peer:r}of b(this,Me).values())r.send(i)}setStatus(t){ft(this,as,t);const e=lt(this,Qt,tn).call(this),n={type:"status",identityId:e,status:t};for(const{peer:r}of b(this,Me).values())r.send(n);const i={type:"delta",identityId:e,status:t,v:++us(this,eo)._};for(const{peer:r}of b(this,Me).values())r.send(i)}broadcastTalking(t){const e={type:"talking",identityId:lt(this,Qt,tn).call(this),talking:!!t};for(const{peer:n}of b(this,Me).values())n.send(e)}addVoiceTrack(t,e){b(this,Qr).push({track:t,stream:e});for(const{peer:n}of b(this,Me).values())n.addTrack(t,e)}onVoiceTrack(t){ft(this,ir,t);const e=b(this,jr).splice(0);for(const{track:n,stream:i,identityId:r,nostrPubkey:o}of e)n.readyState!=="ended"&&t(n,i,r,o);for(const[n,{peer:i}]of b(this,Me))for(const r of i.pc.getReceivers()){const o=r.track;!o||o.kind!=="audio"||o.readyState==="ended"||t(o,new MediaStream([o]),n,n)}}wireToIdentityId(t){return t}get roomName(){return b(this,Ai)}get roomHash(){return b(this,Pn)}get nodeUrl(){return b(this,li)}getPeers(){const t={};for(const[e,{peer:n}]of b(this,Me))t[e]=n.pc;return t}on(t,e){return b(this,ai)[t]||(b(this,ai)[t]=[]),b(this,ai)[t].push(e),()=>{b(this,ai)[t]=b(this,ai)[t].filter(n=>n!==e)}}}sn=new WeakMap,Me=new WeakMap,ai=new WeakMap,rs=new WeakMap,os=new WeakMap,as=new WeakMap,Pn=new WeakMap,Ai=new WeakMap,li=new WeakMap,ci=new WeakMap,ir=new WeakMap,jr=new WeakMap,Qr=new WeakMap,to=new WeakMap,eo=new WeakMap,Qt=new WeakSet,Fl=async function(t,e){const n=new Ex(e);b(this,Me).set(t,{identityId:t,peer:n}),n.addEventListener("signal",({detail:i})=>{var r;(r=b(this,sn))==null||r.send({t:"signal",roomId:b(this,Pn),to:t,payload:i})}),n.onMessage(i=>lt(this,Qt,pd).call(this,i,t)),n.onTrack((i,r)=>{b(this,ir)?b(this,ir).call(this,i,r,t,t):b(this,jr).push({track:i,stream:r,identityId:t,nostrPubkey:t})}),n.addEventListener("open",()=>{n.send({type:"intro",identityId:lt(this,Qt,tn).call(this),username:b(this,rs),presetId:b(this,os),status:b(this,as)}),n.send({type:"state_req",identityId:lt(this,Qt,tn).call(this)}),lc(b(this,Pn),t)}),n.addEventListener("failed",()=>lt(this,Qt,Bl).call(this,t));for(const{track:i,stream:r}of b(this,Qr))n.addTrack(i,r);return n},Bl=function(t){const e=b(this,Me).get(t);e&&(e.peer.close(),b(this,Me).delete(t),lt(this,Qt,vn).call(this,"PEER_LEAVE",{from:t}))},pd=function(t,e){var i;const n=t.identityId??e;switch(t.type){case"intro":lt(this,Qt,vn).call(this,"HELLO",{from:n,username:t.username,presetId:t.presetId??0,status:t.status??"available"});break;case"move":lt(this,Qt,vn).call(this,"MOVE",{from:n,pos:t.pos});break;case"chat":lt(this,Qt,vn).call(this,"CHAT",{from:n,username:t.username,text:t.text,ts:t.ts});break;case"avatar":lt(this,Qt,vn).call(this,"AVATAR_CHANGE",{from:n,presetId:t.presetId}),Be.patchPeer(n,{presetId:t.presetId});break;case"status":lt(this,Qt,vn).call(this,"STATUS_CHANGE",{from:n,status:t.status}),Be.patchPeer(n,{status:t.status});break;case"talking":lt(this,Qt,vn).call(this,"PEER_TALKING",{from:n,talking:!!t.talking});break;case"bye":lt(this,Qt,vn).call(this,"PEER_LEAVE",{from:n});break;case"hb":Be.heartbeat(n);break;case"state_req":{const r=Be.getSnapshot(),o=(i=b(this,Me).get(e))==null?void 0:i.peer;o==null||o.send({type:"state",identityId:lt(this,Qt,tn).call(this),peers:r});break}case"state":{const r=lt(this,Qt,tn).call(this),o=t.peers??{};for(const[a,l]of Object.entries(o)){if(a===r)continue;Be.upsertPeer(a,l)&&!b(this,Me).has(a)&&lt(this,Qt,vn).call(this,"HELLO",{from:a,username:l.username??"",presetId:l.presetId??0,status:l.status??"available"})}break}case"delta":{Be.upsertPeer(n,t)&&!b(this,Me).has(n)&&lt(this,Qt,vn).call(this,"HELLO",{from:n,username:t.username??"",presetId:t.presetId??0,status:t.status??"available"});break}}},tn=function(){var t;return((t=rc())==null?void 0:t.peerId)??"unknown"},vn=function(t,e){var n;(n=b(this,ai)[t])==null||n.forEach(i=>i(e))};function bx(s){const t=new URLSearchParams(window.location.search).get("nodeApi");if(t)return t;if(!(Ks!=null&&Ks.VITE_XPACENODE_API_URL)){if(!s)return null;try{const e=new URL(s.replace(/^ws/,"http"));return e.port="",e.toString().replace(/\/$/,"")}catch{return null}}}async function Tx(s){const t=ud();if(!t)return s([]),()=>{};const e=bx(t);if(!e)return s([]),()=>{};let n=!1;const i=9e4,r=new Map,o=async()=>{if(!n)try{const h=await(await fetch(`${e}/rooms`,{signal:AbortSignal.timeout(5e3)})).json(),u=Date.now();for(const d of h.rooms??[])r.set(d.roomId,{count:d.count,usernames:d.usernames??[],lastSeen:u});for(const[d,f]of r)u-f.lastSeen>i&&r.delete(d);a()}catch{}},a=()=>{const c=[...r.entries()].map(([h,u])=>({roomId:h,roomName:h,count:u.count})).sort((h,u)=>u.count-h.count);s(c)};await o();const l=setInterval(o,3e4);return()=>{n=!0,clearInterval(l)}}const Ax=[{urls:"stun:stun.l.google.com:19302"},{urls:"stun:stun1.l.google.com:19302"},{urls:"turn:openrelay.metered.ca:80",username:"openrelayproject",credential:"openrelayproject"},{urls:"turn:openrelay.metered.ca:80?transport=tcp",username:"openrelayproject",credential:"openrelayproject"}];var Ne,hi,sr,rr,or,ar,no,kl,zn,ca,lr,io,so,ro,oo,ao,lo,co,ha,ho,ua,da,cr,uo,fo,hr,Le,ii,An;class ru{constructor(t,e=0,n="available"){at(this,Le);at(this,Ne,null);at(this,hi,{});at(this,sr,"");at(this,rr,0);at(this,or,"available");at(this,ar,"");at(this,no,"main");at(this,kl,null);at(this,zn,new Map);at(this,ca,[]);at(this,lr,null);at(this,io,[]);at(this,so,null);at(this,ro,null);at(this,oo,null);at(this,ao,null);at(this,lo,null);at(this,co,null);at(this,ha,null);at(this,ho,null);at(this,ua,null);at(this,da,null);at(this,cr,null);at(this,uo,[]);at(this,fo,0);at(this,hr,null);ft(this,sr,t),ft(this,rr,e),ft(this,or,n)}async start(t,e,n="default",i=[]){ft(this,ar,t),ft(this,no,e),ft(this,uo,i),n==="link"&&he.info("Invite link decoded — using hashed room address"),i.length&&he.info(`${i.length} known peer${i.length>1?"s":""} cached`,"Will recognise them when they appear on DHT");const r=he.push("Trying public DHT route (BitTorrent)…");ft(this,Ne,xd({appId:"xpacenet-v3",rtcConfig:{iceServers:Ax}},t));const[o,a]=b(this,Ne).makeAction("intro"),[l,c]=b(this,Ne).makeAction("move"),[h,u]=b(this,Ne).makeAction("chat"),[d,f]=b(this,Ne).makeAction("avatar"),[g,_]=b(this,Ne).makeAction("status"),[m,p]=b(this,Ne).makeAction("talking"),[E,v]=b(this,Ne).makeAction("bye"),[M,U]=b(this,Ne).makeAction("hb"),[A,T]=b(this,Ne).makeAction("stateReq"),[O,w]=b(this,Ne).makeAction("state"),[x,P]=b(this,Ne).makeAction("delta");ft(this,so,l),ft(this,ro,h),ft(this,oo,d),ft(this,ao,g),ft(this,lo,m),ft(this,co,E),ft(this,ha,o),ft(this,ho,M),ft(this,ua,A),ft(this,da,O),ft(this,cr,x),b(this,Ne).onPeerJoin(D=>{if(D===lt(this,Le,ii).call(this))return;const F=b(this,uo).includes(D);he.peerJoined(D.slice(0,10)),F&&he.info("✓ Known peer reconnected via DHT"),o({identityId:lt(this,Le,ii).call(this),username:b(this,sr),presetId:b(this,rr),status:b(this,or)},[D]),A({identityId:lt(this,Le,ii).call(this)},[D]),b(this,zn).has(D)||(b(this,zn).set(D,{peerId:D,username:"",presetId:0,status:"available"}),lc(b(this,ar),D))}),b(this,Ne).onPeerLeave(D=>{b(this,zn).delete(D),lt(this,Le,An).call(this,"PEER_LEAVE",{from:D})}),a(({identityId:D,username:F,presetId:B=0,status:j="available"},V)=>{const et=D??V;b(this,zn).set(et,{peerId:et,username:F,presetId:B,status:j}),he.info(`Connected to ${F||et.slice(0,10)}`),lt(this,Le,An).call(this,"HELLO",{from:et,username:F,presetId:B,status:j})}),c(({pos:D},F)=>lt(this,Le,An).call(this,"MOVE",{from:F,pos:D})),u((D,F)=>lt(this,Le,An).call(this,"CHAT",{from:F,username:D.username,text:D.text,ts:D.ts})),p(({talking:D},F)=>lt(this,Le,An).call(this,"PEER_TALKING",{from:F,talking:!!D})),v((D,F)=>lt(this,Le,An).call(this,"PEER_LEAVE",{from:F})),f(({presetId:D},F)=>{lt(this,Le,An).call(this,"AVATAR_CHANGE",{from:F,presetId:D}),Be.patchPeer(F,{presetId:D})}),_(({status:D},F)=>{lt(this,Le,An).call(this,"STATUS_CHANGE",{from:F,status:D}),Be.patchPeer(F,{status:D})}),U((D,F)=>{Be.heartbeat(F)}),T((D,F)=>{const B=Be.getSnapshot();O({identityId:lt(this,Le,ii).call(this),peers:B},[F])}),w(({peers:D={}},F)=>{const B=lt(this,Le,ii).call(this);for(const[j,V]of Object.entries(D)){if(j===B)continue;Be.upsertPeer(j,V)&&!b(this,zn).has(j)&&lt(this,Le,An).call(this,"HELLO",{from:j,username:V.username??"",presetId:V.presetId??0,status:V.status??"available"})}}),P((D,F)=>{Be.upsertPeer(F,D)&&!b(this,zn).has(F)&&lt(this,Le,An).call(this,"HELLO",{from:F,username:D.username??"",presetId:D.presetId??0,status:D.status??"available"})}),b(this,Ne).onPeerStream((D,F)=>{const B=D.getAudioTracks()[0];B&&(b(this,lr)?b(this,lr).call(this,B,D,F,F):b(this,io).push({track:B,stream:D,identityId:F,nostrPubkey:F}))}),ft(this,hr,setInterval(()=>{var D;(D=b(this,ho))==null||D.call(this,{identityId:lt(this,Le,ii).call(this)})},3e4)),Nl.schedule(()=>Be.pruneCold(),"prune-cold-rooms"),he.ok(r,"DHT ready — searching for peers"),he.info("Searching for peers in room…"),he.startFirstTimer(15e3)}stop(){var t,e;clearInterval(b(this,hr)),ft(this,hr,null),(t=b(this,co))==null||t.call(this),(e=b(this,Ne))==null||e.leave(),ft(this,Ne,null),b(this,zn).clear(),Nl.clear()}move(t,e,n,i=0){var r;(r=b(this,so))==null||r.call(this,{pos:{x:t,y:e,z:n,ry:i}})}chat(t){var e;(e=b(this,ro))==null||e.call(this,{username:b(this,sr),text:t,ts:Date.now()})}setAvatar(t){var e,n;ft(this,rr,t),(e=b(this,oo))==null||e.call(this,{presetId:t}),(n=b(this,cr))==null||n.call(this,{identityId:lt(this,Le,ii).call(this),presetId:t,v:++us(this,fo)._})}setStatus(t){var e,n;ft(this,or,t),(e=b(this,ao))==null||e.call(this,{status:t}),(n=b(this,cr))==null||n.call(this,{identityId:lt(this,Le,ii).call(this),status:t,v:++us(this,fo)._})}broadcastTalking(t){var e;(e=b(this,lo))==null||e.call(this,{talking:!!t})}addVoiceTrack(t,e){var n;b(this,ca).push({track:t,stream:e}),(n=b(this,Ne))==null||n.addStream(e)}onVoiceTrack(t){ft(this,lr,t);const e=b(this,io).splice(0);for(const{track:n,stream:i,identityId:r,nostrPubkey:o}of e)n.readyState!=="ended"&&t(n,i,r,o)}wireToIdentityId(t){return t}getPeers(){return{}}on(t,e){return b(this,hi)[t]||(b(this,hi)[t]=[]),b(this,hi)[t].push(e),()=>{b(this,hi)[t]=b(this,hi)[t].filter(n=>n!==e)}}get roomName(){return b(this,no)}get roomHash(){return b(this,ar)}get nodeUrl(){return null}}Ne=new WeakMap,hi=new WeakMap,sr=new WeakMap,rr=new WeakMap,or=new WeakMap,ar=new WeakMap,no=new WeakMap,kl=new WeakMap,zn=new WeakMap,ca=new WeakMap,lr=new WeakMap,io=new WeakMap,so=new WeakMap,ro=new WeakMap,oo=new WeakMap,ao=new WeakMap,lo=new WeakMap,co=new WeakMap,ha=new WeakMap,ho=new WeakMap,ua=new WeakMap,da=new WeakMap,cr=new WeakMap,uo=new WeakMap,fo=new WeakMap,hr=new WeakMap,Le=new WeakSet,ii=function(){var t;return((t=rc())==null?void 0:t.peerId)??"unknown"},An=function(t,e){var n;(n=b(this,hi)[t])==null||n.forEach(i=>i(e))};var Ye,rn,ur,po,mo,go,Ue,md,gd,zl,xn;class Rx extends EventTarget{constructor(){super(...arguments);at(this,Ue);at(this,Ye,null);at(this,rn,new Map);at(this,ur,!1);at(this,po,"");at(this,mo,0);at(this,go,"available")}get id(){var e;return((e=rc())==null?void 0:e.peerId)??""}get peers(){return[...b(this,rn).values()]}get peerCount(){return b(this,rn).size}get roomName(){var e;return((e=b(this,Ye))==null?void 0:e.roomName)??"main"}get nodeUrl(){var e;return((e=b(this,Ye))==null?void 0:e.nodeUrl)??null}async start(e,n=0,i="available"){if(b(this,ur))return;ft(this,ur,!0),ft(this,po,e),ft(this,mo,n),ft(this,go,i);let r;try{r=new wx(e,n,i),await r.start()}catch(o){if((o==null?void 0:o.message)==="NO_NODE")r=new ru(e,n,i),await r.start(o.roomHash,o.roomName,o.linkType,o.knownPeers??[]);else{he.info("xpacenode unreachable — falling back to public DHT route");const{parseCurrentLink:a,getKnownPeers:l}=await ul(async()=>{const{parseCurrentLink:u,getKnownPeers:d}=await Promise.resolve().then(()=>Pl);return{parseCurrentLink:u,getKnownPeers:d}},void 0,import.meta.url),c=await a(),h=l(c.roomHash);r=new ru(e,n,i),await r.start(c.roomHash,c.roomId,c.type,h)}}ft(this,Ye,r),lt(this,Ue,md).call(this),lt(this,Ue,xn).call(this,"status",{peerCount:b(this,rn).size})}stop(){var e;(e=b(this,Ye))==null||e.stop(),ft(this,Ye,null),b(this,rn).clear(),ft(this,ur,!1),Be.clearHot()}move(e,n,i,r=0){var o;(o=b(this,Ye))==null||o.move(e,n,i,r)}setAvatar(e){var n;ft(this,mo,e),(n=b(this,Ye))==null||n.setAvatar(e)}setStatus(e){var n;ft(this,go,e),(n=b(this,Ye))==null||n.setStatus(e)}sendChat(e){var i;if(!e.trim())return;const n=Date.now();lt(this,Ue,xn).call(this,"chat",{from:this.id,username:b(this,po),text:e,ts:n}),(i=b(this,Ye))==null||i.chat(e)}addVoiceTrack(e,n){var i;(i=b(this,Ye))==null||i.addVoiceTrack(e,n)}onVoiceTrack(e){var n;(n=b(this,Ye))==null||n.onVoiceTrack(e)}wireToIdentityId(e){var n;return(n=b(this,Ye))==null?void 0:n.wireToIdentityId(e)}broadcastTalking(e){var n;(n=b(this,Ye))==null||n.broadcastTalking(e)}}Ye=new WeakMap,rn=new WeakMap,ur=new WeakMap,po=new WeakMap,mo=new WeakMap,go=new WeakMap,Ue=new WeakSet,md=function(){const e=b(this,Ye);e.on("HELLO",({from:n,username:i,presetId:r=0,status:o="available"})=>{b(this,rn).has(n)||(lt(this,Ue,gd).call(this,n,i,r,o),Be.upsertPeer(n,{username:i,presetId:r,status:o,v:0}))}),e.on("PEER_LEAVE",({from:n})=>{lt(this,Ue,zl).call(this,n),Be.removePeer(n)}),e.on("MOVE",({from:n,pos:i})=>{lt(this,Ue,xn).call(this,"peer:move",{peerId:n,pos:i}),Be.updatePos(n,i)}),e.on("AVATAR_CHANGE",({from:n,presetId:i})=>{lt(this,Ue,xn).call(this,"peer:avatar",{peerId:n,presetId:i})}),e.on("STATUS_CHANGE",({from:n,status:i})=>{lt(this,Ue,xn).call(this,"peer:status",{peerId:n,status:i})}),e.on("PEER_TALKING",({from:n,talking:i})=>{lt(this,Ue,xn).call(this,"peer:talking",{peerId:n,talking:i})}),e.on("CHAT",({from:n,username:i,text:r,ts:o})=>{lt(this,Ue,xn).call(this,"chat",{from:n,username:i,text:r,ts:o})}),Be.addEventListener("peer:expired",({detail:{peerId:n}})=>{b(this,rn).has(n)&&lt(this,Ue,zl).call(this,n)})},gd=function(e,n,i,r){b(this,rn).set(e,{peerId:e,username:n,presetId:i,status:r}),lt(this,Ue,xn).call(this,"peer:join",{peerId:e,username:n,presetId:i,status:r}),lt(this,Ue,xn).call(this,"status",{peerCount:b(this,rn).size})},zl=function(e){b(this,rn).has(e)&&(b(this,rn).delete(e),lt(this,Ue,xn).call(this,"peer:leave",{peerId:e}),lt(this,Ue,xn).call(this,"status",{peerCount:b(this,rn).size}))},xn=function(e,n){this.dispatchEvent(new CustomEvent(e,{detail:n}))};const ce=new Rx,ti=Object.freeze({OCEAN:"ocean",COAST:"coast",DESERT:"desert",PLAINS:"plains",FOREST:"forest",MOUNTAIN:"mountain",ARCTIC:"arctic",JUNGLE:"jungle",TUNDRA:"tundra"});function Ko(s){let t=5381;for(let e=0;e<s.length;e++)t=Math.imul(t,33)^s.charCodeAt(e);return(t>>>0).toString(16).padStart(8,"0")}function _d(s,t,e,n){const i=JSON.stringify({parentHash:s,authorId:t,changes:e,timestamp:n});let r=Ko(i),o=Ko(r+i.slice(0,32)),a=Ko(o+i.slice(-32)),l=Ko(a+t);return r+o+a+l}class Zs{constructor(t,e,n,i="",r=Date.now()){this.parentHash=t,this.authorId=e,this.changes=Object.freeze([...n]),this.message=i,this.timestamp=r,this.hash=_d(t,e,n,r)}buildRevert(t,e=Date.now()){const n=this.changes.map(i=>({cellId:i.cellId,key:i.key,oldValue:i.newValue,newValue:i.oldValue}));return new Zs(this.hash,t,n,`revert: ${this.message||this.hash.slice(0,8)}`,e)}toJSON(){return{hash:this.hash,parentHash:this.parentHash,authorId:this.authorId,message:this.message,timestamp:this.timestamp,changes:this.changes}}}const Cx="universe",Px="genesis: the universe begins";var We,on;class Lx{constructor(){at(this,We,new Map);at(this,on,null);this._genesis()}_genesis(){const t=new Zs(null,Cx,[],Px,0);b(this,We).set(t.hash,t),ft(this,on,t.hash)}get head(){return b(this,on)}get length(){return b(this,We).size}getCommit(t){return b(this,We).get(t)??null}headCommit(){return b(this,We).get(b(this,on))}log(t=1/0){const e=[];let n=b(this,on);for(;n&&e.length<t;){const i=b(this,We).get(n);if(!i)break;e.push(i),n=i.parentHash}return e}stateAt(t){const e=[];let n=t;for(;n;){const r=b(this,We).get(n);if(!r)break;e.unshift(r),n=r.parentHash}const i=new Map;for(const r of e)for(const{cellId:o,key:a,newValue:l}of r.changes)i.set(`${o}:${a}`,l);return i}currentState(){return this.stateAt(b(this,on))}diff(t,e){const n=this.stateAt(t),i=this.stateAt(e),r=[],o=new Set([...n.keys(),...i.keys()]);for(const a of o){const l=n.get(a)??null,c=i.get(a)??null;if(l!==c){const[h,u]=a.split(":");r.push({cellId:h,key:u,before:l,after:c})}}return r}commit(t,e,n=""){if(!Array.isArray(e)||e.length===0)throw new Error("commit requires at least one change");for(const r of e)if(!r.cellId||!r.key)throw new Error("each change must have cellId and key");const i=new Zs(b(this,on),t,e,n);return b(this,We).set(i.hash,i),ft(this,on,i.hash),i}revert(t,e){const n=b(this,We).get(t);if(!n)throw new Error(`commit ${t} not found`);if(n.changes.length===0)throw new Error("cannot revert empty commit");n.buildRevert(e);const i=new Zs(b(this,on),e,[...n.changes].map(r=>({cellId:r.cellId,key:r.key,oldValue:r.newValue,newValue:r.oldValue})),`revert: ${n.message||n.hash.slice(0,8)}`);return b(this,We).set(i.hash,i),ft(this,on,i.hash),i}applyExternal(t){if(b(this,We).has(t.hash))return b(this,We).get(t.hash);if(t.parentHash&&!b(this,We).has(t.parentHash))throw new Error(`missing parent ${t.parentHash} — cannot apply ${t.hash}`);const e=new Zs(t.parentHash,t.authorId,t.changes,t.message,t.timestamp);return b(this,We).set(t.hash,e),t.parentHash===b(this,on)&&ft(this,on,t.hash),e}verify(){for(const t of b(this,We).values()){if(_d(t.parentHash,t.authorId,t.changes,t.timestamp)!==t.hash)return{valid:!1,broken:t.hash};if(t.parentHash&&!b(this,We).has(t.parentHash))return{valid:!1,broken:t.hash,reason:"missing-parent"}}return{valid:!0}}}We=new WeakMap,on=new WeakMap;const pe=Object.freeze({SOLAR:"solar",WIND:"wind",HYDRO:"hydro",MINERAL:"mineral",RARE_EARTH:"rare_earth",BIOLOGICAL:"biological",FISHERY:"fishery",GEOTHERMAL:"geothermal"});ti.OCEAN+"",pe.FISHERY+"",pe.WIND+"",ti.COAST+"",pe.FISHERY+"",pe.WIND+"",pe.SOLAR+"",ti.DESERT+"",pe.SOLAR+"",pe.RARE_EARTH+"",pe.MINERAL+"",ti.PLAINS+"",pe.WIND+"",pe.MINERAL+"",pe.BIOLOGICAL+"",pe.SOLAR+"",ti.FOREST+"",pe.BIOLOGICAL+"",pe.HYDRO+"",pe.WIND+"",ti.MOUNTAIN+"",pe.MINERAL+"",pe.RARE_EARTH+"",pe.GEOTHERMAL+"",pe.WIND+"",pe.HYDRO+"",ti.ARCTIC+"",pe.MINERAL+"",pe.WIND+"",ti.JUNGLE+"",pe.BIOLOGICAL+"",pe.HYDRO+"",pe.SOLAR+"",ti.TUNDRA+"",pe.MINERAL+"",pe.GEOTHERMAL+"",pe.WIND+"";(()=>{var u;const s=document.getElementById("conn-log"),t=document.getElementById("conn-log-body"),e=document.getElementById("conn-log-title"),n=document.getElementById("conn-log-toggle"),i=document.getElementById("conn-log-dismiss");if(!s)return;const r={pending:"⏳",ok:"✅",fail:"❌",warn:"⚠️",info:"·",host:"🏠"},o=new Map,a=()=>s.classList.remove("hidden"),l=()=>s.classList.add("hidden");he.addEventListener("step",({detail:d})=>{if(a(),d.action==="add"){const g=document.createElement("div");g.className=`cl-step ${d.status}`,g.innerHTML=`
      ...
      `,f.addEventListener("click",async()=>{try{const{link:g}=await oc({roomId:ce.roomName,node:ce.nodeUrl??void 0});await navigator.clipboard.writeText(g),f.textContent="✅ Copied!",setTimeout(()=>{f.textContent="🔗 Copy invite link"},2e3)}catch{}}),t.after(f)}});let h=null;ce.addEventListener("peer:join",()=>{var d;e.textContent="⬡ Connected",s.style.borderColor="",(d=document.getElementById("cl-host-share"))==null||d.remove(),clearTimeout(h),h=setTimeout(l,6e3)})})();(async()=>{const s=await ux(),t=new Lx;window._worldHistory=t;let e=!1;function n({peerCount:E}={}){document.querySelectorAll(".ipfs-dot").forEach(M=>{M.className="ipfs-dot green"}),document.querySelectorAll(".ipfs-label").forEach(M=>{M.textContent=`P2P · ${s.shortId}`});const v=document.getElementById("ipfs-tier");if(v&&e){const M=!!ce.nodeUrl;v.textContent=M?"xpacenode":"DHT fallback (slow)",v.className=M?"tier-node":"tier-fallback",v.title=M?`Connected via ${ce.nodeUrl}`:"xpacenode was unreachable — using public BitTorrent-tracker signaling instead"}E!==void 0&&document.querySelectorAll("#ipfs-peers").forEach(M=>{E>0?(M.textContent=`${E} peer${E!==1?"s":""}`,M.style.color="rgba(120,255,160,0.7)"):e?(M.textContent="· searching…",M.style.color="rgba(255,200,80,0.7)"):M.textContent=""})}n({peerCount:0}),ce.addEventListener("status",E=>n(E.detail)),ce.addEventListener("commit",E=>{try{t.applyExternal(E.detail.commit)}catch{}});const i=document.getElementById("lobby"),r=document.getElementById("loading"),o=document.getElementById("load-fill"),a=document.getElementById("load-text"),l=document.getElementById("hud"),c=document.getElementById("click-to-start"),h=document.getElementById("enter-btn"),u=document.getElementById("username"),d=document.getElementById("room-name");!s.isNew&&s.displayName&&(u.value=s.displayName),(async()=>{const{parseCurrentLink:E}=await ul(async()=>{const{parseCurrentLink:P}=await Promise.resolve().then(()=>Pl);return{parseCurrentLink:P}},void 0,import.meta.url),v=await E(),M=document.getElementById("lobby-invited"),U=document.getElementById("lobby-invited-room"),A=document.getElementById("lobby-default"),T=document.getElementById("lobby-create-row"),O=document.getElementById("lobby-room-row"),w=document.getElementById("create-btn"),x=document.getElementById("join-named-btn");v.type==="link"?(U.textContent=v.roomId,M.style.display="block",A.style.display="none",O.style.display="none",T.style.display="none",h.style.display="block",h.textContent="Join Room →"):v.type==="plain"?(d&&(d.value=v.roomId),Nr(v.roomId),A.style.display="none",T.style.display="none",h.style.display="block",h.textContent=`Enter ${v.roomId} →`):(M.style.display="none",T.style.display="none",O.style.display="none",h.style.display="block",h.textContent="Enter main →",Nr("main")),w==null||w.addEventListener("click",async()=>{const P=u.value.trim();if(!P){u.focus(),u.style.borderColor="#f55";return}u.style.borderColor="";const D=(d==null?void 0:d.value.trim())||`room-${Math.random().toString(36).slice(2,7)}`;Nr(D);try{const{createRoomLink:F}=await ul(async()=>{const{createRoomLink:V}=await Promise.resolve().then(()=>Pl);return{createRoomLink:V}},void 0,import.meta.url),{link:B}=await F({roomId:D});if(await navigator.clipboard.writeText(B).then(()=>!0).catch(()=>!1)){const V=w.textContent;w.textContent="✅ Link copied!",w.disabled=!0,setTimeout(()=>{w.textContent=V,w.disabled=!1},1800)}else{const V=document.createElement("div");V.style.cssText=`
          ...
          `,V.textContent=B,V.title="Click to select all",V.addEventListener("click",()=>{const et=document.createRange();et.selectNodeContents(V);const J=window.getSelection();J.removeAllRanges(),J.addRange(et)}),w.parentElement.insertBefore(V,w.nextSibling),setTimeout(()=>V.remove(),2e4)}}catch{}p(P)}),x==null||x.addEventListener("click",()=>{const P=u.value.trim();if(!P){u.focus(),u.style.borderColor="#f55";return}u.style.borderColor="";const D=(d==null?void 0:d.value.trim())||"main";Nr(D),p(P)}),h==null||h.addEventListener("click",()=>{const P=u.value.trim();if(!P){u.focus(),u.style.borderColor="#f55";return}u.style.borderColor="",p(P)})})();const f=document.getElementById("id-fingerprint");f&&(f.textContent=s.isNew?"New identity generated":`Identity · ${s.shortId}`),function(){const v=document.getElementById("lobby-avatar-grid");if(!v)return;const M=parseInt(localStorage.getItem("spaceAvatarId")??"0",10),U=A=>"#"+A.toString(16).padStart(6,"0");cs.forEach(A=>{const T=U(A.skin),O=U(A.hair),w=U(A.outfit),x=U(A.accent),P=document.createElement("div");P.className="lav-chip"+(A.id===M?" lav-active":""),P.dataset.id=String(A.id),P.title=A.label,P.innerHTML=`<svg viewBox="0 0 60 82" xmlns="http://www.w3.org/2000/svg">
        ...
        `,Xt.appendChild(we),Xt.scrollTop=Xt.scrollHeight,!Gt.classList.contains("open")&&!xe){_e++;const On=_e>9?"9+":String(_e);Wt.textContent=On,Wt.classList.add("visible"),C&&(C.textContent=On,C.classList.add("visible"))}}function it(X){const xt=document.createElement("div");xt.className="chat-system",xt.textContent=X,Xt.appendChild(xt),Xt.scrollTop=Xt.scrollHeight}const Lt=new Map;ce.addEventListener("chat",X=>st(X.detail)),ce.addEventListener("peer:join",X=>{Lt.set(X.detail.peerId,X.detail.username),it(`${X.detail.username} joined`)}),ce.addEventListener("peer:leave",X=>{const xt=Lt.get(X.detail.peerId)??"Someone";Lt.delete(X.detail.peerId),it(`${xt} left`)});const pt=new ex,mt=new ix,Yt=new tx(E);pt.createReality(Yt),mt.setNode(E,ks.PUBLIC),(se=document.getElementById("nm-open-btn"))==null||se.addEventListener("click",X=>{X.stopPropagation(),Qh(pt,mt,E)}),(ln=document.getElementById("leave-room-btn"))==null||ln.addEventListener("click",()=>{ce.stop(),history.replaceState(null,"",window.location.pathname+window.location.search),window.location.reload()});const rt=document.getElementById("invite-modal"),Tt=document.getElementById("invite-lock-input"),Kt=document.getElementById("invite-link-box"),Ut=document.getElementById("invite-link-text"),vt=document.getElementById("invite-room-name"),Dt=document.getElementById("invite-generate-btn"),kt=document.getElementById("invite-copy-btn"),ve=document.getElementById("invite-close-btn");let N="";const Mt=()=>{vt.textContent=`Room: ${ce.roomName}`,Tt.value="",Kt.style.display="none",kt.style.display="none",Dt.style.display="",Dt.textContent="Generate link",rt.style.display="flex",setTimeout(()=>Tt.focus(),50)};(cn=document.getElementById("invite-btn"))==null||cn.addEventListener("click",X=>{X.stopPropagation(),Mt()}),ve==null||ve.addEventListener("click",()=>{rt.style.display="none"}),rt==null||rt.addEventListener("click",X=>{X.target===rt&&(rt.style.display="none")}),Dt==null||Dt.addEventListener("click",async()=>{Dt.textContent="Generating…",Dt.disabled=!0;try{const{link:X}=await oc({roomId:ce.roomName,lockCode:Tt.value.trim(),node:ce.nodeUrl??void 0});N=X,Ut.textContent=X,Kt.style.display="block",kt.style.display="",Dt.style.display="none",navigator.clipboard.writeText(X).catch(()=>{})}catch(X){console.error("[invite] link generation failed",X),Dt.textContent="Generate link"}finally{Dt.disabled=!1}}),kt==null||kt.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(N);const X=kt.textContent;kt.textContent="✅ Copied!",setTimeout(()=>{kt.textContent=X},2e3)}catch{prompt("Copy this link:",N)}}),Ut==null||Ut.addEventListener("click",()=>kt==null?void 0:kt.click()),Tt==null||Tt.addEventListener("keydown",X=>{X.key==="Enter"&&(Dt==null||Dt.click())}),(Un=document.getElementById("mb-avatar-btn"))==null||Un.addEventListener("click",()=>{var X;return(X=document.getElementById("avatar-btn"))==null?void 0:X.click()}),(hs=document.getElementById("mb-nm-btn"))==null||hs.addEventListener("click",X=>{X.stopPropagation(),Qh(pt,mt,E)}),(Er=document.getElementById("mb-voice-btn"))==null||Er.addEventListener("click",X=>{X.stopPropagation(),$==null||$.click()}),(wr=document.getElementById("mb-status-btn"))==null||wr.addEventListener("click",X=>{X.stopPropagation(),V==null||V.click()}),K.onStateChange(({active:X,muted:xt}={})=>{const Et=document.getElementById("mb-voice-btn");Et&&(X?xt?(Et.innerHTML="🔇",Et.className="mb-btn mb-voice-active",Et.style.color="#ff6b6b"):(Et.innerHTML="🎙",Et.className="mb-btn mb-voice-active",Et.style.color=""):(Et.innerHTML="🎙",Et.className="mb-btn"))});const Q=document.getElementById("screen-hint"),tt=document.getElementById("screen-hint-name");let ct=null,Ot=null;document.addEventListener("keydown",X=>{if(X.code==="KeyE"&&ct&&!x()&&w(ct),X.code==="KeyF"&&Ot){const xt=Ot.def.id,Et=xt==="main-left"||xt==="main-right",jt=ni(Et?"main-left":xt);Et&&ni("main-right"),ie(Ot.def.label,jt)}});function ie(X,xt){let Et=document.getElementById("door-action-hint");Et||(Et=document.createElement("div"),Et.id="door-action-hint",Et.style.cssText=`
          ...
          `,document.body.appendChild(Et)),Et.textContent=`${X} ${xt?"opened":"closed"}`,Et.style.opacity="1",clearTimeout(Et._t),Et._t=setTimeout(()=>{Et.style.opacity="0"},1500)}const ae=new Set;setInterval(()=>{var He;if(x())return;const X=B.getPosition();let xt=null,Et=4;O.forEach(we=>{const On=X.x-we.position.x,S=X.z-we.position.z,z=Math.sqrt(On*On+S*S);z<Et&&(Et=z,xt=we)}),ct=xt,Q&&(Q.style.display=xt?"flex":"none",xt&&tt&&(tt.textContent=xt.label)),xo.forEach(we=>{const On=X.x-we.hinge.x,S=X.z-we.hinge.z,z=Math.sqrt(On*On+S*S),G=we.id;z<2.2&&!Fs(G)?(ni(G),ae.add(G),G==="main-left"&&(Fs("main-right")||ni("main-right"),ae.add("main-right")),G==="main-right"&&(Fs("main-left")||ni("main-left"),ae.add("main-left"))):z>3.5&&ae.has(G)&&Fs(G)&&(ni(G),ae.delete(G),G==="main-left"&&(Fs("main-right")&&ni("main-right"),ae.delete("main-right")),G==="main-right"&&(Fs("main-left")&&ni("main-left"),ae.delete("main-left")))});const jt=Qu(X,2.8);Ot=jt;const xe=document.getElementById("door-proximity-hint");if(xe)if(jt&&!xt){const we=(He=jt.state)!=null&&He.open?"Close":"Open";xe.style.display="flex",xe.querySelector("#door-hint-name").textContent=`${we} ${jt.def.label}`}else xe.style.display="none"},150)})}})();function Ix(s){let t=0;for(let e=0;e<s.length;e++)t=t*31+s.charCodeAt(e)|0;return Math.abs(t)%cs.length}function ou(s,t){var n;const e=(n=s==null?void 0:s.querySelector)==null?void 0:n.call(s,"#online-count");e&&(e.textContent=`● ${t} aboard`)}const au={OUTSIDE:{color:"#88cc66",desc:"Outside the building"},LOBBY:{color:"#ffffff",desc:"Reception & Entrance"},OPS:{color:"#ffaa44",desc:"Operations & Technical Support"},FUN:{color:"#44ffaa",desc:"Chill, Social & Games"},DESIGN:{color:"#ff6ba0",desc:"UI/UX, Design & 3D"},ENGINEERING:{color:"#44aaff",desc:"Development & Engineering"},"":{color:"#ffffff",desc:""}};function Dx(s){const t=document.getElementById("zone-name"),e=document.getElementById("zone-desc"),n=au[s]||au[""];t&&(t.textContent=s,t.style.color=n.color),e&&(e.textContent=n.desc),document.querySelectorAll(".map-zone").forEach(i=>{i.classList.toggle("active",i.dataset.zone===s)})}
