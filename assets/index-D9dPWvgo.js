...
void main() {
	...
	`}function am(i){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===ta||l===ea,h=l===vs||l===xs;if(c||h){let u=t.get(a);const d=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return e===null&&(e=new Hl(i)),u=c?e.fromEquirectangular(a,u):e.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),u.texture;if(u!==void 0)return u.texture;{const f=a.image;return c&&f&&f.height>0||h&&f&&s(f)?(e===null&&(e=new Hl(i)),u=c?e.fromEquirectangular(a):e.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function s(a){let l=0;const c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function lm(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const s=e(n);return s===null&&va("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function cm(i,t,e,n){const s={},r=new WeakMap;function o(u){const d=u.target;d.index!==null&&t.remove(d.index);for(const g in d.attributes)t.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let m=0,p=_.length;m<p;m++)t.remove(_[m])}d.removeEventListener("dispose",o),delete s[d.id];const f=r.get(d);f&&(t.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function a(u,d){return s[d.id]===!0||(d.addEventListener("dispose",o),s[d.id]=!0,e.memory.geometries++),d}function l(u){const d=u.attributes;for(const g in d)t.update(d[g],i.ARRAY_BUFFER);const f=u.morphAttributes;for(const g in f){const _=f[g];for(let m=0,p=_.length;m<p;m++)t.update(_[m],i.ARRAY_BUFFER)}}function c(u){const d=[],f=u.index,g=u.attributes.position;let _=0;if(f!==null){const b=f.array;_=f.version;for(let y=0,E=b.length;y<E;y+=3){const N=b[y+0],A=b[y+1],T=b[y+2];d.push(N,A,A,T,T,N)}}else if(g!==void 0){const b=g.array;_=g.version;for(let y=0,E=b.length/3-1;y<E;y+=3){const N=y+0,A=y+1,T=y+2;d.push(N,A,A,T,T,N)}}else return;const m=new($c(d)?eh:th)(d,1);m.version=_;const p=r.get(u);p&&t.remove(p),r.set(u,m)}function h(u){const d=r.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&c(u)}else c(u);return r.get(u)}return{get:a,update:l,getWireframeAttribute:h}}function hm(i,t,e){let n;function s(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function l(d,f){i.drawElements(n,f,r,d*o),e.update(f,n,1)}function c(d,f,g){g!==0&&(i.drawElementsInstanced(n,f,r,d*o,g),e.update(f,n,g))}function h(d,f,g){if(g===0)return;const _=t.get("WEBGL_multi_draw");if(_===null)for(let m=0;m<g;m++)this.render(d[m]/o,f[m]);else{_.multiDrawElementsWEBGL(n,f,0,r,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];e.update(m,n,1)}}function u(d,f,g,_){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)c(d[p]/o,f[p],_[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,_,0,g);let p=0;for(let b=0;b<g;b++)p+=f[b];for(let b=0;b<_.length;b++)e.update(p,n,_[b])}}this.setMode=s,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function um(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(r/3);break;case i.LINES:e.lines+=a*(r/2);break;case i.LINE_STRIP:e.lines+=a*(r-1);break;case i.LINE_LOOP:e.lines+=a*r;break;case i.POINTS:e.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function dm(i,t,e){const n=new WeakMap,s=new pe;function r(o,a,l){const c=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(a);if(d===void 0||d.count!==u){let w=function(){T.dispose(),n.delete(a),a.removeEventListener("dispose",w)};d!==void 0&&d.texture.dispose();const f=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,_=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],p=a.morphAttributes.normal||[],b=a.morphAttributes.color||[];let y=0;f===!0&&(y=1),g===!0&&(y=2),_===!0&&(y=3);let E=a.attributes.position.count*y,N=1;E>t.maxTextureSize&&(N=Math.ceil(E/t.maxTextureSize),E=t.maxTextureSize);const A=new Float32Array(E*N*4*u),T=new Jc(A,E,N,u);T.type=ti,T.needsUpdate=!0;const D=y*4;for(let v=0;v<u;v++){const I=m[v],G=p[v],z=b[v],k=E*N*4*v;for(let tt=0;tt<I.count;tt++){const $=tt*D;f===!0&&(s.fromBufferAttribute(I,tt),A[k+$+0]=s.x,A[k+$+1]=s.y,A[k+$+2]=s.z,A[k+$+3]=0),g===!0&&(s.fromBufferAttribute(G,tt),A[k+$+4]=s.x,A[k+$+5]=s.y,A[k+$+6]=s.z,A[k+$+7]=0),_===!0&&(s.fromBufferAttribute(z,tt),A[k+$+8]=s.x,A[k+$+9]=s.y,A[k+$+10]=s.z,A[k+$+11]=z.itemSize===4?s.w:1)}}d={count:u,texture:T,size:new mt(E,N)},n.set(a,d),a.addEventListener("dispose",w)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let f=0;for(let _=0;_<c.length;_++)f+=c[_];const g=a.morphTargetsRelative?1:1-f;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function fm(i,t,e,n){let s=new WeakMap;function r(l){const c=n.render.frame,h=l.geometry,u=t.get(l,h);if(s.get(u)!==c&&(t.update(u),s.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),s.get(l)!==c&&(e.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;s.get(d)!==c&&(d.update(),s.set(d,c))}return u}function o(){s=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:r,dispose:o}}class ah extends Ve{constructor(t,e,n,s,r,o,a,l,c,h=cs){if(h!==cs&&h!==Ss)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===cs&&(n=ys),n===void 0&&h===Ss&&(n=Ms),super(null,s,r,o,a,l,h,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:rn,this.minFilter=l!==void 0?l:rn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const lh=new Ve,ch=new ah(1,1);ch.compareFunction=qc;const hh=new Jc,uh=new ju,dh=new sh,Xl=[],Zl=[],Yl=new Float32Array(16),ql=new Float32Array(9),$l=new Float32Array(4);function Ts(i,t,e){const n=i[0];if(n<=0||n>0)return i;const s=t*e;let r=Xl[s];if(r===void 0&&(r=new Float32Array(s),Xl[s]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(r,a)}return r}function Ae(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function Re(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function eo(i,t){let e=Zl[t];e===void 0&&(e=new Int32Array(t),Zl[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function pm(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function mm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ae(e,t))return;i.uniform2fv(this.addr,t),Re(e,t)}}function gm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Ae(e,t))return;i.uniform3fv(this.addr,t),Re(e,t)}}function _m(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ae(e,t))return;i.uniform4fv(this.addr,t),Re(e,t)}}function vm(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ae(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),Re(e,t)}else{if(Ae(e,n))return;$l.set(n),i.uniformMatrix2fv(this.addr,!1,$l),Re(e,n)}}function xm(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ae(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),Re(e,t)}else{if(Ae(e,n))return;ql.set(n),i.uniformMatrix3fv(this.addr,!1,ql),Re(e,n)}}function ym(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ae(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),Re(e,t)}else{if(Ae(e,n))return;Yl.set(n),i.uniformMatrix4fv(this.addr,!1,Yl),Re(e,n)}}function Mm(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function Sm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ae(e,t))return;i.uniform2iv(this.addr,t),Re(e,t)}}function Em(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ae(e,t))return;i.uniform3iv(this.addr,t),Re(e,t)}}function wm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ae(e,t))return;i.uniform4iv(this.addr,t),Re(e,t)}}function bm(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Tm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ae(e,t))return;i.uniform2uiv(this.addr,t),Re(e,t)}}function Am(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ae(e,t))return;i.uniform3uiv(this.addr,t),Re(e,t)}}function Rm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ae(e,t))return;i.uniform4uiv(this.addr,t),Re(e,t)}}function Cm(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);const r=this.type===i.SAMPLER_2D_SHADOW?ch:lh;e.setTexture2D(t||r,s)}function Pm(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||uh,s)}function Lm(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||dh,s)}function Im(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||hh,s)}function Dm(i){switch(i){case 5126:return pm;case 35664:return mm;case 35665:return gm;case 35666:return _m;case 35674:return vm;case 35675:return xm;case 35676:return ym;case 5124:case 35670:return Mm;case 35667:case 35671:return Sm;case 35668:case 35672:return Em;case 35669:case 35673:return wm;case 5125:return bm;case 36294:return Tm;case 36295:return Am;case 36296:return Rm;case 35678:case 36198:case 36298:case 36306:case 35682:return Cm;case 35679:case 36299:case 36307:return Pm;case 35680:case 36300:case 36308:case 36293:return Lm;case 36289:case 36303:case 36311:case 36292:return Im}}function Nm(i,t){i.uniform1fv(this.addr,t)}function Um(i,t){const e=Ts(t,this.size,2);i.uniform2fv(this.addr,e)}function Om(i,t){const e=Ts(t,this.size,3);i.uniform3fv(this.addr,e)}function Fm(i,t){const e=Ts(t,this.size,4);i.uniform4fv(this.addr,e)}function Bm(i,t){const e=Ts(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function zm(i,t){const e=Ts(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function km(i,t){const e=Ts(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function Hm(i,t){i.uniform1iv(this.addr,t)}function Gm(i,t){i.uniform2iv(this.addr,t)}function Vm(i,t){i.uniform3iv(this.addr,t)}function Wm(i,t){i.uniform4iv(this.addr,t)}function Xm(i,t){i.uniform1uiv(this.addr,t)}function Zm(i,t){i.uniform2uiv(this.addr,t)}function Ym(i,t){i.uniform3uiv(this.addr,t)}function qm(i,t){i.uniform4uiv(this.addr,t)}function $m(i,t,e){const n=this.cache,s=t.length,r=eo(e,s);Ae(n,r)||(i.uniform1iv(this.addr,r),Re(n,r));for(let o=0;o!==s;++o)e.setTexture2D(t[o]||lh,r[o])}function Km(i,t,e){const n=this.cache,s=t.length,r=eo(e,s);Ae(n,r)||(i.uniform1iv(this.addr,r),Re(n,r));for(let o=0;o!==s;++o)e.setTexture3D(t[o]||uh,r[o])}function Jm(i,t,e){const n=this.cache,s=t.length,r=eo(e,s);Ae(n,r)||(i.uniform1iv(this.addr,r),Re(n,r));for(let o=0;o!==s;++o)e.setTextureCube(t[o]||dh,r[o])}function jm(i,t,e){const n=this.cache,s=t.length,r=eo(e,s);Ae(n,r)||(i.uniform1iv(this.addr,r),Re(n,r));for(let o=0;o!==s;++o)e.setTexture2DArray(t[o]||hh,r[o])}function Qm(i){switch(i){case 5126:return Nm;case 35664:return Um;case 35665:return Om;case 35666:return Fm;case 35674:return Bm;case 35675:return zm;case 35676:return km;case 5124:case 35670:return Hm;case 35667:case 35671:return Gm;case 35668:case 35672:return Vm;case 35669:case 35673:return Wm;case 5125:return Xm;case 36294:return Zm;case 36295:return Ym;case 36296:return qm;case 35678:case 36198:case 36298:case 36306:case 35682:return $m;case 35679:case 36299:case 36307:return Km;case 35680:case 36300:case 36308:case 36293:return Jm;case 36289:case 36303:case 36311:case 36292:return jm}}class t0{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Dm(e.type)}}class e0{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Qm(e.type)}}class n0{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(t,e[a.id],n)}}}const Ho=/(\w+)(\])?(\[|\.)?/g;function Kl(i,t){i.seq.push(t),i.map[t.id]=t}function i0(i,t,e){const n=i.name,s=n.length;for(Ho.lastIndex=0;;){const r=Ho.exec(n),o=Ho.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===s){Kl(e,c===void 0?new t0(a,i,t):new e0(a,i,t));break}else{let u=e.map[a];u===void 0&&(u=new n0(a),Kl(e,u)),e=u}}}class kr{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=t.getActiveUniform(e,s),o=t.getUniformLocation(e,r.name);i0(r,o,this)}}setValue(t,e,n,s){const r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){const s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,o=e.length;r!==o;++r){const a=e[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(t,l.value,s)}}static seqWithValue(t,e){const n=[];for(let s=0,r=t.length;s!==r;++s){const o=t[s];o.id in e&&n.push(o)}return n}}function Jl(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const s0=37297;let r0=0;function o0(i,t){const e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}function a0(i){const t=se.getPrimaries(se.workingColorSpace),e=se.getPrimaries(i);let n;switch(t===e?n="":t===Xr&&e===Wr?n="LinearDisplayP3ToLinearSRGB":t===Wr&&e===Xr&&(n="LinearSRGBToLinearDisplayP3"),i){case ci:case to:return[n,"LinearTransferOETF"];case _n:case _a:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function jl(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),s=i.getShaderInfoLog(t).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+o0(i.getShaderSource(t),o)}else return s}function l0(i,t){const e=a0(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function c0(i,t){let e;switch(t){case _u:e="Linear";break;case vu:e="Reinhard";break;case xu:e="OptimizedCineon";break;case zc:e="ACESFilmic";break;case Mu:e="AgX";break;case Su:e="Neutral";break;case yu:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function h0(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Fs).join(`
`)}function u0(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function d0(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function Fs(i){return i!==""}function Ql(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function tc(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const f0=/^[ \t]*#include +<([\w\d./]+)>/gm;function oa(i){return i.replace(f0,m0)}const p0=new Map;function m0(i,t){let e=Gt[t];if(e===void 0){const n=p0.get(t);if(n!==void 0)e=Gt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return oa(e)}const g0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ec(i){return i.replace(g0,_0)}function _0(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function nc(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function v0(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Oc?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Fc?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===In&&(t="SHADOWMAP_TYPE_VSM"),t}function x0(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case vs:case xs:t="ENVMAP_TYPE_CUBE";break;case jr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function y0(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case xs:t="ENVMAP_MODE_REFRACTION";break}return t}function M0(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Bc:t="ENVMAP_BLENDING_MULTIPLY";break;case mu:t="ENVMAP_BLENDING_MIX";break;case gu:t="ENVMAP_BLENDING_ADD";break}return t}function S0(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function E0(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=v0(e),c=x0(e),h=y0(e),u=M0(e),d=S0(e),f=h0(e),g=u0(r),_=s.createProgram();let m,p,b=e.glslVersion?"#version "+e.glslVersion+`
...
}`;function H0(i,t,e){let n=new Ma;const s=new mt,r=new mt,o=new pe,a=new F0({depthPacking:Uu}),l=new B0,c={},h=e.maxTextureSize,u={[ri]:Xe,[Xe]:ri,[Je]:Je},d=new ai({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new mt},radius:{value:4}},vertexShader:z0,fragmentShader:k0}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new je;g.setAttribute("position",new dn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new yt(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Oc;let p=this.type;this.render=function(A,T,D){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;const w=i.getRenderTarget(),v=i.getActiveCubeFace(),I=i.getActiveMipmapLevel(),G=i.state;G.setBlending(ei),G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const z=p!==In&&this.type===In,k=p===In&&this.type!==In;for(let tt=0,$=A.length;tt<$;tt++){const at=A[tt],J=at.shadow;if(J===void 0){console.warn("THREE.WebGLShadowMap:",at,"has no shadow.");continue}if(J.autoUpdate===!1&&J.needsUpdate===!1)continue;s.copy(J.mapSize);const gt=J.getFrameExtents();if(s.multiply(gt),r.copy(J.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/gt.x),s.x=r.x*gt.x,J.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/gt.y),s.y=r.y*gt.y,J.mapSize.y=r.y)),J.map===null||z===!0||k===!0){const St=this.type!==In?{minFilter:rn,magFilter:rn}:{};J.map!==null&&J.map.dispose(),J.map=new bi(s.x,s.y,St),J.map.texture.name=at.name+".shadowMap",J.camera.updateProjectionMatrix()}i.setRenderTarget(J.map),i.clear();const Mt=J.getViewportCount();for(let St=0;St<Mt;St++){const Z=J.getViewport(St);o.set(r.x*Z.x,r.y*Z.y,r.x*Z.z,r.y*Z.w),G.viewport(o),J.updateMatrices(at,St),n=J.getFrustum(),E(T,D,J.camera,at,this.type)}J.isPointLightShadow!==!0&&this.type===In&&b(J,D),J.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(w,v,I)};function b(A,T){const D=t.update(_);d.defines.VSM_SAMPLES!==A.blurSamples&&(d.defines.VSM_SAMPLES=A.blurSamples,f.defines.VSM_SAMPLES=A.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new bi(s.x,s.y)),d.uniforms.shadow_pass.value=A.map.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,i.setRenderTarget(A.mapPass),i.clear(),i.renderBufferDirect(T,null,D,d,_,null),f.uniforms.shadow_pass.value=A.mapPass.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,i.setRenderTarget(A.map),i.clear(),i.renderBufferDirect(T,null,D,f,_,null)}function y(A,T,D,w){let v=null;const I=D.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(I!==void 0)v=I;else if(v=D.isPointLight===!0?l:a,i.localClippingEnabled&&T.clipShadows===!0&&Array.isArray(T.clippingPlanes)&&T.clippingPlanes.length!==0||T.displacementMap&&T.displacementScale!==0||T.alphaMap&&T.alphaTest>0||T.map&&T.alphaTest>0){const G=v.uuid,z=T.uuid;let k=c[G];k===void 0&&(k={},c[G]=k);let tt=k[z];tt===void 0&&(tt=v.clone(),k[z]=tt,T.addEventListener("dispose",N)),v=tt}if(v.visible=T.visible,v.wireframe=T.wireframe,w===In?v.side=T.shadowSide!==null?T.shadowSide:T.side:v.side=T.shadowSide!==null?T.shadowSide:u[T.side],v.alphaMap=T.alphaMap,v.alphaTest=T.alphaTest,v.map=T.map,v.clipShadows=T.clipShadows,v.clippingPlanes=T.clippingPlanes,v.clipIntersection=T.clipIntersection,v.displacementMap=T.displacementMap,v.displacementScale=T.displacementScale,v.displacementBias=T.displacementBias,v.wireframeLinewidth=T.wireframeLinewidth,v.linewidth=T.linewidth,D.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const G=i.properties.get(v);G.light=D}return v}function E(A,T,D,w,v){if(A.visible===!1)return;if(A.layers.test(T.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&v===In)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,A.matrixWorld);const z=t.update(A),k=A.material;if(Array.isArray(k)){const tt=z.groups;for(let $=0,at=tt.length;$<at;$++){const J=tt[$],gt=k[J.materialIndex];if(gt&&gt.visible){const Mt=y(A,gt,w,v);A.onBeforeShadow(i,A,T,D,z,Mt,J),i.renderBufferDirect(D,null,z,Mt,A,J),A.onAfterShadow(i,A,T,D,z,Mt,J)}}}else if(k.visible){const tt=y(A,k,w,v);A.onBeforeShadow(i,A,T,D,z,tt,null),i.renderBufferDirect(D,null,z,tt,A,null),A.onAfterShadow(i,A,T,D,z,tt,null)}}const G=A.children;for(let z=0,k=G.length;z<k;z++)E(G[z],T,D,w,v)}function N(A){A.target.removeEventListener("dispose",N);for(const D in c){const w=c[D],v=A.target.uuid;v in w&&(w[v].dispose(),delete w[v])}}}function G0(i){function t(){let M=!1;const Y=new pe;let F=null;const X=new pe(0,0,0,0);return{setMask:function(et){F!==et&&!M&&(i.colorMask(et,et,et,et),F=et)},setLocked:function(et){M=et},setClear:function(et,wt,Ot,te,de){de===!0&&(et*=te,wt*=te,Ot*=te),Y.set(et,wt,Ot,te),X.equals(Y)===!1&&(i.clearColor(et,wt,Ot,te),X.copy(Y))},reset:function(){M=!1,F=null,X.set(-1,0,0,0)}}}function e(){let M=!1,Y=null,F=null,X=null;return{setTest:function(et){et?j(i.DEPTH_TEST):Q(i.DEPTH_TEST)},setMask:function(et){Y!==et&&!M&&(i.depthMask(et),Y=et)},setFunc:function(et){if(F!==et){switch(et){case lu:i.depthFunc(i.NEVER);break;case cu:i.depthFunc(i.ALWAYS);break;case hu:i.depthFunc(i.LESS);break;case Hr:i.depthFunc(i.LEQUAL);break;case uu:i.depthFunc(i.EQUAL);break;case du:i.depthFunc(i.GEQUAL);break;case fu:i.depthFunc(i.GREATER);break;case pu:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}F=et}},setLocked:function(et){M=et},setClear:function(et){X!==et&&(i.clearDepth(et),X=et)},reset:function(){M=!1,Y=null,F=null,X=null}}}function n(){let M=!1,Y=null,F=null,X=null,et=null,wt=null,Ot=null,te=null,de=null;return{setTest:function(Kt){M||(Kt?j(i.STENCIL_TEST):Q(i.STENCIL_TEST))},setMask:function(Kt){Y!==Kt&&!M&&(i.stencilMask(Kt),Y=Kt)},setFunc:function(Kt,ve,pn){(F!==Kt||X!==ve||et!==pn)&&(i.stencilFunc(Kt,ve,pn),F=Kt,X=ve,et=pn)},setOp:function(Kt,ve,pn){(wt!==Kt||Ot!==ve||te!==pn)&&(i.stencilOp(Kt,ve,pn),wt=Kt,Ot=ve,te=pn)},setLocked:function(Kt){M=Kt},setClear:function(Kt){de!==Kt&&(i.clearStencil(Kt),de=Kt)},reset:function(){M=!1,Y=null,F=null,X=null,et=null,wt=null,Ot=null,te=null,de=null}}}const s=new t,r=new e,o=new n,a=new WeakMap,l=new WeakMap;let c={},h={},u=new WeakMap,d=[],f=null,g=!1,_=null,m=null,p=null,b=null,y=null,E=null,N=null,A=new $t(0,0,0),T=0,D=!1,w=null,v=null,I=null,G=null,z=null;const k=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let tt=!1,$=0;const at=i.getParameter(i.VERSION);at.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(at)[1]),tt=$>=1):at.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(at)[1]),tt=$>=2);let J=null,gt={};const Mt=i.getParameter(i.SCISSOR_BOX),St=i.getParameter(i.VIEWPORT),Z=new pe().fromArray(Mt),st=new pe().fromArray(St);function U(M,Y,F,X){const et=new Uint8Array(4),wt=i.createTexture();i.bindTexture(M,wt),i.texParameteri(M,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(M,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ot=0;Ot<F;Ot++)M===i.TEXTURE_3D||M===i.TEXTURE_2D_ARRAY?i.texImage3D(Y,0,i.RGBA,1,1,X,0,i.RGBA,i.UNSIGNED_BYTE,et):i.texImage2D(Y+Ot,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,et);return wt}const q={};q[i.TEXTURE_2D]=U(i.TEXTURE_2D,i.TEXTURE_2D,1),q[i.TEXTURE_CUBE_MAP]=U(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[i.TEXTURE_2D_ARRAY]=U(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),q[i.TEXTURE_3D]=U(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),o.setClear(0),j(i.DEPTH_TEST),r.setFunc(Hr),At(!1),Wt(Ha),j(i.CULL_FACE),Nt(ei);function j(M){c[M]!==!0&&(i.enable(M),c[M]=!0)}function Q(M){c[M]!==!1&&(i.disable(M),c[M]=!1)}function ft(M,Y){return h[M]!==Y?(i.bindFramebuffer(M,Y),h[M]=Y,M===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=Y),M===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=Y),!0):!1}function vt(M,Y){let F=d,X=!1;if(M){F=u.get(Y),F===void 0&&(F=[],u.set(Y,F));const et=M.textures;if(F.length!==et.length||F[0]!==i.COLOR_ATTACHMENT0){for(let wt=0,Ot=et.length;wt<Ot;wt++)F[wt]=i.COLOR_ATTACHMENT0+wt;F.length=et.length,X=!0}}else F[0]!==i.BACK&&(F[0]=i.BACK,X=!0);X&&i.drawBuffers(F)}function Dt(M){return f!==M?(i.useProgram(M),f=M,!0):!1}const P={[yi]:i.FUNC_ADD,[Xh]:i.FUNC_SUBTRACT,[Zh]:i.FUNC_REVERSE_SUBTRACT};P[Yh]=i.MIN,P[qh]=i.MAX;const kt={[$h]:i.ZERO,[Kh]:i.ONE,[Jh]:i.SRC_COLOR,[jo]:i.SRC_ALPHA,[iu]:i.SRC_ALPHA_SATURATE,[eu]:i.DST_COLOR,[Qh]:i.DST_ALPHA,[jh]:i.ONE_MINUS_SRC_COLOR,[Qo]:i.ONE_MINUS_SRC_ALPHA,[nu]:i.ONE_MINUS_DST_COLOR,[tu]:i.ONE_MINUS_DST_ALPHA,[su]:i.CONSTANT_COLOR,[ru]:i.ONE_MINUS_CONSTANT_COLOR,[ou]:i.CONSTANT_ALPHA,[au]:i.ONE_MINUS_CONSTANT_ALPHA};function Nt(M,Y,F,X,et,wt,Ot,te,de,Kt){if(M===ei){g===!0&&(Q(i.BLEND),g=!1);return}if(g===!1&&(j(i.BLEND),g=!0),M!==Wh){if(M!==_||Kt!==D){if((m!==yi||y!==yi)&&(i.blendEquation(i.FUNC_ADD),m=yi,y=yi),Kt)switch(M){case ls:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ga:i.blendFunc(i.ONE,i.ONE);break;case Va:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Wa:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",M);break}else switch(M){case ls:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ga:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Va:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Wa:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",M);break}p=null,b=null,E=null,N=null,A.set(0,0,0),T=0,_=M,D=Kt}return}et=et||Y,wt=wt||F,Ot=Ot||X,(Y!==m||et!==y)&&(i.blendEquationSeparate(P[Y],P[et]),m=Y,y=et),(F!==p||X!==b||wt!==E||Ot!==N)&&(i.blendFuncSeparate(kt[F],kt[X],kt[wt],kt[Ot]),p=F,b=X,E=wt,N=Ot),(te.equals(A)===!1||de!==T)&&(i.blendColor(te.r,te.g,te.b,de),A.copy(te),T=de),_=M,D=!1}function Qt(M,Y){M.side===Je?Q(i.CULL_FACE):j(i.CULL_FACE);let F=M.side===Xe;Y&&(F=!F),At(F),M.blending===ls&&M.transparent===!1?Nt(ei):Nt(M.blending,M.blendEquation,M.blendSrc,M.blendDst,M.blendEquationAlpha,M.blendSrcAlpha,M.blendDstAlpha,M.blendColor,M.blendAlpha,M.premultipliedAlpha),r.setFunc(M.depthFunc),r.setTest(M.depthTest),r.setMask(M.depthWrite),s.setMask(M.colorWrite);const X=M.stencilWrite;o.setTest(X),X&&(o.setMask(M.stencilWriteMask),o.setFunc(M.stencilFunc,M.stencilRef,M.stencilFuncMask),o.setOp(M.stencilFail,M.stencilZFail,M.stencilZPass)),Ft(M.polygonOffset,M.polygonOffsetFactor,M.polygonOffsetUnits),M.alphaToCoverage===!0?j(i.SAMPLE_ALPHA_TO_COVERAGE):Q(i.SAMPLE_ALPHA_TO_COVERAGE)}function At(M){w!==M&&(M?i.frontFace(i.CW):i.frontFace(i.CCW),w=M)}function Wt(M){M!==Gh?(j(i.CULL_FACE),M!==v&&(M===Ha?i.cullFace(i.BACK):M===Vh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Q(i.CULL_FACE),v=M}function Ht(M){M!==I&&(tt&&i.lineWidth(M),I=M)}function Ft(M,Y,F){M?(j(i.POLYGON_OFFSET_FILL),(G!==Y||z!==F)&&(i.polygonOffset(Y,F),G=Y,z=F)):Q(i.POLYGON_OFFSET_FILL)}function me(M){M?j(i.SCISSOR_TEST):Q(i.SCISSOR_TEST)}function C(M){M===void 0&&(M=i.TEXTURE0+k-1),J!==M&&(i.activeTexture(M),J=M)}function x(M,Y,F){F===void 0&&(J===null?F=i.TEXTURE0+k-1:F=J);let X=gt[F];X===void 0&&(X={type:void 0,texture:void 0},gt[F]=X),(X.type!==M||X.texture!==Y)&&(J!==F&&(i.activeTexture(F),J=F),i.bindTexture(M,Y||q[M]),X.type=M,X.texture=Y)}function W(){const M=gt[J];M!==void 0&&M.type!==void 0&&(i.bindTexture(M.type,null),M.type=void 0,M.texture=void 0)}function nt(){try{i.compressedTexImage2D.apply(i,arguments)}catch(M){console.error("THREE.WebGLState:",M)}}function it(){try{i.compressedTexImage3D.apply(i,arguments)}catch(M){console.error("THREE.WebGLState:",M)}}function rt(){try{i.texSubImage2D.apply(i,arguments)}catch(M){console.error("THREE.WebGLState:",M)}}function Tt(){try{i.texSubImage3D.apply(i,arguments)}catch(M){console.error("THREE.WebGLState:",M)}}function ut(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(M){console.error("THREE.WebGLState:",M)}}function ht(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(M){console.error("THREE.WebGLState:",M)}}function Bt(){try{i.texStorage2D.apply(i,arguments)}catch(M){console.error("THREE.WebGLState:",M)}}function lt(){try{i.texStorage3D.apply(i,arguments)}catch(M){console.error("THREE.WebGLState:",M)}}function xt(){try{i.texImage2D.apply(i,arguments)}catch(M){console.error("THREE.WebGLState:",M)}}function Xt(){try{i.texImage3D.apply(i,arguments)}catch(M){console.error("THREE.WebGLState:",M)}}function Lt(M){Z.equals(M)===!1&&(i.scissor(M.x,M.y,M.z,M.w),Z.copy(M))}function pt(M){st.equals(M)===!1&&(i.viewport(M.x,M.y,M.z,M.w),st.copy(M))}function zt(M,Y){let F=l.get(Y);F===void 0&&(F=new WeakMap,l.set(Y,F));let X=F.get(M);X===void 0&&(X=i.getUniformBlockIndex(Y,M.name),F.set(M,X))}function Yt(M,Y){const X=l.get(Y).get(M);a.get(Y)!==X&&(i.uniformBlockBinding(Y,X,M.__bindingPointIndex),a.set(Y,X))}function ue(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),c={},J=null,gt={},h={},u=new WeakMap,d=[],f=null,g=!1,_=null,m=null,p=null,b=null,y=null,E=null,N=null,A=new $t(0,0,0),T=0,D=!1,w=null,v=null,I=null,G=null,z=null,Z.set(0,0,i.canvas.width,i.canvas.height),st.set(0,0,i.canvas.width,i.canvas.height),s.reset(),r.reset(),o.reset()}return{buffers:{color:s,depth:r,stencil:o},enable:j,disable:Q,bindFramebuffer:ft,drawBuffers:vt,useProgram:Dt,setBlending:Nt,setMaterial:Qt,setFlipSided:At,setCullFace:Wt,setLineWidth:Ht,setPolygonOffset:Ft,setScissorTest:me,activeTexture:C,bindTexture:x,unbindTexture:W,compressedTexImage2D:nt,compressedTexImage3D:it,texImage2D:xt,texImage3D:Xt,updateUBOMapping:zt,uniformBlockBinding:Yt,texStorage2D:Bt,texStorage3D:lt,texSubImage2D:rt,texSubImage3D:Tt,compressedTexSubImage2D:ut,compressedTexSubImage3D:ht,scissor:Lt,viewport:pt,reset:ue}}function V0(i,t,e,n,s,r,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new mt,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(C,x){return f?new OffscreenCanvas(C,x):Yr("canvas")}function _(C,x,W){let nt=1;const it=me(C);if((it.width>W||it.height>W)&&(nt=W/Math.max(it.width,it.height)),nt<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const rt=Math.floor(nt*it.width),Tt=Math.floor(nt*it.height);u===void 0&&(u=g(rt,Tt));const ut=x?g(rt,Tt):u;return ut.width=rt,ut.height=Tt,ut.getContext("2d").drawImage(C,0,0,rt,Tt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+it.width+"x"+it.height+") to ("+rt+"x"+Tt+")."),ut}else return"data"in C&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+it.width+"x"+it.height+")."),C;return C}function m(C){return C.generateMipmaps&&C.minFilter!==rn&&C.minFilter!==hn}function p(C){i.generateMipmap(C)}function b(C,x,W,nt,it=!1){if(C!==null){if(i[C]!==void 0)return i[C];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let rt=x;if(x===i.RED&&(W===i.FLOAT&&(rt=i.R32F),W===i.HALF_FLOAT&&(rt=i.R16F),W===i.UNSIGNED_BYTE&&(rt=i.R8)),x===i.RED_INTEGER&&(W===i.UNSIGNED_BYTE&&(rt=i.R8UI),W===i.UNSIGNED_SHORT&&(rt=i.R16UI),W===i.UNSIGNED_INT&&(rt=i.R32UI),W===i.BYTE&&(rt=i.R8I),W===i.SHORT&&(rt=i.R16I),W===i.INT&&(rt=i.R32I)),x===i.RG&&(W===i.FLOAT&&(rt=i.RG32F),W===i.HALF_FLOAT&&(rt=i.RG16F),W===i.UNSIGNED_BYTE&&(rt=i.RG8)),x===i.RG_INTEGER&&(W===i.UNSIGNED_BYTE&&(rt=i.RG8UI),W===i.UNSIGNED_SHORT&&(rt=i.RG16UI),W===i.UNSIGNED_INT&&(rt=i.RG32UI),W===i.BYTE&&(rt=i.RG8I),W===i.SHORT&&(rt=i.RG16I),W===i.INT&&(rt=i.RG32I)),x===i.RGB&&W===i.UNSIGNED_INT_5_9_9_9_REV&&(rt=i.RGB9_E5),x===i.RGBA){const Tt=it?Vr:se.getTransfer(nt);W===i.FLOAT&&(rt=i.RGBA32F),W===i.HALF_FLOAT&&(rt=i.RGBA16F),W===i.UNSIGNED_BYTE&&(rt=Tt===ce?i.SRGB8_ALPHA8:i.RGBA8),W===i.UNSIGNED_SHORT_4_4_4_4&&(rt=i.RGBA4),W===i.UNSIGNED_SHORT_5_5_5_1&&(rt=i.RGB5_A1)}return(rt===i.R16F||rt===i.R32F||rt===i.RG16F||rt===i.RG32F||rt===i.RGBA16F||rt===i.RGBA32F)&&t.get("EXT_color_buffer_float"),rt}function y(C,x){let W;return C?x===null||x===ys||x===Ms?W=i.DEPTH24_STENCIL8:x===ti?W=i.DEPTH32F_STENCIL8:x===Gr&&(W=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===ys||x===Ms?W=i.DEPTH_COMPONENT24:x===ti?W=i.DEPTH_COMPONENT32F:x===Gr&&(W=i.DEPTH_COMPONENT16),W}function E(C,x){return m(C)===!0||C.isFramebufferTexture&&C.minFilter!==rn&&C.minFilter!==hn?Math.log2(Math.max(x.width,x.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?x.mipmaps.length:1}function N(C){const x=C.target;x.removeEventListener("dispose",N),T(x),x.isVideoTexture&&h.delete(x)}function A(C){const x=C.target;x.removeEventListener("dispose",A),w(x)}function T(C){const x=n.get(C);if(x.__webglInit===void 0)return;const W=C.source,nt=d.get(W);if(nt){const it=nt[x.__cacheKey];it.usedTimes--,it.usedTimes===0&&D(C),Object.keys(nt).length===0&&d.delete(W)}n.remove(C)}function D(C){const x=n.get(C);i.deleteTexture(x.__webglTexture);const W=C.source,nt=d.get(W);delete nt[x.__cacheKey],o.memory.textures--}function w(C){const x=n.get(C);if(C.depthTexture&&C.depthTexture.dispose(),C.isWebGLCubeRenderTarget)for(let nt=0;nt<6;nt++){if(Array.isArray(x.__webglFramebuffer[nt]))for(let it=0;it<x.__webglFramebuffer[nt].length;it++)i.deleteFramebuffer(x.__webglFramebuffer[nt][it]);else i.deleteFramebuffer(x.__webglFramebuffer[nt]);x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer[nt])}else{if(Array.isArray(x.__webglFramebuffer))for(let nt=0;nt<x.__webglFramebuffer.length;nt++)i.deleteFramebuffer(x.__webglFramebuffer[nt]);else i.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&i.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let nt=0;nt<x.__webglColorRenderbuffer.length;nt++)x.__webglColorRenderbuffer[nt]&&i.deleteRenderbuffer(x.__webglColorRenderbuffer[nt]);x.__webglDepthRenderbuffer&&i.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const W=C.textures;for(let nt=0,it=W.length;nt<it;nt++){const rt=n.get(W[nt]);rt.__webglTexture&&(i.deleteTexture(rt.__webglTexture),o.memory.textures--),n.remove(W[nt])}n.remove(C)}let v=0;function I(){v=0}function G(){const C=v;return C>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+s.maxTextures),v+=1,C}function z(C){const x=[];return x.push(C.wrapS),x.push(C.wrapT),x.push(C.wrapR||0),x.push(C.magFilter),x.push(C.minFilter),x.push(C.anisotropy),x.push(C.internalFormat),x.push(C.format),x.push(C.type),x.push(C.generateMipmaps),x.push(C.premultiplyAlpha),x.push(C.flipY),x.push(C.unpackAlignment),x.push(C.colorSpace),x.join()}function k(C,x){const W=n.get(C);if(C.isVideoTexture&&Ht(C),C.isRenderTargetTexture===!1&&C.version>0&&W.__version!==C.version){const nt=C.image;if(nt===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(nt.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{st(W,C,x);return}}e.bindTexture(i.TEXTURE_2D,W.__webglTexture,i.TEXTURE0+x)}function tt(C,x){const W=n.get(C);if(C.version>0&&W.__version!==C.version){st(W,C,x);return}e.bindTexture(i.TEXTURE_2D_ARRAY,W.__webglTexture,i.TEXTURE0+x)}function $(C,x){const W=n.get(C);if(C.version>0&&W.__version!==C.version){st(W,C,x);return}e.bindTexture(i.TEXTURE_3D,W.__webglTexture,i.TEXTURE0+x)}function at(C,x){const W=n.get(C);if(C.version>0&&W.__version!==C.version){U(W,C,x);return}e.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture,i.TEXTURE0+x)}const J={[na]:i.REPEAT,[Si]:i.CLAMP_TO_EDGE,[ia]:i.MIRRORED_REPEAT},gt={[rn]:i.NEAREST,[Eu]:i.NEAREST_MIPMAP_NEAREST,[hr]:i.NEAREST_MIPMAP_LINEAR,[hn]:i.LINEAR,[co]:i.LINEAR_MIPMAP_NEAREST,[Ei]:i.LINEAR_MIPMAP_LINEAR},Mt={[Fu]:i.NEVER,[Vu]:i.ALWAYS,[Bu]:i.LESS,[qc]:i.LEQUAL,[zu]:i.EQUAL,[Gu]:i.GEQUAL,[ku]:i.GREATER,[Hu]:i.NOTEQUAL};function St(C,x){if(x.type===ti&&t.has("OES_texture_float_linear")===!1&&(x.magFilter===hn||x.magFilter===co||x.magFilter===hr||x.magFilter===Ei||x.minFilter===hn||x.minFilter===co||x.minFilter===hr||x.minFilter===Ei)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(C,i.TEXTURE_WRAP_S,J[x.wrapS]),i.texParameteri(C,i.TEXTURE_WRAP_T,J[x.wrapT]),(C===i.TEXTURE_3D||C===i.TEXTURE_2D_ARRAY)&&i.texParameteri(C,i.TEXTURE_WRAP_R,J[x.wrapR]),i.texParameteri(C,i.TEXTURE_MAG_FILTER,gt[x.magFilter]),i.texParameteri(C,i.TEXTURE_MIN_FILTER,gt[x.minFilter]),x.compareFunction&&(i.texParameteri(C,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(C,i.TEXTURE_COMPARE_FUNC,Mt[x.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===rn||x.minFilter!==hr&&x.minFilter!==Ei||x.type===ti&&t.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const W=t.get("EXT_texture_filter_anisotropic");i.texParameterf(C,W.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,s.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function Z(C,x){let W=!1;C.__webglInit===void 0&&(C.__webglInit=!0,x.addEventListener("dispose",N));const nt=x.source;let it=d.get(nt);it===void 0&&(it={},d.set(nt,it));const rt=z(x);if(rt!==C.__cacheKey){it[rt]===void 0&&(it[rt]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,W=!0),it[rt].usedTimes++;const Tt=it[C.__cacheKey];Tt!==void 0&&(it[C.__cacheKey].usedTimes--,Tt.usedTimes===0&&D(x)),C.__cacheKey=rt,C.__webglTexture=it[rt].texture}return W}function st(C,x,W){let nt=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(nt=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(nt=i.TEXTURE_3D);const it=Z(C,x),rt=x.source;e.bindTexture(nt,C.__webglTexture,i.TEXTURE0+W);const Tt=n.get(rt);if(rt.version!==Tt.__version||it===!0){e.activeTexture(i.TEXTURE0+W);const ut=se.getPrimaries(se.workingColorSpace),ht=x.colorSpace===Jn?null:se.getPrimaries(x.colorSpace),Bt=x.colorSpace===Jn||ut===ht?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Bt);let lt=_(x.image,!1,s.maxTextureSize);lt=Ft(x,lt);const xt=r.convert(x.format,x.colorSpace),Xt=r.convert(x.type);let Lt=b(x.internalFormat,xt,Xt,x.colorSpace,x.isVideoTexture);St(nt,x);let pt;const zt=x.mipmaps,Yt=x.isVideoTexture!==!0,ue=Tt.__version===void 0||it===!0,M=rt.dataReady,Y=E(x,lt);if(x.isDepthTexture)Lt=y(x.format===Ss,x.type),ue&&(Yt?e.texStorage2D(i.TEXTURE_2D,1,Lt,lt.width,lt.height):e.texImage2D(i.TEXTURE_2D,0,Lt,lt.width,lt.height,0,xt,Xt,null));else if(x.isDataTexture)if(zt.length>0){Yt&&ue&&e.texStorage2D(i.TEXTURE_2D,Y,Lt,zt[0].width,zt[0].height);for(let F=0,X=zt.length;F<X;F++)pt=zt[F],Yt?M&&e.texSubImage2D(i.TEXTURE_2D,F,0,0,pt.width,pt.height,xt,Xt,pt.data):e.texImage2D(i.TEXTURE_2D,F,Lt,pt.width,pt.height,0,xt,Xt,pt.data);x.generateMipmaps=!1}else Yt?(ue&&e.texStorage2D(i.TEXTURE_2D,Y,Lt,lt.width,lt.height),M&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,lt.width,lt.height,xt,Xt,lt.data)):e.texImage2D(i.TEXTURE_2D,0,Lt,lt.width,lt.height,0,xt,Xt,lt.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Yt&&ue&&e.texStorage3D(i.TEXTURE_2D_ARRAY,Y,Lt,zt[0].width,zt[0].height,lt.depth);for(let F=0,X=zt.length;F<X;F++)if(pt=zt[F],x.format!==yn)if(xt!==null)if(Yt){if(M)if(x.layerUpdates.size>0){for(const et of x.layerUpdates){const wt=pt.width*pt.height;e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,F,0,0,et,pt.width,pt.height,1,xt,pt.data.slice(wt*et,wt*(et+1)),0,0)}x.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,F,0,0,0,pt.width,pt.height,lt.depth,xt,pt.data,0,0)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,F,Lt,pt.width,pt.height,lt.depth,0,pt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Yt?M&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,F,0,0,0,pt.width,pt.height,lt.depth,xt,Xt,pt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,F,Lt,pt.width,pt.height,lt.depth,0,xt,Xt,pt.data)}else{Yt&&ue&&e.texStorage2D(i.TEXTURE_2D,Y,Lt,zt[0].width,zt[0].height);for(let F=0,X=zt.length;F<X;F++)pt=zt[F],x.format!==yn?xt!==null?Yt?M&&e.compressedTexSubImage2D(i.TEXTURE_2D,F,0,0,pt.width,pt.height,xt,pt.data):e.compressedTexImage2D(i.TEXTURE_2D,F,Lt,pt.width,pt.height,0,pt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Yt?M&&e.texSubImage2D(i.TEXTURE_2D,F,0,0,pt.width,pt.height,xt,Xt,pt.data):e.texImage2D(i.TEXTURE_2D,F,Lt,pt.width,pt.height,0,xt,Xt,pt.data)}else if(x.isDataArrayTexture)if(Yt){if(ue&&e.texStorage3D(i.TEXTURE_2D_ARRAY,Y,Lt,lt.width,lt.height,lt.depth),M)if(x.layerUpdates.size>0){let F;switch(Xt){case i.UNSIGNED_BYTE:switch(xt){case i.ALPHA:F=1;break;case i.LUMINANCE:F=1;break;case i.LUMINANCE_ALPHA:F=2;break;case i.RGB:F=3;break;case i.RGBA:F=4;break;default:throw new Error(`Unknown texel size for format ${xt}.`)}break;case i.UNSIGNED_SHORT_4_4_4_4:case i.UNSIGNED_SHORT_5_5_5_1:case i.UNSIGNED_SHORT_5_6_5:F=1;break;default:throw new Error(`Unknown texel size for type ${Xt}.`)}const X=lt.width*lt.height*F;for(const et of x.layerUpdates)e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,et,lt.width,lt.height,1,xt,Xt,lt.data.slice(X*et,X*(et+1)));x.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,lt.width,lt.height,lt.depth,xt,Xt,lt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Lt,lt.width,lt.height,lt.depth,0,xt,Xt,lt.data);else if(x.isData3DTexture)Yt?(ue&&e.texStorage3D(i.TEXTURE_3D,Y,Lt,lt.width,lt.height,lt.depth),M&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,lt.width,lt.height,lt.depth,xt,Xt,lt.data)):e.texImage3D(i.TEXTURE_3D,0,Lt,lt.width,lt.height,lt.depth,0,xt,Xt,lt.data);else if(x.isFramebufferTexture){if(ue)if(Yt)e.texStorage2D(i.TEXTURE_2D,Y,Lt,lt.width,lt.height);else{let F=lt.width,X=lt.height;for(let et=0;et<Y;et++)e.texImage2D(i.TEXTURE_2D,et,Lt,F,X,0,xt,Xt,null),F>>=1,X>>=1}}else if(zt.length>0){if(Yt&&ue){const F=me(zt[0]);e.texStorage2D(i.TEXTURE_2D,Y,Lt,F.width,F.height)}for(let F=0,X=zt.length;F<X;F++)pt=zt[F],Yt?M&&e.texSubImage2D(i.TEXTURE_2D,F,0,0,xt,Xt,pt):e.texImage2D(i.TEXTURE_2D,F,Lt,xt,Xt,pt);x.generateMipmaps=!1}else if(Yt){if(ue){const F=me(lt);e.texStorage2D(i.TEXTURE_2D,Y,Lt,F.width,F.height)}M&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,xt,Xt,lt)}else e.texImage2D(i.TEXTURE_2D,0,Lt,xt,Xt,lt);m(x)&&p(nt),Tt.__version=rt.version,x.onUpdate&&x.onUpdate(x)}C.__version=x.version}function U(C,x,W){if(x.image.length!==6)return;const nt=Z(C,x),it=x.source;e.bindTexture(i.TEXTURE_CUBE_MAP,C.__webglTexture,i.TEXTURE0+W);const rt=n.get(it);if(it.version!==rt.__version||nt===!0){e.activeTexture(i.TEXTURE0+W);const Tt=se.getPrimaries(se.workingColorSpace),ut=x.colorSpace===Jn?null:se.getPrimaries(x.colorSpace),ht=x.colorSpace===Jn||Tt===ut?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ht);const Bt=x.isCompressedTexture||x.image[0].isCompressedTexture,lt=x.image[0]&&x.image[0].isDataTexture,xt=[];for(let X=0;X<6;X++)!Bt&&!lt?xt[X]=_(x.image[X],!0,s.maxCubemapSize):xt[X]=lt?x.image[X].image:x.image[X],xt[X]=Ft(x,xt[X]);const Xt=xt[0],Lt=r.convert(x.format,x.colorSpace),pt=r.convert(x.type),zt=b(x.internalFormat,Lt,pt,x.colorSpace),Yt=x.isVideoTexture!==!0,ue=rt.__version===void 0||nt===!0,M=it.dataReady;let Y=E(x,Xt);St(i.TEXTURE_CUBE_MAP,x);let F;if(Bt){Yt&&ue&&e.texStorage2D(i.TEXTURE_CUBE_MAP,Y,zt,Xt.width,Xt.height);for(let X=0;X<6;X++){F=xt[X].mipmaps;for(let et=0;et<F.length;et++){const wt=F[et];x.format!==yn?Lt!==null?Yt?M&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,et,0,0,wt.width,wt.height,Lt,wt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,et,zt,wt.width,wt.height,0,wt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Yt?M&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,et,0,0,wt.width,wt.height,Lt,pt,wt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,et,zt,wt.width,wt.height,0,Lt,pt,wt.data)}}}else{if(F=x.mipmaps,Yt&&ue){F.length>0&&Y++;const X=me(xt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,Y,zt,X.width,X.height)}for(let X=0;X<6;X++)if(lt){Yt?M&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,0,0,xt[X].width,xt[X].height,Lt,pt,xt[X].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,zt,xt[X].width,xt[X].height,0,Lt,pt,xt[X].data);for(let et=0;et<F.length;et++){const Ot=F[et].image[X].image;Yt?M&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,et+1,0,0,Ot.width,Ot.height,Lt,pt,Ot.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,et+1,zt,Ot.width,Ot.height,0,Lt,pt,Ot.data)}}else{Yt?M&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,0,0,Lt,pt,xt[X]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,zt,Lt,pt,xt[X]);for(let et=0;et<F.length;et++){const wt=F[et];Yt?M&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,et+1,0,0,Lt,pt,wt.image[X]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,et+1,zt,Lt,pt,wt.image[X])}}}m(x)&&p(i.TEXTURE_CUBE_MAP),rt.__version=it.version,x.onUpdate&&x.onUpdate(x)}C.__version=x.version}function q(C,x,W,nt,it,rt){const Tt=r.convert(W.format,W.colorSpace),ut=r.convert(W.type),ht=b(W.internalFormat,Tt,ut,W.colorSpace);if(!n.get(x).__hasExternalTextures){const lt=Math.max(1,x.width>>rt),xt=Math.max(1,x.height>>rt);it===i.TEXTURE_3D||it===i.TEXTURE_2D_ARRAY?e.texImage3D(it,rt,ht,lt,xt,x.depth,0,Tt,ut,null):e.texImage2D(it,rt,ht,lt,xt,0,Tt,ut,null)}e.bindFramebuffer(i.FRAMEBUFFER,C),Wt(x)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,nt,it,n.get(W).__webglTexture,0,At(x)):(it===i.TEXTURE_2D||it>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&it<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,nt,it,n.get(W).__webglTexture,rt),e.bindFramebuffer(i.FRAMEBUFFER,null)}function j(C,x,W){if(i.bindRenderbuffer(i.RENDERBUFFER,C),x.depthBuffer){const nt=x.depthTexture,it=nt&&nt.isDepthTexture?nt.type:null,rt=y(x.stencilBuffer,it),Tt=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ut=At(x);Wt(x)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ut,rt,x.width,x.height):W?i.renderbufferStorageMultisample(i.RENDERBUFFER,ut,rt,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,rt,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Tt,i.RENDERBUFFER,C)}else{const nt=x.textures;for(let it=0;it<nt.length;it++){const rt=nt[it],Tt=r.convert(rt.format,rt.colorSpace),ut=r.convert(rt.type),ht=b(rt.internalFormat,Tt,ut,rt.colorSpace),Bt=At(x);W&&Wt(x)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Bt,ht,x.width,x.height):Wt(x)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Bt,ht,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,ht,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Q(C,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,C),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),k(x.depthTexture,0);const nt=n.get(x.depthTexture).__webglTexture,it=At(x);if(x.depthTexture.format===cs)Wt(x)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,nt,0,it):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,nt,0);else if(x.depthTexture.format===Ss)Wt(x)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,nt,0,it):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,nt,0);else throw new Error("Unknown depthTexture format")}function ft(C){const x=n.get(C),W=C.isWebGLCubeRenderTarget===!0;if(C.depthTexture&&!x.__autoAllocateDepthBuffer){if(W)throw new Error("target.depthTexture not supported in Cube render targets");Q(x.__webglFramebuffer,C)}else if(W){x.__webglDepthbuffer=[];for(let nt=0;nt<6;nt++)e.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[nt]),x.__webglDepthbuffer[nt]=i.createRenderbuffer(),j(x.__webglDepthbuffer[nt],C,!1)}else e.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer=i.createRenderbuffer(),j(x.__webglDepthbuffer,C,!1);e.bindFramebuffer(i.FRAMEBUFFER,null)}function vt(C,x,W){const nt=n.get(C);x!==void 0&&q(nt.__webglFramebuffer,C,C.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),W!==void 0&&ft(C)}function Dt(C){const x=C.texture,W=n.get(C),nt=n.get(x);C.addEventListener("dispose",A);const it=C.textures,rt=C.isWebGLCubeRenderTarget===!0,Tt=it.length>1;if(Tt||(nt.__webglTexture===void 0&&(nt.__webglTexture=i.createTexture()),nt.__version=x.version,o.memory.textures++),rt){W.__webglFramebuffer=[];for(let ut=0;ut<6;ut++)if(x.mipmaps&&x.mipmaps.length>0){W.__webglFramebuffer[ut]=[];for(let ht=0;ht<x.mipmaps.length;ht++)W.__webglFramebuffer[ut][ht]=i.createFramebuffer()}else W.__webglFramebuffer[ut]=i.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){W.__webglFramebuffer=[];for(let ut=0;ut<x.mipmaps.length;ut++)W.__webglFramebuffer[ut]=i.createFramebuffer()}else W.__webglFramebuffer=i.createFramebuffer();if(Tt)for(let ut=0,ht=it.length;ut<ht;ut++){const Bt=n.get(it[ut]);Bt.__webglTexture===void 0&&(Bt.__webglTexture=i.createTexture(),o.memory.textures++)}if(C.samples>0&&Wt(C)===!1){W.__webglMultisampledFramebuffer=i.createFramebuffer(),W.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,W.__webglMultisampledFramebuffer);for(let ut=0;ut<it.length;ut++){const ht=it[ut];W.__webglColorRenderbuffer[ut]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,W.__webglColorRenderbuffer[ut]);const Bt=r.convert(ht.format,ht.colorSpace),lt=r.convert(ht.type),xt=b(ht.internalFormat,Bt,lt,ht.colorSpace,C.isXRRenderTarget===!0),Xt=At(C);i.renderbufferStorageMultisample(i.RENDERBUFFER,Xt,xt,C.width,C.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.RENDERBUFFER,W.__webglColorRenderbuffer[ut])}i.bindRenderbuffer(i.RENDERBUFFER,null),C.depthBuffer&&(W.__webglDepthRenderbuffer=i.createRenderbuffer(),j(W.__webglDepthRenderbuffer,C,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(rt){e.bindTexture(i.TEXTURE_CUBE_MAP,nt.__webglTexture),St(i.TEXTURE_CUBE_MAP,x);for(let ut=0;ut<6;ut++)if(x.mipmaps&&x.mipmaps.length>0)for(let ht=0;ht<x.mipmaps.length;ht++)q(W.__webglFramebuffer[ut][ht],C,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ut,ht);else q(W.__webglFramebuffer[ut],C,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ut,0);m(x)&&p(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Tt){for(let ut=0,ht=it.length;ut<ht;ut++){const Bt=it[ut],lt=n.get(Bt);e.bindTexture(i.TEXTURE_2D,lt.__webglTexture),St(i.TEXTURE_2D,Bt),q(W.__webglFramebuffer,C,Bt,i.COLOR_ATTACHMENT0+ut,i.TEXTURE_2D,0),m(Bt)&&p(i.TEXTURE_2D)}e.unbindTexture()}else{let ut=i.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ut=C.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(ut,nt.__webglTexture),St(ut,x),x.mipmaps&&x.mipmaps.length>0)for(let ht=0;ht<x.mipmaps.length;ht++)q(W.__webglFramebuffer[ht],C,x,i.COLOR_ATTACHMENT0,ut,ht);else q(W.__webglFramebuffer,C,x,i.COLOR_ATTACHMENT0,ut,0);m(x)&&p(ut),e.unbindTexture()}C.depthBuffer&&ft(C)}function P(C){const x=C.textures;for(let W=0,nt=x.length;W<nt;W++){const it=x[W];if(m(it)){const rt=C.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,Tt=n.get(it).__webglTexture;e.bindTexture(rt,Tt),p(rt),e.unbindTexture()}}}const kt=[],Nt=[];function Qt(C){if(C.samples>0){if(Wt(C)===!1){const x=C.textures,W=C.width,nt=C.height;let it=i.COLOR_BUFFER_BIT;const rt=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Tt=n.get(C),ut=x.length>1;if(ut)for(let ht=0;ht<x.length;ht++)e.bindFramebuffer(i.FRAMEBUFFER,Tt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ht,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,Tt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ht,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,Tt.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Tt.__webglFramebuffer);for(let ht=0;ht<x.length;ht++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(it|=i.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(it|=i.STENCIL_BUFFER_BIT)),ut){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Tt.__webglColorRenderbuffer[ht]);const Bt=n.get(x[ht]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Bt,0)}i.blitFramebuffer(0,0,W,nt,0,0,W,nt,it,i.NEAREST),l===!0&&(kt.length=0,Nt.length=0,kt.push(i.COLOR_ATTACHMENT0+ht),C.depthBuffer&&C.resolveDepthBuffer===!1&&(kt.push(rt),Nt.push(rt),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Nt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,kt))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ut)for(let ht=0;ht<x.length;ht++){e.bindFramebuffer(i.FRAMEBUFFER,Tt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ht,i.RENDERBUFFER,Tt.__webglColorRenderbuffer[ht]);const Bt=n.get(x[ht]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,Tt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ht,i.TEXTURE_2D,Bt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Tt.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const x=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[x])}}}function At(C){return Math.min(s.maxSamples,C.samples)}function Wt(C){const x=n.get(C);return C.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function Ht(C){const x=o.render.frame;h.get(C)!==x&&(h.set(C,x),C.update())}function Ft(C,x){const W=C.colorSpace,nt=C.format,it=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||W!==ci&&W!==Jn&&(se.getTransfer(W)===ce?(nt!==yn||it!==oi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",W)),x}function me(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=G,this.resetTextureUnits=I,this.setTexture2D=k,this.setTexture2DArray=tt,this.setTexture3D=$,this.setTextureCube=at,this.rebindTextures=vt,this.setupRenderTarget=Dt,this.updateRenderTargetMipmap=P,this.updateMultisampleRenderTarget=Qt,this.setupDepthRenderbuffer=ft,this.setupFrameBufferTexture=q,this.useMultisampledRTT=Wt}function W0(i,t){function e(n,s=Jn){let r;const o=se.getTransfer(s);if(n===oi)return i.UNSIGNED_BYTE;if(n===Gc)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Vc)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Tu)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===wu)return i.BYTE;if(n===bu)return i.SHORT;if(n===Gr)return i.UNSIGNED_SHORT;if(n===Hc)return i.INT;if(n===ys)return i.UNSIGNED_INT;if(n===ti)return i.FLOAT;if(n===Qr)return i.HALF_FLOAT;if(n===Au)return i.ALPHA;if(n===Ru)return i.RGB;if(n===yn)return i.RGBA;if(n===Cu)return i.LUMINANCE;if(n===Pu)return i.LUMINANCE_ALPHA;if(n===cs)return i.DEPTH_COMPONENT;if(n===Ss)return i.DEPTH_STENCIL;if(n===Lu)return i.RED;if(n===Wc)return i.RED_INTEGER;if(n===Iu)return i.RG;if(n===Xc)return i.RG_INTEGER;if(n===Zc)return i.RGBA_INTEGER;if(n===ho||n===uo||n===fo||n===po)if(o===ce)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ho)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===uo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===fo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===po)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ho)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===uo)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===fo)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===po)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Xa||n===Za||n===Ya||n===qa)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Xa)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Za)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ya)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===qa)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===$a||n===Ka||n===Ja)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===$a||n===Ka)return o===ce?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Ja)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===ja||n===Qa||n===tl||n===el||n===nl||n===il||n===sl||n===rl||n===ol||n===al||n===ll||n===cl||n===hl||n===ul)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===ja)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Qa)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===tl)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===el)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===nl)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===il)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===sl)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===rl)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ol)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===al)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ll)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===cl)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===hl)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ul)return o===ce?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===mo||n===dl||n===fl)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===mo)return o===ce?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===dl)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===fl)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Du||n===pl||n===ml||n===gl)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===mo)return r.COMPRESSED_RED_RGTC1_EXT;if(n===pl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ml)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===gl)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ms?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}class X0 extends Ke{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class Bn extends De{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Z0={type:"move"};class Go{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Bn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Bn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new L,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new L),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Bn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new L,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new L),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let s=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){o=!0;for(const _ of t.hand.values()){const m=e.getJointPose(_,n),p=this._getHandJoint(c,_);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],d=h.position.distanceTo(u.position),f=.02,g=.005;c.inputState.pinching&&d>f+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&d<=f-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(r=e.getPose(t.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(s=e.getPose(t.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Z0)))}return a!==null&&(a.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new Bn;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const Y0=`
void main() {
...
void main() {
    ...
    `}}function P_(i){return i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const fa="sw_id_v1",pa=i=>Array.from(i).map(t=>t.toString(16).padStart(2,"0")).join(""),Lc=i=>{const t=i.replace(/-/g,"+").replace(/_/g,"/"),e=atob(t);return Uint8Array.from(e,n=>n.charCodeAt(0))};class Ic{constructor(t,e,n,s){this.peerId=t,this.displayName=e,this.isNew=s,this._priv=n}get shortId(){return this.peerId.slice(-8)}setName(t){this.displayName=t,Ih()}async sign(t){const e=new TextEncoder().encode(t),n=await crypto.subtle.sign({name:"Ed25519"},this._priv,e);return pa(new Uint8Array(n))}}let Nn=null,ks=null;function Ih(){if(!(!Nn||!ks))try{localStorage.setItem(fa,JSON.stringify({privJwk:ks,displayName:Nn.displayName}))}catch{}}async function L_(){if(Nn)return Nn;const i=localStorage.getItem(fa);if(i)try{const{privJwk:n,displayName:s}=JSON.parse(i),r=await crypto.subtle.importKey("jwk",n,{name:"Ed25519"},!1,["sign"]),o=pa(Lc(n.x));return ks=n,Nn=new Ic(o,s||"",r,!1),Nn}catch{localStorage.removeItem(fa)}const t=await crypto.subtle.generateKey({name:"Ed25519"},!0,["sign","verify"]);ks=await crypto.subtle.exportKey("jwk",t.privateKey);const e=pa(Lc(ks.x));return Nn=new Ic(e,"",t.privateKey,!0),Ih(),Nn}function Dh(){return Nn}const I_="spacework-v1",Dc=["wss://tracker.webtorrent.dev","wss://tracker.novage.com.ua","wss://tracker.openwebtorrent.com","wss://tracker.btorrent.xyz","wss://tracker.files.fm:7073/announce"];function D_(){return`sw-1-${window.location.hash.slice(1).trim().toLowerCase().replace(/[^a-z0-9-]/g,"-").replace(/-{2,}/g,"-").slice(0,40)||"main"}`}function N_(){return window.location.hash.slice(1).trim()||"main"}function U_(i){const t=i.trim().toLowerCase().replace(/[^a-z0-9-]/g,"-").replace(/-{2,}/g,"-")||"main";window.location.hash=t}var Be,ds,fs,ps,On,Qn,ms,Xs,Zs,Ys,qs,$s,gs,Ks,Js,js,Qs,tr,Te,xi,$n,ma;class O_{constructor(t,e=0,n="available"){qt(this,Te);qt(this,Be,null);qt(this,ds,"");qt(this,fs,0);qt(this,ps,"available");qt(this,On,{});qt(this,Qn,new Map);qt(this,ms,null);qt(this,Xs,null);qt(this,Zs,null);qt(this,Ys,null);qt(this,qs,null);qt(this,$s,null);qt(this,gs,null);qt(this,Ks,null);qt(this,Js,null);qt(this,js,null);qt(this,Qs,null);qt(this,tr,null);ge(this,ds,t),ge(this,fs,e),ge(this,ps,n)}async start(){const t=D_();ge(this,Be,Hh({appId:I_,relayConfig:{urls:Dc,redundancy:Dc.length}},t)),[Ye(this,ms)._,Ye(this,Xs)._]=K(this,Be).makeAction("intro"),[Ye(this,Zs)._,Ye(this,Ys)._]=K(this,Be).makeAction("move"),[Ye(this,qs)._,Ye(this,$s)._]=K(this,Be).makeAction("chat"),[Ye(this,gs)._,Ye(this,Ks)._]=K(this,Be).makeAction("bye"),[Ye(this,Js)._,Ye(this,js)._]=K(this,Be).makeAction("avatar"),[Ye(this,Qs)._,Ye(this,tr)._]=K(this,Be).makeAction("status"),K(this,Be).onPeerJoin(e=>{K(this,ms).call(this,Jt(this,Te,ma).call(this),e)}),K(this,Be).onPeerLeave(e=>{const n=K(this,Qn).get(e)??e;K(this,Qn).delete(e),Jt(this,Te,$n).call(this,"PEER_LEAVE",{from:n})}),K(this,Xs).call(this,({identityId:e,username:n,presetId:s=0,status:r="available"},o)=>{const a=e;K(this,Qn).set(o,e),Jt(this,Te,$n).call(this,"HELLO",{from:a,username:n,presetId:s,status:r}),K(this,ms).call(this,Jt(this,Te,ma).call(this),o)}),K(this,js).call(this,({identityId:e,presetId:n},s)=>{Jt(this,Te,$n).call(this,"AVATAR_CHANGE",{from:e,presetId:n})}),K(this,tr).call(this,({identityId:e,status:n},s)=>{Jt(this,Te,$n).call(this,"STATUS_CHANGE",{from:e,status:n})}),K(this,Ys).call(this,({identityId:e,pos:n},s)=>{Jt(this,Te,$n).call(this,"MOVE",{from:e,pos:n})}),K(this,$s).call(this,({identityId:e,username:n,text:s,ts:r},o)=>{Jt(this,Te,$n).call(this,"CHAT",{from:e,username:n,text:s,ts:r})}),K(this,Ks).call(this,({identityId:e},n)=>{Jt(this,Te,$n).call(this,"PEER_LEAVE",{from:e})})}stop(){var t;K(this,gs)&&K(this,gs).call(this,{identityId:Jt(this,Te,xi).call(this)}),(t=K(this,Be))==null||t.leave(),ge(this,Be,null)}addVoiceTrack(t,e){var n;(n=K(this,Be))==null||n.addTrack(t,e)}onVoiceTrack(t){var e;(e=K(this,Be))==null||e.onTrack((n,s,r)=>{const o=K(this,Qn).get(r)??r;t(n,s,o,r)})}wireToIdentityId(t){return K(this,Qn).get(t)}move(t,e,n,s=0){var r;(r=K(this,Zs))==null||r.call(this,{identityId:Jt(this,Te,xi).call(this),pos:{x:t,y:e,z:n,ry:s}})}chat(t){var e;(e=K(this,qs))==null||e.call(this,{identityId:Jt(this,Te,xi).call(this),username:K(this,ds),text:t,ts:Date.now()})}setAvatar(t){var e;ge(this,fs,t),(e=K(this,Js))==null||e.call(this,{identityId:Jt(this,Te,xi).call(this),presetId:t})}setStatus(t){var e;ge(this,ps,t),(e=K(this,Qs))==null||e.call(this,{identityId:Jt(this,Te,xi).call(this),status:t})}on(t,e){return K(this,On)[t]||(K(this,On)[t]=[]),K(this,On)[t].push(e),()=>{K(this,On)[t]=K(this,On)[t].filter(n=>n!==e)}}}Be=new WeakMap,ds=new WeakMap,fs=new WeakMap,ps=new WeakMap,On=new WeakMap,Qn=new WeakMap,ms=new WeakMap,Xs=new WeakMap,Zs=new WeakMap,Ys=new WeakMap,qs=new WeakMap,$s=new WeakMap,gs=new WeakMap,Ks=new WeakMap,Js=new WeakMap,js=new WeakMap,Qs=new WeakMap,tr=new WeakMap,Te=new WeakSet,xi=function(){var t;return((t=Dh())==null?void 0:t.peerId)??"unknown"},$n=function(t,e){var n;(n=K(this,On)[t])==null||n.forEach(s=>s(e))},ma=function(){return{identityId:Jt(this,Te,xi).call(this),username:K(this,ds),presetId:K(this,fs),status:K(this,ps)}};var be,en,_s,er,nr,ir,ze,Nh,Uh,mn;class F_ extends EventTarget{constructor(){super(...arguments);qt(this,ze);qt(this,be,null);qt(this,en,new Map);qt(this,_s,!1);qt(this,er,"");qt(this,nr,0);qt(this,ir,"available")}get id(){var e;return((e=Dh())==null?void 0:e.peerId)??""}get peers(){return[...K(this,en).values()]}get peerCount(){return K(this,en).size}async start(e,n=0,s="available"){K(this,_s)||(ge(this,_s,!0),ge(this,er,e),ge(this,nr,n),ge(this,ir,s),ge(this,be,new O_(e,n,s)),K(this,be).on("HELLO",({from:r,username:o,presetId:a=0,status:l="available"})=>{K(this,en).has(r)||Jt(this,ze,Nh).call(this,r,o,a,l)}),K(this,be).on("PEER_LEAVE",({from:r})=>Jt(this,ze,Uh).call(this,r)),K(this,be).on("MOVE",({from:r,pos:o})=>{Jt(this,ze,mn).call(this,"peer:move",{peerId:r,pos:o})}),K(this,be).on("AVATAR_CHANGE",({from:r,presetId:o})=>{Jt(this,ze,mn).call(this,"peer:avatar",{peerId:r,presetId:o})}),K(this,be).on("STATUS_CHANGE",({from:r,status:o})=>{Jt(this,ze,mn).call(this,"peer:status",{peerId:r,status:o})}),K(this,be).on("CHAT",({from:r,username:o,text:a,ts:l})=>{Jt(this,ze,mn).call(this,"chat",{from:r,username:o,text:a,ts:l})}),await K(this,be).start())}stop(){var e;(e=K(this,be))==null||e.stop(),ge(this,be,null),K(this,en).clear(),ge(this,_s,!1)}move(e,n,s,r=0){var o;(o=K(this,be))==null||o.move(e,n,s,r)}setAvatar(e){var n;ge(this,nr,e),(n=K(this,be))==null||n.setAvatar(e)}setStatus(e){var n;ge(this,ir,e),(n=K(this,be))==null||n.setStatus(e)}sendChat(e){var s;if(!e.trim())return;const n=Date.now();Jt(this,ze,mn).call(this,"chat",{from:this.id,username:K(this,er),text:e,ts:n}),(s=K(this,be))==null||s.chat(e)}addVoiceTrack(e,n){var s;(s=K(this,be))==null||s.addVoiceTrack(e,n)}onVoiceTrack(e){var n;(n=K(this,be))==null||n.onVoiceTrack(e)}wireToIdentityId(e){var n;return(n=K(this,be))==null?void 0:n.wireToIdentityId(e)}}be=new WeakMap,en=new WeakMap,_s=new WeakMap,er=new WeakMap,nr=new WeakMap,ir=new WeakMap,ze=new WeakSet,Nh=function(e,n,s,r){K(this,en).set(e,{peerId:e,username:n,presetId:s,status:r}),Jt(this,ze,mn).call(this,"peer:join",{peerId:e,username:n,presetId:s,status:r}),Jt(this,ze,mn).call(this,"status",{peerCount:K(this,en).size})},Uh=function(e){K(this,en).has(e)&&(K(this,en).delete(e),Jt(this,ze,mn).call(this,"peer:leave",{peerId:e}),Jt(this,ze,mn).call(this,"status",{peerCount:K(this,en).size}))},mn=function(e,n){this.dispatchEvent(new CustomEvent(e,{detail:n}))};const Le=new F_,Ln=Object.freeze({OCEAN:"ocean",COAST:"coast",DESERT:"desert",PLAINS:"plains",FOREST:"forest",MOUNTAIN:"mountain",ARCTIC:"arctic",JUNGLE:"jungle",TUNDRA:"tundra"});function zr(i){let t=5381;for(let e=0;e<i.length;e++)t=Math.imul(t,33)^i.charCodeAt(e);return(t>>>0).toString(16).padStart(8,"0")}function Oh(i,t,e,n){const s=JSON.stringify({parentHash:i,authorId:t,changes:e,timestamp:n});let r=zr(s),o=zr(r+s.slice(0,32)),a=zr(o+s.slice(-32)),l=zr(a+t);return r+o+a+l}class as{constructor(t,e,n,s="",r=Date.now()){this.parentHash=t,this.authorId=e,this.changes=Object.freeze([...n]),this.message=s,this.timestamp=r,this.hash=Oh(t,e,n,r)}buildRevert(t,e=Date.now()){const n=this.changes.map(s=>({cellId:s.cellId,key:s.key,oldValue:s.newValue,newValue:s.oldValue}));return new as(this.hash,t,n,`revert: ${this.message||this.hash.slice(0,8)}`,e)}toJSON(){return{hash:this.hash,parentHash:this.parentHash,authorId:this.authorId,message:this.message,timestamp:this.timestamp,changes:this.changes}}}const B_="universe",z_="genesis: the universe begins";var Ie,We;class k_{constructor(){qt(this,Ie,new Map);qt(this,We,null);this._genesis()}_genesis(){const t=new as(null,B_,[],z_,0);K(this,Ie).set(t.hash,t),ge(this,We,t.hash)}get head(){return K(this,We)}get length(){return K(this,Ie).size}getCommit(t){return K(this,Ie).get(t)??null}headCommit(){return K(this,Ie).get(K(this,We))}log(t=1/0){const e=[];let n=K(this,We);for(;n&&e.length<t;){const s=K(this,Ie).get(n);if(!s)break;e.push(s),n=s.parentHash}return e}stateAt(t){const e=[];let n=t;for(;n;){const r=K(this,Ie).get(n);if(!r)break;e.unshift(r),n=r.parentHash}const s=new Map;for(const r of e)for(const{cellId:o,key:a,newValue:l}of r.changes)s.set(`${o}:${a}`,l);return s}currentState(){return this.stateAt(K(this,We))}diff(t,e){const n=this.stateAt(t),s=this.stateAt(e),r=[],o=new Set([...n.keys(),...s.keys()]);for(const a of o){const l=n.get(a)??null,c=s.get(a)??null;if(l!==c){const[h,u]=a.split(":");r.push({cellId:h,key:u,before:l,after:c})}}return r}commit(t,e,n=""){if(!Array.isArray(e)||e.length===0)throw new Error("commit requires at least one change");for(const r of e)if(!r.cellId||!r.key)throw new Error("each change must have cellId and key");const s=new as(K(this,We),t,e,n);return K(this,Ie).set(s.hash,s),ge(this,We,s.hash),s}revert(t,e){const n=K(this,Ie).get(t);if(!n)throw new Error(`commit ${t} not found`);if(n.changes.length===0)throw new Error("cannot revert empty commit");n.buildRevert(e);const s=new as(K(this,We),e,[...n.changes].map(r=>({cellId:r.cellId,key:r.key,oldValue:r.newValue,newValue:r.oldValue})),`revert: ${n.message||n.hash.slice(0,8)}`);return K(this,Ie).set(s.hash,s),ge(this,We,s.hash),s}applyExternal(t){if(K(this,Ie).has(t.hash))return K(this,Ie).get(t.hash);if(t.parentHash&&!K(this,Ie).has(t.parentHash))throw new Error(`missing parent ${t.parentHash} — cannot apply ${t.hash}`);const e=new as(t.parentHash,t.authorId,t.changes,t.message,t.timestamp);return K(this,Ie).set(t.hash,e),t.parentHash===K(this,We)&&ge(this,We,t.hash),e}verify(){for(const t of K(this,Ie).values()){if(Oh(t.parentHash,t.authorId,t.changes,t.timestamp)!==t.hash)return{valid:!1,broken:t.hash};if(t.parentHash&&!K(this,Ie).has(t.parentHash))return{valid:!1,broken:t.hash,reason:"missing-parent"}}return{valid:!0}}}Ie=new WeakMap,We=new WeakMap;const oe=Object.freeze({SOLAR:"solar",WIND:"wind",HYDRO:"hydro",MINERAL:"mineral",RARE_EARTH:"rare_earth",BIOLOGICAL:"biological",FISHERY:"fishery",GEOTHERMAL:"geothermal"});Ln.OCEAN+"",oe.FISHERY+"",oe.WIND+"",Ln.COAST+"",oe.FISHERY+"",oe.WIND+"",oe.SOLAR+"",Ln.DESERT+"",oe.SOLAR+"",oe.RARE_EARTH+"",oe.MINERAL+"",Ln.PLAINS+"",oe.WIND+"",oe.MINERAL+"",oe.BIOLOGICAL+"",oe.SOLAR+"",Ln.FOREST+"",oe.BIOLOGICAL+"",oe.HYDRO+"",oe.WIND+"",Ln.MOUNTAIN+"",oe.MINERAL+"",oe.RARE_EARTH+"",oe.GEOTHERMAL+"",oe.WIND+"",oe.HYDRO+"",Ln.ARCTIC+"",oe.MINERAL+"",oe.WIND+"",Ln.JUNGLE+"",oe.BIOLOGICAL+"",oe.HYDRO+"",oe.SOLAR+"",Ln.TUNDRA+"",oe.MINERAL+"",oe.GEOTHERMAL+"",oe.WIND+"";(async()=>{const i=await L_(),t=new k_;window._worldHistory=t;function e({peerCount:g}={}){document.querySelectorAll(".ipfs-dot").forEach(_=>{_.className="ipfs-dot green"}),document.querySelectorAll("#ipfs-label").forEach(_=>{_.textContent=`P2P · ${i.shortId}`}),g!==void 0&&document.querySelectorAll("#ipfs-peers").forEach(_=>{_.textContent=g>0?`${g} peer${g!==1?"s":""}`:""})}e({peerCount:0}),Le.addEventListener("status",g=>e(g.detail)),Le.addEventListener("commit",g=>{try{t.applyExternal(g.detail.commit)}catch{}});const n=document.getElementById("lobby"),s=document.getElementById("loading"),r=document.getElementById("load-fill"),o=document.getElementById("load-text"),a=document.getElementById("hud"),l=document.getElementById("click-to-start"),c=document.getElementById("enter-btn"),h=document.getElementById("username"),u=document.getElementById("room-name");!i.isNew&&i.displayName&&(h.value=i.displayName),u&&(u.value=N_());const d=document.getElementById("id-fingerprint");d&&(d.textContent=i.isNew?"New identity generated":`Identity · ${i.shortId}`),function(){const _=document.getElementById("lobby-avatar-grid");if(!_)return;const m=parseInt(localStorage.getItem("spaceAvatarId")??"0",10),p=b=>"#"+b.toString(16).padStart(6,"0");Ti.forEach(b=>{const y=p(b.skin),E=p(b.hair),N=p(b.outfit),A=p(b.accent),T=document.createElement("div");T.className="lav-chip"+(b.id===m?" lav-active":""),T.dataset.id=String(b.id),T.title=b.label,T.innerHTML=`<svg viewBox="0 0 60 82" xmlns="http://www.w3.org/2000/svg">
      ...
      </svg>`,T.addEventListener("click",()=>{_.querySelectorAll(".lav-chip").forEach(D=>D.classList.remove("lav-active")),T.classList.add("lav-active"),localStorage.setItem("spaceAvatarId",String(b.id))}),_.appendChild(T)})}(),h==null||h.addEventListener("keydown",g=>{g.key==="Enter"&&f()}),u==null||u.addEventListener("keydown",g=>{g.key==="Enter"&&f()}),c==null||c.addEventListener("click",f);function f(){const g=h.value.trim();if(!g){h.focus(),h.style.borderColor="#f55";return}h.style.borderColor="",i.setName(g),u!=null&&u.value.trim()&&U_(u.value.trim()),window._spaceUsername=g,n.style.display="none",s.classList.add("visible");const{scene:_,camera:m,renderer:p,onShipLoaded:b}=kg((y,E)=>{r.style.width=y+"%",o.textContent=E});b(()=>{var Xt,Lt,pt,zt,Yt,ue;s.classList.remove("visible"),a.classList.add("visible"),l.classList.remove("hidden");const{meshes:y,screens:E}=Hg(_),{openScreen:N,isOpen:A}=v_(),T=parseInt(localStorage.getItem("spaceAvatarId")??"0",10),D=new C_(M=>v==null?void 0:v.navigate(M)),w=document.getElementById("presence-panel");w&&w.classList.add("pp-visible"),D.setSelf(g,T,"OUTSIDE","available");const v=f_(_,m,p,M=>{G_(M),D.updateSelfZone(M)},M=>{Le.setAvatar(M),D.setSelf(g,M,D._self.zone,I)});let I="available";const G=document.getElementById("status-btn"),z=document.getElementById("status-menu");G&&z&&(La.forEach(M=>{const Y="#"+M.color.toString(16).padStart(6,"0"),F=document.createElement("div");F.className="sm-opt"+(M.id===I?" sm-active":""),F.dataset.status=M.id,F.innerHTML=`<span class="sm-dot" style="background:${Y};box-shadow:0 0 4px ${Y}40"></span>${M.label}`,F.addEventListener("click",X=>{X.stopPropagation(),I=M.id,G.innerHTML=`<span class="sm-dot" style="background:${Y};box-shadow:0 0 4px ${Y}40;display:inline-block;vertical-align:middle;width:8px;height:8px;border-radius:50%;margin-right:5px"></span>${M.label.replace(/^\S+\s/,"")}`,v.setStatus(M.id),D.updateSelfStatus(M.id),Le.setStatus(M.id),z.querySelectorAll(".sm-opt").forEach(et=>et.classList.toggle("sm-active",et.dataset.status===M.id)),z.classList.remove("sm-open")}),z.appendChild(F)}),G.addEventListener("click",M=>{M.stopPropagation(),z.classList.toggle("sm-open")}),document.addEventListener("click",()=>z.classList.remove("sm-open"))),document.querySelectorAll(".vtbtn").forEach(M=>{M.addEventListener("click",Y=>{Y.stopPropagation(),tt(),v.setView(M.dataset.view),M.dataset.view==="first"&&document.pointerLockElement!==p.domElement&&p.domElement.requestPointerLock()})});let k=!1;function tt(){k||(k=!0,l.classList.add("hidden"))}document.addEventListener("pointerlockchange",()=>{document.pointerLockElement===p.domElement&&tt()}),l.addEventListener("click",tt);const $=new Set(["KeyW","KeyA","KeyS","KeyD"]),at=new Set([...$,"ArrowUp","ArrowDown","ArrowLeft","ArrowRight"]);document.addEventListener("keydown",M=>{at.has(M.code)&&(tt(),$.has(M.code)&&v.getMode()==="first"&&document.pointerLockElement!==p.domElement&&p.domElement.requestPointerLock())});const J=new Sg,gt=new mt,Mt=new Kn(new L(0,1,0),0),St=new L;p.domElement.addEventListener("click",M=>{if(A()||document.pointerLockElement===p.domElement||v.isDragMoved())return;tt(),gt.x=M.clientX/window.innerWidth*2-1,gt.y=-(M.clientY/window.innerHeight)*2+1,J.setFromCamera(gt,m);const Y=J.intersectObjects(y);if(Y.length>0){N(Y[0].object.userData.screen);return}J.ray.intersectPlane(Mt,St)&&v.navigate({x:Math.max(-65,Math.min(65,St.x)),z:Math.max(-65,Math.min(65,St.z))})});const Z=new T_,st=document.getElementById("voice-btn"),U=new Map,q=new Map;Le.addEventListener("peer:join",M=>{const{peerId:Y,username:F,presetId:X}=M.detail;if(q.set(Y,F),U.has(Y))return;const et=X??H_(Y),wt=Mh(F,et);_.add(wt),U.set(Y,wt),Nc(a,U.size+1),D.addPeer(Y,F,et),v.peerJoin(Y,F)}),Le.addEventListener("peer:move",M=>{const{peerId:Y,pos:F}=M.detail,X=U.get(Y);if(D.movePeer(Y,F.x,F.z),X){const et=X.position.clone();if(X.position.lerp(new L(F.x,F.y??0,F.z),.6),F.ry!==void 0){let wt=F.ry-X.rotation.y;for(;wt>Math.PI;)wt-=Math.PI*2;for(;wt<-Math.PI;)wt+=Math.PI*2;X.rotation.y+=wt*.25}et.distanceTo(X.position)>.008&&(X.userData.isMoving=!0,clearTimeout(X.userData._stopTimer),X.userData._stopTimer=setTimeout(()=>{X.userData.isMoving=!1},180))}v.peerMove(Y,F.x,F.z,q.get(Y)??Y.slice(-4))}),Le.addEventListener("peer:leave",M=>{const Y=U.get(M.detail.peerId);Y&&(_.remove(Y),U.delete(M.detail.peerId),Nc(a,U.size+1)),Z.removePeer(M.detail.peerId),D.removePeer(M.detail.peerId),v.peerLeave(M.detail.peerId),q.delete(M.detail.peerId)}),Le.addEventListener("peer:avatar",M=>{const{peerId:Y,presetId:F}=M.detail,X=U.get(Y),et=q.get(Y)??Y.slice(-4);X&&wh(X,et,F),D.updatePeerPreset(Y,F)}),Le.addEventListener("peer:status",M=>{const{peerId:Y,status:F}=M.detail,X=U.get(Y);X&&Sh(X,F),D.updatePeerStatus(Y,F)});let j=performance.now();(function M(){requestAnimationFrame(M);const Y=performance.now(),F=Math.min((Y-j)/1e3,.1);j=Y;const X=Y/1e3;U.forEach((et,wt)=>{Th(et,et.userData.isMoving??!1,F),Eh(et,Z.isTalking(wt),X)}),v.setSelfTalking(Z.isTalking("self"),X)})(),Le.start(g,T,I),window._sync=Le;const Q=({active:M,muted:Y}={})=>{st&&(M?Y?(st.textContent="🔇 Muted",st.className="hud-side-btn voice-muted"):(st.textContent="🎙 Live",st.className="hud-side-btn voice-active"):(st.textContent="🎙 Voice",st.className="hud-side-btn"))};Z.onStateChange(Q),Q({active:!1,muted:!1}),Z.onTalkChange(M=>{v.setTalkingPeers(M)}),st&&st.addEventListener("click",async M=>{if(M.stopPropagation(),Z.active)Z.toggleMute();else if(st.textContent="⏳ Connecting…",!await Z.start(Le)){st.textContent="🚫 No mic";return}}),setInterval(()=>{const M=v.getPosition(),Y=v.getRotation();Le.move(M.x,M.y,M.z,Y.y),Z.update(M,U)},50);const ft=document.getElementById("chat-toggle"),vt=document.getElementById("chat-panel"),Dt=document.getElementById("chat-close"),P=document.getElementById("chat-input"),kt=document.getElementById("chat-send"),Nt=document.getElementById("chat-messages"),Qt=document.getElementById("chat-badge");let At=0;const Wt=document.getElementById("mb-chat-badge");function Ht(){var M;vt.classList.add("open"),ft.classList.add("open"),(M=document.getElementById("mb-chat-btn"))==null||M.classList.add("mb-active"),At=0,Qt.textContent="",Qt.classList.remove("visible"),Wt&&(Wt.textContent="",Wt.classList.remove("visible")),P.focus()}function Ft(){var M;vt.classList.remove("open"),ft.classList.remove("open"),(M=document.getElementById("mb-chat-btn"))==null||M.classList.remove("mb-active")}ft.addEventListener("click",M=>{M.stopPropagation(),vt.classList.contains("open")?Ft():Ht()}),Dt.addEventListener("click",M=>{M.stopPropagation(),Ft()}),(Xt=document.getElementById("mb-chat-btn"))==null||Xt.addEventListener("click",M=>{M.stopPropagation(),vt.classList.contains("open")?Ft():Ht()});function me(){const M=P.value.trim();M&&(Le.sendChat(M),P.value="")}kt.addEventListener("click",M=>{M.stopPropagation(),me()}),P.addEventListener("keydown",M=>{M.key==="Enter"&&me()}),vt.addEventListener("click",M=>M.stopPropagation());function C({from:M,username:Y,text:F,ts:X}){const et=M===Le.id,wt=new Date(X).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),Ot=document.createElement("div");if(Ot.className="chat-msg",Ot.innerHTML=`
          <div class="chat-msg-meta">
            <span class="chat-msg-name${et?" self":""}">${Y}</span>
            <span class="chat-msg-time">${wt}</span>
          </div>
          <div class="chat-msg-body">${F.replace(/</g,"&lt;")}</div>
        `,Nt.appendChild(Ot),Nt.scrollTop=Nt.scrollHeight,!vt.classList.contains("open")&&!et){At++;const te=At>9?"9+":String(At);Qt.textContent=te,Qt.classList.add("visible"),Wt&&(Wt.textContent=te,Wt.classList.add("visible"))}}function x(M){const Y=document.createElement("div");Y.className="chat-system",Y.textContent=M,Nt.appendChild(Y),Nt.scrollTop=Nt.scrollHeight}const W=new Map;Le.addEventListener("chat",M=>C(M.detail)),Le.addEventListener("peer:join",M=>{W.set(M.detail.peerId,M.detail.username),x(`${M.detail.username} joined`)}),Le.addEventListener("peer:leave",M=>{const Y=W.get(M.detail.peerId)??"Someone";W.delete(M.detail.peerId),x(`${Y} left`)});const nt=new M_,it=new E_,rt=new y_(g);nt.createReality(rt),it.setNode(g,es.PUBLIC),(Lt=document.getElementById("nm-open-btn"))==null||Lt.addEventListener("click",M=>{M.stopPropagation(),Rc(nt,it,g)}),(pt=document.getElementById("mb-avatar-btn"))==null||pt.addEventListener("click",()=>{var M;return(M=document.getElementById("avatar-btn"))==null?void 0:M.click()}),(zt=document.getElementById("mb-nm-btn"))==null||zt.addEventListener("click",M=>{M.stopPropagation(),Rc(nt,it,g)}),(Yt=document.getElementById("mb-voice-btn"))==null||Yt.addEventListener("click",M=>{M.stopPropagation(),st==null||st.click()}),(ue=document.getElementById("mb-status-btn"))==null||ue.addEventListener("click",M=>{M.stopPropagation(),G==null||G.click()}),Z.onStateChange(({active:M,muted:Y}={})=>{const F=document.getElementById("mb-voice-btn");F&&(M?Y?(F.innerHTML="🔇",F.className="mb-btn mb-voice-active",F.style.color="#ff6b6b"):(F.innerHTML="🎙",F.className="mb-btn mb-voice-active",F.style.color=""):(F.innerHTML="🎙",F.className="mb-btn"))});const Tt=document.getElementById("screen-hint"),ut=document.getElementById("screen-hint-name");let ht=null,Bt=null;document.addEventListener("keydown",M=>{if(M.code==="KeyE"&&ht&&!A()&&N(ht),M.code==="KeyF"&&Bt){const Y=Bt.def.id,F=Y==="main-left"||Y==="main-right",X=Dn(F?"main-left":Y);F&&Dn("main-right"),lt(Bt.def.label,X)}});function lt(M,Y){let F=document.getElementById("door-action-hint");F||(F=document.createElement("div"),F.id="door-action-hint",F.style.cssText=`
          ...
          `,document.body.appendChild(F)),F.textContent=`${M} ${Y?"opened":"closed"}`,F.style.opacity="1",clearTimeout(F._t),F._t=setTimeout(()=>{F.style.opacity="0"},1500)}const xt=new Set;setInterval(()=>{var wt;if(A())return;const M=v.getPosition();let Y=null,F=4;E.forEach(Ot=>{const te=M.x-Ot.position.x,de=M.z-Ot.position.z,Kt=Math.sqrt(te*te+de*de);Kt<F&&(F=Kt,Y=Ot)}),ht=Y,Tt&&(Tt.style.display=Y?"flex":"none",Y&&ut&&(ut.textContent=Y.label)),or.forEach(Ot=>{const te=M.x-Ot.hinge.x,de=M.z-Ot.hinge.z,Kt=Math.sqrt(te*te+de*de),ve=Ot.id;Kt<2.2&&!ji(ve)?(Dn(ve),xt.add(ve),ve==="main-left"&&(ji("main-right")||Dn("main-right"),xt.add("main-right")),ve==="main-right"&&(ji("main-left")||Dn("main-left"),xt.add("main-left"))):Kt>3.5&&xt.has(ve)&&ji(ve)&&(Dn(ve),xt.delete(ve),ve==="main-left"&&(ji("main-right")&&Dn("main-right"),xt.delete("main-right")),ve==="main-right"&&(ji("main-left")&&Dn("main-left"),xt.delete("main-left")))});const X=Ah(M,2.8);Bt=X;const et=document.getElementById("door-proximity-hint");if(et)if(X&&!Y){const Ot=(wt=X.state)!=null&&wt.open?"Close":"Open";et.style.display="flex",et.querySelector("#door-hint-name").textContent=`${Ot} ${X.def.label}`}else et.style.display="none"},150)})}})();function H_(i){let t=0;for(let e=0;e<i.length;e++)t=t*31+i.charCodeAt(e)|0;return Math.abs(t)%Ti.length}function Nc(i,t){var n;const e=(n=i==null?void 0:i.querySelector)==null?void 0:n.call(i,"#online-count");e&&(e.textContent=`● ${t} aboard`)}const Uc={OUTSIDE:{color:"#88cc66",desc:"Outside the building"},LOBBY:{color:"#ffffff",desc:"Reception & Entrance"},OPS:{color:"#ffaa44",desc:"Operations & Technical Support"},FUN:{color:"#44ffaa",desc:"Chill, Social & Games"},DESIGN:{color:"#ff6ba0",desc:"UI/UX, Design & 3D"},ENGINEERING:{color:"#44aaff",desc:"Development & Engineering"},"":{color:"#ffffff",desc:""}};function G_(i){const t=document.getElementById("zone-name"),e=document.getElementById("zone-desc"),n=Uc[i]||Uc[""];t&&(t.textContent=i,t.style.color=n.color),e&&(e.textContent=n.desc),document.querySelectorAll(".map-zone").forEach(s=>{s.classList.toggle("active",s.dataset.zone===i)})}
