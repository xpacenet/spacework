...
`].filter(yr).join(`
`)),o=ja(o),o=$c(o,e),o=Kc(o,e),a=ja(a),a=$c(a,e),a=Kc(a,e),o=Jc(o),a=Jc(a),e.isRawShaderMaterial!==!0&&(x=`#version 300 es
...
`)+`
`+p);const v=x+m+o,E=x+p+a,N=Yc(i,i.VERTEX_SHADER,v),T=Yc(i,i.FRAGMENT_SHADER,E);i.attachShader(_,N),i.attachShader(_,T),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function b(L){if(s.debug.checkShaderErrors){const H=i.getProgramInfoLog(_).trim(),k=i.getShaderInfoLog(N).trim(),B=i.getShaderInfoLog(T).trim();let Q=!0,Z=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Q=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,N,T);else{const st=qc(i,N,"vertex"),J=qc(i,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;function Zg(s,t,e){let n=new xl;const i=new vt,r=new vt,o=new Ee,a=new Gg({depthPacking:kd}),l=new Vg,c={},h=e.maxTextureSize,u={[bi]:nn,[nn]:bi,[hn]:hn},d=new Ai({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new vt},radius:{value:4}},vertexShader:Wg,fragmentShader:Xg}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new un;g.setAttribute("position",new An(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new wt(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Dh;let p=this.type;this.render=function(T,b,O){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;const w=s.getRenderTarget(),y=s.getActiveCubeFace(),L=s.getActiveMipmapLevel(),H=s.state;H.setBlending(Mi),H.buffers.color.setClear(1,1,1,1),H.buffers.depth.setTest(!0),H.setScissorTest(!1);const k=p!==$n&&this.type===$n,B=p===$n&&this.type!==$n;for(let Q=0,Z=T.length;Q<Z;Q++){const st=T[Q],J=st.shadow;if(J===void 0){console.warn("THREE.WebGLShadowMap:",st,"has no shadow.");continue}if(J.autoUpdate===!1&&J.needsUpdate===!1)continue;i.copy(J.mapSize);const gt=J.getFrameExtents();if(i.multiply(gt),r.copy(J.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/gt.x),i.x=r.x*gt.x,J.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/gt.y),i.y=r.y*gt.y,J.mapSize.y=r.y)),J.map===null||k===!0||B===!0){const Rt=this.type!==$n?{minFilter:vn,magFilter:vn}:{};J.map!==null&&J.map.dispose(),J.map=new ts(i.x,i.y,Rt),J.map.texture.name=st.name+".shadowMap",J.camera.updateProjectionMatrix()}s.setRenderTarget(J.map),s.clear();const St=J.getViewportCount();for(let Rt=0;Rt<St;Rt++){const q=J.getViewport(Rt);o.set(r.x*q.x,r.y*q.y,r.x*q.z,r.y*q.w),H.viewport(o),J.updateMatrices(st,Rt),n=J.getFrustum(),E(b,O,J.camera,st,this.type)}J.isPointLightShadow!==!0&&this.type===$n&&x(J,O),J.needsUpdate=!1}p=this.type,m.needsUpdate=!1,s.setRenderTarget(w,y,L)};function x(T,b){const O=t.update(_);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new ts(i.x,i.y)),d.uniforms.shadow_pass.value=T.map.texture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,s.setRenderTarget(T.mapPass),s.clear(),s.renderBufferDirect(b,null,O,d,_,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,s.setRenderTarget(T.map),s.clear(),s.renderBufferDirect(b,null,O,f,_,null)}function v(T,b,O,w){let y=null;const L=O.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(L!==void 0)y=L;else if(y=O.isPointLight===!0?l:a,s.localClippingEnabled&&b.clipShadows===!0&&Array.isArray(b.clippingPlanes)&&b.clippingPlanes.length!==0||b.displacementMap&&b.displacementScale!==0||b.alphaMap&&b.alphaTest>0||b.map&&b.alphaTest>0){const H=y.uuid,k=b.uuid;let B=c[H];B===void 0&&(B={},c[H]=B);let Q=B[k];Q===void 0&&(Q=y.clone(),B[k]=Q,b.addEventListener("dispose",N)),y=Q}if(y.visible=b.visible,y.wireframe=b.wireframe,w===$n?y.side=b.shadowSide!==null?b.shadowSide:b.side:y.side=b.shadowSide!==null?b.shadowSide:u[b.side],y.alphaMap=b.alphaMap,y.alphaTest=b.alphaTest,y.map=b.map,y.clipShadows=b.clipShadows,y.clippingPlanes=b.clippingPlanes,y.clipIntersection=b.clipIntersection,y.displacementMap=b.displacementMap,y.displacementScale=b.displacementScale,y.displacementBias=b.displacementBias,y.wireframeLinewidth=b.wireframeLinewidth,y.linewidth=b.linewidth,O.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const H=s.properties.get(y);H.light=O}return y}function E(T,b,O,w,y){if(T.visible===!1)return;if(T.layers.test(b.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&y===$n)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,T.matrixWorld);const k=t.update(T),B=T.material;if(Array.isArray(B)){const Q=k.groups;for(let Z=0,st=Q.length;Z<st;Z++){const J=Q[Z],gt=B[J.materialIndex];if(gt&&gt.visible){const St=v(T,gt,w,y);T.onBeforeShadow(s,T,b,O,k,St,J),s.renderBufferDirect(O,null,k,St,T,J),T.onAfterShadow(s,T,b,O,k,St,J)}}}else if(B.visible){const Q=v(T,B,w,y);T.onBeforeShadow(s,T,b,O,k,Q,null),s.renderBufferDirect(O,null,k,Q,T,null),T.onAfterShadow(s,T,b,O,k,Q,null)}}const H=T.children;for(let k=0,B=H.length;k<B;k++)E(H[k],b,O,w,y)}function N(T){T.target.removeEventListener("dispose",N);for(const O in c){const w=c[O],y=T.target.uuid;y in w&&(w[y].dispose(),delete w[y])}}}function Yg(s){function t(){let D=!1;const xt=new Ee;let j=null;const tt=new Ee(0,0,0,0);return{setMask:function(at){j!==at&&!D&&(s.colorMask(at,at,at,at),j=at)},setLocked:function(at){D=at},setClear:function(at,Ot,ne,ae,Ce){Ce===!0&&(at*=ae,Ot*=ae,ne*=ae),xt.set(at,Ot,ne,ae),tt.equals(xt)===!1&&(s.clearColor(at,Ot,ne,ae),tt.copy(xt))},reset:function(){D=!1,j=null,tt.set(-1,0,0,0)}}}function e(){let D=!1,xt=null,j=null,tt=null;return{setTest:function(at){at?K(s.DEPTH_TEST):$(s.DEPTH_TEST)},setMask:function(at){xt!==at&&!D&&(s.depthMask(at),xt=at)},setFunc:function(at){if(j!==at){switch(at){case fd:s.depthFunc(s.NEVER);break;case pd:s.depthFunc(s.ALWAYS);break;case md:s.depthFunc(s.LESS);break;case Io:s.depthFunc(s.LEQUAL);break;case gd:s.depthFunc(s.EQUAL);break;case _d:s.depthFunc(s.GEQUAL);break;case vd:s.depthFunc(s.GREATER);break;case xd:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}j=at}},setLocked:function(at){D=at},setClear:function(at){tt!==at&&(s.clearDepth(at),tt=at)},reset:function(){D=!1,xt=null,j=null,tt=null}}}function n(){let D=!1,xt=null,j=null,tt=null,at=null,Ot=null,ne=null,ae=null,Ce=null;return{setTest:function(ie){D||(ie?K(s.STENCIL_TEST):$(s.STENCIL_TEST))},setMask:function(ie){xt!==ie&&!D&&(s.stencilMask(ie),xt=ie)},setFunc:function(ie,sn,rn){(j!==ie||tt!==sn||at!==rn)&&(s.stencilFunc(ie,sn,rn),j=ie,tt=sn,at=rn)},setOp:function(ie,sn,rn){(Ot!==ie||ne!==sn||ae!==rn)&&(s.stencilOp(ie,sn,rn),Ot=ie,ne=sn,ae=rn)},setLocked:function(ie){D=ie},setClear:function(ie){Ce!==ie&&(s.clearStencil(ie),Ce=ie)},reset:function(){D=!1,xt=null,j=null,tt=null,at=null,Ot=null,ne=null,ae=null,Ce=null}}}const i=new t,r=new e,o=new n,a=new WeakMap,l=new WeakMap;let c={},h={},u=new WeakMap,d=[],f=null,g=!1,_=null,m=null,p=null,x=null,v=null,E=null,N=null,T=new Qt(0,0,0),b=0,O=!1,w=null,y=null,L=null,H=null,k=null;const B=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Q=!1,Z=0;const st=s.getParameter(s.VERSION);st.indexOf("WebGL")!==-1?(Z=parseFloat(/^WebGL (\d)/.exec(st)[1]),Q=Z>=1):st.indexOf("OpenGL ES")!==-1&&(Z=parseFloat(/^OpenGL ES (\d)/.exec(st)[1]),Q=Z>=2);let J=null,gt={};const St=s.getParameter(s.SCISSOR_BOX),Rt=s.getParameter(s.VIEWPORT),q=new Ee().fromArray(St),lt=new Ee().fromArray(Rt);function F(D,xt,j,tt){const at=new Uint8Array(4),Ot=s.createTexture();s.bindTexture(D,Ot),s.texParameteri(D,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(D,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let ne=0;ne<j;ne++)D===s.TEXTURE_3D||D===s.TEXTURE_2D_ARRAY?s.texImage3D(xt,0,s.RGBA,1,1,tt,0,s.RGBA,s.UNSIGNED_BYTE,at):s.texImage2D(xt+ne,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,at);return Ot}const Y={};Y[s.TEXTURE_2D]=F(s.TEXTURE_2D,s.TEXTURE_2D,1),Y[s.TEXTURE_CUBE_MAP]=F(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),Y[s.TEXTURE_2D_ARRAY]=F(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),Y[s.TEXTURE_3D]=F(s.TEXTURE_3D,s.TEXTURE_3D,1,1),i.setClear(0,0,0,1),r.setClear(1),o.setClear(0),K(s.DEPTH_TEST),r.setFunc(Io),It(!1),te(Fl),K(s.CULL_FACE),Gt(Mi);function K(D){c[D]!==!0&&(s.enable(D),c[D]=!0)}function $(D){c[D]!==!1&&(s.disable(D),c[D]=!1)}function ct(D,xt){return h[D]!==xt?(s.bindFramebuffer(D,xt),h[D]=xt,D===s.DRAW_FRAMEBUFFER&&(h[s.FRAMEBUFFER]=xt),D===s.FRAMEBUFFER&&(h[s.DRAW_FRAMEBUFFER]=xt),!0):!1}function Tt(D,xt){let j=d,tt=!1;if(D){j=u.get(xt),j===void 0&&(j=[],u.set(xt,j));const at=D.textures;if(j.length!==at.length||j[0]!==s.COLOR_ATTACHMENT0){for(let Ot=0,ne=at.length;Ot<ne;Ot++)j[Ot]=s.COLOR_ATTACHMENT0+Ot;j.length=at.length,tt=!0}}else j[0]!==s.BACK&&(j[0]=s.BACK,tt=!0);tt&&s.drawBuffers(j)}function zt(D){return f!==D?(s.useProgram(D),f=D,!0):!1}const I={[ki]:s.FUNC_ADD,[Ku]:s.FUNC_SUBTRACT,[Ju]:s.FUNC_REVERSE_SUBTRACT};I[ju]=s.MIN,I[Qu]=s.MAX;const Zt={[td]:s.ZERO,[ed]:s.ONE,[nd]:s.SRC_COLOR,[Wa]:s.SRC_ALPHA,[ld]:s.SRC_ALPHA_SATURATE,[od]:s.DST_COLOR,[sd]:s.DST_ALPHA,[id]:s.ONE_MINUS_SRC_COLOR,[Xa]:s.ONE_MINUS_SRC_ALPHA,[ad]:s.ONE_MINUS_DST_COLOR,[rd]:s.ONE_MINUS_DST_ALPHA,[cd]:s.CONSTANT_COLOR,[hd]:s.ONE_MINUS_CONSTANT_COLOR,[ud]:s.CONSTANT_ALPHA,[dd]:s.ONE_MINUS_CONSTANT_ALPHA};function Gt(D,xt,j,tt,at,Ot,ne,ae,Ce,ie){if(D===Mi){g===!0&&($(s.BLEND),g=!1);return}if(g===!1&&(K(s.BLEND),g=!0),D!==$u){if(D!==_||ie!==O){if((m!==ki||v!==ki)&&(s.blendEquation(s.FUNC_ADD),m=ki,v=ki),ie)switch(D){case Bs:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Bl:s.blendFunc(s.ONE,s.ONE);break;case zl:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case kl:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case Bs:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Bl:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case zl:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case kl:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}p=null,x=null,E=null,N=null,T.set(0,0,0),b=0,_=D,O=ie}return}at=at||xt,Ot=Ot||j,ne=ne||tt,(xt!==m||at!==v)&&(s.blendEquationSeparate(I[xt],I[at]),m=xt,v=at),(j!==p||tt!==x||Ot!==E||ne!==N)&&(s.blendFuncSeparate(Zt[j],Zt[tt],Zt[Ot],Zt[ne]),p=j,x=tt,E=Ot,N=ne),(ae.equals(T)===!1||Ce!==b)&&(s.blendColor(ae.r,ae.g,ae.b,Ce),T.copy(ae),b=Ce),_=D,O=!1}function he(D,xt){D.side===hn?$(s.CULL_FACE):K(s.CULL_FACE);let j=D.side===nn;xt&&(j=!j),It(j),D.blending===Bs&&D.transparent===!1?Gt(Mi):Gt(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),r.setFunc(D.depthFunc),r.setTest(D.depthTest),r.setMask(D.depthWrite),i.setMask(D.colorWrite);const tt=D.stencilWrite;o.setTest(tt),tt&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),Wt(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?K(s.SAMPLE_ALPHA_TO_COVERAGE):$(s.SAMPLE_ALPHA_TO_COVERAGE)}function It(D){w!==D&&(D?s.frontFace(s.CW):s.frontFace(s.CCW),w=D)}function te(D){D!==Yu?(K(s.CULL_FACE),D!==y&&(D===Fl?s.cullFace(s.BACK):D===qu?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):$(s.CULL_FACE),y=D}function Xt(D){D!==L&&(Q&&s.lineWidth(D),L=D)}function Wt(D,xt,j){D?(K(s.POLYGON_OFFSET_FILL),(H!==xt||k!==j)&&(s.polygonOffset(xt,j),H=xt,k=j)):$(s.POLYGON_OFFSET_FILL)}function me(D){D?K(s.SCISSOR_TEST):$(s.SCISSOR_TEST)}function C(D){D===void 0&&(D=s.TEXTURE0+B-1),J!==D&&(s.activeTexture(D),J=D)}function M(D,xt,j){j===void 0&&(J===null?j=s.TEXTURE0+B-1:j=J);let tt=gt[j];tt===void 0&&(tt={type:void 0,texture:void 0},gt[j]=tt),(tt.type!==D||tt.texture!==xt)&&(J!==j&&(s.activeTexture(j),J=j),s.bindTexture(D,xt||Y[D]),tt.type=D,tt.texture=xt)}function W(){const D=gt[J];D!==void 0&&D.type!==void 0&&(s.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function et(){try{s.compressedTexImage2D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function it(){try{s.compressedTexImage3D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function nt(){try{s.texSubImage2D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Lt(){try{s.texSubImage3D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ut(){try{s.compressedTexSubImage2D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function dt(){try{s.compressedTexSubImage3D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Yt(){try{s.texStorage2D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function rt(){try{s.texStorage3D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function bt(){try{s.texImage2D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Jt(){try{s.texImage3D.apply(s,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ut(D){q.equals(D)===!1&&(s.scissor(D.x,D.y,D.z,D.w),q.copy(D))}function _t(D){lt.equals(D)===!1&&(s.viewport(D.x,D.y,D.z,D.w),lt.copy(D))}function Dt(D,xt){let j=l.get(xt);j===void 0&&(j=new WeakMap,l.set(xt,j));let tt=j.get(D);tt===void 0&&(tt=s.getUniformBlockIndex(xt,D.name),j.set(D,tt))}function kt(D,xt){const tt=l.get(xt).get(D);a.get(xt)!==tt&&(s.uniformBlockBinding(xt,tt,D.__bindingPointIndex),a.set(xt,tt))}function ge(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),c={},J=null,gt={},h={},u=new WeakMap,d=[],f=null,g=!1,_=null,m=null,p=null,x=null,v=null,E=null,N=null,T=new Qt(0,0,0),b=0,O=!1,w=null,y=null,L=null,H=null,k=null,q.set(0,0,s.canvas.width,s.canvas.height),lt.set(0,0,s.canvas.width,s.canvas.height),i.reset(),r.reset(),o.reset()}return{buffers:{color:i,depth:r,stencil:o},enable:K,disable:$,bindFramebuffer:ct,drawBuffers:Tt,useProgram:zt,setBlending:Gt,setMaterial:he,setFlipSided:It,setCullFace:te,setLineWidth:Xt,setPolygonOffset:Wt,setScissorTest:me,activeTexture:C,bindTexture:M,unbindTexture:W,compressedTexImage2D:et,compressedTexImage3D:it,texImage2D:bt,texImage3D:Jt,updateUBOMapping:Dt,uniformBlockBinding:kt,texStorage2D:Yt,texStorage3D:rt,texSubImage2D:nt,texSubImage3D:Lt,compressedTexSubImage2D:ut,compressedTexSubImage3D:dt,scissor:Ut,viewport:_t,reset:ge}}function qg(s,t,e,n,i,r,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new vt,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(C,M){return f?new OffscreenCanvas(C,M):Bo("canvas")}function _(C,M,W){let et=1;const it=me(C);if((it.width>W||it.height>W)&&(et=W/Math.max(it.width,it.height)),et<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const nt=Math.floor(et*it.width),Lt=Math.floor(et*it.height);u===void 0&&(u=g(nt,Lt));const ut=M?g(nt,Lt):u;return ut.width=nt,ut.height=Lt,ut.getContext("2d").drawImage(C,0,0,nt,Lt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+it.width+"x"+it.height+") to ("+nt+"x"+Lt+")."),ut}else return"data"in C&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+it.width+"x"+it.height+")."),C;return C}function m(C){return C.generateMipmaps&&C.minFilter!==vn&&C.minFilter!==bn}function p(C){s.generateMipmap(C)}function x(C,M,W,et,it=!1){if(C!==null){if(s[C]!==void 0)return s[C];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let nt=M;if(M===s.RED&&(W===s.FLOAT&&(nt=s.R32F),W===s.HALF_FLOAT&&(nt=s.R16F),W===s.UNSIGNED_BYTE&&(nt=s.R8)),M===s.RED_INTEGER&&(W===s.UNSIGNED_BYTE&&(nt=s.R8UI),W===s.UNSIGNED_SHORT&&(nt=s.R16UI),W===s.UNSIGNED_INT&&(nt=s.R32UI),W===s.BYTE&&(nt=s.R8I),W===s.SHORT&&(nt=s.R16I),W===s.INT&&(nt=s.R32I)),M===s.RG&&(W===s.FLOAT&&(nt=s.RG32F),W===s.HALF_FLOAT&&(nt=s.RG16F),W===s.UNSIGNED_BYTE&&(nt=s.RG8)),M===s.RG_INTEGER&&(W===s.UNSIGNED_BYTE&&(nt=s.RG8UI),W===s.UNSIGNED_SHORT&&(nt=s.RG16UI),W===s.UNSIGNED_INT&&(nt=s.RG32UI),W===s.BYTE&&(nt=s.RG8I),W===s.SHORT&&(nt=s.RG16I),W===s.INT&&(nt=s.RG32I)),M===s.RGB&&W===s.UNSIGNED_INT_5_9_9_9_REV&&(nt=s.RGB9_E5),M===s.RGBA){const Lt=it?No:ce.getTransfer(et);W===s.FLOAT&&(nt=s.RGBA32F),W===s.HALF_FLOAT&&(nt=s.RGBA16F),W===s.UNSIGNED_BYTE&&(nt=Lt===xe?s.SRGB8_ALPHA8:s.RGBA8),W===s.UNSIGNED_SHORT_4_4_4_4&&(nt=s.RGBA4),W===s.UNSIGNED_SHORT_5_5_5_1&&(nt=s.RGB5_A1)}return(nt===s.R16F||nt===s.R32F||nt===s.RG16F||nt===s.RG32F||nt===s.RGBA16F||nt===s.RGBA32F)&&t.get("EXT_color_buffer_float"),nt}function v(C,M){let W;return C?M===null||M===er||M===nr?W=s.DEPTH24_STENCIL8:M===yi?W=s.DEPTH32F_STENCIL8:M===Do&&(W=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===er||M===nr?W=s.DEPTH_COMPONENT24:M===yi?W=s.DEPTH_COMPONENT32F:M===Do&&(W=s.DEPTH_COMPONENT16),W}function E(C,M){return m(C)===!0||C.isFramebufferTexture&&C.minFilter!==vn&&C.minFilter!==bn?Math.log2(Math.max(M.width,M.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?M.mipmaps.length:1}function N(C){const M=C.target;M.removeEventListener("dispose",N),b(M),M.isVideoTexture&&h.delete(M)}function T(C){const M=C.target;M.removeEventListener("dispose",T),w(M)}function b(C){const M=n.get(C);if(M.__webglInit===void 0)return;const W=C.source,et=d.get(W);if(et){const it=et[M.__cacheKey];it.usedTimes--,it.usedTimes===0&&O(C),Object.keys(et).length===0&&d.delete(W)}n.remove(C)}function O(C){const M=n.get(C);s.deleteTexture(M.__webglTexture);const W=C.source,et=d.get(W);delete et[M.__cacheKey],o.memory.textures--}function w(C){const M=n.get(C);if(C.depthTexture&&C.depthTexture.dispose(),C.isWebGLCubeRenderTarget)for(let et=0;et<6;et++){if(Array.isArray(M.__webglFramebuffer[et]))for(let it=0;it<M.__webglFramebuffer[et].length;it++)s.deleteFramebuffer(M.__webglFramebuffer[et][it]);else s.deleteFramebuffer(M.__webglFramebuffer[et]);M.__webglDepthbuffer&&s.deleteRenderbuffer(M.__webglDepthbuffer[et])}else{if(Array.isArray(M.__webglFramebuffer))for(let et=0;et<M.__webglFramebuffer.length;et++)s.deleteFramebuffer(M.__webglFramebuffer[et]);else s.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&s.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&s.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let et=0;et<M.__webglColorRenderbuffer.length;et++)M.__webglColorRenderbuffer[et]&&s.deleteRenderbuffer(M.__webglColorRenderbuffer[et]);M.__webglDepthRenderbuffer&&s.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const W=C.textures;for(let et=0,it=W.length;et<it;et++){const nt=n.get(W[et]);nt.__webglTexture&&(s.deleteTexture(nt.__webglTexture),o.memory.textures--),n.remove(W[et])}n.remove(C)}let y=0;function L(){y=0}function H(){const C=y;return C>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+i.maxTextures),y+=1,C}function k(C){const M=[];return M.push(C.wrapS),M.push(C.wrapT),M.push(C.wrapR||0),M.push(C.magFilter),M.push(C.minFilter),M.push(C.anisotropy),M.push(C.internalFormat),M.push(C.format),M.push(C.type),M.push(C.generateMipmaps),M.push(C.premultiplyAlpha),M.push(C.flipY),M.push(C.unpackAlignment),M.push(C.colorSpace),M.join()}function B(C,M){const W=n.get(C);if(C.isVideoTexture&&Xt(C),C.isRenderTargetTexture===!1&&C.version>0&&W.__version!==C.version){const et=C.image;if(et===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(et.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{lt(W,C,M);return}}e.bindTexture(s.TEXTURE_2D,W.__webglTexture,s.TEXTURE0+M)}function Q(C,M){const W=n.get(C);if(C.version>0&&W.__version!==C.version){lt(W,C,M);return}e.bindTexture(s.TEXTURE_2D_ARRAY,W.__webglTexture,s.TEXTURE0+M)}function Z(C,M){const W=n.get(C);if(C.version>0&&W.__version!==C.version){lt(W,C,M);return}e.bindTexture(s.TEXTURE_3D,W.__webglTexture,s.TEXTURE0+M)}function st(C,M){const W=n.get(C);if(C.version>0&&W.__version!==C.version){F(W,C,M);return}e.bindTexture(s.TEXTURE_CUBE_MAP,W.__webglTexture,s.TEXTURE0+M)}const J={[qa]:s.REPEAT,[Gi]:s.CLAMP_TO_EDGE,[$a]:s.MIRRORED_REPEAT},gt={[vn]:s.NEAREST,[Rd]:s.NEAREST_MIPMAP_NEAREST,[to]:s.NEAREST_MIPMAP_LINEAR,[bn]:s.LINEAR,[ea]:s.LINEAR_MIPMAP_NEAREST,[Vi]:s.LINEAR_MIPMAP_LINEAR},St={[Gd]:s.NEVER,[qd]:s.ALWAYS,[Vd]:s.LESS,[Xh]:s.LEQUAL,[Wd]:s.EQUAL,[Yd]:s.GEQUAL,[Xd]:s.GREATER,[Zd]:s.NOTEQUAL};function Rt(C,M){if(M.type===yi&&t.has("OES_texture_float_linear")===!1&&(M.magFilter===bn||M.magFilter===ea||M.magFilter===to||M.magFilter===Vi||M.minFilter===bn||M.minFilter===ea||M.minFilter===to||M.minFilter===Vi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(C,s.TEXTURE_WRAP_S,J[M.wrapS]),s.texParameteri(C,s.TEXTURE_WRAP_T,J[M.wrapT]),(C===s.TEXTURE_3D||C===s.TEXTURE_2D_ARRAY)&&s.texParameteri(C,s.TEXTURE_WRAP_R,J[M.wrapR]),s.texParameteri(C,s.TEXTURE_MAG_FILTER,gt[M.magFilter]),s.texParameteri(C,s.TEXTURE_MIN_FILTER,gt[M.minFilter]),M.compareFunction&&(s.texParameteri(C,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(C,s.TEXTURE_COMPARE_FUNC,St[M.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===vn||M.minFilter!==to&&M.minFilter!==Vi||M.type===yi&&t.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||n.get(M).__currentAnisotropy){const W=t.get("EXT_texture_filter_anisotropic");s.texParameterf(C,W.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,i.getMaxAnisotropy())),n.get(M).__currentAnisotropy=M.anisotropy}}}function q(C,M){let W=!1;C.__webglInit===void 0&&(C.__webglInit=!0,M.addEventListener("dispose",N));const et=M.source;let it=d.get(et);it===void 0&&(it={},d.set(et,it));const nt=k(M);if(nt!==C.__cacheKey){it[nt]===void 0&&(it[nt]={texture:s.createTexture(),usedTimes:0},o.memory.textures++,W=!0),it[nt].usedTimes++;const Lt=it[C.__cacheKey];Lt!==void 0&&(it[C.__cacheKey].usedTimes--,Lt.usedTimes===0&&O(M)),C.__cacheKey=nt,C.__webglTexture=it[nt].texture}return W}function lt(C,M,W){let et=s.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(et=s.TEXTURE_2D_ARRAY),M.isData3DTexture&&(et=s.TEXTURE_3D);const it=q(C,M),nt=M.source;e.bindTexture(et,C.__webglTexture,s.TEXTURE0+W);const Lt=n.get(nt);if(nt.version!==Lt.__version||it===!0){e.activeTexture(s.TEXTURE0+W);const ut=ce.getPrimaries(ce.workingColorSpace),dt=M.colorSpace===gi?null:ce.getPrimaries(M.colorSpace),Yt=M.colorSpace===gi||ut===dt?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,M.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,M.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Yt);let rt=_(M.image,!1,i.maxTextureSize);rt=Wt(M,rt);const bt=r.convert(M.format,M.colorSpace),Jt=r.convert(M.type);let Ut=x(M.internalFormat,bt,Jt,M.colorSpace,M.isVideoTexture);Rt(et,M);let _t;const Dt=M.mipmaps,kt=M.isVideoTexture!==!0,ge=Lt.__version===void 0||it===!0,D=nt.dataReady,xt=E(M,rt);if(M.isDepthTexture)Ut=v(M.format===ir,M.type),ge&&(kt?e.texStorage2D(s.TEXTURE_2D,1,Ut,rt.width,rt.height):e.texImage2D(s.TEXTURE_2D,0,Ut,rt.width,rt.height,0,bt,Jt,null));else if(M.isDataTexture)if(Dt.length>0){kt&&ge&&e.texStorage2D(s.TEXTURE_2D,xt,Ut,Dt[0].width,Dt[0].height);for(let j=0,tt=Dt.length;j<tt;j++)_t=Dt[j],kt?D&&e.texSubImage2D(s.TEXTURE_2D,j,0,0,_t.width,_t.height,bt,Jt,_t.data):e.texImage2D(s.TEXTURE_2D,j,Ut,_t.width,_t.height,0,bt,Jt,_t.data);M.generateMipmaps=!1}else kt?(ge&&e.texStorage2D(s.TEXTURE_2D,xt,Ut,rt.width,rt.height),D&&e.texSubImage2D(s.TEXTURE_2D,0,0,0,rt.width,rt.height,bt,Jt,rt.data)):e.texImage2D(s.TEXTURE_2D,0,Ut,rt.width,rt.height,0,bt,Jt,rt.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){kt&&ge&&e.texStorage3D(s.TEXTURE_2D_ARRAY,xt,Ut,Dt[0].width,Dt[0].height,rt.depth);for(let j=0,tt=Dt.length;j<tt;j++)if(_t=Dt[j],M.format!==Fn)if(bt!==null)if(kt){if(D)if(M.layerUpdates.size>0){for(const at of M.layerUpdates){const Ot=_t.width*_t.height;e.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,j,0,0,at,_t.width,_t.height,1,bt,_t.data.slice(Ot*at,Ot*(at+1)),0,0)}M.clearLayerUpdates()}else e.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,j,0,0,0,_t.width,_t.height,rt.depth,bt,_t.data,0,0)}else e.compressedTexImage3D(s.TEXTURE_2D_ARRAY,j,Ut,_t.width,_t.height,rt.depth,0,_t.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else kt?D&&e.texSubImage3D(s.TEXTURE_2D_ARRAY,j,0,0,0,_t.width,_t.height,rt.depth,bt,Jt,_t.data):e.texImage3D(s.TEXTURE_2D_ARRAY,j,Ut,_t.width,_t.height,rt.depth,0,bt,Jt,_t.data)}else{kt&&ge&&e.texStorage2D(s.TEXTURE_2D,xt,Ut,Dt[0].width,Dt[0].height);for(let j=0,tt=Dt.length;j<tt;j++)_t=Dt[j],M.format!==Fn?bt!==null?kt?D&&e.compressedTexSubImage2D(s.TEXTURE_2D,j,0,0,_t.width,_t.height,bt,_t.data):e.compressedTexImage2D(s.TEXTURE_2D,j,Ut,_t.width,_t.height,0,_t.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):kt?D&&e.texSubImage2D(s.TEXTURE_2D,j,0,0,_t.width,_t.height,bt,Jt,_t.data):e.texImage2D(s.TEXTURE_2D,j,Ut,_t.width,_t.height,0,bt,Jt,_t.data)}else if(M.isDataArrayTexture)if(kt){if(ge&&e.texStorage3D(s.TEXTURE_2D_ARRAY,xt,Ut,rt.width,rt.height,rt.depth),D)if(M.layerUpdates.size>0){let j;switch(Jt){case s.UNSIGNED_BYTE:switch(bt){case s.ALPHA:j=1;break;case s.LUMINANCE:j=1;break;case s.LUMINANCE_ALPHA:j=2;break;case s.RGB:j=3;break;case s.RGBA:j=4;break;default:throw new Error(`Unknown texel size for format ${bt}.`)}break;case s.UNSIGNED_SHORT_4_4_4_4:case s.UNSIGNED_SHORT_5_5_5_1:case s.UNSIGNED_SHORT_5_6_5:j=1;break;default:throw new Error(`Unknown texel size for type ${Jt}.`)}const tt=rt.width*rt.height*j;for(const at of M.layerUpdates)e.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,at,rt.width,rt.height,1,bt,Jt,rt.data.slice(tt*at,tt*(at+1)));M.clearLayerUpdates()}else e.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,rt.width,rt.height,rt.depth,bt,Jt,rt.data)}else e.texImage3D(s.TEXTURE_2D_ARRAY,0,Ut,rt.width,rt.height,rt.depth,0,bt,Jt,rt.data);else if(M.isData3DTexture)kt?(ge&&e.texStorage3D(s.TEXTURE_3D,xt,Ut,rt.width,rt.height,rt.depth),D&&e.texSubImage3D(s.TEXTURE_3D,0,0,0,0,rt.width,rt.height,rt.depth,bt,Jt,rt.data)):e.texImage3D(s.TEXTURE_3D,0,Ut,rt.width,rt.height,rt.depth,0,bt,Jt,rt.data);else if(M.isFramebufferTexture){if(ge)if(kt)e.texStorage2D(s.TEXTURE_2D,xt,Ut,rt.width,rt.height);else{let j=rt.width,tt=rt.height;for(let at=0;at<xt;at++)e.texImage2D(s.TEXTURE_2D,at,Ut,j,tt,0,bt,Jt,null),j>>=1,tt>>=1}}else if(Dt.length>0){if(kt&&ge){const j=me(Dt[0]);e.texStorage2D(s.TEXTURE_2D,xt,Ut,j.width,j.height)}for(let j=0,tt=Dt.length;j<tt;j++)_t=Dt[j],kt?D&&e.texSubImage2D(s.TEXTURE_2D,j,0,0,bt,Jt,_t):e.texImage2D(s.TEXTURE_2D,j,Ut,bt,Jt,_t);M.generateMipmaps=!1}else if(kt){if(ge){const j=me(rt);e.texStorage2D(s.TEXTURE_2D,xt,Ut,j.width,j.height)}D&&e.texSubImage2D(s.TEXTURE_2D,0,0,0,bt,Jt,rt)}else e.texImage2D(s.TEXTURE_2D,0,Ut,bt,Jt,rt);m(M)&&p(et),Lt.__version=nt.version,M.onUpdate&&M.onUpdate(M)}C.__version=M.version}function F(C,M,W){if(M.image.length!==6)return;const et=q(C,M),it=M.source;e.bindTexture(s.TEXTURE_CUBE_MAP,C.__webglTexture,s.TEXTURE0+W);const nt=n.get(it);if(it.version!==nt.__version||et===!0){e.activeTexture(s.TEXTURE0+W);const Lt=ce.getPrimaries(ce.workingColorSpace),ut=M.colorSpace===gi?null:ce.getPrimaries(M.colorSpace),dt=M.colorSpace===gi||Lt===ut?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,M.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,M.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,dt);const Yt=M.isCompressedTexture||M.image[0].isCompressedTexture,rt=M.image[0]&&M.image[0].isDataTexture,bt=[];for(let tt=0;tt<6;tt++)!Yt&&!rt?bt[tt]=_(M.image[tt],!0,i.maxCubemapSize):bt[tt]=rt?M.image[tt].image:M.image[tt],bt[tt]=Wt(M,bt[tt]);const Jt=bt[0],Ut=r.convert(M.format,M.colorSpace),_t=r.convert(M.type),Dt=x(M.internalFormat,Ut,_t,M.colorSpace),kt=M.isVideoTexture!==!0,ge=nt.__version===void 0||et===!0,D=it.dataReady;let xt=E(M,Jt);Rt(s.TEXTURE_CUBE_MAP,M);let j;if(Yt){kt&&ge&&e.texStorage2D(s.TEXTURE_CUBE_MAP,xt,Dt,Jt.width,Jt.height);for(let tt=0;tt<6;tt++){j=bt[tt].mipmaps;for(let at=0;at<j.length;at++){const Ot=j[at];M.format!==Fn?Ut!==null?kt?D&&e.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+tt,at,0,0,Ot.width,Ot.height,Ut,Ot.data):e.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+tt,at,Dt,Ot.width,Ot.height,0,Ot.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):kt?D&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+tt,at,0,0,Ot.width,Ot.height,Ut,_t,Ot.data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+tt,at,Dt,Ot.width,Ot.height,0,Ut,_t,Ot.data)}}}else{if(j=M.mipmaps,kt&&ge){j.length>0&&xt++;const tt=me(bt[0]);e.texStorage2D(s.TEXTURE_CUBE_MAP,xt,Dt,tt.width,tt.height)}for(let tt=0;tt<6;tt++)if(rt){kt?D&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,0,0,bt[tt].width,bt[tt].height,Ut,_t,bt[tt].data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,Dt,bt[tt].width,bt[tt].height,0,Ut,_t,bt[tt].data);for(let at=0;at<j.length;at++){const ne=j[at].image[tt].image;kt?D&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+tt,at+1,0,0,ne.width,ne.height,Ut,_t,ne.data):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+tt,at+1,Dt,ne.width,ne.height,0,Ut,_t,ne.data)}}else{kt?D&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,0,0,Ut,_t,bt[tt]):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,Dt,Ut,_t,bt[tt]);for(let at=0;at<j.length;at++){const Ot=j[at];kt?D&&e.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+tt,at+1,0,0,Ut,_t,Ot.image[tt]):e.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+tt,at+1,Dt,Ut,_t,Ot.image[tt])}}}m(M)&&p(s.TEXTURE_CUBE_MAP),nt.__version=it.version,M.onUpdate&&M.onUpdate(M)}C.__version=M.version}function Y(C,M,W,et,it,nt){const Lt=r.convert(W.format,W.colorSpace),ut=r.convert(W.type),dt=x(W.internalFormat,Lt,ut,W.colorSpace);if(!n.get(M).__hasExternalTextures){const rt=Math.max(1,M.width>>nt),bt=Math.max(1,M.height>>nt);it===s.TEXTURE_3D||it===s.TEXTURE_2D_ARRAY?e.texImage3D(it,nt,dt,rt,bt,M.depth,0,Lt,ut,null):e.texImage2D(it,nt,dt,rt,bt,0,Lt,ut,null)}e.bindFramebuffer(s.FRAMEBUFFER,C),te(M)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,et,it,n.get(W).__webglTexture,0,It(M)):(it===s.TEXTURE_2D||it>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&it<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,et,it,n.get(W).__webglTexture,nt),e.bindFramebuffer(s.FRAMEBUFFER,null)}function K(C,M,W){if(s.bindRenderbuffer(s.RENDERBUFFER,C),M.depthBuffer){const et=M.depthTexture,it=et&&et.isDepthTexture?et.type:null,nt=v(M.stencilBuffer,it),Lt=M.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ut=It(M);te(M)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,ut,nt,M.width,M.height):W?s.renderbufferStorageMultisample(s.RENDERBUFFER,ut,nt,M.width,M.height):s.renderbufferStorage(s.RENDERBUFFER,nt,M.width,M.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,Lt,s.RENDERBUFFER,C)}else{const et=M.textures;for(let it=0;it<et.length;it++){const nt=et[it],Lt=r.convert(nt.format,nt.colorSpace),ut=r.convert(nt.type),dt=x(nt.internalFormat,Lt,ut,nt.colorSpace),Yt=It(M);W&&te(M)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,Yt,dt,M.width,M.height):te(M)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Yt,dt,M.width,M.height):s.renderbufferStorage(s.RENDERBUFFER,dt,M.width,M.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function $(C,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(s.FRAMEBUFFER,C),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(M.depthTexture).__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),B(M.depthTexture,0);const et=n.get(M.depthTexture).__webglTexture,it=It(M);if(M.depthTexture.format===zs)te(M)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,et,0,it):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,et,0);else if(M.depthTexture.format===ir)te(M)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,et,0,it):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,et,0);else throw new Error("Unknown depthTexture format")}function ct(C){const M=n.get(C),W=C.isWebGLCubeRenderTarget===!0;if(C.depthTexture&&!M.__autoAllocateDepthBuffer){if(W)throw new Error("target.depthTexture not supported in Cube render targets");$(M.__webglFramebuffer,C)}else if(W){M.__webglDepthbuffer=[];for(let et=0;et<6;et++)e.bindFramebuffer(s.FRAMEBUFFER,M.__webglFramebuffer[et]),M.__webglDepthbuffer[et]=s.createRenderbuffer(),K(M.__webglDepthbuffer[et],C,!1)}else e.bindFramebuffer(s.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer=s.createRenderbuffer(),K(M.__webglDepthbuffer,C,!1);e.bindFramebuffer(s.FRAMEBUFFER,null)}function Tt(C,M,W){const et=n.get(C);M!==void 0&&Y(et.__webglFramebuffer,C,C.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),W!==void 0&&ct(C)}function zt(C){const M=C.texture,W=n.get(C),et=n.get(M);C.addEventListener("dispose",T);const it=C.textures,nt=C.isWebGLCubeRenderTarget===!0,Lt=it.length>1;if(Lt||(et.__webglTexture===void 0&&(et.__webglTexture=s.createTexture()),et.__version=M.version,o.memory.textures++),nt){W.__webglFramebuffer=[];for(let ut=0;ut<6;ut++)if(M.mipmaps&&M.mipmaps.length>0){W.__webglFramebuffer[ut]=[];for(let dt=0;dt<M.mipmaps.length;dt++)W.__webglFramebuffer[ut][dt]=s.createFramebuffer()}else W.__webglFramebuffer[ut]=s.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){W.__webglFramebuffer=[];for(let ut=0;ut<M.mipmaps.length;ut++)W.__webglFramebuffer[ut]=s.createFramebuffer()}else W.__webglFramebuffer=s.createFramebuffer();if(Lt)for(let ut=0,dt=it.length;ut<dt;ut++){const Yt=n.get(it[ut]);Yt.__webglTexture===void 0&&(Yt.__webglTexture=s.createTexture(),o.memory.textures++)}if(C.samples>0&&te(C)===!1){W.__webglMultisampledFramebuffer=s.createFramebuffer(),W.__webglColorRenderbuffer=[],e.bindFramebuffer(s.FRAMEBUFFER,W.__webglMultisampledFramebuffer);for(let ut=0;ut<it.length;ut++){const dt=it[ut];W.__webglColorRenderbuffer[ut]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,W.__webglColorRenderbuffer[ut]);const Yt=r.convert(dt.format,dt.colorSpace),rt=r.convert(dt.type),bt=x(dt.internalFormat,Yt,rt,dt.colorSpace,C.isXRRenderTarget===!0),Jt=It(C);s.renderbufferStorageMultisample(s.RENDERBUFFER,Jt,bt,C.width,C.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ut,s.RENDERBUFFER,W.__webglColorRenderbuffer[ut])}s.bindRenderbuffer(s.RENDERBUFFER,null),C.depthBuffer&&(W.__webglDepthRenderbuffer=s.createRenderbuffer(),K(W.__webglDepthRenderbuffer,C,!0)),e.bindFramebuffer(s.FRAMEBUFFER,null)}}if(nt){e.bindTexture(s.TEXTURE_CUBE_MAP,et.__webglTexture),Rt(s.TEXTURE_CUBE_MAP,M);for(let ut=0;ut<6;ut++)if(M.mipmaps&&M.mipmaps.length>0)for(let dt=0;dt<M.mipmaps.length;dt++)Y(W.__webglFramebuffer[ut][dt],C,M,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ut,dt);else Y(W.__webglFramebuffer[ut],C,M,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ut,0);m(M)&&p(s.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Lt){for(let ut=0,dt=it.length;ut<dt;ut++){const Yt=it[ut],rt=n.get(Yt);e.bindTexture(s.TEXTURE_2D,rt.__webglTexture),Rt(s.TEXTURE_2D,Yt),Y(W.__webglFramebuffer,C,Yt,s.COLOR_ATTACHMENT0+ut,s.TEXTURE_2D,0),m(Yt)&&p(s.TEXTURE_2D)}e.unbindTexture()}else{let ut=s.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ut=C.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),e.bindTexture(ut,et.__webglTexture),Rt(ut,M),M.mipmaps&&M.mipmaps.length>0)for(let dt=0;dt<M.mipmaps.length;dt++)Y(W.__webglFramebuffer[dt],C,M,s.COLOR_ATTACHMENT0,ut,dt);else Y(W.__webglFramebuffer,C,M,s.COLOR_ATTACHMENT0,ut,0);m(M)&&p(ut),e.unbindTexture()}C.depthBuffer&&ct(C)}function I(C){const M=C.textures;for(let W=0,et=M.length;W<et;W++){const it=M[W];if(m(it)){const nt=C.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:s.TEXTURE_2D,Lt=n.get(it).__webglTexture;e.bindTexture(nt,Lt),p(nt),e.unbindTexture()}}}const Zt=[],Gt=[];function he(C){if(C.samples>0){if(te(C)===!1){const M=C.textures,W=C.width,et=C.height;let it=s.COLOR_BUFFER_BIT;const nt=C.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Lt=n.get(C),ut=M.length>1;if(ut)for(let dt=0;dt<M.length;dt++)e.bindFramebuffer(s.FRAMEBUFFER,Lt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+dt,s.RENDERBUFFER,null),e.bindFramebuffer(s.FRAMEBUFFER,Lt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+dt,s.TEXTURE_2D,null,0);e.bindFramebuffer(s.READ_FRAMEBUFFER,Lt.__webglMultisampledFramebuffer),e.bindFramebuffer(s.DRAW_FRAMEBUFFER,Lt.__webglFramebuffer);for(let dt=0;dt<M.length;dt++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(it|=s.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(it|=s.STENCIL_BUFFER_BIT)),ut){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,Lt.__webglColorRenderbuffer[dt]);const Yt=n.get(M[dt]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,Yt,0)}s.blitFramebuffer(0,0,W,et,0,0,W,et,it,s.NEAREST),l===!0&&(Zt.length=0,Gt.length=0,Zt.push(s.COLOR_ATTACHMENT0+dt),C.depthBuffer&&C.resolveDepthBuffer===!1&&(Zt.push(nt),Gt.push(nt),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Gt)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Zt))}if(e.bindFramebuffer(s.READ_FRAMEBUFFER,null),e.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),ut)for(let dt=0;dt<M.length;dt++){e.bindFramebuffer(s.FRAMEBUFFER,Lt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+dt,s.RENDERBUFFER,Lt.__webglColorRenderbuffer[dt]);const Yt=n.get(M[dt]).__webglTexture;e.bindFramebuffer(s.FRAMEBUFFER,Lt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+dt,s.TEXTURE_2D,Yt,0)}e.bindFramebuffer(s.DRAW_FRAMEBUFFER,Lt.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const M=C.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[M])}}}function It(C){return Math.min(i.maxSamples,C.samples)}function te(C){const M=n.get(C);return C.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function Xt(C){const M=o.render.frame;h.get(C)!==M&&(h.set(C,M),C.update())}function Wt(C,M){const W=C.colorSpace,et=C.format,it=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||W!==Pi&&W!==gi&&(ce.getTransfer(W)===xe?(et!==Fn||it!==Ti)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",W)),M}function me(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=H,this.resetTextureUnits=L,this.setTexture2D=B,this.setTexture2DArray=Q,this.setTexture3D=Z,this.setTextureCube=st,this.rebindTextures=Tt,this.setupRenderTarget=zt,this.updateRenderTargetMipmap=I,this.updateMultisampleRenderTarget=he,this.setupDepthRenderbuffer=ct,this.setupFrameBufferTexture=Y,this.useMultisampledRTT=te}function $g(s,t){function e(n,i=gi){let r;const o=ce.getTransfer(i);if(n===Ti)return s.UNSIGNED_BYTE;if(n===zh)return s.UNSIGNED_SHORT_4_4_4_4;if(n===kh)return s.UNSIGNED_SHORT_5_5_5_1;if(n===Ld)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Cd)return s.BYTE;if(n===Pd)return s.SHORT;if(n===Do)return s.UNSIGNED_SHORT;if(n===Bh)return s.INT;if(n===er)return s.UNSIGNED_INT;if(n===yi)return s.FLOAT;if(n===Zo)return s.HALF_FLOAT;if(n===Id)return s.ALPHA;if(n===Dd)return s.RGB;if(n===Fn)return s.RGBA;if(n===Nd)return s.LUMINANCE;if(n===Ud)return s.LUMINANCE_ALPHA;if(n===zs)return s.DEPTH_COMPONENT;if(n===ir)return s.DEPTH_STENCIL;if(n===Od)return s.RED;if(n===Hh)return s.RED_INTEGER;if(n===Fd)return s.RG;if(n===Gh)return s.RG_INTEGER;if(n===Vh)return s.RGBA_INTEGER;if(n===na||n===ia||n===sa||n===ra)if(o===xe)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===na)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ia)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===sa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ra)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===na)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ia)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===sa)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ra)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Hl||n===Gl||n===Vl||n===Wl)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Hl)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Gl)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Vl)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Wl)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Xl||n===Zl||n===Yl)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Xl||n===Zl)return o===xe?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Yl)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===ql||n===$l||n===Kl||n===Jl||n===jl||n===Ql||n===tc||n===ec||n===nc||n===ic||n===sc||n===rc||n===oc||n===ac)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===ql)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===$l)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Kl)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Jl)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===jl)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ql)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===tc)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ec)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===nc)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ic)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===sc)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===rc)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===oc)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ac)return o===xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===oa||n===lc||n===cc)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===oa)return o===xe?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===lc)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===cc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Bd||n===hc||n===uc||n===dc)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===oa)return r.COMPRESSED_RED_RGTC1_EXT;if(n===hc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===uc)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===dc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===nr?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:e}}class Kg extends cn{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class si extends ze{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Jg={type:"move"};class Da{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new si,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new si,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new P,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new P),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new si,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new P,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new P),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let i=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){o=!0;for(const _ of t.hand.values()){const m=e.getJointPose(_,n),p=this._getHandJoint(c,_);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],d=h.position.distanceTo(u.position),f=.02,g=.005;c.inputState.pinching&&d>f+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&d<=f-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(r=e.getPose(t.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(i=e.getPose(t.targetRaySpace,n),i===null&&r!==null&&(i=r),i!==null&&(a.matrix.fromArray(i.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,i.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(i.linearVelocity)):a.hasLinearVelocity=!1,i.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(i.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Jg)))}return a!==null&&(a.visible=i!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new si;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const jg=`
void main() {
...
void main() {
    ...
    `}}function Uv(s){return s.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const Ov="modulepreload",Fv=function(s,t){return new URL(s,t).href},Ah={},Bv=function(t,e,n){let i=Promise.resolve();if(e&&e.length>0){const o=document.getElementsByTagName("link"),a=document.querySelector("meta[property=csp-nonce]"),l=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));i=Promise.allSettled(e.map(c=>{if(c=Fv(c,n),c in Ah)return;Ah[c]=!0;const h=c.endsWith(".css"),u=h?'[rel="stylesheet"]':"";if(!!n)for(let g=o.length-1;g>=0;g--){const _=o[g];if(_.href===c&&(!h||_.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${c}"]${u}`))return;const f=document.createElement("link");if(f.rel=h?"stylesheet":Ov,h||(f.as="script"),f.crossOrigin="",f.href=c,l&&f.setAttribute("nonce",l),document.head.appendChild(f),h)return new Promise((g,_)=>{f.addEventListener("load",g),f.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return i.then(o=>{for(const a of o||[])a.status==="rejected"&&r(a.reason);return t().catch(r)})},rl="sw_id_v1",ol=s=>Array.from(s).map(t=>t.toString(16).padStart(2,"0")).join(""),Rh=s=>{const t=s.replace(/-/g,"+").replace(/_/g,"/"),e=atob(t);return Uint8Array.from(e,n=>n.charCodeAt(0))};class Ch{constructor(t,e,n,i){this.peerId=t,this.displayName=e,this.isNew=i,this._priv=n}get shortId(){return this.peerId.slice(-8)}setName(t){this.displayName=t,Cu()}async sign(t){const e=new TextEncoder().encode(t),n=await crypto.subtle.sign({name:"Ed25519"},this._priv,e);return ol(new Uint8Array(n))}}let jn=null,Er=null;function Cu(){if(!(!jn||!Er))try{localStorage.setItem(rl,JSON.stringify({privJwk:Er,displayName:jn.displayName}))}catch{}}async function zv(){if(jn)return jn;const s=localStorage.getItem(rl);if(s)try{const{privJwk:n,displayName:i}=JSON.parse(s),r=await crypto.subtle.importKey("jwk",n,{name:"Ed25519"},!1,["sign"]),o=ol(Rh(n.x));return Er=n,jn=new Ch(o,i||"",r,!1),jn}catch{localStorage.removeItem(rl)}const t=await crypto.subtle.generateKey({name:"Ed25519"},!0,["sign","verify"]);Er=await crypto.subtle.exportKey("jwk",t.privateKey);const e=ol(Rh(Er.x));return jn=new Ch(e,"",t.privateKey,!0),Cu(),jn}function Il(){return jn}const al="xn_",Pu="xn_known_peers";async function Lu(s){const t=new TextEncoder().encode(s),e=await crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(e)).map(n=>n.toString(16).padStart(2,"0")).join("")}async function wr(s,t=""){return Lu(s.toLowerCase().trim()+":"+t.trim())}function kv(s){return btoa(s).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"")}function Hv(s){const t=s.length%4,e=t?s+"=".repeat(4-t):s;return atob(e.replace(/-/g,"+").replace(/_/g,"/"))}async function Iu({roomId:s,lockCode:t="",node:e}={}){if(!(s!=null&&s.trim()))throw new Error("roomId is required");const n=await wr(s,t),i=Uu(n),r={r:s.trim(),h:n};e&&(r.n=e),i.length&&(r.p=i.slice(0,8));const o=kv(JSON.stringify(r));return{link:`${window.location.origin+window.location.pathname}#${al}${o}`,roomHash:n}}async function Du(){const s=window.location.hash.slice(1);if(s.startsWith(al))try{const e=JSON.parse(Hv(s.slice(al.length))),n=e.r||"main",i=e.h||await wr(n);return{type:"link",roomId:n,roomHash:i,node:e.n||null,peers:e.p||[]}}catch{console.warn("[roomLink] failed to decode link — falling back to main")}if(s){const e=s.trim().toLowerCase(),n=await wr(e);return{type:"plain",roomId:e,roomHash:n,node:null,peers:[]}}return{type:"default",roomId:"main",roomHash:await wr("main"),node:null,peers:[]}}function Nu(){try{return JSON.parse(localStorage.getItem(Pu)||"{}")}catch{return{}}}function Gv(s){try{localStorage.setItem(Pu,JSON.stringify(s))}catch{}}function Uu(s){return Nu()[s]||[]}function Dl(s,t){const e=Nu(),n=e[s]||[];n.includes(t)||(n.unshift(t),n.length>20&&(n.length=20),e[s]=n,Gv(e))}function Ou(s){const t=s.trim().toLowerCase().replace(/[^a-z0-9-]/g,"-").replace(/-{2,}/g,"-").replace(/^-+|-+$/g,"")||"main";window.location.hash=t}const Vv=Object.freeze(Object.defineProperty({__proto__:null,createRoomLink:Iu,deriveRoomHash:wr,getKnownPeers:Uu,parseCurrentLink:Du,recordPeer:Dl,setRoomNameInUrl:Ou,sha256hex:Lu},Symbol.toStringTag,{value:"Module"}));var Xi;class Wv extends EventTarget{constructor(){super(...arguments);pt(this,Xi,[])}push(e,n="pending",i=""){const r=`s${Date.now()}-${Math.random().toString(36).slice(2,6)}`,o={id:r,text:e,status:n,detail:i,ts:Date.now()};return A(this,Xi).push(o),this.dispatchEvent(new CustomEvent("step",{detail:{...o,action:"add"}})),r}update(e,n,i=""){const r=A(this,Xi).find(o=>o.id===e);r&&(r.status=n,i&&(r.detail=i),this.dispatchEvent(new CustomEvent("step",{detail:{...r,action:"update"}})))}ok(e,n=""){this.update(e,"ok",n)}fail(e,n=""){this.update(e,"fail",n)}warn(e,n=""){this.update(e,"warn",n)}info(e,n=""){return this.push(e,"info",n)}get steps(){return[...A(this,Xi)]}clear(){Mt(this,Xi,[]),this.dispatchEvent(new CustomEvent("clear"))}}Xi=new WeakMap;const Ve=new Wv,Va={};function Fu(s){if(s)return s;const t=new URLSearchParams(window.location.search).get("node");if(t)return t;if(!(Va!=null&&Va.VITE_XPACENODE_URL))return null}function Xv(){const s=window.location.hash.slice(1).trim();return!s||s.startsWith("xn_")?"main":s}function Zv(s){Ou(s)}const Yv=[{urls:"stun:stun.l.google.com:19302"},{urls:"stun:stun1.l.google.com:19302"},{urls:"turn:openrelay.metered.ca:80",username:"openrelayproject",credential:"openrelayproject"},{urls:"turn:openrelay.metered.ca:80?transport=tcp",username:"openrelayproject",credential:"openrelayproject"}];var Zi,Cr,Yi,qi,Gs,Pr,Lr,rr,Bu,zu;class qv{constructor(){pt(this,rr);pt(this,Zi,null);pt(this,Cr,"");pt(this,Yi,new Map);pt(this,qi,!1);pt(this,Gs,!1);pt(this,Pr,[]);pt(this,Lr,0)}async connect(t){return Mt(this,Cr,t),new Promise((e,n)=>{const i=new WebSocket(t);Mt(this,Zi,i);const r=setTimeout(()=>n(new Error("xpacenode connect timeout")),1e4);i.onopen=()=>{clearTimeout(r),Mt(this,qi,!0),Mt(this,Lr,0),A(this,Pr).splice(0).forEach(a=>i.send(a)),e()},i.onmessage=({data:o})=>{try{const a=JSON.parse(o);Ct(this,rr,Bu).call(this,a)}catch{}},i.onerror=o=>{clearTimeout(r),n(o)},i.onclose=()=>{Mt(this,qi,!1),Ct(this,rr,zu).call(this)}})}send(t){var n;const e=JSON.stringify(t);A(this,qi)&&((n=A(this,Zi))==null?void 0:n.readyState)===WebSocket.OPEN?A(this,Zi).send(e):A(this,Pr).push(e)}on(t,e){A(this,Yi).has(t)||A(this,Yi).set(t,[]),A(this,Yi).get(t).push(e)}close(){var t;Mt(this,Gs,!0),Mt(this,qi,!1),(t=A(this,Zi))==null||t.close()}}Zi=new WeakMap,Cr=new WeakMap,Yi=new WeakMap,qi=new WeakMap,Gs=new WeakMap,Pr=new WeakMap,Lr=new WeakMap,rr=new WeakSet,Bu=function(t){const e=A(this,Yi).get(t.t);e==null||e.forEach(n=>n(t))},zu=function(){if(A(this,Gs))return;const t=Math.min(1e3*2**Ol(this,Lr)._++,3e4);console.warn(`[xpacenode] disconnected — reconnecting in ${t}ms`),setTimeout(()=>{A(this,Gs)||this.connect(A(this,Cr)).catch(()=>{})},t)};var ve,ti,Vs,$i,Ws,Ir,Dr,Nr,Xs,Ur,Ci,ll,cl;class $v extends EventTarget{constructor(e){super();pt(this,Ci);pt(this,ve);pt(this,ti,null);pt(this,Vs,!1);pt(this,$i,!1);pt(this,Ws,!1);pt(this,Ir,null);pt(this,Dr,null);pt(this,Nr,[]);pt(this,Xs,!1);pt(this,Ur,async()=>{if(!A(this,$i)&&A(this,ve).signalingState==="stable")try{Mt(this,$i,!0),await A(this,ve).setLocalDescription(),this.dispatchEvent(new CustomEvent("signal",{detail:{type:"offer",sdp:A(this,ve).localDescription.sdp}}))}catch(e){console.warn("[RTCPeer] negotiate error",e)}finally{Mt(this,$i,!1)}});Mt(this,Vs,e),Mt(this,ve,new RTCPeerConnection({iceServers:Yv})),e||(Mt(this,ti,A(this,ve).createDataChannel("sw",{ordered:!0})),Ct(this,Ci,ll).call(this,A(this,ti))),A(this,ve).ondatachannel=({channel:n})=>{Mt(this,ti,n),Ct(this,Ci,ll).call(this,n)},A(this,ve).onicecandidate=({candidate:n})=>{n&&this.dispatchEvent(new CustomEvent("signal",{detail:{type:"ice",candidate:n.toJSON()}}))},A(this,ve).onnegotiationneeded=A(this,Ur),A(this,ve).ontrack=({track:n,streams:i})=>{var o;const r=i[0]??new MediaStream([n]);(o=A(this,Dr))==null||o.call(this,n,r)},A(this,ve).onconnectionstatechange=()=>{A(this,ve).connectionState==="failed"&&this.dispatchEvent(new CustomEvent("failed"))}}async handleSignal({type:e,sdp:n,candidate:i}){try{if(e==="offer"){const r=A(this,ve).signalingState==="have-local-offer",o=A(this,$i)||r;if(Mt(this,Ws,!A(this,Vs)&&o),A(this,Ws))return;await A(this,ve).setRemoteDescription({type:"offer",sdp:n}),Mt(this,Xs,!0),await A(this,ve).setLocalDescription(),this.dispatchEvent(new CustomEvent("signal",{detail:{type:"answer",sdp:A(this,ve).localDescription.sdp}})),await Ct(this,Ci,cl).call(this),A(this,Vs)&&r&&setTimeout(A(this,Ur),200)}else if(e==="answer")A(this,ve).signalingState==="have-local-offer"&&(await A(this,ve).setRemoteDescription({type:"answer",sdp:n}),Mt(this,Xs,!0),await Ct(this,Ci,cl).call(this));else if(e==="ice")if(!A(this,Xs))A(this,Nr).push(i);else try{await A(this,ve).addIceCandidate(i)}catch(r){A(this,Ws)||console.warn("[RTCPeer] addIceCandidate",r)}}catch(r){console.warn("[RTCPeer] handleSignal",e,r)}}send(e){var n;((n=A(this,ti))==null?void 0:n.readyState)==="open"&&A(this,ti).send(JSON.stringify(e))}addTrack(e,n){try{A(this,ve).addTrack(e,n)}catch{}}onMessage(e){Mt(this,Ir,e)}onTrack(e){Mt(this,Dr,e)}get pc(){return A(this,ve)}get connected(){var e;return((e=A(this,ti))==null?void 0:e.readyState)==="open"}close(){try{A(this,ve).close()}catch{}}}ve=new WeakMap,ti=new WeakMap,Vs=new WeakMap,$i=new WeakMap,Ws=new WeakMap,Ir=new WeakMap,Dr=new WeakMap,Nr=new WeakMap,Xs=new WeakMap,Ur=new WeakMap,Ci=new WeakSet,ll=function(e){e.onopen=()=>this.dispatchEvent(new CustomEvent("open")),e.onclose=()=>this.dispatchEvent(new CustomEvent("close")),e.onmessage=({data:n})=>{var i;try{(i=A(this,Ir))==null||i.call(this,JSON.parse(n))}catch{}}},cl=async function(){const e=A(this,Nr).splice(0);for(const n of e)try{await A(this,ve).addIceCandidate(n)}catch{}};var Qe,Ie,ei,Ki,Ji,ji,pn,vi,Nn,Qi,Zs,Or,Fr,Br,se,hl,ul,ku,Sn,Ln;class Kv{constructor(t,e=0,n="available"){pt(this,se);pt(this,Qe,null);pt(this,Ie,new Map);pt(this,ei,{});pt(this,Ki,"");pt(this,Ji,0);pt(this,ji,"available");pt(this,pn,"");pt(this,vi,"main");pt(this,Nn,"");pt(this,Qi,[]);pt(this,Zs,null);pt(this,Or,[]);pt(this,Fr,[]);pt(this,Br,null);Mt(this,Ki,t),Mt(this,Ji,e),Mt(this,ji,n)}async start(){const t=Ve.push("Resolving room…"),e=await Du();if(Mt(this,pn,e.roomHash),Mt(this,vi,e.roomId),Mt(this,Qi,e.peers??[]),Ve.ok(t,`Room: ${A(this,vi)}`),A(this,Qi).length&&Ve.info(`Found ${A(this,Qi).length} known peer${A(this,Qi).length>1?"s":""} from previous session`),Mt(this,Nn,Fu(e.node)),!A(this,Nn))throw Object.assign(new Error("NO_NODE"),{roomHash:A(this,pn),roomName:A(this,vi)});Mt(this,Qe,new qv);const n=Ve.push("Connecting to xpacenode…","pending",A(this,Nn));console.log(`[RemoteSync] room:"${A(this,vi)}" hash:${A(this,pn).slice(0,12)}… node:${A(this,Nn)}`);try{await A(this,Qe).connect(A(this,Nn)),Ve.ok(n,A(this,Nn))}catch(i){throw Ve.fail(n,"Could not reach xpacenode"),i}Ve.info("Waiting for peers in room…"),A(this,Qe).on("peer_join",async i=>{const{peerId:r,username:o="",presetId:a=0,status:l="available"}=i;if(r!==Ct(this,se,Sn).call(this)&&(Ve.info(`Peer found: ${o||r.slice(0,10)}…`),Ct(this,se,Ln).call(this,"HELLO",{from:r,username:o,presetId:a,status:l}),!A(this,Ie).has(r))){const c=Ct(this,se,Sn).call(this)<r;await Ct(this,se,hl).call(this,r,c)}}),A(this,Qe).on("peer_leave",i=>{Ct(this,se,ul).call(this,i.peerId)}),A(this,Qe).on("signal",async i=>{var a;const{from:r,payload:o}=i;if(!(!r||!o)){if(!A(this,Ie).has(r)){const l=Ct(this,se,Sn).call(this)<r;await Ct(this,se,hl).call(this,r,l)}await((a=A(this,Ie).get(r))==null?void 0:a.peer.handleSignal(o))}}),A(this,Qe).send({t:"hello",roomId:A(this,pn),peerId:Ct(this,se,Sn).call(this),username:A(this,Ki),presetId:A(this,Ji),status:A(this,ji)}),Mt(this,Br,setInterval(()=>{A(this,Qe).send({t:"hb",roomId:A(this,pn)})},3e4))}stop(){var t,e;clearInterval(A(this,Br)),(t=A(this,Qe))==null||t.send({t:"leave",roomId:A(this,pn)}),(e=A(this,Qe))==null||e.close();for(const{peer:n}of A(this,Ie).values())n.close();A(this,Ie).clear(),Mt(this,Qe,null)}move(t,e,n,i=0){const r={type:"move",identityId:Ct(this,se,Sn).call(this),pos:{x:t,y:e,z:n,ry:i}};for(const{peer:o}of A(this,Ie).values())o.send(r)}chat(t){const e={type:"chat",identityId:Ct(this,se,Sn).call(this),username:A(this,Ki),text:t,ts:Date.now()};for(const{peer:n}of A(this,Ie).values())n.send(e)}setAvatar(t){Mt(this,Ji,t);const e={type:"avatar",identityId:Ct(this,se,Sn).call(this),presetId:t};for(const{peer:n}of A(this,Ie).values())n.send(e)}setStatus(t){Mt(this,ji,t);const e={type:"status",identityId:Ct(this,se,Sn).call(this),status:t};for(const{peer:n}of A(this,Ie).values())n.send(e)}broadcastTalking(t){const e={type:"talking",identityId:Ct(this,se,Sn).call(this),talking:!!t};for(const{peer:n}of A(this,Ie).values())n.send(e)}addVoiceTrack(t,e){A(this,Fr).push({track:t,stream:e});for(const{peer:n}of A(this,Ie).values())n.addTrack(t,e)}onVoiceTrack(t){Mt(this,Zs,t);const e=A(this,Or).splice(0);for(const{track:n,stream:i,identityId:r,nostrPubkey:o}of e)n.readyState!=="ended"&&t(n,i,r,o);for(const[n,{peer:i}]of A(this,Ie))for(const r of i.pc.getReceivers()){const o=r.track;!o||o.kind!=="audio"||o.readyState==="ended"||t(o,new MediaStream([o]),n,n)}}wireToIdentityId(t){return t}get roomName(){return A(this,vi)}get roomHash(){return A(this,pn)}get nodeUrl(){return A(this,Nn)}getPeers(){const t={};for(const[e,{peer:n}]of A(this,Ie))t[e]=n.pc;return t}on(t,e){return A(this,ei)[t]||(A(this,ei)[t]=[]),A(this,ei)[t].push(e),()=>{A(this,ei)[t]=A(this,ei)[t].filter(n=>n!==e)}}}Qe=new WeakMap,Ie=new WeakMap,ei=new WeakMap,Ki=new WeakMap,Ji=new WeakMap,ji=new WeakMap,pn=new WeakMap,vi=new WeakMap,Nn=new WeakMap,Qi=new WeakMap,Zs=new WeakMap,Or=new WeakMap,Fr=new WeakMap,Br=new WeakMap,se=new WeakSet,hl=async function(t,e){const n=new $v(e);A(this,Ie).set(t,{identityId:t,peer:n}),n.addEventListener("signal",({detail:i})=>{var r;(r=A(this,Qe))==null||r.send({t:"signal",roomId:A(this,pn),to:t,payload:i})}),n.onMessage(i=>Ct(this,se,ku).call(this,i,t)),n.onTrack((i,r)=>{A(this,Zs)?A(this,Zs).call(this,i,r,t,t):A(this,Or).push({track:i,stream:r,identityId:t,nostrPubkey:t})}),n.addEventListener("open",()=>{n.send({type:"intro",identityId:Ct(this,se,Sn).call(this),username:A(this,Ki),presetId:A(this,Ji),status:A(this,ji)}),Dl(A(this,pn),t)}),n.addEventListener("failed",()=>Ct(this,se,ul).call(this,t));for(const{track:i,stream:r}of A(this,Fr))n.addTrack(i,r);return n},ul=function(t){const e=A(this,Ie).get(t);e&&(e.peer.close(),A(this,Ie).delete(t),Ct(this,se,Ln).call(this,"PEER_LEAVE",{from:t}))},ku=function(t,e){const n=t.identityId??e;switch(t.type){case"intro":Ct(this,se,Ln).call(this,"HELLO",{from:n,username:t.username,presetId:t.presetId??0,status:t.status??"available"});break;case"move":Ct(this,se,Ln).call(this,"MOVE",{from:n,pos:t.pos});break;case"chat":Ct(this,se,Ln).call(this,"CHAT",{from:n,username:t.username,text:t.text,ts:t.ts});break;case"avatar":Ct(this,se,Ln).call(this,"AVATAR_CHANGE",{from:n,presetId:t.presetId});break;case"status":Ct(this,se,Ln).call(this,"STATUS_CHANGE",{from:n,status:t.status});break;case"talking":Ct(this,se,Ln).call(this,"PEER_TALKING",{from:n,talking:!!t.talking});break;case"bye":Ct(this,se,Ln).call(this,"PEER_LEAVE",{from:n});break}},Sn=function(){var t;return((t=Il())==null?void 0:t.peerId)??"unknown"},Ln=function(t,e){var n;(n=A(this,ei)[t])==null||n.forEach(i=>i(e))};async function Jv(s){const e=Fu().replace(/^ws(s?):\/\//,"http$1://").replace(/:4002$/,":3000");let n=!1;const i=9e4,r=new Map,o=async()=>{if(!n)try{const h=await(await fetch(`${e}/rooms`,{signal:AbortSignal.timeout(5e3)})).json(),u=Date.now();for(const d of h.rooms??[])r.set(d.roomId,{count:d.count,usernames:d.usernames??[],lastSeen:u});for(const[d,f]of r)u-f.lastSeen>i&&r.delete(d);a()}catch{}},a=()=>{const c=[...r.entries()].map(([h,u])=>({roomId:h,roomName:h,count:u.count})).sort((h,u)=>u.count-h.count);s(c)};await o();const l=setInterval(o,3e4);return()=>{n=!0,clearInterval(l)}}const jv=[{urls:"stun:stun.l.google.com:19302"},{urls:"stun:stun1.l.google.com:19302"},{urls:"turn:openrelay.metered.ca:80",username:"openrelayproject",credential:"openrelayproject"},{urls:"turn:openrelay.metered.ca:80?transport=tcp",username:"openrelayproject",credential:"openrelayproject"}];var He,ni,Ys,qs,$s,Ks,zr,fl,xi,Vo,Js,kr,Hr,Gr,Vr,Wr,Xr,Zr,Wo,en,dl,Jn;class Ph{constructor(t,e=0,n="available"){pt(this,en);pt(this,He,null);pt(this,ni,{});pt(this,Ys,"");pt(this,qs,0);pt(this,$s,"available");pt(this,Ks,"");pt(this,zr,"main");pt(this,fl,null);pt(this,xi,new Map);pt(this,Vo,[]);pt(this,Js,null);pt(this,kr,[]);pt(this,Hr,null);pt(this,Gr,null);pt(this,Vr,null);pt(this,Wr,null);pt(this,Xr,null);pt(this,Zr,null);pt(this,Wo,null);Mt(this,Ys,t),Mt(this,qs,e),Mt(this,$s,n)}async start(t,e){Mt(this,Ks,t),Mt(this,zr,e);const n=Ve.push("Starting BitTorrent DHT discovery…");Mt(this,He,Zu({appId:"xpacenet-v3",rtcConfig:{iceServers:jv}},t));const[i,r]=A(this,He).makeAction("intro"),[o,a]=A(this,He).makeAction("move"),[l,c]=A(this,He).makeAction("chat"),[h,u]=A(this,He).makeAction("avatar"),[d,f]=A(this,He).makeAction("status"),[g,_]=A(this,He).makeAction("talking"),[m,p]=A(this,He).makeAction("bye");Mt(this,Hr,o),Mt(this,Gr,l),Mt(this,Vr,h),Mt(this,Wr,d),Mt(this,Xr,g),Mt(this,Zr,m),Mt(this,Wo,i),A(this,He).onPeerJoin(x=>{x!==Ct(this,en,dl).call(this)&&(Ve.info(`Peer found via DHT: ${x.slice(0,10)}…`),i({identityId:Ct(this,en,dl).call(this),username:A(this,Ys),presetId:A(this,qs),status:A(this,$s)},[x]),A(this,xi).has(x)||(A(this,xi).set(x,{peerId:x,username:"",presetId:0,status:"available"}),Dl(A(this,Ks),x)))}),A(this,He).onPeerLeave(x=>{A(this,xi).delete(x),Ct(this,en,Jn).call(this,"PEER_LEAVE",{from:x})}),r(({identityId:x,username:v,presetId:E=0,status:N="available"},T)=>{const b=x??T;A(this,xi).set(b,{peerId:b,username:v,presetId:E,status:N}),Ve.info(`Connected to ${v||b.slice(0,10)}`),Ct(this,en,Jn).call(this,"HELLO",{from:b,username:v,presetId:E,status:N})}),a(({pos:x},v)=>Ct(this,en,Jn).call(this,"MOVE",{from:v,pos:x})),c((x,v)=>Ct(this,en,Jn).call(this,"CHAT",{from:v,username:x.username,text:x.text,ts:x.ts})),u(({presetId:x},v)=>Ct(this,en,Jn).call(this,"AVATAR_CHANGE",{from:v,presetId:x})),f(({status:x},v)=>Ct(this,en,Jn).call(this,"STATUS_CHANGE",{from:v,status:x})),_(({talking:x},v)=>Ct(this,en,Jn).call(this,"PEER_TALKING",{from:v,talking:!!x})),p((x,v)=>Ct(this,en,Jn).call(this,"PEER_LEAVE",{from:v})),A(this,He).onPeerStream((x,v)=>{const E=x.getAudioTracks()[0];E&&(A(this,Js)?A(this,Js).call(this,E,x,v,v):A(this,kr).push({track:E,stream:x,identityId:v,nostrPubkey:v}))}),Ve.ok(n,"DHT ready — searching for peers")}stop(){var t,e;(t=A(this,Zr))==null||t.call(this),(e=A(this,He))==null||e.leave(),Mt(this,He,null),A(this,xi).clear()}move(t,e,n,i=0){var r;(r=A(this,Hr))==null||r.call(this,{pos:{x:t,y:e,z:n,ry:i}})}chat(t){var e;(e=A(this,Gr))==null||e.call(this,{username:A(this,Ys),text:t,ts:Date.now()})}setAvatar(t){var e;Mt(this,qs,t),(e=A(this,Vr))==null||e.call(this,{presetId:t})}setStatus(t){var e;Mt(this,$s,t),(e=A(this,Wr))==null||e.call(this,{status:t})}broadcastTalking(t){var e;(e=A(this,Xr))==null||e.call(this,{talking:!!t})}addVoiceTrack(t,e){var n;A(this,Vo).push({track:t,stream:e}),(n=A(this,He))==null||n.addStream(e)}onVoiceTrack(t){Mt(this,Js,t);const e=A(this,kr).splice(0);for(const{track:n,stream:i,identityId:r,nostrPubkey:o}of e)n.readyState!=="ended"&&t(n,i,r,o)}wireToIdentityId(t){return t}getPeers(){return{}}on(t,e){return A(this,ni)[t]||(A(this,ni)[t]=[]),A(this,ni)[t].push(e),()=>{A(this,ni)[t]=A(this,ni)[t].filter(n=>n!==e)}}get roomName(){return A(this,zr)}get roomHash(){return A(this,Ks)}get nodeUrl(){return null}}He=new WeakMap,ni=new WeakMap,Ys=new WeakMap,qs=new WeakMap,$s=new WeakMap,Ks=new WeakMap,zr=new WeakMap,fl=new WeakMap,xi=new WeakMap,Vo=new WeakMap,Js=new WeakMap,kr=new WeakMap,Hr=new WeakMap,Gr=new WeakMap,Vr=new WeakMap,Wr=new WeakMap,Xr=new WeakMap,Zr=new WeakMap,Wo=new WeakMap,en=new WeakSet,dl=function(){var t;return((t=Il())==null?void 0:t.peerId)??"unknown"},Jn=function(t,e){var n;(n=A(this,ni)[t])==null||n.forEach(i=>i(e))};var Ge,mn,js,Yr,qr,$r,De,Hu,Gu,Vu,En;class Qv extends EventTarget{constructor(){super(...arguments);pt(this,De);pt(this,Ge,null);pt(this,mn,new Map);pt(this,js,!1);pt(this,Yr,"");pt(this,qr,0);pt(this,$r,"available")}get id(){var e;return((e=Il())==null?void 0:e.peerId)??""}get peers(){return[...A(this,mn).values()]}get peerCount(){return A(this,mn).size}get roomName(){var e;return((e=A(this,Ge))==null?void 0:e.roomName)??"main"}get nodeUrl(){var e;return((e=A(this,Ge))==null?void 0:e.nodeUrl)??null}async start(e,n=0,i="available"){if(A(this,js))return;Mt(this,js,!0),Mt(this,Yr,e),Mt(this,qr,n),Mt(this,$r,i);let r;try{r=new Kv(e,n,i),await r.start()}catch(o){if((o==null?void 0:o.message)==="NO_NODE")Ve.info("No xpacenode configured — using BitTorrent DHT (serverless)"),r=new Ph(e,n,i),await r.start(o.roomHash,o.roomName);else{Ve.info("xpacenode unreachable — falling back to BitTorrent DHT");const{parseCurrentLink:a}=await Bv(async()=>{const{parseCurrentLink:c}=await Promise.resolve().then(()=>Vv);return{parseCurrentLink:c}},void 0,import.meta.url),l=await a();r=new Ph(e,n,i),await r.start(l.roomHash,l.roomId)}}Mt(this,Ge,r),Ct(this,De,Hu).call(this)}stop(){var e;(e=A(this,Ge))==null||e.stop(),Mt(this,Ge,null),A(this,mn).clear(),Mt(this,js,!1)}move(e,n,i,r=0){var o;(o=A(this,Ge))==null||o.move(e,n,i,r)}setAvatar(e){var n;Mt(this,qr,e),(n=A(this,Ge))==null||n.setAvatar(e)}setStatus(e){var n;Mt(this,$r,e),(n=A(this,Ge))==null||n.setStatus(e)}sendChat(e){var i;if(!e.trim())return;const n=Date.now();Ct(this,De,En).call(this,"chat",{from:this.id,username:A(this,Yr),text:e,ts:n}),(i=A(this,Ge))==null||i.chat(e)}addVoiceTrack(e,n){var i;(i=A(this,Ge))==null||i.addVoiceTrack(e,n)}onVoiceTrack(e){var n;(n=A(this,Ge))==null||n.onVoiceTrack(e)}wireToIdentityId(e){var n;return(n=A(this,Ge))==null?void 0:n.wireToIdentityId(e)}broadcastTalking(e){var n;(n=A(this,Ge))==null||n.broadcastTalking(e)}}Ge=new WeakMap,mn=new WeakMap,js=new WeakMap,Yr=new WeakMap,qr=new WeakMap,$r=new WeakMap,De=new WeakSet,Hu=function(){const e=A(this,Ge);e.on("HELLO",({from:n,username:i,presetId:r=0,status:o="available"})=>{A(this,mn).has(n)||Ct(this,De,Gu).call(this,n,i,r,o)}),e.on("PEER_LEAVE",({from:n})=>Ct(this,De,Vu).call(this,n)),e.on("MOVE",({from:n,pos:i})=>{Ct(this,De,En).call(this,"peer:move",{peerId:n,pos:i})}),e.on("AVATAR_CHANGE",({from:n,presetId:i})=>{Ct(this,De,En).call(this,"peer:avatar",{peerId:n,presetId:i})}),e.on("STATUS_CHANGE",({from:n,status:i})=>{Ct(this,De,En).call(this,"peer:status",{peerId:n,status:i})}),e.on("PEER_TALKING",({from:n,talking:i})=>{Ct(this,De,En).call(this,"peer:talking",{peerId:n,talking:i})}),e.on("CHAT",({from:n,username:i,text:r,ts:o})=>{Ct(this,De,En).call(this,"chat",{from:n,username:i,text:r,ts:o})})},Gu=function(e,n,i,r){A(this,mn).set(e,{peerId:e,username:n,presetId:i,status:r}),Ct(this,De,En).call(this,"peer:join",{peerId:e,username:n,presetId:i,status:r}),Ct(this,De,En).call(this,"status",{peerCount:A(this,mn).size})},Vu=function(e){A(this,mn).has(e)&&(A(this,mn).delete(e),Ct(this,De,En).call(this,"peer:leave",{peerId:e}),Ct(this,De,En).call(this,"status",{peerCount:A(this,mn).size}))},En=function(e,n){this.dispatchEvent(new CustomEvent(e,{detail:n}))};const Se=new Qv,qn=Object.freeze({OCEAN:"ocean",COAST:"coast",DESERT:"desert",PLAINS:"plains",FOREST:"forest",MOUNTAIN:"mountain",ARCTIC:"arctic",JUNGLE:"jungle",TUNDRA:"tundra"});function Po(s){let t=5381;for(let e=0;e<s.length;e++)t=Math.imul(t,33)^s.charCodeAt(e);return(t>>>0).toString(16).padStart(8,"0")}function Wu(s,t,e,n){const i=JSON.stringify({parentHash:s,authorId:t,changes:e,timestamp:n});let r=Po(i),o=Po(r+i.slice(0,32)),a=Po(o+i.slice(-32)),l=Po(a+t);return r+o+a+l}class Fs{constructor(t,e,n,i="",r=Date.now()){this.parentHash=t,this.authorId=e,this.changes=Object.freeze([...n]),this.message=i,this.timestamp=r,this.hash=Wu(t,e,n,r)}buildRevert(t,e=Date.now()){const n=this.changes.map(i=>({cellId:i.cellId,key:i.key,oldValue:i.newValue,newValue:i.oldValue}));return new Fs(this.hash,t,n,`revert: ${this.message||this.hash.slice(0,8)}`,e)}toJSON(){return{hash:this.hash,parentHash:this.parentHash,authorId:this.authorId,message:this.message,timestamp:this.timestamp,changes:this.changes}}}const tx="universe",ex="genesis: the universe begins";var Be,tn;class nx{constructor(){pt(this,Be,new Map);pt(this,tn,null);this._genesis()}_genesis(){const t=new Fs(null,tx,[],ex,0);A(this,Be).set(t.hash,t),Mt(this,tn,t.hash)}get head(){return A(this,tn)}get length(){return A(this,Be).size}getCommit(t){return A(this,Be).get(t)??null}headCommit(){return A(this,Be).get(A(this,tn))}log(t=1/0){const e=[];let n=A(this,tn);for(;n&&e.length<t;){const i=A(this,Be).get(n);if(!i)break;e.push(i),n=i.parentHash}return e}stateAt(t){const e=[];let n=t;for(;n;){const r=A(this,Be).get(n);if(!r)break;e.unshift(r),n=r.parentHash}const i=new Map;for(const r of e)for(const{cellId:o,key:a,newValue:l}of r.changes)i.set(`${o}:${a}`,l);return i}currentState(){return this.stateAt(A(this,tn))}diff(t,e){const n=this.stateAt(t),i=this.stateAt(e),r=[],o=new Set([...n.keys(),...i.keys()]);for(const a of o){const l=n.get(a)??null,c=i.get(a)??null;if(l!==c){const[h,u]=a.split(":");r.push({cellId:h,key:u,before:l,after:c})}}return r}commit(t,e,n=""){if(!Array.isArray(e)||e.length===0)throw new Error("commit requires at least one change");for(const r of e)if(!r.cellId||!r.key)throw new Error("each change must have cellId and key");const i=new Fs(A(this,tn),t,e,n);return A(this,Be).set(i.hash,i),Mt(this,tn,i.hash),i}revert(t,e){const n=A(this,Be).get(t);if(!n)throw new Error(`commit ${t} not found`);if(n.changes.length===0)throw new Error("cannot revert empty commit");n.buildRevert(e);const i=new Fs(A(this,tn),e,[...n.changes].map(r=>({cellId:r.cellId,key:r.key,oldValue:r.newValue,newValue:r.oldValue})),`revert: ${n.message||n.hash.slice(0,8)}`);return A(this,Be).set(i.hash,i),Mt(this,tn,i.hash),i}applyExternal(t){if(A(this,Be).has(t.hash))return A(this,Be).get(t.hash);if(t.parentHash&&!A(this,Be).has(t.parentHash))throw new Error(`missing parent ${t.parentHash} — cannot apply ${t.hash}`);const e=new Fs(t.parentHash,t.authorId,t.changes,t.message,t.timestamp);return A(this,Be).set(t.hash,e),t.parentHash===A(this,tn)&&Mt(this,tn,t.hash),e}verify(){for(const t of A(this,Be).values()){if(Wu(t.parentHash,t.authorId,t.changes,t.timestamp)!==t.hash)return{valid:!1,broken:t.hash};if(t.parentHash&&!A(this,Be).has(t.parentHash))return{valid:!1,broken:t.hash,reason:"missing-parent"}}return{valid:!0}}}Be=new WeakMap,tn=new WeakMap;const de=Object.freeze({SOLAR:"solar",WIND:"wind",HYDRO:"hydro",MINERAL:"mineral",RARE_EARTH:"rare_earth",BIOLOGICAL:"biological",FISHERY:"fishery",GEOTHERMAL:"geothermal"});qn.OCEAN+"",de.FISHERY+"",de.WIND+"",qn.COAST+"",de.FISHERY+"",de.WIND+"",de.SOLAR+"",qn.DESERT+"",de.SOLAR+"",de.RARE_EARTH+"",de.MINERAL+"",qn.PLAINS+"",de.WIND+"",de.MINERAL+"",de.BIOLOGICAL+"",de.SOLAR+"",qn.FOREST+"",de.BIOLOGICAL+"",de.HYDRO+"",de.WIND+"",qn.MOUNTAIN+"",de.MINERAL+"",de.RARE_EARTH+"",de.GEOTHERMAL+"",de.WIND+"",de.HYDRO+"",qn.ARCTIC+"",de.MINERAL+"",de.WIND+"",qn.JUNGLE+"",de.BIOLOGICAL+"",de.HYDRO+"",de.SOLAR+"",qn.TUNDRA+"",de.MINERAL+"",de.GEOTHERMAL+"",de.WIND+"";(()=>{var h;const s=document.getElementById("conn-log"),t=document.getElementById("conn-log-body"),e=document.getElementById("conn-log-title"),n=document.getElementById("conn-log-toggle"),i=document.getElementById("conn-log-dismiss");if(!s)return;const r={pending:"⏳",ok:"✅",fail:"❌",warn:"⚠️",info:"·"},o=new Map,a=()=>s.classList.remove("hidden"),l=()=>s.classList.add("hidden");Ve.addEventListener("step",({detail:u})=>{if(a(),u.action==="add"){const f=document.createElement("div");f.className=`cl-step ${u.status}`,f.innerHTML=`
        <span class="cl-icon">${r[u.status]??"·"}</span>
        <div>
          <div class="cl-text">${u.text}</div>
          ${u.detail?`<div class="cl-detail">${u.detail}</div>`:""}
        </div>`,t.appendChild(f),o.set(u.id,f),t.scrollTop=t.scrollHeight}else{const f=o.get(u.id);if(!f)return;if(f.className=`cl-step ${u.status}`,f.querySelector(".cl-icon").textContent=r[u.status]??"·",u.detail){let g=f.querySelector(".cl-detail");g||(g=document.createElement("div"),g.className="cl-detail",f.querySelector(".cl-text").after(g)),g.textContent=u.detail}}const d=Ve.steps.at(-1);d&&(e.textContent=`⬡ ${d.text}`)}),Ve.addEventListener("clear",()=>{t.innerHTML="",o.clear()});let c=!1;(h=document.getElementById("conn-log-header"))==null||h.addEventListener("click",()=>{c=!c,t.classList.toggle("collapsed",c),n.textContent=c?"▼":"▲"}),i==null||i.addEventListener("click",l),Se.addEventListener("peer:join",()=>{e.textContent="⬡ Connected",setTimeout(l,6e3)})})();(async()=>{const s=await zv(),t=new nx;window._worldHistory=t;let e=!1;function n({peerCount:x}={}){document.querySelectorAll(".ipfs-dot").forEach(v=>{v.className="ipfs-dot green"}),document.querySelectorAll("#ipfs-label").forEach(v=>{v.textContent=`P2P · ${s.shortId}`}),x!==void 0&&document.querySelectorAll("#ipfs-peers").forEach(v=>{x>0?(v.textContent=`${x} peer${x!==1?"s":""}`,v.style.color="rgba(120,255,160,0.7)"):e?(v.textContent="· searching…",v.style.color="rgba(255,200,80,0.7)"):v.textContent=""})}n({peerCount:0}),Se.addEventListener("status",x=>n(x.detail)),Se.addEventListener("commit",x=>{try{t.applyExternal(x.detail.commit)}catch{}});const i=document.getElementById("lobby"),r=document.getElementById("loading"),o=document.getElementById("load-fill"),a=document.getElementById("load-text"),l=document.getElementById("hud"),c=document.getElementById("click-to-start"),h=document.getElementById("enter-btn"),u=document.getElementById("username"),d=document.getElementById("room-name");!s.isNew&&s.displayName&&(u.value=s.displayName),d&&(d.value=Xv());const f=document.getElementById("id-fingerprint");f&&(f.textContent=s.isNew?"New identity generated":`Identity · ${s.shortId}`),function(){const v=document.getElementById("lobby-avatar-grid");if(!v)return;const E=parseInt(localStorage.getItem("spaceAvatarId")??"0",10),N=T=>"#"+T.toString(16).padStart(6,"0");es.forEach(T=>{const b=N(T.skin),O=N(T.hair),w=N(T.outfit),y=N(T.accent),L=document.createElement("div");L.className="lav-chip"+(T.id===E?" lav-active":""),L.dataset.id=String(T.id),L.title=T.label,L.innerHTML=`<svg viewBox="0 0 60 82" xmlns="http://www.w3.org/2000/svg">
      ...
      </svg>`,L.addEventListener("click",()=>{v.querySelectorAll(".lav-chip").forEach(H=>H.classList.remove("lav-active")),L.classList.add("lav-active"),localStorage.setItem("spaceAvatarId",String(T.id))}),v.appendChild(L)})}();let g=null;const _=document.getElementById("active-rooms"),m=document.getElementById("active-rooms-list");Jv(x=>{if(!(!_||!m)){if(x.length===0){_.style.display="none";return}_.style.display="block",m.innerHTML=x.slice(0,5).map(v=>{const E=v.roomName==="main"?"main (public)":v.roomName,N=`${v.count} ${v.count===1?"person":"people"}`;return`<button class="lobby-room-chip" data-room="${v.roomName}">
        <span class="room-chip-dot"></span>
        <span class="room-chip-name">${E}</span>
        <span class="room-chip-count">${N}</span>
      </button>`}).join(""),m.querySelectorAll(".lobby-room-chip").forEach(v=>{v.addEventListener("click",()=>{d&&(d.value=v.dataset.room)})})}}).then(x=>{g=x}),u==null||u.addEventListener("keydown",x=>{x.key==="Enter"&&p()}),d==null||d.addEventListener("keydown",x=>{x.key==="Enter"&&p()}),h==null||h.addEventListener("click",p);function p(){const x=u.value.trim();if(!x){u.focus(),u.style.borderColor="#f55";return}u.style.borderColor="",s.setName(x),d!=null&&d.value.trim()&&Zv(d.value.trim()),g==null||g(),g=null,window._spaceUsername=x,i.style.display="none",r.classList.add("visible");const{scene:v,camera:E,renderer:N,onShipLoaded:T}=X_((b,O)=>{o.style.width=b+"%",a.textContent=O});T(()=>{var Ce,ie,sn,rn,Cn,ns,hr;r.classList.remove("visible"),l.classList.add("visible"),c.classList.remove("hidden");const{meshes:b,screens:O}=Z_(v),{openScreen:w,isOpen:y}=Ev(),L=parseInt(localStorage.getItem("spaceAvatarId")??"0",10),H=new Nv(X=>B==null?void 0:B.navigate(X)),k=document.getElementById("presence-panel");k&&k.classList.add("pp-visible"),H.setSelf(x,L,"OUTSIDE","available");const B=vv(v,E,N,X=>{sx(X),H.updateSelfZone(X)},X=>{Se.setAvatar(X),H.setSelf(x,X,H._self.zone,Q)});let Q="available";const Z=document.getElementById("status-btn"),st=document.getElementById("status-menu");Z&&st&&(Cl.forEach(X=>{const mt="#"+X.color.toString(16).padStart(6,"0"),Et=document.createElement("div");Et.className="sm-opt"+(X.id===Q?" sm-active":""),Et.dataset.status=X.id,Et.innerHTML=`<span class="sm-dot" style="background:${mt};box-shadow:0 0 4px ${mt}40"></span>${X.label}`,Et.addEventListener("click",qt=>{qt.stopPropagation(),Q=X.id,Z.innerHTML=`<span class="sm-dot" style="background:${mt};box-shadow:0 0 4px ${mt}40;display:inline-block;vertical-align:middle;width:8px;height:8px;border-radius:50%;margin-right:5px"></span>${X.label.replace(/^\S+\s/,"")}`,B.setStatus(X.id),H.updateSelfStatus(X.id),Se.setStatus(X.id),st.querySelectorAll(".sm-opt").forEach(_e=>_e.classList.toggle("sm-active",_e.dataset.status===X.id)),st.classList.remove("sm-open")}),st.appendChild(Et)}),Z.addEventListener("click",X=>{X.stopPropagation(),st.classList.toggle("sm-open")}),document.addEventListener("click",()=>st.classList.remove("sm-open"))),document.querySelectorAll(".vtbtn").forEach(X=>{X.addEventListener("click",mt=>{mt.stopPropagation(),gt(),B.setView(X.dataset.view),X.dataset.view==="first"&&document.pointerLockElement!==N.domElement&&N.domElement.requestPointerLock()})});let J=!1;function gt(){J||(J=!0,c.classList.add("hidden"))}document.addEventListener("pointerlockchange",()=>{document.pointerLockElement===N.domElement&&gt()}),c.addEventListener("click",gt);const St=new Set(["KeyW","KeyA","KeyS","KeyD"]),Rt=new Set([...St,"ArrowUp","ArrowDown","ArrowLeft","ArrowRight"]);document.addEventListener("keydown",X=>{Rt.has(X.code)&&(gt(),St.has(X.code)&&B.getMode()==="first"&&document.pointerLockElement!==N.domElement&&N.domElement.requestPointerLock())});const q=new A_,lt=new vt,F=new mi(new P(0,1,0),0),Y=new P;N.domElement.addEventListener("click",X=>{if(y()||document.pointerLockElement===N.domElement||B.isDragMoved())return;gt(),lt.x=X.clientX/window.innerWidth*2-1,lt.y=-(X.clientY/window.innerHeight)*2+1,q.setFromCamera(lt,E);const mt=q.intersectObjects(b);if(mt.length>0){w(mt[0].object.userData.screen);return}q.ray.intersectPlane(F,Y)&&B.navigate({x:Math.max(-65,Math.min(65,Y.x)),z:Math.max(-65,Math.min(65,Y.z))})});const K=new Lv,$=document.getElementById("voice-btn"),ct=new Map,Tt=new Map;Se.addEventListener("peer:join",X=>{const{peerId:mt,username:Et,presetId:qt}=X.detail;if(Tt.set(mt,Et),ct.has(mt))return;const _e=qt??ix(mt),ke=vu(Et,_e);v.add(ke),ct.set(mt,ke),Lh(l,ct.size+1),H.addPeer(mt,Et,_e),B.peerJoin(mt,Et)}),Se.addEventListener("peer:move",X=>{const{peerId:mt,pos:Et}=X.detail,qt=ct.get(mt);if(H.movePeer(mt,Et.x,Et.z),qt){const _e=qt.position.clone();if(qt.position.lerp(new P(Et.x,Et.y??0,Et.z),.6),Et.ry!==void 0){let ke=Et.ry-qt.rotation.y;for(;ke>Math.PI;)ke-=Math.PI*2;for(;ke<-Math.PI;)ke+=Math.PI*2;qt.rotation.y+=ke*.25}_e.distanceTo(qt.position)>.008&&(qt.userData.isMoving=!0,clearTimeout(qt.userData._stopTimer),qt.userData._stopTimer=setTimeout(()=>{qt.userData.isMoving=!1},180))}B.peerMove(mt,Et.x,Et.z,Tt.get(mt)??mt.slice(-4))}),Se.addEventListener("peer:leave",X=>{const mt=ct.get(X.detail.peerId);mt&&(v.remove(mt),ct.delete(X.detail.peerId),Lh(l,ct.size+1)),K.removePeer(X.detail.peerId),H.removePeer(X.detail.peerId),B.peerLeave(X.detail.peerId),Tt.delete(X.detail.peerId)}),Se.addEventListener("peer:avatar",X=>{const{peerId:mt,presetId:Et}=X.detail,qt=ct.get(mt),_e=Tt.get(mt)??mt.slice(-4);qt&&Mu(qt,_e,Et),H.updatePeerPreset(mt,Et)}),Se.addEventListener("peer:status",X=>{const{peerId:mt,status:Et}=X.detail,qt=ct.get(mt);qt&&xu(qt,Et),H.updatePeerStatus(mt,Et)}),Se.addEventListener("peer:talking",X=>{const{peerId:mt,talking:Et}=X.detail,qt=ct.get(mt);qt&&(qt.userData._isTalking=Et)});let zt=performance.now();(function X(){requestAnimationFrame(X);const mt=performance.now(),Et=Math.min((mt-zt)/1e3,.1);zt=mt;const qt=mt/1e3;ct.forEach((_e,ke)=>{Eu(_e,_e.userData.isMoving??!1,Et),yu(_e,_e.userData._isTalking??!1,qt)}),B.setSelfTalking(K.isTalking("self"),qt)})(),Se.start(x,L,Q),e=!0,n({peerCount:0}),window._sync=Se,window._voice=K;const I=({active:X,muted:mt}={})=>{$&&(X?mt?($.textContent="🔇 Muted",$.className="hud-side-btn voice-muted"):($.textContent="🎙 Live",$.className="hud-side-btn voice-active"):($.textContent="🎙 Voice",$.className="hud-side-btn"))};if(K.onStateChange(I),I({active:!1,muted:!1}),K.onTalkChange(X=>{B.setTalkingPeers(X)}),K.onSelfTalkChange(X=>{Se.broadcastTalking(X)}),$){let X=!1;$.addEventListener("click",async mt=>{if(mt.stopPropagation(),K.active){K.toggleMute();return}if(X)return;X=!0,$.textContent="⏳ Connecting…";const Et=await K.start(Se);if(X=!1,!Et){$.textContent="🚫 No mic",$.className="hud-side-btn";return}I({active:K.active,muted:K.muted})})}setInterval(()=>{const X=B.getPosition(),mt=B.getRotation();Se.move(X.x,X.y,X.z,mt.y),K.update(X,ct)},50);const Zt=document.getElementById("chat-toggle"),Gt=document.getElementById("chat-panel"),he=document.getElementById("chat-close"),It=document.getElementById("chat-input"),te=document.getElementById("chat-send"),Xt=document.getElementById("chat-messages"),Wt=document.getElementById("chat-badge");let me=0;const C=document.getElementById("mb-chat-badge");function M(){var X;Gt.classList.add("open"),Zt.classList.add("open"),(X=document.getElementById("mb-chat-btn"))==null||X.classList.add("mb-active"),me=0,Wt.textContent="",Wt.classList.remove("visible"),C&&(C.textContent="",C.classList.remove("visible")),It.focus()}function W(){var X;Gt.classList.remove("open"),Zt.classList.remove("open"),(X=document.getElementById("mb-chat-btn"))==null||X.classList.remove("mb-active")}Zt.addEventListener("click",X=>{X.stopPropagation(),Gt.classList.contains("open")?W():M()}),he.addEventListener("click",X=>{X.stopPropagation(),W()}),(Ce=document.getElementById("mb-chat-btn"))==null||Ce.addEventListener("click",X=>{X.stopPropagation(),Gt.classList.contains("open")?W():M()});function et(){const X=It.value.trim();X&&(Se.sendChat(X),It.value="")}te.addEventListener("click",X=>{X.stopPropagation(),et()}),It.addEventListener("keydown",X=>{X.key==="Enter"&&et()}),Gt.addEventListener("click",X=>X.stopPropagation());function it({from:X,username:mt,text:Et,ts:qt}){const _e=X===Se.id,ke=new Date(qt).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),qe=document.createElement("div");if(qe.className="chat-msg",qe.innerHTML=`
          <div class="chat-msg-meta">
            <span class="chat-msg-name${_e?" self":""}">${mt}</span>
            <span class="chat-msg-time">${ke}</span>
          </div>
          <div class="chat-msg-body">${Et.replace(/</g,"&lt;")}</div>
        `,Xt.appendChild(qe),Xt.scrollTop=Xt.scrollHeight,!Gt.classList.contains("open")&&!_e){me++;const Pn=me>9?"9+":String(me);Wt.textContent=Pn,Wt.classList.add("visible"),C&&(C.textContent=Pn,C.classList.add("visible"))}}function nt(X){const mt=document.createElement("div");mt.className="chat-system",mt.textContent=X,Xt.appendChild(mt),Xt.scrollTop=Xt.scrollHeight}const Lt=new Map;Se.addEventListener("chat",X=>it(X.detail)),Se.addEventListener("peer:join",X=>{Lt.set(X.detail.peerId,X.detail.username),nt(`${X.detail.username} joined`)}),Se.addEventListener("peer:leave",X=>{const mt=Lt.get(X.detail.peerId)??"Someone";Lt.delete(X.detail.peerId),nt(`${mt} left`)});const ut=new Tv,dt=new Rv,Yt=new bv(x);ut.createReality(Yt),dt.setNode(x,Ls.PUBLIC),(ie=document.getElementById("nm-open-btn"))==null||ie.addEventListener("click",X=>{X.stopPropagation(),wh(ut,dt,x)});const rt=document.getElementById("invite-modal"),bt=document.getElementById("invite-lock-input"),Jt=document.getElementById("invite-link-box"),Ut=document.getElementById("invite-link-text"),_t=document.getElementById("invite-room-name"),Dt=document.getElementById("invite-generate-btn"),kt=document.getElementById("invite-copy-btn"),ge=document.getElementById("invite-close-btn");let D="";const xt=()=>{_t.textContent=`Room: ${Se.roomName}`,bt.value="",Jt.style.display="none",kt.style.display="none",Dt.style.display="",Dt.textContent="Generate link",rt.style.display="flex",setTimeout(()=>bt.focus(),50)};(sn=document.getElementById("invite-btn"))==null||sn.addEventListener("click",X=>{X.stopPropagation(),xt()}),ge==null||ge.addEventListener("click",()=>{rt.style.display="none"}),rt==null||rt.addEventListener("click",X=>{X.target===rt&&(rt.style.display="none")}),Dt==null||Dt.addEventListener("click",async()=>{Dt.textContent="Generating…",Dt.disabled=!0;try{const{link:X}=await Iu({roomId:Se.roomName,lockCode:bt.value.trim(),node:Se.nodeUrl??void 0});D=X,Ut.textContent=X,Jt.style.display="block",kt.style.display="",Dt.style.display="none",navigator.clipboard.writeText(X).catch(()=>{})}catch(X){console.error("[invite] link generation failed",X),Dt.textContent="Generate link"}finally{Dt.disabled=!1}}),kt==null||kt.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(D);const X=kt.textContent;kt.textContent="✅ Copied!",setTimeout(()=>{kt.textContent=X},2e3)}catch{prompt("Copy this link:",D)}}),Ut==null||Ut.addEventListener("click",()=>kt==null?void 0:kt.click()),bt==null||bt.addEventListener("keydown",X=>{X.key==="Enter"&&(Dt==null||Dt.click())}),(rn=document.getElementById("mb-avatar-btn"))==null||rn.addEventListener("click",()=>{var X;return(X=document.getElementById("avatar-btn"))==null?void 0:X.click()}),(Cn=document.getElementById("mb-nm-btn"))==null||Cn.addEventListener("click",X=>{X.stopPropagation(),wh(ut,dt,x)}),(ns=document.getElementById("mb-voice-btn"))==null||ns.addEventListener("click",X=>{X.stopPropagation(),$==null||$.click()}),(hr=document.getElementById("mb-status-btn"))==null||hr.addEventListener("click",X=>{X.stopPropagation(),Z==null||Z.click()}),K.onStateChange(({active:X,muted:mt}={})=>{const Et=document.getElementById("mb-voice-btn");Et&&(X?mt?(Et.innerHTML="🔇",Et.className="mb-btn mb-voice-active",Et.style.color="#ff6b6b"):(Et.innerHTML="🎙",Et.className="mb-btn mb-voice-active",Et.style.color=""):(Et.innerHTML="🎙",Et.className="mb-btn"))});const j=document.getElementById("screen-hint"),tt=document.getElementById("screen-hint-name");let at=null,Ot=null;document.addEventListener("keydown",X=>{if(X.code==="KeyE"&&at&&!y()&&w(at),X.code==="KeyF"&&Ot){const mt=Ot.def.id,Et=mt==="main-left"||mt==="main-right",qt=Kn(Et?"main-left":mt);Et&&Kn("main-right"),ne(Ot.def.label,qt)}});function ne(X,mt){let Et=document.getElementById("door-action-hint");Et||(Et=document.createElement("div"),Et.id="door-action-hint",Et.style.cssText=`
          ...
          `,document.body.appendChild(Et)),Et.textContent=`${X} ${mt?"opened":"closed"}`,Et.style.opacity="1",clearTimeout(Et._t),Et._t=setTimeout(()=>{Et.style.opacity="0"},1500)}const ae=new Set;setInterval(()=>{var ke;if(y())return;const X=B.getPosition();let mt=null,Et=4;O.forEach(qe=>{const Pn=X.x-qe.position.x,Li=X.z-qe.position.z,S=Math.sqrt(Pn*Pn+Li*Li);S<Et&&(Et=S,mt=qe)}),at=mt,j&&(j.style.display=mt?"flex":"none",mt&&tt&&(tt.textContent=mt.label)),jr.forEach(qe=>{const Pn=X.x-qe.hinge.x,Li=X.z-qe.hinge.z,S=Math.sqrt(Pn*Pn+Li*Li),U=qe.id;S<2.2&&!Rs(U)?(Kn(U),ae.add(U),U==="main-left"&&(Rs("main-right")||Kn("main-right"),ae.add("main-right")),U==="main-right"&&(Rs("main-left")||Kn("main-left"),ae.add("main-left"))):S>3.5&&ae.has(U)&&Rs(U)&&(Kn(U),ae.delete(U),U==="main-left"&&(Rs("main-right")&&Kn("main-right"),ae.delete("main-right")),U==="main-right"&&(Rs("main-left")&&Kn("main-left"),ae.delete("main-left")))});const qt=wu(X,2.8);Ot=qt;const _e=document.getElementById("door-proximity-hint");if(_e)if(qt&&!mt){const qe=(ke=qt.state)!=null&&ke.open?"Close":"Open";_e.style.display="flex",_e.querySelector("#door-hint-name").textContent=`${qe} ${qt.def.label}`}else _e.style.display="none"},150)})}})();function ix(s){let t=0;for(let e=0;e<s.length;e++)t=t*31+s.charCodeAt(e)|0;return Math.abs(t)%es.length}function Lh(s,t){var n;const e=(n=s==null?void 0:s.querySelector)==null?void 0:n.call(s,"#online-count");e&&(e.textContent=`● ${t} aboard`)}const Ih={OUTSIDE:{color:"#88cc66",desc:"Outside the building"},LOBBY:{color:"#ffffff",desc:"Reception & Entrance"},OPS:{color:"#ffaa44",desc:"Operations & Technical Support"},FUN:{color:"#44ffaa",desc:"Chill, Social & Games"},DESIGN:{color:"#ff6ba0",desc:"UI/UX, Design & 3D"},ENGINEERING:{color:"#44aaff",desc:"Development & Engineering"},"":{color:"#ffffff",desc:""}};function sx(s){const t=document.getElementById("zone-name"),e=document.getElementById("zone-desc"),n=Ih[s]||Ih[""];t&&(t.textContent=s,t.style.color=n.color),e&&(e.textContent=n.desc),document.querySelectorAll(".map-zone").forEach(i=>{i.classList.toggle("active",i.dataset.zone===s)})}
