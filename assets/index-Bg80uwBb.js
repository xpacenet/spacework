...
`)+`
`+p);const y=T+m+o,w=T+p+a,L=Ql(s,s.VERTEX_SHADER,y),R=Ql(s,s.FRAGMENT_SHADER,w);s.attachShader(v,L),s.attachShader(v,R),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function E(P){if(i.debug.checkShaderErrors){const Y=s.getProgramInfoLog(v).trim(),Z=s.getShaderInfoLog(L).trim(),ee=s.getShaderInfoLog(R).trim();let ie=!0,te=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(ie=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,L,R);else{const z=eh(s,L,"vertex"),V=eh(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
}`;function v_(i,e,t){let n=new vc;const s=new Ee,r=new Ee,o=new pt,a=new p_({depthPacking:ff}),c=new m_,l={},h=t.maxTextureSize,u={[pi]:qt,[qt]:pi,[on]:on},d=new gi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ee},radius:{value:4}},vertexShader:g_,fragmentShader:__}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new ln;g.setAttribute("position",new gn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new be(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Jh;let p=this.type;this.render=function(R,E,D){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;const M=i.getRenderTarget(),x=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),Y=i.state;Y.setBlending(li),Y.buffers.color.setClear(1,1,1,1),Y.buffers.depth.setTest(!0),Y.setScissorTest(!1);const Z=p!==kn&&this.type===kn,ee=p===kn&&this.type!==kn;for(let ie=0,te=R.length;ie<te;ie++){const z=R[ie],V=z.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",z,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);const he=V.getFrameExtents();if(s.multiply(he),r.copy(V.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/he.x),s.x=r.x*he.x,V.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/he.y),s.y=r.y*he.y,V.mapSize.y=r.y)),V.map===null||Z===!0||ee===!0){const k=this.type!==kn?{minFilter:an,magFilter:an}:{};V.map!==null&&V.map.dispose(),V.map=new Fi(s.x,s.y,k),V.map.texture.name=z.name+".shadowMap",V.camera.updateProjectionMatrix()}i.setRenderTarget(V.map),i.clear();const O=V.getViewportCount();for(let k=0;k<O;k++){const se=V.getViewport(k);o.set(r.x*se.x,r.y*se.y,r.x*se.z,r.y*se.w),Y.viewport(o),V.updateMatrices(z,k),n=V.getFrustum(),w(E,D,V.camera,z,this.type)}V.isPointLightShadow!==!0&&this.type===kn&&T(V,D),V.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(M,x,P)};function T(R,E){const D=e.update(v);d.defines.VSM_SAMPLES!==R.blurSamples&&(d.defines.VSM_SAMPLES=R.blurSamples,f.defines.VSM_SAMPLES=R.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Fi(s.x,s.y)),d.uniforms.shadow_pass.value=R.map.texture,d.uniforms.resolution.value=R.mapSize,d.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(E,null,D,d,v,null),f.uniforms.shadow_pass.value=R.mapPass.texture,f.uniforms.resolution.value=R.mapSize,f.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(E,null,D,f,v,null)}function y(R,E,D,M){let x=null;const P=D.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(P!==void 0)x=P;else if(x=D.isPointLight===!0?c:a,i.localClippingEnabled&&E.clipShadows===!0&&Array.isArray(E.clippingPlanes)&&E.clippingPlanes.length!==0||E.displacementMap&&E.displacementScale!==0||E.alphaMap&&E.alphaTest>0||E.map&&E.alphaTest>0){const Y=x.uuid,Z=E.uuid;let ee=l[Y];ee===void 0&&(ee={},l[Y]=ee);let ie=ee[Z];ie===void 0&&(ie=x.clone(),ee[Z]=ie,E.addEventListener("dispose",L)),x=ie}if(x.visible=E.visible,x.wireframe=E.wireframe,M===kn?x.side=E.shadowSide!==null?E.shadowSide:E.side:x.side=E.shadowSide!==null?E.shadowSide:u[E.side],x.alphaMap=E.alphaMap,x.alphaTest=E.alphaTest,x.map=E.map,x.clipShadows=E.clipShadows,x.clippingPlanes=E.clippingPlanes,x.clipIntersection=E.clipIntersection,x.displacementMap=E.displacementMap,x.displacementScale=E.displacementScale,x.displacementBias=E.displacementBias,x.wireframeLinewidth=E.wireframeLinewidth,x.linewidth=E.linewidth,D.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const Y=i.properties.get(x);Y.light=D}return x}function w(R,E,D,M,x){if(R.visible===!1)return;if(R.layers.test(E.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&x===kn)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,R.matrixWorld);const Z=e.update(R),ee=R.material;if(Array.isArray(ee)){const ie=Z.groups;for(let te=0,z=ie.length;te<z;te++){const V=ie[te],he=ee[V.materialIndex];if(he&&he.visible){const O=y(R,he,M,x);R.onBeforeShadow(i,R,E,D,Z,O,V),i.renderBufferDirect(D,null,Z,O,R,V),R.onAfterShadow(i,R,E,D,Z,O,V)}}}else if(ee.visible){const ie=y(R,ee,M,x);R.onBeforeShadow(i,R,E,D,Z,ie,null),i.renderBufferDirect(D,null,Z,ie,R,null),R.onAfterShadow(i,R,E,D,Z,ie,null)}}const Y=R.children;for(let Z=0,ee=Y.length;Z<ee;Z++)w(Y[Z],E,D,M,x)}function L(R){R.target.removeEventListener("dispose",L);for(const D in l){const M=l[D],x=R.target.uuid;x in M&&(M[x].dispose(),delete M[x])}}}function x_(i){function e(){let I=!1;const _e=new pt;let ne=null;const ce=new pt(0,0,0,0);return{setMask:function(pe){ne!==pe&&!I&&(i.colorMask(pe,pe,pe,pe),ne=pe)},setLocked:function(pe){I=pe},setClear:function(pe,Le,Je,mt,Ct){Ct===!0&&(pe*=mt,Le*=mt,Je*=mt),_e.set(pe,Le,Je,mt),ce.equals(_e)===!1&&(i.clearColor(pe,Le,Je,mt),ce.copy(_e))},reset:function(){I=!1,ne=null,ce.set(-1,0,0,0)}}}function t(){let I=!1,_e=null,ne=null,ce=null;return{setTest:function(pe){pe?me(i.DEPTH_TEST):xe(i.DEPTH_TEST)},setMask:function(pe){_e!==pe&&!I&&(i.depthMask(pe),_e=pe)},setFunc:function(pe){if(ne!==pe){switch(pe){case zd:i.depthFunc(i.NEVER);break;case kd:i.depthFunc(i.ALWAYS);break;case Hd:i.depthFunc(i.LESS);break;case Ro:i.depthFunc(i.LEQUAL);break;case Gd:i.depthFunc(i.EQUAL);break;case Vd:i.depthFunc(i.GEQUAL);break;case Wd:i.depthFunc(i.GREATER);break;case Xd:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ne=pe}},setLocked:function(pe){I=pe},setClear:function(pe){ce!==pe&&(i.clearDepth(pe),ce=pe)},reset:function(){I=!1,_e=null,ne=null,ce=null}}}function n(){let I=!1,_e=null,ne=null,ce=null,pe=null,Le=null,Je=null,mt=null,Ct=null;return{setTest:function(rt){I||(rt?me(i.STENCIL_TEST):xe(i.STENCIL_TEST))},setMask:function(rt){_e!==rt&&!I&&(i.stencilMask(rt),_e=rt)},setFunc:function(rt,xn,yn){(ne!==rt||ce!==xn||pe!==yn)&&(i.stencilFunc(rt,xn,yn),ne=rt,ce=xn,pe=yn)},setOp:function(rt,xn,yn){(Le!==rt||Je!==xn||mt!==yn)&&(i.stencilOp(rt,xn,yn),Le=rt,Je=xn,mt=yn)},setLocked:function(rt){I=rt},setClear:function(rt){Ct!==rt&&(i.clearStencil(rt),Ct=rt)},reset:function(){I=!1,_e=null,ne=null,ce=null,pe=null,Le=null,Je=null,mt=null,Ct=null}}}const s=new e,r=new t,o=new n,a=new WeakMap,c=new WeakMap;let l={},h={},u=new WeakMap,d=[],f=null,g=!1,v=null,m=null,p=null,T=null,y=null,w=null,L=null,R=new Ke(0,0,0),E=0,D=!1,M=null,x=null,P=null,Y=null,Z=null;const ee=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ie=!1,te=0;const z=i.getParameter(i.VERSION);z.indexOf("WebGL")!==-1?(te=parseFloat(/^WebGL (\d)/.exec(z)[1]),ie=te>=1):z.indexOf("OpenGL ES")!==-1&&(te=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),ie=te>=2);let V=null,he={};const O=i.getParameter(i.SCISSOR_BOX),k=i.getParameter(i.VIEWPORT),se=new pt().fromArray(O),ge=new pt().fromArray(k);function $(I,_e,ne,ce){const pe=new Uint8Array(4),Le=i.createTexture();i.bindTexture(I,Le),i.texParameteri(I,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(I,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Je=0;Je<ne;Je++)I===i.TEXTURE_3D||I===i.TEXTURE_2D_ARRAY?i.texImage3D(_e,0,i.RGBA,1,1,ce,0,i.RGBA,i.UNSIGNED_BYTE,pe):i.texImage2D(_e+Je,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,pe);return Le}const ae={};ae[i.TEXTURE_2D]=$(i.TEXTURE_2D,i.TEXTURE_2D,1),ae[i.TEXTURE_CUBE_MAP]=$(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ae[i.TEXTURE_2D_ARRAY]=$(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ae[i.TEXTURE_3D]=$(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),o.setClear(0),me(i.DEPTH_TEST),r.setFunc(Ro),Re(!1),qe(Vc),me(i.CULL_FACE),ke(li);function me(I){l[I]!==!0&&(i.enable(I),l[I]=!0)}function xe(I){l[I]!==!1&&(i.disable(I),l[I]=!1)}function Pe(I,_e){return h[I]!==_e?(i.bindFramebuffer(I,_e),h[I]=_e,I===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=_e),I===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=_e),!0):!1}function De(I,_e){let ne=d,ce=!1;if(I){ne=u.get(_e),ne===void 0&&(ne=[],u.set(_e,ne));const pe=I.textures;if(ne.length!==pe.length||ne[0]!==i.COLOR_ATTACHMENT0){for(let Le=0,Je=pe.length;Le<Je;Le++)ne[Le]=i.COLOR_ATTACHMENT0+Le;ne.length=pe.length,ce=!0}}else ne[0]!==i.BACK&&(ne[0]=i.BACK,ce=!0);ce&&i.drawBuffers(ne)}function Ve(I){return f!==I?(i.useProgram(I),f=I,!0):!1}const F={[Li]:i.FUNC_ADD,[Md]:i.FUNC_SUBTRACT,[Ed]:i.FUNC_REVERSE_SUBTRACT};F[wd]=i.MIN,F[bd]=i.MAX;const ze={[Td]:i.ZERO,[Ad]:i.ONE,[Rd]:i.SRC_COLOR,[Xa]:i.SRC_ALPHA,[Nd]:i.SRC_ALPHA_SATURATE,[Id]:i.DST_COLOR,[Pd]:i.DST_ALPHA,[Cd]:i.ONE_MINUS_SRC_COLOR,[Za]:i.ONE_MINUS_SRC_ALPHA,[Dd]:i.ONE_MINUS_DST_COLOR,[Ld]:i.ONE_MINUS_DST_ALPHA,[Ud]:i.CONSTANT_COLOR,[Od]:i.ONE_MINUS_CONSTANT_COLOR,[Fd]:i.CONSTANT_ALPHA,[Bd]:i.ONE_MINUS_CONSTANT_ALPHA};function ke(I,_e,ne,ce,pe,Le,Je,mt,Ct,rt){if(I===li){g===!0&&(xe(i.BLEND),g=!1);return}if(g===!1&&(me(i.BLEND),g=!0),I!==Sd){if(I!==v||rt!==D){if((m!==Li||y!==Li)&&(i.blendEquation(i.FUNC_ADD),m=Li,y=Li),rt)switch(I){case ws:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Wc:i.blendFunc(i.ONE,i.ONE);break;case Xc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Zc:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}else switch(I){case ws:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Wc:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Xc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Zc:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}p=null,T=null,w=null,L=null,R.set(0,0,0),E=0,v=I,D=rt}return}pe=pe||_e,Le=Le||ne,Je=Je||ce,(_e!==m||pe!==y)&&(i.blendEquationSeparate(F[_e],F[pe]),m=_e,y=pe),(ne!==p||ce!==T||Le!==w||Je!==L)&&(i.blendFuncSeparate(ze[ne],ze[ce],ze[Le],ze[Je]),p=ne,T=ce,w=Le,L=Je),(mt.equals(R)===!1||Ct!==E)&&(i.blendColor(mt.r,mt.g,mt.b,Ct),R.copy(mt),E=Ct),v=I,D=!1}function et(I,_e){I.side===on?xe(i.CULL_FACE):me(i.CULL_FACE);let ne=I.side===qt;_e&&(ne=!ne),Re(ne),I.blending===ws&&I.transparent===!1?ke(li):ke(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),r.setFunc(I.depthFunc),r.setTest(I.depthTest),r.setMask(I.depthWrite),s.setMask(I.colorWrite);const ce=I.stencilWrite;o.setTest(ce),ce&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),Oe(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?me(i.SAMPLE_ALPHA_TO_COVERAGE):xe(i.SAMPLE_ALPHA_TO_COVERAGE)}function Re(I){M!==I&&(I?i.frontFace(i.CW):i.frontFace(i.CCW),M=I)}function qe(I){I!==xd?(me(i.CULL_FACE),I!==x&&(I===Vc?i.cullFace(i.BACK):I===yd?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):xe(i.CULL_FACE),x=I}function Ge(I){I!==P&&(ie&&i.lineWidth(I),P=I)}function Oe(I,_e,ne){I?(me(i.POLYGON_OFFSET_FILL),(Y!==_e||Z!==ne)&&(i.polygonOffset(_e,ne),Y=_e,Z=ne)):xe(i.POLYGON_OFFSET_FILL)}function B(I){I?me(i.SCISSOR_TEST):xe(i.SCISSOR_TEST)}function S(I){I===void 0&&(I=i.TEXTURE0+ee-1),V!==I&&(i.activeTexture(I),V=I)}function _(I,_e,ne){ne===void 0&&(V===null?ne=i.TEXTURE0+ee-1:ne=V);let ce=he[ne];ce===void 0&&(ce={type:void 0,texture:void 0},he[ne]=ce),(ce.type!==I||ce.texture!==_e)&&(V!==ne&&(i.activeTexture(ne),V=ne),i.bindTexture(I,_e||ae[I]),ce.type=I,ce.texture=_e)}function A(){const I=he[V];I!==void 0&&I.type!==void 0&&(i.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function N(){try{i.compressedTexImage2D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function G(){try{i.compressedTexImage3D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function q(){try{i.texSubImage2D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Q(){try{i.texSubImage3D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function re(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ue(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function K(){try{i.texStorage2D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function X(){try{i.texStorage3D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function le(){try{i.texImage2D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Me(){try{i.texImage3D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ye(I){se.equals(I)===!1&&(i.scissor(I.x,I.y,I.z,I.w),se.copy(I))}function de(I){ge.equals(I)===!1&&(i.viewport(I.x,I.y,I.z,I.w),ge.copy(I))}function Ae(I,_e){let ne=c.get(_e);ne===void 0&&(ne=new WeakMap,c.set(_e,ne));let ce=ne.get(I);ce===void 0&&(ce=i.getUniformBlockIndex(_e,I.name),ne.set(I,ce))}function Fe(I,_e){const ce=c.get(_e).get(I);a.get(_e)!==ce&&(i.uniformBlockBinding(_e,ce,I.__bindingPointIndex),a.set(_e,ce))}function We(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),l={},V=null,he={},h={},u=new WeakMap,d=[],f=null,g=!1,v=null,m=null,p=null,T=null,y=null,w=null,L=null,R=new Ke(0,0,0),E=0,D=!1,M=null,x=null,P=null,Y=null,Z=null,se.set(0,0,i.canvas.width,i.canvas.height),ge.set(0,0,i.canvas.width,i.canvas.height),s.reset(),r.reset(),o.reset()}return{buffers:{color:s,depth:r,stencil:o},enable:me,disable:xe,bindFramebuffer:Pe,drawBuffers:De,useProgram:Ve,setBlending:ke,setMaterial:et,setFlipSided:Re,setCullFace:qe,setLineWidth:Ge,setPolygonOffset:Oe,setScissorTest:B,activeTexture:S,bindTexture:_,unbindTexture:A,compressedTexImage2D:N,compressedTexImage3D:G,texImage2D:le,texImage3D:Me,updateUBOMapping:Ae,uniformBlockBinding:Fe,texStorage2D:K,texStorage3D:X,texSubImage2D:q,texSubImage3D:Q,compressedTexSubImage2D:re,compressedTexSubImage3D:ue,scissor:ye,viewport:de,reset:We}}function y_(i,e,t,n,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Ee,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(S,_){return f?new OffscreenCanvas(S,_):No("canvas")}function v(S,_,A){let N=1;const G=B(S);if((G.width>A||G.height>A)&&(N=A/Math.max(G.width,G.height)),N<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const q=Math.floor(N*G.width),Q=Math.floor(N*G.height);u===void 0&&(u=g(q,Q));const re=_?g(q,Q):u;return re.width=q,re.height=Q,re.getContext("2d").drawImage(S,0,0,q,Q),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+G.width+"x"+G.height+") to ("+q+"x"+Q+")."),re}else return"data"in S&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+G.width+"x"+G.height+")."),S;return S}function m(S){return S.generateMipmaps&&S.minFilter!==an&&S.minFilter!==pn}function p(S){i.generateMipmap(S)}function T(S,_,A,N,G=!1){if(S!==null){if(i[S]!==void 0)return i[S];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let q=_;if(_===i.RED&&(A===i.FLOAT&&(q=i.R32F),A===i.HALF_FLOAT&&(q=i.R16F),A===i.UNSIGNED_BYTE&&(q=i.R8)),_===i.RED_INTEGER&&(A===i.UNSIGNED_BYTE&&(q=i.R8UI),A===i.UNSIGNED_SHORT&&(q=i.R16UI),A===i.UNSIGNED_INT&&(q=i.R32UI),A===i.BYTE&&(q=i.R8I),A===i.SHORT&&(q=i.R16I),A===i.INT&&(q=i.R32I)),_===i.RG&&(A===i.FLOAT&&(q=i.RG32F),A===i.HALF_FLOAT&&(q=i.RG16F),A===i.UNSIGNED_BYTE&&(q=i.RG8)),_===i.RG_INTEGER&&(A===i.UNSIGNED_BYTE&&(q=i.RG8UI),A===i.UNSIGNED_SHORT&&(q=i.RG16UI),A===i.UNSIGNED_INT&&(q=i.RG32UI),A===i.BYTE&&(q=i.RG8I),A===i.SHORT&&(q=i.RG16I),A===i.INT&&(q=i.RG32I)),_===i.RGB&&A===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),_===i.RGBA){const Q=G?Po:st.getTransfer(N);A===i.FLOAT&&(q=i.RGBA32F),A===i.HALF_FLOAT&&(q=i.RGBA16F),A===i.UNSIGNED_BYTE&&(q=Q===ht?i.SRGB8_ALPHA8:i.RGBA8),A===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),A===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function y(S,_){let A;return S?_===null||_===zs||_===ks?A=i.DEPTH24_STENCIL8:_===ci?A=i.DEPTH32F_STENCIL8:_===Co&&(A=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===zs||_===ks?A=i.DEPTH_COMPONENT24:_===ci?A=i.DEPTH_COMPONENT32F:_===Co&&(A=i.DEPTH_COMPONENT16),A}function w(S,_){return m(S)===!0||S.isFramebufferTexture&&S.minFilter!==an&&S.minFilter!==pn?Math.log2(Math.max(_.width,_.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?_.mipmaps.length:1}function L(S){const _=S.target;_.removeEventListener("dispose",L),E(_),_.isVideoTexture&&h.delete(_)}function R(S){const _=S.target;_.removeEventListener("dispose",R),M(_)}function E(S){const _=n.get(S);if(_.__webglInit===void 0)return;const A=S.source,N=d.get(A);if(N){const G=N[_.__cacheKey];G.usedTimes--,G.usedTimes===0&&D(S),Object.keys(N).length===0&&d.delete(A)}n.remove(S)}function D(S){const _=n.get(S);i.deleteTexture(_.__webglTexture);const A=S.source,N=d.get(A);delete N[_.__cacheKey],o.memory.textures--}function M(S){const _=n.get(S);if(S.depthTexture&&S.depthTexture.dispose(),S.isWebGLCubeRenderTarget)for(let N=0;N<6;N++){if(Array.isArray(_.__webglFramebuffer[N]))for(let G=0;G<_.__webglFramebuffer[N].length;G++)i.deleteFramebuffer(_.__webglFramebuffer[N][G]);else i.deleteFramebuffer(_.__webglFramebuffer[N]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[N])}else{if(Array.isArray(_.__webglFramebuffer))for(let N=0;N<_.__webglFramebuffer.length;N++)i.deleteFramebuffer(_.__webglFramebuffer[N]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let N=0;N<_.__webglColorRenderbuffer.length;N++)_.__webglColorRenderbuffer[N]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[N]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const A=S.textures;for(let N=0,G=A.length;N<G;N++){const q=n.get(A[N]);q.__webglTexture&&(i.deleteTexture(q.__webglTexture),o.memory.textures--),n.remove(A[N])}n.remove(S)}let x=0;function P(){x=0}function Y(){const S=x;return S>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+s.maxTextures),x+=1,S}function Z(S){const _=[];return _.push(S.wrapS),_.push(S.wrapT),_.push(S.wrapR||0),_.push(S.magFilter),_.push(S.minFilter),_.push(S.anisotropy),_.push(S.internalFormat),_.push(S.format),_.push(S.type),_.push(S.generateMipmaps),_.push(S.premultiplyAlpha),_.push(S.flipY),_.push(S.unpackAlignment),_.push(S.colorSpace),_.join()}function ee(S,_){const A=n.get(S);if(S.isVideoTexture&&Ge(S),S.isRenderTargetTexture===!1&&S.version>0&&A.__version!==S.version){const N=S.image;if(N===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(N.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ge(A,S,_);return}}t.bindTexture(i.TEXTURE_2D,A.__webglTexture,i.TEXTURE0+_)}function ie(S,_){const A=n.get(S);if(S.version>0&&A.__version!==S.version){ge(A,S,_);return}t.bindTexture(i.TEXTURE_2D_ARRAY,A.__webglTexture,i.TEXTURE0+_)}function te(S,_){const A=n.get(S);if(S.version>0&&A.__version!==S.version){ge(A,S,_);return}t.bindTexture(i.TEXTURE_3D,A.__webglTexture,i.TEXTURE0+_)}function z(S,_){const A=n.get(S);if(S.version>0&&A.__version!==S.version){$(A,S,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+_)}const V={[$a]:i.REPEAT,[Di]:i.CLAMP_TO_EDGE,[Ka]:i.MIRRORED_REPEAT},he={[an]:i.NEAREST,[ef]:i.NEAREST_MIPMAP_NEAREST,[Xr]:i.NEAREST_MIPMAP_LINEAR,[pn]:i.LINEAR,[jo]:i.LINEAR_MIPMAP_NEAREST,[Ni]:i.LINEAR_MIPMAP_LINEAR},O={[mf]:i.NEVER,[Sf]:i.ALWAYS,[gf]:i.LESS,[lu]:i.LEQUAL,[_f]:i.EQUAL,[yf]:i.GEQUAL,[vf]:i.GREATER,[xf]:i.NOTEQUAL};function k(S,_){if(_.type===ci&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===pn||_.magFilter===jo||_.magFilter===Xr||_.magFilter===Ni||_.minFilter===pn||_.minFilter===jo||_.minFilter===Xr||_.minFilter===Ni)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(S,i.TEXTURE_WRAP_S,V[_.wrapS]),i.texParameteri(S,i.TEXTURE_WRAP_T,V[_.wrapT]),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,V[_.wrapR]),i.texParameteri(S,i.TEXTURE_MAG_FILTER,he[_.magFilter]),i.texParameteri(S,i.TEXTURE_MIN_FILTER,he[_.minFilter]),_.compareFunction&&(i.texParameteri(S,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(S,i.TEXTURE_COMPARE_FUNC,O[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===an||_.minFilter!==Xr&&_.minFilter!==Ni||_.type===ci&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const A=e.get("EXT_texture_filter_anisotropic");i.texParameterf(S,A.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function se(S,_){let A=!1;S.__webglInit===void 0&&(S.__webglInit=!0,_.addEventListener("dispose",L));const N=_.source;let G=d.get(N);G===void 0&&(G={},d.set(N,G));const q=Z(_);if(q!==S.__cacheKey){G[q]===void 0&&(G[q]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,A=!0),G[q].usedTimes++;const Q=G[S.__cacheKey];Q!==void 0&&(G[S.__cacheKey].usedTimes--,Q.usedTimes===0&&D(_)),S.__cacheKey=q,S.__webglTexture=G[q].texture}return A}function ge(S,_,A){let N=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(N=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(N=i.TEXTURE_3D);const G=se(S,_),q=_.source;t.bindTexture(N,S.__webglTexture,i.TEXTURE0+A);const Q=n.get(q);if(q.version!==Q.__version||G===!0){t.activeTexture(i.TEXTURE0+A);const re=st.getPrimaries(st.workingColorSpace),ue=_.colorSpace===oi?null:st.getPrimaries(_.colorSpace),K=_.colorSpace===oi||re===ue?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,K);let X=v(_.image,!1,s.maxTextureSize);X=Oe(_,X);const le=r.convert(_.format,_.colorSpace),Me=r.convert(_.type);let ye=T(_.internalFormat,le,Me,_.colorSpace,_.isVideoTexture);k(N,_);let de;const Ae=_.mipmaps,Fe=_.isVideoTexture!==!0,We=Q.__version===void 0||G===!0,I=q.dataReady,_e=w(_,X);if(_.isDepthTexture)ye=y(_.format===Hs,_.type),We&&(Fe?t.texStorage2D(i.TEXTURE_2D,1,ye,X.width,X.height):t.texImage2D(i.TEXTURE_2D,0,ye,X.width,X.height,0,le,Me,null));else if(_.isDataTexture)if(Ae.length>0){Fe&&We&&t.texStorage2D(i.TEXTURE_2D,_e,ye,Ae[0].width,Ae[0].height);for(let ne=0,ce=Ae.length;ne<ce;ne++)de=Ae[ne],Fe?I&&t.texSubImage2D(i.TEXTURE_2D,ne,0,0,de.width,de.height,le,Me,de.data):t.texImage2D(i.TEXTURE_2D,ne,ye,de.width,de.height,0,le,Me,de.data);_.generateMipmaps=!1}else Fe?(We&&t.texStorage2D(i.TEXTURE_2D,_e,ye,X.width,X.height),I&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,X.width,X.height,le,Me,X.data)):t.texImage2D(i.TEXTURE_2D,0,ye,X.width,X.height,0,le,Me,X.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Fe&&We&&t.texStorage3D(i.TEXTURE_2D_ARRAY,_e,ye,Ae[0].width,Ae[0].height,X.depth);for(let ne=0,ce=Ae.length;ne<ce;ne++)if(de=Ae[ne],_.format!==An)if(le!==null)if(Fe){if(I)if(_.layerUpdates.size>0){for(const pe of _.layerUpdates){const Le=de.width*de.height;t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ne,0,0,pe,de.width,de.height,1,le,de.data.slice(Le*pe,Le*(pe+1)),0,0)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ne,0,0,0,de.width,de.height,X.depth,le,de.data,0,0)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,ne,ye,de.width,de.height,X.depth,0,de.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Fe?I&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,ne,0,0,0,de.width,de.height,X.depth,le,Me,de.data):t.texImage3D(i.TEXTURE_2D_ARRAY,ne,ye,de.width,de.height,X.depth,0,le,Me,de.data)}else{Fe&&We&&t.texStorage2D(i.TEXTURE_2D,_e,ye,Ae[0].width,Ae[0].height);for(let ne=0,ce=Ae.length;ne<ce;ne++)de=Ae[ne],_.format!==An?le!==null?Fe?I&&t.compressedTexSubImage2D(i.TEXTURE_2D,ne,0,0,de.width,de.height,le,de.data):t.compressedTexImage2D(i.TEXTURE_2D,ne,ye,de.width,de.height,0,de.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Fe?I&&t.texSubImage2D(i.TEXTURE_2D,ne,0,0,de.width,de.height,le,Me,de.data):t.texImage2D(i.TEXTURE_2D,ne,ye,de.width,de.height,0,le,Me,de.data)}else if(_.isDataArrayTexture)if(Fe){if(We&&t.texStorage3D(i.TEXTURE_2D_ARRAY,_e,ye,X.width,X.height,X.depth),I)if(_.layerUpdates.size>0){let ne;switch(Me){case i.UNSIGNED_BYTE:switch(le){case i.ALPHA:ne=1;break;case i.LUMINANCE:ne=1;break;case i.LUMINANCE_ALPHA:ne=2;break;case i.RGB:ne=3;break;case i.RGBA:ne=4;break;default:throw new Error(`Unknown texel size for format ${le}.`)}break;case i.UNSIGNED_SHORT_4_4_4_4:case i.UNSIGNED_SHORT_5_5_5_1:case i.UNSIGNED_SHORT_5_6_5:ne=1;break;default:throw new Error(`Unknown texel size for type ${Me}.`)}const ce=X.width*X.height*ne;for(const pe of _.layerUpdates)t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,pe,X.width,X.height,1,le,Me,X.data.slice(ce*pe,ce*(pe+1)));_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,X.width,X.height,X.depth,le,Me,X.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ye,X.width,X.height,X.depth,0,le,Me,X.data);else if(_.isData3DTexture)Fe?(We&&t.texStorage3D(i.TEXTURE_3D,_e,ye,X.width,X.height,X.depth),I&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,X.width,X.height,X.depth,le,Me,X.data)):t.texImage3D(i.TEXTURE_3D,0,ye,X.width,X.height,X.depth,0,le,Me,X.data);else if(_.isFramebufferTexture){if(We)if(Fe)t.texStorage2D(i.TEXTURE_2D,_e,ye,X.width,X.height);else{let ne=X.width,ce=X.height;for(let pe=0;pe<_e;pe++)t.texImage2D(i.TEXTURE_2D,pe,ye,ne,ce,0,le,Me,null),ne>>=1,ce>>=1}}else if(Ae.length>0){if(Fe&&We){const ne=B(Ae[0]);t.texStorage2D(i.TEXTURE_2D,_e,ye,ne.width,ne.height)}for(let ne=0,ce=Ae.length;ne<ce;ne++)de=Ae[ne],Fe?I&&t.texSubImage2D(i.TEXTURE_2D,ne,0,0,le,Me,de):t.texImage2D(i.TEXTURE_2D,ne,ye,le,Me,de);_.generateMipmaps=!1}else if(Fe){if(We){const ne=B(X);t.texStorage2D(i.TEXTURE_2D,_e,ye,ne.width,ne.height)}I&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,le,Me,X)}else t.texImage2D(i.TEXTURE_2D,0,ye,le,Me,X);m(_)&&p(N),Q.__version=q.version,_.onUpdate&&_.onUpdate(_)}S.__version=_.version}function $(S,_,A){if(_.image.length!==6)return;const N=se(S,_),G=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,S.__webglTexture,i.TEXTURE0+A);const q=n.get(G);if(G.version!==q.__version||N===!0){t.activeTexture(i.TEXTURE0+A);const Q=st.getPrimaries(st.workingColorSpace),re=_.colorSpace===oi?null:st.getPrimaries(_.colorSpace),ue=_.colorSpace===oi||Q===re?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ue);const K=_.isCompressedTexture||_.image[0].isCompressedTexture,X=_.image[0]&&_.image[0].isDataTexture,le=[];for(let ce=0;ce<6;ce++)!K&&!X?le[ce]=v(_.image[ce],!0,s.maxCubemapSize):le[ce]=X?_.image[ce].image:_.image[ce],le[ce]=Oe(_,le[ce]);const Me=le[0],ye=r.convert(_.format,_.colorSpace),de=r.convert(_.type),Ae=T(_.internalFormat,ye,de,_.colorSpace),Fe=_.isVideoTexture!==!0,We=q.__version===void 0||N===!0,I=G.dataReady;let _e=w(_,Me);k(i.TEXTURE_CUBE_MAP,_);let ne;if(K){Fe&&We&&t.texStorage2D(i.TEXTURE_CUBE_MAP,_e,Ae,Me.width,Me.height);for(let ce=0;ce<6;ce++){ne=le[ce].mipmaps;for(let pe=0;pe<ne.length;pe++){const Le=ne[pe];_.format!==An?ye!==null?Fe?I&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,pe,0,0,Le.width,Le.height,ye,Le.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,pe,Ae,Le.width,Le.height,0,Le.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Fe?I&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,pe,0,0,Le.width,Le.height,ye,de,Le.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,pe,Ae,Le.width,Le.height,0,ye,de,Le.data)}}}else{if(ne=_.mipmaps,Fe&&We){ne.length>0&&_e++;const ce=B(le[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,_e,Ae,ce.width,ce.height)}for(let ce=0;ce<6;ce++)if(X){Fe?I&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,0,0,le[ce].width,le[ce].height,ye,de,le[ce].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,Ae,le[ce].width,le[ce].height,0,ye,de,le[ce].data);for(let pe=0;pe<ne.length;pe++){const Je=ne[pe].image[ce].image;Fe?I&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,pe+1,0,0,Je.width,Je.height,ye,de,Je.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,pe+1,Ae,Je.width,Je.height,0,ye,de,Je.data)}}else{Fe?I&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,0,0,ye,de,le[ce]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,Ae,ye,de,le[ce]);for(let pe=0;pe<ne.length;pe++){const Le=ne[pe];Fe?I&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,pe+1,0,0,ye,de,Le.image[ce]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,pe+1,Ae,ye,de,Le.image[ce])}}}m(_)&&p(i.TEXTURE_CUBE_MAP),q.__version=G.version,_.onUpdate&&_.onUpdate(_)}S.__version=_.version}function ae(S,_,A,N,G,q){const Q=r.convert(A.format,A.colorSpace),re=r.convert(A.type),ue=T(A.internalFormat,Q,re,A.colorSpace);if(!n.get(_).__hasExternalTextures){const X=Math.max(1,_.width>>q),le=Math.max(1,_.height>>q);G===i.TEXTURE_3D||G===i.TEXTURE_2D_ARRAY?t.texImage3D(G,q,ue,X,le,_.depth,0,Q,re,null):t.texImage2D(G,q,ue,X,le,0,Q,re,null)}t.bindFramebuffer(i.FRAMEBUFFER,S),qe(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,N,G,n.get(A).__webglTexture,0,Re(_)):(G===i.TEXTURE_2D||G>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&G<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,N,G,n.get(A).__webglTexture,q),t.bindFramebuffer(i.FRAMEBUFFER,null)}function me(S,_,A){if(i.bindRenderbuffer(i.RENDERBUFFER,S),_.depthBuffer){const N=_.depthTexture,G=N&&N.isDepthTexture?N.type:null,q=y(_.stencilBuffer,G),Q=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,re=Re(_);qe(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,re,q,_.width,_.height):A?i.renderbufferStorageMultisample(i.RENDERBUFFER,re,q,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,q,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,S)}else{const N=_.textures;for(let G=0;G<N.length;G++){const q=N[G],Q=r.convert(q.format,q.colorSpace),re=r.convert(q.type),ue=T(q.internalFormat,Q,re,q.colorSpace),K=Re(_);A&&qe(_)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,K,ue,_.width,_.height):qe(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,K,ue,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,ue,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function xe(S,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,S),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(_.depthTexture).__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),ee(_.depthTexture,0);const N=n.get(_.depthTexture).__webglTexture,G=Re(_);if(_.depthTexture.format===bs)qe(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,N,0,G):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,N,0);else if(_.depthTexture.format===Hs)qe(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,N,0,G):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,N,0);else throw new Error("Unknown depthTexture format")}function Pe(S){const _=n.get(S),A=S.isWebGLCubeRenderTarget===!0;if(S.depthTexture&&!_.__autoAllocateDepthBuffer){if(A)throw new Error("target.depthTexture not supported in Cube render targets");xe(_.__webglFramebuffer,S)}else if(A){_.__webglDepthbuffer=[];for(let N=0;N<6;N++)t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[N]),_.__webglDepthbuffer[N]=i.createRenderbuffer(),me(_.__webglDepthbuffer[N],S,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer=i.createRenderbuffer(),me(_.__webglDepthbuffer,S,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function De(S,_,A){const N=n.get(S);_!==void 0&&ae(N.__webglFramebuffer,S,S.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),A!==void 0&&Pe(S)}function Ve(S){const _=S.texture,A=n.get(S),N=n.get(_);S.addEventListener("dispose",R);const G=S.textures,q=S.isWebGLCubeRenderTarget===!0,Q=G.length>1;if(Q||(N.__webglTexture===void 0&&(N.__webglTexture=i.createTexture()),N.__version=_.version,o.memory.textures++),q){A.__webglFramebuffer=[];for(let re=0;re<6;re++)if(_.mipmaps&&_.mipmaps.length>0){A.__webglFramebuffer[re]=[];for(let ue=0;ue<_.mipmaps.length;ue++)A.__webglFramebuffer[re][ue]=i.createFramebuffer()}else A.__webglFramebuffer[re]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){A.__webglFramebuffer=[];for(let re=0;re<_.mipmaps.length;re++)A.__webglFramebuffer[re]=i.createFramebuffer()}else A.__webglFramebuffer=i.createFramebuffer();if(Q)for(let re=0,ue=G.length;re<ue;re++){const K=n.get(G[re]);K.__webglTexture===void 0&&(K.__webglTexture=i.createTexture(),o.memory.textures++)}if(S.samples>0&&qe(S)===!1){A.__webglMultisampledFramebuffer=i.createFramebuffer(),A.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,A.__webglMultisampledFramebuffer);for(let re=0;re<G.length;re++){const ue=G[re];A.__webglColorRenderbuffer[re]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,A.__webglColorRenderbuffer[re]);const K=r.convert(ue.format,ue.colorSpace),X=r.convert(ue.type),le=T(ue.internalFormat,K,X,ue.colorSpace,S.isXRRenderTarget===!0),Me=Re(S);i.renderbufferStorageMultisample(i.RENDERBUFFER,Me,le,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+re,i.RENDERBUFFER,A.__webglColorRenderbuffer[re])}i.bindRenderbuffer(i.RENDERBUFFER,null),S.depthBuffer&&(A.__webglDepthRenderbuffer=i.createRenderbuffer(),me(A.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(q){t.bindTexture(i.TEXTURE_CUBE_MAP,N.__webglTexture),k(i.TEXTURE_CUBE_MAP,_);for(let re=0;re<6;re++)if(_.mipmaps&&_.mipmaps.length>0)for(let ue=0;ue<_.mipmaps.length;ue++)ae(A.__webglFramebuffer[re][ue],S,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+re,ue);else ae(A.__webglFramebuffer[re],S,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+re,0);m(_)&&p(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Q){for(let re=0,ue=G.length;re<ue;re++){const K=G[re],X=n.get(K);t.bindTexture(i.TEXTURE_2D,X.__webglTexture),k(i.TEXTURE_2D,K),ae(A.__webglFramebuffer,S,K,i.COLOR_ATTACHMENT0+re,i.TEXTURE_2D,0),m(K)&&p(i.TEXTURE_2D)}t.unbindTexture()}else{let re=i.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(re=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(re,N.__webglTexture),k(re,_),_.mipmaps&&_.mipmaps.length>0)for(let ue=0;ue<_.mipmaps.length;ue++)ae(A.__webglFramebuffer[ue],S,_,i.COLOR_ATTACHMENT0,re,ue);else ae(A.__webglFramebuffer,S,_,i.COLOR_ATTACHMENT0,re,0);m(_)&&p(re),t.unbindTexture()}S.depthBuffer&&Pe(S)}function F(S){const _=S.textures;for(let A=0,N=_.length;A<N;A++){const G=_[A];if(m(G)){const q=S.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,Q=n.get(G).__webglTexture;t.bindTexture(q,Q),p(q),t.unbindTexture()}}}const ze=[],ke=[];function et(S){if(S.samples>0){if(qe(S)===!1){const _=S.textures,A=S.width,N=S.height;let G=i.COLOR_BUFFER_BIT;const q=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Q=n.get(S),re=_.length>1;if(re)for(let ue=0;ue<_.length;ue++)t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Q.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Q.__webglFramebuffer);for(let ue=0;ue<_.length;ue++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(G|=i.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(G|=i.STENCIL_BUFFER_BIT)),re){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Q.__webglColorRenderbuffer[ue]);const K=n.get(_[ue]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,K,0)}i.blitFramebuffer(0,0,A,N,0,0,A,N,G,i.NEAREST),c===!0&&(ze.length=0,ke.length=0,ze.push(i.COLOR_ATTACHMENT0+ue),S.depthBuffer&&S.resolveDepthBuffer===!1&&(ze.push(q),ke.push(q),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,ke)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ze))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),re)for(let ue=0;ue<_.length;ue++){t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.RENDERBUFFER,Q.__webglColorRenderbuffer[ue]);const K=n.get(_[ue]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.TEXTURE_2D,K,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Q.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&c){const _=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function Re(S){return Math.min(s.maxSamples,S.samples)}function qe(S){const _=n.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Ge(S){const _=o.render.frame;h.get(S)!==_&&(h.set(S,_),S.update())}function Oe(S,_){const A=S.colorSpace,N=S.format,G=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||A!==xi&&A!==oi&&(st.getTransfer(A)===ht?(N!==An||G!==mi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",A)),_}function B(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(l.width=S.naturalWidth||S.width,l.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(l.width=S.displayWidth,l.height=S.displayHeight):(l.width=S.width,l.height=S.height),l}this.allocateTextureUnit=Y,this.resetTextureUnits=P,this.setTexture2D=ee,this.setTexture2DArray=ie,this.setTexture3D=te,this.setTextureCube=z,this.rebindTextures=De,this.setupRenderTarget=Ve,this.updateRenderTargetMipmap=F,this.updateMultisampleRenderTarget=et,this.setupDepthRenderbuffer=Pe,this.setupFrameBufferTexture=ae,this.useMultisampledRTT=qe}function S_(i,e){function t(n,s=oi){let r;const o=st.getTransfer(s);if(n===mi)return i.UNSIGNED_BYTE;if(n===iu)return i.UNSIGNED_SHORT_4_4_4_4;if(n===su)return i.UNSIGNED_SHORT_5_5_5_1;if(n===sf)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===tf)return i.BYTE;if(n===nf)return i.SHORT;if(n===Co)return i.UNSIGNED_SHORT;if(n===nu)return i.INT;if(n===zs)return i.UNSIGNED_INT;if(n===ci)return i.FLOAT;if(n===Ho)return i.HALF_FLOAT;if(n===rf)return i.ALPHA;if(n===of)return i.RGB;if(n===An)return i.RGBA;if(n===af)return i.LUMINANCE;if(n===cf)return i.LUMINANCE_ALPHA;if(n===bs)return i.DEPTH_COMPONENT;if(n===Hs)return i.DEPTH_STENCIL;if(n===lf)return i.RED;if(n===ru)return i.RED_INTEGER;if(n===hf)return i.RG;if(n===ou)return i.RG_INTEGER;if(n===au)return i.RGBA_INTEGER;if(n===Qo||n===ea||n===ta||n===na)if(o===ht)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Qo)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ea)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ta)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===na)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Qo)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ea)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ta)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===na)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Yc||n===qc||n===$c||n===Kc)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Yc)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===qc)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===$c)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Kc)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Jc||n===jc||n===Qc)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Jc||n===jc)return o===ht?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Qc)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===el||n===tl||n===nl||n===il||n===sl||n===rl||n===ol||n===al||n===cl||n===ll||n===hl||n===ul||n===dl||n===fl)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===el)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===tl)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===nl)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===il)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===sl)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===rl)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ol)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===al)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===cl)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ll)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===hl)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ul)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===dl)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===fl)return o===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===ia||n===pl||n===ml)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===ia)return o===ht?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===pl)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ml)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===uf||n===gl||n===_l||n===vl)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===ia)return r.COMPRESSED_RED_RGTC1_EXT;if(n===gl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===_l)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===vl)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ks?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class M_ extends Qt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Zn extends Nt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const E_={type:"move"};class Pa{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Zn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Zn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new U,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new U),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Zn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new U,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new U),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,o=null;const a=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){o=!0;for(const v of e.hand.values()){const m=t.getJointPose(v,n),p=this._getHandJoint(l,v);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const h=l.joints["index-finger-tip"],u=l.joints["thumb-tip"],d=h.position.distanceTo(u.position),f=.02,g=.005;l.inputState.pinching&&d>f+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&d<=f-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(c.matrix.fromArray(r.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,r.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(r.linearVelocity)):c.hasLinearVelocity=!1,r.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(r.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(E_)))}return a!==null&&(a.visible=s!==null),c!==null&&(c.visible=r!==null),l!==null&&(l.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Zn;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const w_=`
void main() {
...
void main() {
    ...
    `}}function hx(i){return i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const{floor:oc,random:ux,sin:dx}=Math,zi="Trystero",mr=(i,e)=>Array(i).fill(void 0).map(e),fx="0123456789AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz",kr=i=>mr(i,()=>fx[oc(ux()*62)]??"").join(""),vn=kr(20),qs=Promise.all.bind(Promise),Zu=typeof window<"u",{entries:_i,fromEntries:Yu,keys:Gt,values:As}=Object,Ut=()=>{},qu="candidate",St=i=>(i!==null&&clearTimeout(i),null),ut=i=>new Error(`${zi}: ${i}`),Pc=(i,e)=>i instanceof Error&&i.message?i.message:typeof i=="string"&&i?i:ki(i??e),Ui=(i,e)=>i instanceof Error?i:ut(Pc(i,e)),px=new TextEncoder,mx=new TextDecoder,fi=i=>px.encode(i),Rs=i=>mx.decode(i),$u=i=>i.reduce((e,t)=>e+t.toString(16).padStart(2,"0"),""),gr=(...i)=>i.join("@"),gx=(i,e)=>{const t=[...i],n=()=>{const r=dx(e++)*1e4;return r-oc(r)};let s=t.length;for(;s;){const r=oc(n()*s--),o=t[s];t[s]=t[r],t[r]=o}return t},_x=(i,e,t,n=!1)=>{var s,r;return((s=i.relayConfig)==null?void 0:s.urls)||(n?gx(e,vx(i.appId)):e).slice(0,((r=i.relayConfig)==null?void 0:r.redundancy)??t)},ki=JSON.stringify,_r=i=>{try{return JSON.parse(i)}catch{throw ut(`failed to parse JSON: ${i}`)}},vx=(i,e=Number.MAX_SAFE_INTEGER)=>i.split("").reduce((t,n)=>t+n.charCodeAt(0),0)%e,Ch=3333,ms={};let dr=null,fr=null;const xx=()=>{dr||(dr=new Promise(i=>{fr=i}).finally(()=>{fr=null,dr=null}))},yx=()=>{fr==null||fr()},Sx=(i,e)=>{const t={},n=()=>{const s=new WebSocket(i);s.onclose=()=>{if(dr){dr.then(n);return}ms[i]??(ms[i]=Ch),setTimeout(n,ms[i]),ms[i]*=2},s.onmessage=r=>e(String(r.data)),t.socket=s,t.url=s.url,t.ready=new Promise(r=>s.onopen=()=>{r(t),ms[i]=Ch}),t.send=r=>{s.readyState===1&&s.send(r)}};return n(),t},Mx=i=>{const e={},t=new WeakMap,n=r=>{const o=t.get(r);if(!o)throw ut("relay bookkeeping missing registration for relay client");return o};return{register:(r,o)=>(e[r]=o,t.set(o,r),o),keyOf:n,scoped:()=>{const r={},o=a=>r[a]??(r[a]={});return{forKey:o,forRelay:a=>o(n(a))}},getSockets:()=>Yu(_i(e).flatMap(([r,o])=>{const a=i(o);return a?[[r,a]]:[]}))}},Ex=()=>{if(Zu){const i=new AbortController;return addEventListener("online",yx,{signal:i.signal}),addEventListener("offline",xx,{signal:i.signal}),()=>i.abort()}return Ut},Lc="AES-GCM",ka={},wx=i=>btoa(String.fromCharCode.apply(null,Array.from(new Uint8Array(i)))),bx=i=>{const e=atob(i);return new Uint8Array(e.length).map((t,n)=>e.charCodeAt(n)).buffer},Ic=async(i,e)=>new Uint8Array(await crypto.subtle.digest(i,fi(e))),Vs=async i=>ka[i]??(ka[i]=Array.from(await Ic("SHA-1",i)).map(e=>e.toString(36)).join("")),Tx=async(i,e,t)=>crypto.subtle.importKey("raw",await crypto.subtle.digest({name:"SHA-256"},fi(`${i}:${e}:${t}`)),{name:Lc},!1,["encrypt","decrypt"]),Ax=async(i,e)=>$u(await Ic("SHA-256",`${zi}:${i}:${e}`)),Ku="$",Ju=",",Rx=async(i,e)=>{const t=crypto.getRandomValues(new Uint8Array(16));return t.join(Ju)+Ku+wx(await crypto.subtle.encrypt({name:Lc,iv:t},await i,fi(e)))},Cx=async(i,e)=>{const[t,n]=e.split(Ku);return Rs(await crypto.subtle.decrypt({name:Lc,iv:new Uint8Array((t==null?void 0:t.split(Ju).map(Number))??[])},await i,bx(n??"")))},Dc=57333,Px=18e4,Lx=20;var Ix=class{constructor(i){In(this,"pool",[]);In(this,"pooled",new Set);In(this,"leased",new Map);In(this,"recycling",new Set);In(this,"cleanupTimer",null);In(this,"active",!1);this.makeOffer=i}get isActive(){return this.active}warmup(){this.pool=[],this.pooled.clear(),mr(Lx,this.makeOffer).forEach(i=>this.push(i)),this.active=!0,this.cleanupTimer=setInterval(()=>{this.pool=this.pool.filter(i=>i.isDead?(this.pooled.delete(i),!1):!0)},Dc)}push(i){i.isDead||this.pooled.has(i)||this.leased.has(i)||(this.pool.push(i),this.pooled.add(i))}shift(i){const e=[];for(;e.length<i&&this.pool.length>0;){const t=this.pool.shift();if(!t)break;this.pooled.delete(t),e.push(t)}return e}claimLeased(i){const e=this.leased.get(i);e&&(St(e),this.leased.delete(i))}recycle(i){if(!(i.isDead||this.recycling.has(i))){if(i.connection.remoteDescription){i.destroy();return}if(!this.active){i.destroy();return}this.recycling.add(i),i.setHandlers({connect:Ut,close:Ut,error:Ut}),i.getOffer(!0).then(e=>{if(!e||e.type!=="offer"||i.isDead||!this.active){i.destroy();return}this.push(i)}).catch(()=>i.destroy()).finally(()=>this.recycling.delete(i))}}reclaimLeased(i){const e=this.leased.get(i);e&&(St(e),this.leased.delete(i),this.recycle(i))}lease(i){this.claimLeased(i),this.leased.set(i,setTimeout(()=>{this.leased.delete(i),this.recycle(i)},Px))}checkout(i,e,t){const n=this.shift(i),s=Math.max(0,i-n.length);s>0&&n.push(...mr(s,this.makeOffer));const r=async(o,a=!1)=>{try{const c=await t(o);return e?(this.lease(o),{peer:o,offer:c,claim:()=>this.claimLeased(o),reclaim:()=>this.reclaimLeased(o)}):{peer:o,offer:c}}catch(c){if(this.claimLeased(o),this.pooled.delete(o),o.destroy(),!a)return r(this.makeOffer(),!0);throw c}};return qs(n.map(o=>r(o)))}getOffers(i,e){return this.checkout(i,!0,e)}destroy(){this.active=!1,this.cleanupTimer&&(clearInterval(this.cleanupTimer),this.cleanupTimer=null),this.pool.forEach(i=>i.destroy()),this.pool=[],this.pooled.clear(),this.leased.forEach((i,e)=>{St(i),e.destroy()}),this.leased.clear(),this.recycling.forEach(i=>i.destroy()),this.recycling.clear()}};const Ha=ut("incorrect password for overlapping room"),Dx=(i,e,t)=>{const n=o=>Ic("SHA-256",`${o}:${i}:${e}:${t}`).then($u),s=async(o,a,c)=>{if(!i)return;if(c){const h=kr(36);await o({__trystero_pw:"challenge",c:h});const{data:u}=await a();if(!u||typeof u!="object"||u.__trystero_pw!=="response"||typeof u.h!="string")throw Ha;const d=await n(h);if(u.h!==d)throw Ha;return}const{data:l}=await a();if(!l||typeof l!="object"||l.__trystero_pw!=="challenge"||typeof l.c!="string")throw Ha;await o({__trystero_pw:"response",h:await n(l.c)})};return{run:s,compose:o=>i||o?async(a,c,l,h)=>{await s(c,l,h),await(o==null?void 0:o(a,c,l,h))}:void 0}},Nx=15e3,Ux=5e3,Ph="icegatheringstatechange",sr="offer",Ox="answer",Fx=/out of range/i,Lh=i=>i.replace(/ (\S+\.local) (\d+) typ host/g," 127.0.0.1 $2 typ host");var Ih=(i,{trickleIce:e,rtcConfig:t,rtcPolyfill:n,turnConfig:s,_test_only_mdnsHostFallbackToLoopback:r})=>{const o=new(n??RTCPeerConnection)({iceServers:Bx.concat(s??[]),...t}),a={},c=[],l=[],h=e!==!1,u=[],d=[];let f=!1,g=!1,v=null,m=null,p=!1;const T=()=>m=St(m),y=()=>{var O;p||(p=!0,T(),(O=a.close)==null||O.call(a))},w=O=>{a.signal?a.signal(O):c.push(O)},L=O=>{const k=a.signal;a.signal=se=>{k==null||k(se),O(se)},c.length>0&&c.splice(0).forEach(se=>{var ge;return(ge=a.signal)==null?void 0:ge.call(a,se)})},R=O=>r?Lh(O):O,E=O=>{if(!r||typeof O.candidate!="string")return O;const k=Lh(O.candidate);return k===O.candidate?O:{...O,candidate:k}},D=O=>{var k,se;return{type:((k=O.localDescription)==null?void 0:k.type)??sr,sdp:R(((se=O.localDescription)==null?void 0:se.sdp)??"")}},M=()=>{var k,se;const O=(k=o.remoteDescription)==null?void 0:k.sdp;return O?((se=O.match(/a=ice-ufrag:([^\s]+)/))==null?void 0:se[1])??null:null},x=()=>{var O,k;return(((k=(O=o.remoteDescription)==null?void 0:O.sdp)==null?void 0:k.match(/^m=/gm))??[]).length},P=O=>{if(!o.remoteDescription)return!1;const k=x();if(typeof O.sdpMLineIndex=="number"&&k>0&&O.sdpMLineIndex>=k)return!1;const se=M();return!(se&&O.usernameFragment&&O.usernameFragment!==se)},Y=async O=>{try{return await o.addIceCandidate(O),!0}catch(k){if(k instanceof Error&&Fx.test(k.message)&&typeof O.sdpMLineIndex=="number")return!1;throw k}},Z=async()=>{if(!o.remoteDescription||u.length===0)return;const O=u.splice(0),k=[];for(const se of O){if(!P(se)){k.push(se);continue}await Y(se)||k.push(se)}k.length>0&&u.push(...k)},ee=async O=>{if(P(O)){await Y(O)||u.push(O);return}u.push(O)},ie=O=>{O.binaryType="arraybuffer",O.bufferedAmountLowThreshold=65535,O.onmessage=k=>{const se=k.data;a.data?a.data(se):l.push(se)},O.onopen=()=>{var k;return(k=a.connect)==null?void 0:k.call(a)},O.onclose=y,O.onerror=({error:k})=>{var se;return(se=a.error)==null?void 0:se.call(a,Ui(k,"data channel error"))}},te=async O=>{let k=null;try{await Promise.race([new Promise(se=>{const ge=()=>{O.iceGatheringState==="complete"&&(O.removeEventListener(Ph,ge),se())};O.addEventListener(Ph,ge),ge()}),new Promise(se=>{k=setTimeout(se,Nx)})])}finally{St(k)}return D(O)},z=async()=>{const O=h?D(o):await te(o);return w(O),O};i?(v=o.createDataChannel("data"),ie(v)):o.ondatachannel=({channel:O})=>{v=O,ie(O)};const V=async(O=!1)=>{var k,se;if(o.connectionState!=="closed")try{return f=!0,O&&(o.signalingState!=="stable"&&o.signalingState!=="closed"&&((k=o.localDescription)==null?void 0:k.type)===sr&&await o.setLocalDescription({type:"rollback"}),typeof o.restartIce=="function"&&o.restartIce()),await o.setLocalDescription(O?await o.createOffer({iceRestart:!0}):void 0),await z()}catch(ge){(se=a.error)==null||se.call(a,Ui(ge,"failed to create local offer"))}finally{f=!1}};o.onnegotiationneeded=async()=>V(!1),o.onicecandidate=({candidate:O})=>{if(!h||!O)return;const k=E(typeof O.toJSON=="function"?O.toJSON():{candidate:O.candidate,sdpMid:O.sdpMid,sdpMLineIndex:O.sdpMLineIndex,usernameFragment:O.usernameFragment});w({type:qu,sdp:JSON.stringify(k)})},o.onconnectionstatechange=()=>{if(o.connectionState==="connected"||o.connectionState==="connecting"){T();return}if(o.connectionState==="disconnected"){m||(m=setTimeout(()=>{m=null,o.connectionState==="disconnected"&&y()},Ux));return}(o.connectionState==="failed"||o.connectionState==="closed")&&y()},o.ontrack=O=>{var se,ge;const k=O.streams[0];if(k){if(!a.track&&!a.stream){d.push({track:O.track,stream:k});return}(se=a.track)==null||se.call(a,O.track,k),(ge=a.stream)==null||ge.call(a,k)}},o.onremovestream=O=>{var k;return(k=a.stream)==null?void 0:k.call(a,O.stream)};const he=i?new Promise(O=>L(k=>{k.type===sr&&O(k)})):Promise.resolve();return i&&queueMicrotask(()=>{var O;!f&&o.signalingState==="stable"&&!o.localDescription&&o.connectionState!=="closed"&&((O=o.onnegotiationneeded)==null||O.call(o,new Event("negotiationneeded")))}),{created:Date.now(),connection:o,get channel(){return v},get isDead(){return o.connectionState==="closed"},getOffer:async(O=!1)=>{var k;if(i)return O?V(!0):((k=o.localDescription)==null?void 0:k.type)===sr?h?D(o):te(o):he},async signal(O){var k,se,ge;if(O.type==="candidate"){try{const $=JSON.parse(O.sdp);$&&typeof $=="object"&&await ee(E($))}catch($){(k=a.error)==null||k.call(a,Ui($,"failed to parse remote candidate"))}return}if(!((v==null?void 0:v.readyState)==="open"&&!((se=O.sdp)!=null&&se.includes("a=rtpmap"))))try{const $={...O,sdp:R(O.sdp)};if(O.type===sr){if(f||o.signalingState!=="stable"&&!g){if(i)return;await qs([o.setLocalDescription({type:"rollback"}),o.setRemoteDescription($)])}else await o.setRemoteDescription($);return await Z(),await o.setLocalDescription(),await z()}if(O.type===Ox){g=!0;try{await o.setRemoteDescription($),await Z()}finally{g=!1}}}catch($){(ge=a.error)==null||ge.call(a,Ui($,"failed to apply remote signal"))}},sendData:O=>v==null?void 0:v.send(O),destroy:()=>{T(),v==null||v.close(),o.close(),f=!1,g=!1,y()},setHandlers:O=>{const{signal:k,...se}=O;Object.assign(a,se),a.data&&l.length>0&&l.splice(0).forEach(ge=>{var $;return($=a.data)==null?void 0:$.call(a,ge)}),k&&L(k),(a.track||a.stream)&&d.length>0&&d.splice(0).forEach(({track:ge,stream:$})=>{var ae,me;(ae=a.track)==null||ae.call(a,ge,$),(me=a.stream)==null||me.call(a,$)})},offerPromise:he,addStream:O=>O.getTracks().forEach(k=>o.addTrack(k,O)),removeStream:O=>o.getSenders().filter(k=>k.track&&O.getTracks().includes(k.track)).forEach(k=>o.removeTrack(k)),addTrack:(O,k)=>o.addTrack(O,k),removeTrack:O=>{const k=o.getSenders().find(se=>se.track===O);k&&o.removeTrack(k)},replaceTrack:(O,k)=>{const se=o.getSenders().find(ge=>ge.track===O);if(se)return se.replaceTrack(k)}}};const Bx=[...mr(3,(i,e)=>`stun:stun${e||""}.l.google.com:19302`),"stun:stun.cloudflare.com:3478"].map(i=>({urls:i})),zx=Object.getPrototypeOf(Uint8Array),wo=32,kx=2,ju=0,cr=ju+wo,ac=cr+kx,bo=ac+1,To=bo+1,Ri=16*2**10-To,rr=255,Hx=65535,Dh="bufferedamountlow",Nh="close",Uh="error",Oh="beforeunload",Gx=1e4,Vx=1e4,ii=i=>"@_"+i,lr=new Set,Fh=()=>lr.forEach(i=>i()),Wx=i=>(lr.add(i),lr.size===1&&addEventListener(Oh,Fh),()=>{lr.delete(i),lr.size||removeEventListener(Oh,Fh)}),Xx=i=>i instanceof ArrayBuffer?new Uint8Array(i):new Uint8Array(i.buffer,i.byteOffset,i.byteLength),Zx=i=>{const e=Pc(i,"unknown error");return e.startsWith("handshake ")?e:`handshake failed: ${e}`},Yx=(i,e=Vx)=>i.readyState!=="open"||i.bufferedAmount<=i.bufferedAmountLowThreshold?Promise.resolve(i.readyState==="open"):new Promise(t=>{let n=!1,s=null;const r=c=>{n||(n=!0,i.removeEventListener(Dh,o),i.removeEventListener(Nh,a),i.removeEventListener(Uh,a),St(s),t(c))},o=()=>r(!0),a=()=>r(!1);if(i.addEventListener(Dh,o),i.addEventListener(Nh,a),i.addEventListener(Uh,a),s=setTimeout(()=>r(!1),e),i.readyState!=="open"){r(!1);return}i.bufferedAmount<=i.bufferedAmountLowThreshold&&r(!0)});var qx=(i,e,t,{onPeerHandshake:n,onHandshakeError:s,handshakeTimeoutMs:r=Gx}={})=>{const o={},a={},c={},l={},h={},u={},d={},f={},g={},v={},m=new WeakMap,p=new WeakMap,T={onPeerJoin:Ut,onPeerLeave:Ut,onPeerStream:Ut,onPeerTrack:Ut};let y=Ut;const w=(B,S,{includePending:_=!1}={})=>(B?Array.isArray(B)?B:[B]:Gt(_?o:a)).flatMap(A=>{const N=_?o[A]:a[A];return N?[Promise.resolve(S(A,N))]:(console.warn(`${zi}: no peer with id ${A} found`),[])}),L=(B,S,_,A,N,G={})=>{const q={k:S,...G,..._===void 0?{}:{m:_}};return w(B,async(Q,re)=>{await A(q,Q),N(re)})},R=B=>S=>{let _=B.get(S);return _||(_=kr(20),B.set(S,_)),_},E=R(m),D=R(p),M=B=>o[B]??null,x=(B,S,_,A)=>{var N,G,q,Q;a[B]&&((G=(N=M(B))==null?void 0:N.__trysteroSetRemoteStreamByKey)==null||G.call(N,S,_),typeof _.id=="string"&&((Q=(q=M(B))==null?void 0:q.__trysteroSetRemoteStreamById)==null||Q.call(q,_.id,_)),T.onPeerStream(_,B,A))},P=(B,S,_,A,N)=>{var G,q,Q,re,ue,K;a[B]&&((q=(G=M(B))==null?void 0:G.__trysteroSetRemoteTrackByKey)==null||q.call(G,S,_,A),typeof A.id=="string"&&((re=(Q=M(B))==null?void 0:Q.__trysteroSetRemoteStreamById)==null||re.call(Q,A.id,A)),typeof _.id=="string"&&((K=(ue=M(B))==null?void 0:ue.__trysteroSetRemoteTrackById)==null||K.call(ue,_.id,_,A)),T.onPeerTrack(_,A,B,N))},Y=(B,S=ut("peer disconnected"))=>{var N;const _=c[B],A=Ui(S,"peer disconnected");_&&(St(_.handshakeTimer),_.pendingHandshakePayloads.length=0,_.handshakeWaiters.splice(0).forEach(G=>G.reject(A)),delete c[B]),delete o[B],delete a[B],delete u[B],(N=f[B])==null||N.splice(0).forEach(G=>G.reject(A)),delete f[B],delete g[B],delete v[B]},Z=(B,S,_)=>{const A=o[B];if(!A||S&&A!==S)return;const N=!!a[B];Y(B,_),A.destroy(),N&&T.onPeerLeave(B),e(B)},ee=(B,S={})=>{const _=h[B];if(l[B]&&_){const Q=l[B].options;if(Q.sendToPending!==!!S.sendToPending||Q.receiveWhilePending!==!!S.receiveWhilePending)throw ut(`action type "${B}" cannot be redefined`);return _}if(!B)throw ut("action type argument is required");const A=fi(B);if(A.byteLength>wo)throw ut(`action type string "${B}" (${A.byteLength}b) exceeds byte limit (${wo}). Hint: choose a shorter name.`);const N={sendToPending:!!S.sendToPending,receiveWhilePending:!!S.receiveWhilePending},G=new Uint8Array(wo);G.set(A);let q=0;return l[B]={onComplete:Ut,onProgress:Ut,setOnComplete:Q=>{l[B].onComplete=Q;const re=d[B];re!=null&&re.length&&(delete d[B],re.forEach(({payload:ue,peerId:K,metadata:X})=>Q(ue,K,X)))},setOnProgress:Q=>{l[B].onProgress=Q},send:async(Q,re,ue,K)=>{const X=typeof Q;if(X==="undefined")throw ut("action data cannot be undefined");const le=X!=="string",Me=Q instanceof Blob,ye=Me||Q instanceof ArrayBuffer||Q instanceof zx,de=ue!==void 0,Ae=ye?Xx(Me?await Q.arrayBuffer():Q):fi(le?ki(Q):Q),Fe=de?fi(ki(ue)):null,We=Math.ceil(Ae.byteLength/Ri)+(de?1:0)||1,I=mr(We,(_e,ne)=>{const ce=ne===We-1,pe=!!(de&&ne===0),Le=new Uint8Array(To+(pe?(Fe==null?void 0:Fe.byteLength)??0:ce?Ae.byteLength-Ri*(We-(de?2:1)):Ri));return Le.set(G),Le.set([q>>8,q&rr],cr),Le.set([Number(ce)|Number(pe)<<1|Number(ye)<<2|Number(le)<<3],ac),Le.set([Math.round((ne+1)/We*rr)],bo),Le.set(de?pe?Fe??new Uint8Array:Ae.subarray((ne-1)*Ri,ne*Ri):Ae.subarray(ne*Ri,(ne+1)*Ri),To),Le});return q=q+1&Hx,await qs(w(re,async(_e,ne)=>{const{channel:ce}=ne;let pe=0;for(;pe<We;){const Le=I[pe];if(!Le||ce&&ce.bufferedAmount>ce.bufferedAmountLowThreshold&&!await Yx(ce))break;const Je=N.sendToPending?o[_e]:a[_e];if(!Je||Je!==ne)break;ne.sendData(Le),pe++;const mt=Le[bo]??rr;K==null||K(mt/rr,_e,ue)}},{includePending:N.sendToPending})),[]},options:N},h[B]=[l[B].send,l[B].setOnComplete,l[B].setOnProgress]},ie=B=>ee(B),te=(B,S)=>{var Ae,Fe;const _=c[B];if(!_)return;const A=new Uint8Array(S),N=Rs(A.subarray(ju,cr)).replaceAll("\0",""),G=l[N];if(!_.isActive&&!(G!=null&&G.options.receiveWhilePending))return;const q=(A[cr]??0)<<8|(A[cr+1]??0),Q=A[ac]??0,re=A[bo]??0,ue=A.subarray(To),K=!!(Q&1),X=!!(Q&2),le=!!(Q&4),Me=!!(Q&8);u[B]??(u[B]={}),(Ae=u[B])[N]??(Ae[N]={});const ye=(Fe=u[B][N])[q]??(Fe[q]={chunks:[]});if(X?ye.meta=_r(Rs(ue)):ye.chunks.push(ue),G==null||G.onProgress(re/rr,B,ye.meta),!K)return;const de=new Uint8Array(ye.chunks.reduce((We,I)=>We+I.byteLength,0));if(ye.chunks.reduce((We,I)=>(de.set(I,We),We+I.byteLength),0),delete u[B][N][q],le)G?G.onComplete(de,B,ye.meta):(d[N]??(d[N]=[])).push({payload:de,peerId:B,...ye.meta===void 0?{}:{metadata:ye.meta}});else{const We=Rs(de),I=Me?_r(We):We;G?G.onComplete(I,B,ye.meta):(d[N]??(d[N]=[])).push({payload:I,peerId:B,...ye.meta===void 0?{}:{metadata:ye.meta}})}},z=async()=>{await Pe(""),await new Promise(B=>setTimeout(B,99)),_i(o).forEach(([B,S])=>{S.destroy(),Y(B,ut("room left"))}),y(),t()},[V,he]=ee(ii("ping")),[O,k]=ee(ii("pong")),[se,ge]=ee(ii("signal")),[$,ae]=ee(ii("stream")),[me,xe]=ee(ii("track")),[Pe,De]=ee(ii("leave"),{sendToPending:!0,receiveWhilePending:!0}),[Ve,F]=ee(ii("hsdata"),{sendToPending:!0,receiveWhilePending:!0}),[ze,ke]=ee(ii("hsready"),{sendToPending:!0,receiveWhilePending:!0}),et=(B,S)=>{const _=c[B];!_||S&&_.peer!==S||_.isActive||!_.didLocalHandshakePass||!_.didReceiveRemoteReady||(_.isActive=!0,a[B]=_.peer,_.handshakeTimer=St(_.handshakeTimer),T.onPeerJoin(B))},Re=(B,S,_)=>{const A=c[B];if(!A||A.peer!==S)return;const N=Zx(_);s==null||s(B,N),Z(B,S,ut(N))},qe=(B,S)=>{const _=c[B];!_||_.peer!==S||_.isActive||(_.didLocalHandshakePass=!0,ze("",B).catch(A=>Re(B,S,ut(`failed sending handshake readiness: ${Pc(A,"unknown send failure")}`))),et(B,S))},Ge=(B,S)=>{const _=c[B];if(!_||_.peer!==S)return;_.handshakeTimer=setTimeout(()=>Re(B,S,ut(`handshake timed out after ${r}ms`)),r);const A=async(q,Q)=>{await Ve(q,B,Q)},N=()=>new Promise((q,Q)=>{const re=c[B];if(!re||re.peer!==S){Q(ut("peer disconnected during handshake"));return}const ue=re.pendingHandshakePayloads.shift();if(ue){q(ue);return}re.handshakeWaiters.push({resolve:q,reject:K=>Q(K)})}),G=vn<B;Promise.resolve(n==null?void 0:n(B,A,N,G)).then(()=>qe(B,S)).catch(q=>Re(B,S,Ui(q,"handshake failed")))},Oe=B=>B&&typeof B=="object"&&!Array.isArray(B)&&typeof B.k=="string"?{key:B.k,...typeof B.s=="string"?{streamId:B.s}:{},...typeof B.t=="string"?{trackId:B.t}:{},...Object.hasOwn(B,"m")?{metadata:B.m}:{}}:null;return he((B,S)=>O("",S)),k((B,S)=>{var A;const _=f[S];(A=_==null?void 0:_.shift())==null||A.resolve(),_&&!_.length&&delete f[S]}),ge((B,S)=>{var _;a[S]&&((_=o[S])==null||_.signal(B))}),ae((B,S)=>{var G,q;if(!a[S])return;const _=Oe(B);if(!_)return;const A=M(S),N=((G=A==null?void 0:A.__trysteroGetRemoteStreamByKey)==null?void 0:G.call(A,_.key))??(_.streamId?(q=A==null?void 0:A.__trysteroGetRemoteStreamById)==null?void 0:q.call(A,_.streamId):void 0);if(N){x(S,_.key,N,_.metadata);return}(g[S]??(g[S]=[])).push(_)}),xe((B,S)=>{var G,q;if(!a[S])return;const _=Oe(B);if(!_)return;const A=M(S),N=((G=A==null?void 0:A.__trysteroGetRemoteTrackByKey)==null?void 0:G.call(A,_.key))??(_.trackId?(q=A==null?void 0:A.__trysteroGetRemoteTrackById)==null?void 0:q.call(A,_.trackId):void 0);if(N){P(S,_.key,N.track,N.stream,_.metadata);return}(v[S]??(v[S]=[])).push(_)}),De((B,S)=>Z(S,void 0,ut("peer left room"))),F((B,S,_)=>{const A=c[S];if(!A||A.isActive)return;const N=_===void 0?{data:B}:{data:B,metadata:_},G=A.handshakeWaiters.shift();if(G){G.resolve(N);return}A.pendingHandshakePayloads.push(N)}),ke((B,S)=>{const _=c[S];!_||_.isActive||(_.didReceiveRemoteReady=!0,et(S))}),i((B,S)=>{const _=o[S];if(_){if(_===B)return;_.destroy(),Y(S,ut("peer replaced"))}o[S]=B,c[S]={peer:B,isActive:!1,didLocalHandshakePass:!1,didReceiveRemoteReady:!1,handshakeTimer:null,pendingHandshakePayloads:[],handshakeWaiters:[]},B.setHandlers({data:A=>te(S,A),stream:A=>{var G;if(!a[S])return;const N=(G=g[S])==null?void 0:G.shift();N&&x(S,N.key,A,N.metadata)},track:(A,N)=>{var q;if(!a[S])return;const G=(q=v[S])==null?void 0:q.shift();G&&P(S,G.key,A,N,G.metadata)},signal:A=>{a[S]&&se(A,S)},close:()=>Z(S,B,ut("peer disconnected")),error:A=>{console.error(`${zi} peer error:`,A),Z(S,B,A)}}),Ge(S,B)}),Zu&&(y=Wx(()=>z().catch(Ut))),{makeAction:ie,leave:z,ping:async B=>{if(!a[B])throw ut(`no active peer with id ${B}`);const S=Date.now();return await new Promise((_,A)=>{const N=f[B]??(f[B]=[]),G=()=>{const Q=f[B];if(!Q)return;const re=Q.indexOf(q);re>-1&&Q.splice(re,1),Q.length||delete f[B]},q={resolve:()=>{G(),_()},reject:Q=>{G(),A(Q)}};N.push(q),V("",B).catch(Q=>q.reject(Ui(Q,"peer disconnected")))}),Date.now()-S},getPeers:()=>Yu(_i(a).map(([B,S])=>[B,S.connection])),addStream:(B,S,_)=>L(S,E(B),_,$,A=>A.addStream(B),{s:B.id}),removeStream:(B,S)=>{w(S,(_,A)=>A.removeStream(B))},addTrack:(B,S,_,A)=>L(_,D(B),A,me,N=>N.addTrack(B,S),{s:S.id,t:B.id}),removeTrack:(B,S)=>{w(S,(_,A)=>A.removeTrack(B))},replaceTrack:(B,S,_,A)=>L(_,D(S),A,me,N=>N.replaceTrack(B,S),{t:B.id}),onPeerJoin:B=>{T.onPeerJoin=B,Gt(a).forEach(S=>B(S))},onPeerLeave:B=>T.onPeerLeave=B,onPeerStream:B=>T.onPeerStream=B,onPeerTrack:B=>T.onPeerTrack=B}};const Qu=1,ed=2,Bh=(i,e)=>{const t=fi(i),n=new Uint8Array(3+t.byteLength+e.byteLength);return n[0]=Qu,n[1]=t.byteLength>>>8&255,n[2]=t.byteLength&255,n.set(t,3),n.set(e,3+t.byteLength),n},$x=(i,e)=>{const t=fi(i),n=new Uint8Array(4+t.byteLength);return n[0]=ed,n[1]=Number(e),n[2]=t.byteLength>>>8&255,n[3]=t.byteLength&255,n.set(t,4),n},Kx=i=>{const e=new Uint8Array(i);if(e.byteLength<3)return null;if(e[0]===Qu){const s=(e[1]??0)<<8|(e[2]??0),r=3+s;return s<=0||e.byteLength<r?null:{type:"room",roomToken:Rs(e.subarray(3,r)),payload:e.subarray(r).slice().buffer}}if(e[0]!==ed||e.byteLength<4)return null;const t=(e[2]??0)<<8|(e[3]??0),n=4+t;return t<=0||e.byteLength<n?null:{type:"presence",roomToken:Rs(e.subarray(4,n)),isPresent:e[1]===1}},td=i=>{const{connection:e,channel:t}=i;return i.isDead||e.connectionState==="closed"||e.connectionState==="failed"||e.iceConnectionState==="closed"||e.iceConnectionState==="failed"||(t==null?void 0:t.readyState)==="closing"||(t==null?void 0:t.readyState)==="closed"},Jx=i=>{if(td(i))return"stale";const{channel:e}=i;return!e||e.readyState!=="open"?"transient":"live"};var jx=class{constructor(){In(this,"byApp",{});In(this,"roomPresenceHandlers",{})}getMap(i){var e;return(e=this.byApp)[i]??(e[i]={})}get(i,e){var t;return(t=this.byApp[i])==null?void 0:t[e]}isPeerStale(i){return td(i)}getHealth(i){return this.isPeerStale(i)?"stale":"live"}setRoomPresenceHandler(i,e){return this.roomPresenceHandlers[i]=e,()=>{this.roomPresenceHandlers[i]===e&&delete this.roomPresenceHandlers[i]}}sendRoomPresence(i,e,t){i.isClosing||i.peer.isDead||i.peer.sendData($x(e,t))}clear(i,e,{destroyPeer:t}){const n=this.byApp[i],s=n==null?void 0:n[e];if(!s||s.isClosing)return;s.idleTimer=St(s.idleTimer),s.isClosing=!0,t&&!s.peer.isDead&&s.peer.destroy();const r=As(s.bindings);s.bindings={},s.bindingsByToken={},s.controlRoomId=null,delete n[e],r.forEach(o=>{var a,c;(c=(a=o.handlers).close)==null||c.call(a),o.pendingData.length=0,o.pendingSendData.length=0,o.pendingTracks.length=0}),s.remoteStreamsByKey.clear(),s.remoteStreamsById.clear(),s.remoteTracksByKey.clear(),s.remoteTracksById.clear(),s.pendingDataByToken.clear(),s.remoteRoomTokens.clear(),Gt(n).length===0&&delete this.byApp[i]}register(i,e,t,n){const s=this.getMap(i),r=s[e];if(r){if(r.idleTimer=St(r.idleTimer),r.peer===t)return r;this.clear(i,e,{destroyPeer:!0})}const o={appId:i,peerId:e,peer:t,bindings:{},bindingsByToken:{},pendingDataByToken:new Map,remoteRoomTokens:new Set,idleTimer:null,controlRoomId:null,streamOwners:new Map,trackOwners:new Map,remoteStreamsByKey:new Map,remoteStreamsById:new Map,remoteTracksByKey:new Map,remoteTracksById:new Map,idleMs:n,isClosing:!1};return t.setHandlers({data:a=>this.dispatchData(o,a),signal:a=>this.dispatchSignal(o,a),close:()=>this.clear(i,e,{destroyPeer:!1}),error:a=>{console.error(`${zi} peer error:`,a),this.clear(i,e,{destroyPeer:!1})},track:(a,c)=>this.dispatchTrack(o,a,c)}),s[e]=o,o}bind(i,e,t,{onDetach:n}){const s=t.bindings[i];if(s)return t.idleTimer=St(t.idleTimer),{proxy:s.proxy,isNew:!1};const r={roomId:i,roomToken:null,roomTokenPromise:e,handlers:{},pendingData:[],pendingSendData:[],pendingTracks:[],detach:Ut,proxy:{}},o=()=>{t.bindings[i]&&(this.pruneRoomOwnership(t,i),delete t.bindings[i],r.roomToken&&t.bindingsByToken[r.roomToken]===r&&delete t.bindingsByToken[r.roomToken],t.controlRoomId===i&&(t.controlRoomId=Gt(t.bindings)[0]??null),n(),this.scheduleIdleTimer(t))},a={created:t.peer.created,get connection(){return t.peer.connection},get channel(){return t.peer.channel},get isDead(){return t.peer.isDead},getOffer:c=>t.peer.getOffer(c),signal:c=>t.peer.signal(c),sendData:c=>{if(!r.roomToken){r.pendingSendData.push(c);return}t.peer.sendData(Bh(r.roomToken,c))},destroy:()=>o(),setHandlers:c=>{const{signal:l,...h}=c;Object.assign(r.handlers,h),l&&(r.handlers.signal=l),this.flushBindingQueues(r)},offerPromise:t.peer.offerPromise,addStream:c=>{const l=t.streamOwners.get(c)??new Set,h=l.size===0;l.add(i),t.streamOwners.set(c,l),h&&t.peer.addStream(c)},removeStream:c=>{const l=t.streamOwners.get(c);l&&(l.delete(i),l.size===0&&(t.streamOwners.delete(c),t.peer.removeStream(c)))},addTrack:(c,l)=>{const h=t.trackOwners.get(c)??{stream:l,rooms:new Set},u=h.rooms.size===0;return h.stream=l,h.rooms.add(i),t.trackOwners.set(c,h),u?t.peer.addTrack(c,l):t.peer.connection.getSenders().find(d=>d.track===c)??t.peer.addTrack(c,l)},removeTrack:c=>{const l=t.trackOwners.get(c);l&&(l.rooms.delete(i),l.rooms.size===0&&(t.trackOwners.delete(c),t.peer.removeTrack(c)))},replaceTrack:(c,l)=>{const h=t.trackOwners.get(c);if(h){t.trackOwners.delete(c);const u=t.trackOwners.get(l)??{stream:h.stream,rooms:new Set};h.rooms.forEach(d=>u.rooms.add(d)),t.trackOwners.set(l,u)}return t.peer.replaceTrack(c,l)},__trysteroGetRemoteStreamByKey:c=>t.remoteStreamsByKey.get(c),__trysteroSetRemoteStreamByKey:(c,l)=>void t.remoteStreamsByKey.set(c,l),__trysteroGetRemoteStreamById:c=>t.remoteStreamsById.get(c),__trysteroSetRemoteStreamById:(c,l)=>void t.remoteStreamsById.set(c,l),__trysteroGetRemoteTrackByKey:c=>t.remoteTracksByKey.get(c),__trysteroSetRemoteTrackByKey:(c,l,h)=>void t.remoteTracksByKey.set(c,{track:l,stream:h}),__trysteroGetRemoteTrackById:c=>t.remoteTracksById.get(c),__trysteroSetRemoteTrackById:(c,l,h)=>void t.remoteTracksById.set(c,{track:l,stream:h})};return r.proxy=a,r.detach=o,t.bindings[i]=r,t.controlRoomId??(t.controlRoomId=i),t.idleTimer=St(t.idleTimer),e.then(c=>{if(t.isClosing||t.bindings[i]!==r)return;r.roomToken=c,t.bindingsByToken[c]=r;const l=t.pendingDataByToken.get(c);l!=null&&l.length&&(r.pendingData.push(...l),t.pendingDataByToken.delete(c)),r.pendingSendData.splice(0).forEach(h=>t.peer.sendData(Bh(c,h))),this.flushBindingQueues(r)}),{proxy:a,isNew:!0}}pruneRoomOwnership(i,e){i.streamOwners.forEach((t,n)=>{t.delete(e),t.size===0&&(i.streamOwners.delete(n),i.peer.removeStream(n))}),i.trackOwners.forEach((t,n)=>{t.rooms.delete(e),t.rooms.size===0&&(i.trackOwners.delete(n),i.peer.removeTrack(n))})}scheduleIdleTimer(i){i.isClosing||Gt(i.bindings).length>0||(i.idleTimer=St(i.idleTimer),i.idleTimer=setTimeout(()=>{var t;const e=(t=this.byApp[i.appId])==null?void 0:t[i.peerId];!e||Gt(e.bindings).length>0||this.clear(i.appId,i.peerId,{destroyPeer:!0})},i.idleMs))}getSignalBinding(i){if(i.controlRoomId){const t=i.bindings[i.controlRoomId];if(t!=null&&t.handlers.signal)return t}const e=As(i.bindings).find(t=>!!t.handlers.signal);return e?(i.controlRoomId=e.roomId,e):null}flushBindingQueues(i){const{handlers:e}=i;e.data&&i.pendingData.length>0&&i.pendingData.splice(0).forEach(t=>{var n;return(n=e.data)==null?void 0:n.call(e,t)}),(e.track||e.stream)&&i.pendingTracks.length&&i.pendingTracks.splice(0).forEach(({track:t,stream:n})=>{var s,r;(s=e.track)==null||s.call(e,t,n),(r=e.stream)==null||r.call(e,n)})}dispatchData(i,e){var s,r;const t=Kx(e);if(!t)return;if(t.type==="presence"){t.isPresent?i.remoteRoomTokens.add(t.roomToken):i.remoteRoomTokens.delete(t.roomToken),(r=(s=this.roomPresenceHandlers)[i.appId])==null||r.call(s,i.peerId,t.roomToken,t.isPresent);return}const n=i.bindingsByToken[t.roomToken];if(!n){const o=i.pendingDataByToken.get(t.roomToken)??[];o.push(t.payload),i.pendingDataByToken.set(t.roomToken,o);return}n.handlers.data?n.handlers.data(t.payload):n.pendingData.push(t.payload)}dispatchSignal(i,e){var t,n,s;(s=(t=this.getSignalBinding(i))==null?void 0:(n=t.handlers).signal)==null||s.call(n,e)}dispatchTrack(i,e,t){As(i.bindings).forEach(n=>{var s,r,o,a;if(n.handlers.track||n.handlers.stream){(r=(s=n.handlers).track)==null||r.call(s,e,t),(a=(o=n.handlers).stream)==null||a.call(o,t);return}n.pendingTracks.push({track:e,stream:t})})}};const Qx=23333,ey=12,ty=7533,ny=23333,cc="__legacy__",Bo="offer-placeholder",nd=(i,e,t,n,s,r)=>{i.toCipher(e).then(o=>{i.isLeaving()||!r()||n(t,ki(s(o.sdp)))})},iy=()=>({status:"idle",offerPeer:null,offerId:null,offerSdp:null,offerInitPromise:null,offerAnswered:!1,offerRelays:[],offerSignalRelays:[],offerSignalBacklog:[],offerRelayTimers:[],offerExpiryTimer:null,connectedPeer:null,connectedPeerUnhealthySinceMs:null,answeringExpiryTimer:null,answeringPeer:null,pendingCandidates:{}}),vr=(i,e)=>i[e]??(i[e]=iy()),cn=i=>{i.connectedPeer?i.status="connected":i.answeringPeer?i.status="answering":i.offerPeer||i.offerRelays.some(Boolean)?i.status="offering":i.status="idle"},Ao=(i,e)=>{i.answeringPeer===e&&(i.answeringExpiryTimer=St(i.answeringExpiryTimer),i.answeringPeer=null,cn(i))},lc=(i,e,t)=>{i.connectedPeer&&(i.connectedPeer.isDead||i.connectedPeer.destroy(),i.connectedPeer=null,i.connectedPeerUnhealthySinceMs=null,cn(i))},Nc=(i,e)=>{i.offerRelayTimers[e]=St(i.offerRelayTimers[e]),i.offerRelays[e]&&(i.offerRelays[e]=void 0,cn(i))},zh=(i,e)=>{(i==null?void 0:i.offerRelays[e])===Bo&&Nc(i,e)},sy=i=>{if(i.isDead||i.connection.connectionState==="closed")return!0;try{return!!i.connection.remoteDescription}catch{return!0}},xr=(i,e)=>{const t=i.offerAnswered;i.offerExpiryTimer=St(i.offerExpiryTimer),i.offerInitPromise=null,i.offerRelays.forEach((n,s)=>Nc(i,s)),i.offerRelays=[],i.offerSignalRelays=[],i.offerRelayTimers=[],i.offerSignalBacklog=[],i.offerPeer&&i.offerPeer!==i.connectedPeer&&(t||sy(i.offerPeer)?i.offerPeer.isDead||i.offerPeer.destroy():e.recycle(i.offerPeer)),i.offerPeer=null,i.offerId=null,i.offerSdp=null,i.offerAnswered=!1,cn(i)},ry=(i,e,t,n)=>{St(e.answeringExpiryTimer),e.answeringExpiryTimer=setTimeout(()=>{const s=i.peerStates[t];!s||s.connectedPeer||s.answeringPeer!==n||(n.destroy(),Ao(s,n))},ny)},oy=async(i,e,t)=>{const n=t?[t,cc]:[cc];for(const s of n){const r=i.pendingCandidates[s];if(r!=null&&r.length){delete i.pendingCandidates[s];for(const o of r)await e.signal(o)}}},id=(i,e,t,n=Dc)=>{St(e.offerExpiryTimer);const s=e.offerId;e.offerExpiryTimer=setTimeout(()=>{const r=i.peerStates[t];!r||r.connectedPeer||r.offerId!==s||xr(r,i.offerPool)},n)},ay=(i,e,t,n)=>e.offerPeer&&e.offerId&&e.offerSdp?Promise.resolve({peer:e.offerPeer,offer:e.offerSdp,offerId:e.offerId}):(e.offerInitPromise||(e.offerInitPromise=(async()=>{const s=(await i.offerPool.checkout(1,!1,i.encryptOffer))[0];if(!s)throw ut("failed to allocate offer peer");const{peer:r,offer:o}=s;e.offerPeer=r,e.offerId=kr(ey),e.offerSdp=o,e.offerAnswered=!1,e.offerSignalBacklog=[],cn(e);const a=()=>{e.offerPeer===r&&!e.connectedPeer&&xr(e,i.offerPool),i.disconnectPeer(r,t)};return r.setHandlers({connect:()=>i.connectPeer(r,t,n),signal:c=>{e.offerPeer===r&&(e.offerSignalBacklog.push(c),e.offerSignalRelays.forEach(l=>l==null?void 0:l(c)))},close:a,error:a}),id(i,e,t),{peer:r,offer:o,offerId:e.offerId}})().finally(()=>e.offerInitPromise=null)),e.offerInitPromise),cy=async(i,e,t,n,s)=>{if(n){i.attachSharedPeerToRoom(t,n);return}const r=i.peerStates[t];if(!r||r.connectedPeer||r.answeringPeer||r.offerAnswered){zh(r,e);return}if(r.offerRelays[e]!==Bo)return;const[o,a]=await qs([Vs(gr(i.rootTopicPlaintext,t)),ay(i,r,t,e)]);if(i.isLeaving())return;if(r.connectedPeer||r.answeringPeer||r.offerAnswered||r.offerRelays[e]!==Bo){zh(r,e);return}r.offerRelayTimers[e]=St(r.offerRelayTimers[e]),r.offerRelays[e]=!0,cn(r),r.offerRelayTimers[e]=setTimeout(()=>dy(i,t,e),(i.announceIntervals[e]??i.announceIntervalMs)*.9);let c=!1;r.offerSignalRelays[e]=l=>{c&&(i.isLeaving()||r.connectedPeer||r.offerPeer!==a.peer||r.offerId!==a.offerId||l.type!=="candidate"||nd(i,l,o,s,h=>({peerId:vn,offerId:a.offerId,candidate:h}),()=>!r.connectedPeer&&r.offerPeer===a.peer&&r.offerId===a.offerId))},s(o,ki({peerId:vn,offerId:a.offerId,offer:a.offer})),c=!0,r.offerSignalBacklog.forEach(l=>{var h,u;return(u=(h=r.offerSignalRelays)[e])==null?void 0:u.call(h,l)})},ly=async(i,e,t,n,s,r,o)=>{var f;const a=vr(i.peerStates,t);if(a.answeringPeer||a.offerAnswered)return;const c=!!(a.offerPeer||a.offerRelays.some(Boolean));if((c||r)&&vn<t)return;c&&xr(a,i.offerPool);const l=i.initPeer(!1,i.config);a.answeringPeer=l,ry(i,a,t,l),cn(a);const h=()=>{Ao(a,l),i.disconnectPeer(l,t)};l.setHandlers({connect:()=>i.connectPeer(l,t,e),close:h,error:h});let u;try{u=await i.toPlain({type:"offer",sdp:n})}catch{Ao(a,l),(f=i.onJoinError)==null||f.call(i,{error:"incorrect room password when decrypting offer",appId:i.appId,peerId:t,roomId:i.roomId});return}if(l.isDead){Ao(a,l);return}const d=await Vs(gr(i.rootTopicPlaintext,t));i.isLeaving()||(l.setHandlers({signal:g=>{i.isLeaving()||a.answeringPeer!==l||l.isDead||g.type!=="answer"&&g.type!=="candidate"||nd(i,g,d,o,v=>{const m={peerId:vn};return g.type==="answer"?m.answer=v:m.candidate=v,s&&(m.offerId=s),m},()=>a.answeringPeer===l&&!l.isDead)}}),await l.signal(u),await oy(a,l,s))},hy=async(i,e,t,n,s)=>{var u;let r;try{r=await i.toPlain({type:qu,sdp:t})}catch{return}const o=vr(i.peerStates,e),a=n&&(o!=null&&o.offerPeer)&&o.offerId===n?o.offerPeer:null,c=(o==null?void 0:o.answeringPeer)??null,l=!n&&(o!=null&&o.offerPeer)?o.offerPeer:null,h=s&&!s.isDead?s:a??c??l;if(!h||h.isDead){const d=n??cc;((u=o.pendingCandidates)[d]??(u[d]=[])).push(r);return}h.signal(r)},uy=async(i,e,t,n,s,r)=>{var a;let o;try{o=await i.toPlain({type:"answer",sdp:n})}catch{(a=i.onJoinError)==null||a.call(i,{error:"incorrect room password when decrypting answer",appId:i.appId,peerId:t,roomId:i.roomId});return}if(r)i.offerPool.claimLeased(r),r.setHandlers({connect:()=>i.connectPeer(r,t,e),close:()=>i.disconnectPeer(r,t)}),r.signal(o);else{const c=i.peerStates[t];if(!c||!c.offerPeer||c.offerAnswered||s&&c.offerId&&s!==c.offerId||c.offerPeer.isDead)return;c.offerAnswered=!0,id(i,c,t,Qx),c.offerPeer.signal(o)}},dy=(i,e,t)=>{const n=i.peerStates[e];!n||n.connectedPeer||n.offerRelays[t]&&Nc(n,t)},fy=i=>e=>async(t,n,s)=>{if(i.isLeaving())return;const r=typeof n=="string"?_r(n):n,o=typeof r.peerId=="string"?r.peerId:"",a=r.offer,c=r.answer,l=r.candidate,h=r.offerId,u=r.peer,d=r.hasOutgoingOffer===!0;if(o===vn)return;const f=i.peerStates[o],g=f==null?void 0:f.connectedPeer;if(g&&f){const y=Jx(g);if(y==="live"){f.connectedPeerUnhealthySinceMs=null;return}if(y==="stale")lc(f);else{const w=Date.now(),L=f.connectedPeerUnhealthySinceMs??w;if(f.connectedPeerUnhealthySinceMs=L,w-L<ty)return;lc(f)}}let v=i.sharedPeers.get(i.appId,o);v&&i.sharedPeers.getHealth(v.peer)==="stale"&&(i.sharedPeers.clear(i.appId,o,{destroyPeer:!0}),v=void 0);const m=!!(o&&!a&&!c&&!l),[p,T]=await qs([i.rootTopicP,i.selfTopicP]);if(!i.isLeaving()&&!(t!==p&&t!==T)){if(m&&!v){const y=vr(i.peerStates,o),w=vn<o;if(y.answeringPeer||y.connectedPeer||y.offerAnswered)return;if(!w&&!y.offerPeer){const L=await Vs(gr(i.rootTopicPlaintext,o));!i.isLeaving()&&!y.connectedPeer&&s(L,ki({peerId:vn}));return}if(y.offerRelays[e])return;y.offerRelays[e]=Bo,cn(y)}if(v&&(a||c||l)){if(v.bindings[i.roomId])return;i.attachSharedPeerToRoom(o,v);return}if(m)return cy(i,e,o,v,s);if(a)return ly(i,e,o,a,h,d,s);if(l)return hy(i,o,l,h,u);if(c)return uy(i,e,o,c,h,u)}},Ga=5333,py=[233,533,1333],my=123333;var gy=({init:i,subscribe:e,announce:t})=>{const n={},s={},r={},o={},a=new jx,c=()=>As(n).some(w=>Gt(w).length>0),l=w=>s[w]??(s[w]={}),h=w=>r[w]??(r[w]={}),u=(w,L,R)=>{a.getHealth(w.peer)==="live"&&a.sendRoomPresence(w,L,R)},d=(w,L)=>{_i(s[w]??{}).forEach(([R,E])=>{const{roomToken:D,roomTokenPromise:M}=E;if(D){u(L,D,!0);return}M.then(x=>{var P;((P=s[w])==null?void 0:P[R])===E&&E.roomToken===x&&(a.get(w,L.peerId)!==L||L.isClosing||u(L,x,!0))})})},f=(w,L,R)=>As(a.getMap(w)).forEach(E=>u(E,L,R)),g=w=>{o[w]||(o[w]=a.setRoomPresenceHandler(w,(L,R,E)=>{var x,P,Y;if(!E)return;const D=a.get(w,L),M=(x=r[w])==null?void 0:x[R];!D||!M||(Y=(P=s[w])==null?void 0:P[M])==null||Y.attachSharedPeerToRoom(L,D)}))},v=w=>{var L;n[w]&&Gt(n[w]).length>0||((L=o[w])==null||L.call(o),delete o[w],delete s[w],delete r[w])};let m=!1,p=[],T=null,y=Ut;return(w,L,R)=>{var S,_;if(!w)throw ut("requires a config map as the first argument");if(R&&typeof R!="object")throw ut("third argument must be a callbacks object");const{appId:E}=w,D=R==null?void 0:R.onJoinError,M=R==null?void 0:R.onPeerHandshake,x=R==null?void 0:R.handshakeTimeoutMs;if(!E)throw ut("config map is missing appId field");if(!L)throw ut("roomId argument required");if(x!==void 0&&(!Number.isFinite(x)||x<=0))throw ut("handshakeTimeoutMs must be a positive number");if((S=n[E])!=null&&S[L])return n[E][L];g(E);const P=gr(zi,E,L),Y=Vs(P),Z=Vs(gr(P,vn)),ee=Tx(w.password??"",E,L),ie=Ax(E,L),te=w._test_only_sharedPeerIdleMs??my;let z=!1;const V=A=>async N=>({type:N.type,sdp:await A(ee,N.sdp)}),he=V(Cx),O=V(Rx),k=a.getMap(E),se=()=>Ih(!0,w);T||(T=new Ix(se));const ge=T,$=async A=>{const N=await A.getOffer(Date.now()-A.created>Dc);if(!N||N.type!=="offer")throw ut("failed to get offer for peer");return(await O(N)).sdp},ae=(A,N)=>{const G=vr(Pe.peerStates,A);G.answeringExpiryTimer=St(G.answeringExpiryTimer),G.answeringPeer=null;const{proxy:q,isNew:Q}=a.bind(L,ie,N,{onDetach:()=>{const re=Pe.peerStates[A];(re==null?void 0:re.connectedPeer)===N.peer&&(re.connectedPeer=null,re.connectedPeerUnhealthySinceMs=null,cn(re))}});G.connectedPeer=N.peer,G.connectedPeerUnhealthySinceMs=null,cn(G),Q&&ke(q,A),xr(G,ge)},Pe={appId:E,roomId:L,config:w,peerStates:{},rootTopicPlaintext:P,rootTopicP:Y,selfTopicP:Z,toPlain:he,toCipher:O,isLeaving:()=>z,onJoinError:D,sharedPeers:a,offerPool:ge,encryptOffer:$,initPeer:Ih,connectPeer:(A,N,G)=>{if(z){A.destroy();return}const q=vr(Pe.peerStates,N);if(q.connectedPeer){const ue=k[N];if(ue&&q.connectedPeer===ue.peer&&ue.bindings[L])return;q.connectedPeer!==A&&!A.isDead&&A.destroy();return}let Q=k[N];if(Q&&a.getHealth(Q.peer)==="stale"&&(a.clear(E,N,{destroyPeer:!0}),Q=void 0),Q&&Q.peer!==A){A.isDead||A.destroy(),ae(N,Q);return}const re=!Q;Q||(Q=a.register(E,N,A,te)),ae(N,Q),re&&d(E,Q)},disconnectPeer:(A,N)=>{if(z)return;const G=Pe.peerStates[N];(G==null?void 0:G.connectedPeer)===A&&lc(G)},attachSharedPeerToRoom:ae,announceIntervals:[],announceIntervalMs:Ga},De=fy(Pe);if(!m){const A=i(w);ge.warmup(),p=(Array.isArray(A)?A:[A]).map(N=>Promise.resolve(N)),m=!0,y=(_=w.relayConfig)!=null&&_.manualReconnection?Ut:Ex()}Pe.announceIntervals=p.map(()=>Ga);const Ve=p.map(()=>0),F=[],ze=p.map(async(A,N)=>e(await A,await Y,await Z,De(N),G=>ge.getOffers(G,$)));qs([Y,Z]).then(([A,N])=>{if(z)return;const G=async(q,Q)=>{if(z)return;const re=await t(q,A,N);if(z)return;typeof re=="number"&&(Pe.announceIntervals[Q]=re);const ue=Ve[Q]??0;Ve[Q]=ue+1;const K=Pe.announceIntervals[Q]??Ga,X=py[ue];F[Q]=setTimeout(()=>{G(q,Q)},typeof X=="number"?Math.min(K,X):K)};ze.forEach(async(q,Q)=>{if(await q,z)return;const re=await p[Q];re&&!z&&G(re,Q)})});let ke=Ut;const{compose:et}=Dx(w.password??"",E,L),Re=et(M),qe={...Re?{onPeerHandshake:Re}:{},...x===void 0?{}:{handshakeTimeoutMs:x},onHandshakeError:(A,N)=>D==null?void 0:D({error:N.replace(/^handshake failed: /,""),appId:E,peerId:A,roomId:L})};n[E]??(n[E]={});const Ge=l(E),Oe=qx(A=>ke=A,A=>{if(z)return;const N=Pe.peerStates[A];N!=null&&N.connectedPeer&&(N.connectedPeer=null,cn(N))},()=>{var N,G;z=!0,ke=Ut;const A=(N=s[E])==null?void 0:N[L];A!=null&&A.roomToken&&(f(E,A.roomToken,!1),(G=r[E])==null||delete G[A.roomToken],r[E]&&!Gt(r[E]).length&&delete r[E]),s[E]&&(delete s[E][L],Gt(s[E]).length||delete s[E]),_i(Pe.peerStates).forEach(([q,Q])=>{if(Q.answeringExpiryTimer=St(Q.answeringExpiryTimer),Q.connectedPeer&&!Q.connectedPeer.isDead){const re=k[q];(!re||re.peer!==Q.connectedPeer)&&Q.connectedPeer.destroy()}Q.answeringPeer&&!Q.answeringPeer.isDead&&Q.answeringPeer.destroy(),xr(Q,ge),Q.connectedPeer=null,Q.answeringPeer=null,cn(Q)}),n[E]&&(delete n[E][L],Gt(n[E]).length===0&&delete n[E]),F.forEach(St),ze.forEach(async q=>{(await q)()}),!c()&&(m=!1,ge.destroy(),T=null,y(),v(E))},qe),B={roomToken:null,roomTokenPromise:ie,attachSharedPeerToRoom:ae};return Ge[L]=B,ie.then(A=>{var N;z||((N=s[E])==null?void 0:N[L])!==B||(B.roomToken=A,h(E)[A]=L,As(k).forEach(G=>{G.remoteRoomTokens.has(A)&&ae(G.peerId,G)}),f(E,A,!0))}),n[E][L]=Oe}};const Hr=Mx(i=>i.socket),Va={},sd={},kh=Hr.scoped(),Wa=Hr.scoped(),_y=Hr.scoped(),or={},So={},Hh=Hr.scoped(),Cs={},_s={},En={},vy="announce",rd=20,od=3,Gh=1e4,xy=2e4,yy=12e4,Vh=4e3,Sy=3,My=async i=>{if(Va[i])return Va[i];const e=(await Vs(i)).slice(0,rd);return Va[i]=e,sd[e]=i,e},Wh=async(i,e,t)=>i.send(ki({action:vy,info_hash:await My(e),peer_id:vn,...t})),Xh=(i,e,t=!1)=>console.warn(`${zi}: torrent tracker ${t?"failure":"warning"} from ${i} - ${e}`),yr=i=>Cs[i]??(Cs[i]={}),Uc=i=>{delete Cs[i],delete _s[i]},Ey=(i,e)=>{var s;const t=Cs[i],n=t==null?void 0:t[e];if(n)return delete t[e],(s=n.claim)==null||s.call(n),!Gt(t).length&&!En[i]&&Uc(i),n},ad=(i,e)=>{var s;const t=Cs[i],n=t==null?void 0:t[e];n&&(delete t[e],(s=n.reclaim)==null||s.call(n),!Gt(t).length&&!En[i]&&Uc(i))},Zh=i=>{Gt(yr(i)).forEach(e=>ad(i,e)),Uc(i)},wy=i=>{const e=Date.now();_i(yr(i)).forEach(([t,n])=>{e-n.createdAt>yy&&ad(i,t)})},by=async(i,e)=>{for(;_s[i];)await _s[i];const t=(async()=>{wy(i);const n=yr(i),s=Gt(n).length,r=Math.max(0,od-s);r>0&&(await e(r)).forEach(o=>{n[kr(rd)]={...o,createdAt:Date.now()}})})().finally(()=>{_s[i]===t&&delete _s[i]});return _s[i]=t,await t,yr(i)},Ty=gy({init:i=>_x(i,Ry,Sy).map(e=>{const t=Hr.register(e,Sx(e,n=>{var l,h;const s=_r(n),r=s["failure reason"],o=s["warning message"],{interval:a}=s,c=s.info_hash?sd[s.info_hash]:void 0;if(r){Xh(t.url,r,!0);return}if(o&&Xh(t.url,o),a&&a*1e3>(or[t.url]??Gh)&&c&&Wa.forKey(e)[c]){const u=Math.min(a*1e3,xy),d=kh.forKey(e),f=Wa.forKey(e);d[c]&&clearInterval(d[c]),or[t.url]=u;const g=f[c];g&&(d[c]=setInterval(()=>{g()},u))}if((s.offer||s.answer)&&c&&s.offer_id){if(s.peer_id===vn)return;const u=`${c}:${s.offer?"offer":"answer"}:${s.offer_id}:${s.peer_id??""}`,d=Date.now(),f=So[u];if(typeof f=="number"&&d-f<Vh)return;So[u]=d,_i(So).forEach(([g,v])=>{d-v>Vh*6&&delete So[g]}),(h=(l=Hh.forKey(e))[c])==null||h.call(l,s)}}));return t.ready}),subscribe:(i,e,t,n,s)=>{const r=Hh.forRelay(i),o=Wa.forRelay(i),a=kh.forRelay(i),c=_y.forRelay(i),l=Symbol(e);c[e]=l,En[e]=(En[e]??0)+1;const h=d=>{if(d.offer&&d.peer_id&&d.offer_id)n(e,{offer:d.offer.sdp,peerId:d.peer_id,hasOutgoingOffer:Gt(yr(e)).length>0},(f,g)=>void Wh(i,e,{answer:{type:"answer",sdp:_r(g).answer},offer_id:d.offer_id,to_peer_id:d.peer_id}));else if(d.answer&&d.offer_id&&d.peer_id){const f=Ey(e,d.offer_id);f&&n(e,{answer:d.answer.sdp,peerId:d.peer_id,peer:f.peer},()=>{})}};r[e]=h;const u=async()=>{c[e]===l&&Wh(i,e,{numwant:od,offers:_i(await by(e,s)).map(([d,{offer:f}])=>({offer_id:d,offer:{type:"offer",sdp:f}}))})};return or[i.url]=Gh,o[e]=u,a[e]=setInterval(u,or[i.url]),u(),()=>{if(En[e]=Math.max(0,(En[e]??1)-1),En[e]||delete En[e],c[e]!==l){En[e]||Zh(e);return}const d=a[e];d&&(clearInterval(d),delete a[e]),r[e]===h&&delete r[e],o[e]===u&&delete o[e],delete c[e],En[e]||Zh(e)}},announce:i=>or[i.url]}),Ay=(i,e,t)=>Ty({...i,trickleIce:i.trickleIce??!1},e,t),Ry=["tracker.webtorrent.dev","tracker.openwebtorrent.com","tracker.btorrent.xyz","tracker.files.fm:7073/announce"].map(i=>"wss://"+i),hc="sw_id_v1",uc=i=>Array.from(i).map(e=>e.toString(16).padStart(2,"0")).join(""),Yh=i=>{const e=i.replace(/-/g,"+").replace(/_/g,"/"),t=atob(e);return Uint8Array.from(t,n=>n.charCodeAt(0))};class qh{constructor(e,t,n,s){this.peerId=e,this.displayName=t,this.isNew=s,this._priv=n}get shortId(){return this.peerId.slice(-8)}setName(e){this.displayName=e,cd()}async sign(e){const t=new TextEncoder().encode(e),n=await crypto.subtle.sign({name:"Ed25519"},this._priv,t);return uc(new Uint8Array(n))}}let Gn=null,pr=null;function cd(){if(!(!Gn||!pr))try{localStorage.setItem(hc,JSON.stringify({privJwk:pr,displayName:Gn.displayName}))}catch{}}async function Cy(){if(Gn)return Gn;const i=localStorage.getItem(hc);if(i)try{const{privJwk:n,displayName:s}=JSON.parse(i),r=await crypto.subtle.importKey("jwk",n,{name:"Ed25519"},!1,["sign"]),o=uc(Yh(n.x));return pr=n,Gn=new qh(o,s||"",r,!1),Gn}catch{localStorage.removeItem(hc)}const e=await crypto.subtle.generateKey({name:"Ed25519"},!0,["sign","verify"]);pr=await crypto.subtle.exportKey("jwk",e.privateKey);const t=uc(Yh(pr.x));return Gn=new qh(t,"",e.privateKey,!0),cd(),Gn}function ld(){return Gn}const Py="spacework-v1";function Ly(){return`sw-1-${window.location.hash.slice(1).trim().toLowerCase().replace(/[^a-z0-9-]/g,"-").replace(/-{2,}/g,"-").slice(0,40)||"main"}`}function Iy(){return window.location.hash.slice(1).trim()||"main"}function Dy(i){const e=i.trim().toLowerCase().replace(/[^a-z0-9-]/g,"-").replace(/-{2,}/g,"-")||"main";window.location.hash=e}var kt,Ls,Is,Ds,Wn,Ns,wr,br,Tr,Ar,Rr,Us,Cr,Pr,Lr,Ir,Dr,wt,Pi,si,dc;class Ny{constructor(e,t=0,n="available"){$e(this,wt);$e(this,kt,null);$e(this,Ls,"");$e(this,Is,0);$e(this,Ds,"available");$e(this,Wn,{});$e(this,Ns,null);$e(this,wr,null);$e(this,br,null);$e(this,Tr,null);$e(this,Ar,null);$e(this,Rr,null);$e(this,Us,null);$e(this,Cr,null);$e(this,Pr,null);$e(this,Lr,null);$e(this,Ir,null);$e(this,Dr,null);gt(this,Ls,e),gt(this,Is,t),gt(this,Ds,n)}async start(){const e=Ly();gt(this,kt,Ay({appId:Py},e)),[Kt(this,Ns)._,Kt(this,wr)._]=oe(this,kt).makeAction("intro"),[Kt(this,br)._,Kt(this,Tr)._]=oe(this,kt).makeAction("move"),[Kt(this,Ar)._,Kt(this,Rr)._]=oe(this,kt).makeAction("chat"),[Kt(this,Us)._,Kt(this,Cr)._]=oe(this,kt).makeAction("bye"),[Kt(this,Pr)._,Kt(this,Lr)._]=oe(this,kt).makeAction("avatar"),[Kt(this,Ir)._,Kt(this,Dr)._]=oe(this,kt).makeAction("status"),oe(this,kt).onPeerJoin(t=>{oe(this,Ns).call(this,je(this,wt,dc).call(this),t)}),oe(this,kt).onPeerLeave(t=>{je(this,wt,si).call(this,"PEER_LEAVE",{from:t})}),oe(this,wr).call(this,({identityId:t,username:n,presetId:s=0,status:r="available"},o)=>{const a=t;je(this,wt,si).call(this,"HELLO",{from:a,username:n,presetId:s,status:r}),oe(this,Ns).call(this,je(this,wt,dc).call(this),o)}),oe(this,Lr).call(this,({identityId:t,presetId:n},s)=>{je(this,wt,si).call(this,"AVATAR_CHANGE",{from:t,presetId:n})}),oe(this,Dr).call(this,({identityId:t,status:n},s)=>{je(this,wt,si).call(this,"STATUS_CHANGE",{from:t,status:n})}),oe(this,Tr).call(this,({identityId:t,pos:n},s)=>{je(this,wt,si).call(this,"MOVE",{from:t,pos:n})}),oe(this,Rr).call(this,({identityId:t,username:n,text:s,ts:r},o)=>{je(this,wt,si).call(this,"CHAT",{from:t,username:n,text:s,ts:r})}),oe(this,Cr).call(this,({identityId:t},n)=>{je(this,wt,si).call(this,"PEER_LEAVE",{from:t})})}stop(){var e;oe(this,Us)&&oe(this,Us).call(this,{identityId:je(this,wt,Pi).call(this)}),(e=oe(this,kt))==null||e.leave(),gt(this,kt,null)}addVoiceTrack(e,t){var n;(n=oe(this,kt))==null||n.addTrack(e,t)}onVoiceTrack(e){var t;(t=oe(this,kt))==null||t.onTrack((n,s,r)=>e(n,s,r))}move(e,t,n,s=0){var r;(r=oe(this,br))==null||r.call(this,{identityId:je(this,wt,Pi).call(this),pos:{x:e,y:t,z:n,ry:s}})}chat(e){var t;(t=oe(this,Ar))==null||t.call(this,{identityId:je(this,wt,Pi).call(this),username:oe(this,Ls),text:e,ts:Date.now()})}setAvatar(e){var t;gt(this,Is,e),(t=oe(this,Pr))==null||t.call(this,{identityId:je(this,wt,Pi).call(this),presetId:e})}setStatus(e){var t;gt(this,Ds,e),(t=oe(this,Ir))==null||t.call(this,{identityId:je(this,wt,Pi).call(this),status:e})}on(e,t){return oe(this,Wn)[e]||(oe(this,Wn)[e]=[]),oe(this,Wn)[e].push(t),()=>{oe(this,Wn)[e]=oe(this,Wn)[e].filter(n=>n!==t)}}}kt=new WeakMap,Ls=new WeakMap,Is=new WeakMap,Ds=new WeakMap,Wn=new WeakMap,Ns=new WeakMap,wr=new WeakMap,br=new WeakMap,Tr=new WeakMap,Ar=new WeakMap,Rr=new WeakMap,Us=new WeakMap,Cr=new WeakMap,Pr=new WeakMap,Lr=new WeakMap,Ir=new WeakMap,Dr=new WeakMap,wt=new WeakSet,Pi=function(){var e;return((e=ld())==null?void 0:e.peerId)??"unknown"},si=function(e,t){var n;(n=oe(this,Wn)[e])==null||n.forEach(s=>s(t))},dc=function(){return{identityId:je(this,wt,Pi).call(this),username:oe(this,Ls),presetId:oe(this,Is),status:oe(this,Ds)}};var bt,nn,Os,Nr,Ur,Or,Ht,hd,ud,Sn;class Uy extends EventTarget{constructor(){super(...arguments);$e(this,Ht);$e(this,bt,null);$e(this,nn,new Map);$e(this,Os,!1);$e(this,Nr,"");$e(this,Ur,0);$e(this,Or,"available")}get id(){var t;return((t=ld())==null?void 0:t.peerId)??""}get peers(){return[...oe(this,nn).values()]}get peerCount(){return oe(this,nn).size}async start(t,n=0,s="available"){oe(this,Os)||(gt(this,Os,!0),gt(this,Nr,t),gt(this,Ur,n),gt(this,Or,s),gt(this,bt,new Ny(t,n,s)),oe(this,bt).on("HELLO",({from:r,username:o,presetId:a=0,status:c="available"})=>{oe(this,nn).has(r)||je(this,Ht,hd).call(this,r,o,a,c)}),oe(this,bt).on("PEER_LEAVE",({from:r})=>je(this,Ht,ud).call(this,r)),oe(this,bt).on("MOVE",({from:r,pos:o})=>{je(this,Ht,Sn).call(this,"peer:move",{peerId:r,pos:o})}),oe(this,bt).on("AVATAR_CHANGE",({from:r,presetId:o})=>{je(this,Ht,Sn).call(this,"peer:avatar",{peerId:r,presetId:o})}),oe(this,bt).on("STATUS_CHANGE",({from:r,status:o})=>{je(this,Ht,Sn).call(this,"peer:status",{peerId:r,status:o})}),oe(this,bt).on("CHAT",({from:r,username:o,text:a,ts:c})=>{je(this,Ht,Sn).call(this,"chat",{from:r,username:o,text:a,ts:c})}),await oe(this,bt).start())}stop(){var t;(t=oe(this,bt))==null||t.stop(),gt(this,bt,null),oe(this,nn).clear(),gt(this,Os,!1)}move(t,n,s,r=0){var o;(o=oe(this,bt))==null||o.move(t,n,s,r)}setAvatar(t){var n;gt(this,Ur,t),(n=oe(this,bt))==null||n.setAvatar(t)}setStatus(t){var n;gt(this,Or,t),(n=oe(this,bt))==null||n.setStatus(t)}sendChat(t){var s;if(!t.trim())return;const n=Date.now();je(this,Ht,Sn).call(this,"chat",{from:this.id,username:oe(this,Nr),text:t,ts:n}),(s=oe(this,bt))==null||s.chat(t)}addVoiceTrack(t,n){var s;(s=oe(this,bt))==null||s.addVoiceTrack(t,n)}onVoiceTrack(t){var n;(n=oe(this,bt))==null||n.onVoiceTrack(t)}}bt=new WeakMap,nn=new WeakMap,Os=new WeakMap,Nr=new WeakMap,Ur=new WeakMap,Or=new WeakMap,Ht=new WeakSet,hd=function(t,n,s,r){oe(this,nn).set(t,{peerId:t,username:n,presetId:s,status:r}),je(this,Ht,Sn).call(this,"peer:join",{peerId:t,username:n,presetId:s,status:r}),je(this,Ht,Sn).call(this,"status",{peerCount:oe(this,nn).size})},ud=function(t){oe(this,nn).has(t)&&(oe(this,nn).delete(t),je(this,Ht,Sn).call(this,"peer:leave",{peerId:t}),je(this,Ht,Sn).call(this,"status",{peerCount:oe(this,nn).size}))},Sn=function(t,n){this.dispatchEvent(new CustomEvent(t,{detail:n}))};const It=new Uy,zn=Object.freeze({OCEAN:"ocean",COAST:"coast",DESERT:"desert",PLAINS:"plains",FOREST:"forest",MOUNTAIN:"mountain",ARCTIC:"arctic",JUNGLE:"jungle",TUNDRA:"tundra"});function Mo(i){let e=5381;for(let t=0;t<i.length;t++)e=Math.imul(e,33)^i.charCodeAt(t);return(e>>>0).toString(16).padStart(8,"0")}function dd(i,e,t,n){const s=JSON.stringify({parentHash:i,authorId:e,changes:t,timestamp:n});let r=Mo(s),o=Mo(r+s.slice(0,32)),a=Mo(o+s.slice(-32)),c=Mo(a+e);return r+o+a+c}class Es{constructor(e,t,n,s="",r=Date.now()){this.parentHash=e,this.authorId=t,this.changes=Object.freeze([...n]),this.message=s,this.timestamp=r,this.hash=dd(e,t,n,r)}buildRevert(e,t=Date.now()){const n=this.changes.map(s=>({cellId:s.cellId,key:s.key,oldValue:s.newValue,newValue:s.oldValue}));return new Es(this.hash,e,n,`revert: ${this.message||this.hash.slice(0,8)}`,t)}toJSON(){return{hash:this.hash,parentHash:this.parentHash,authorId:this.authorId,message:this.message,timestamp:this.timestamp,changes:this.changes}}}const Oy="universe",Fy="genesis: the universe begins";var Dt,Yt;class By{constructor(){$e(this,Dt,new Map);$e(this,Yt,null);this._genesis()}_genesis(){const e=new Es(null,Oy,[],Fy,0);oe(this,Dt).set(e.hash,e),gt(this,Yt,e.hash)}get head(){return oe(this,Yt)}get length(){return oe(this,Dt).size}getCommit(e){return oe(this,Dt).get(e)??null}headCommit(){return oe(this,Dt).get(oe(this,Yt))}log(e=1/0){const t=[];let n=oe(this,Yt);for(;n&&t.length<e;){const s=oe(this,Dt).get(n);if(!s)break;t.push(s),n=s.parentHash}return t}stateAt(e){const t=[];let n=e;for(;n;){const r=oe(this,Dt).get(n);if(!r)break;t.unshift(r),n=r.parentHash}const s=new Map;for(const r of t)for(const{cellId:o,key:a,newValue:c}of r.changes)s.set(`${o}:${a}`,c);return s}currentState(){return this.stateAt(oe(this,Yt))}diff(e,t){const n=this.stateAt(e),s=this.stateAt(t),r=[],o=new Set([...n.keys(),...s.keys()]);for(const a of o){const c=n.get(a)??null,l=s.get(a)??null;if(c!==l){const[h,u]=a.split(":");r.push({cellId:h,key:u,before:c,after:l})}}return r}commit(e,t,n=""){if(!Array.isArray(t)||t.length===0)throw new Error("commit requires at least one change");for(const r of t)if(!r.cellId||!r.key)throw new Error("each change must have cellId and key");const s=new Es(oe(this,Yt),e,t,n);return oe(this,Dt).set(s.hash,s),gt(this,Yt,s.hash),s}revert(e,t){const n=oe(this,Dt).get(e);if(!n)throw new Error(`commit ${e} not found`);if(n.changes.length===0)throw new Error("cannot revert empty commit");n.buildRevert(t);const s=new Es(oe(this,Yt),t,[...n.changes].map(r=>({cellId:r.cellId,key:r.key,oldValue:r.newValue,newValue:r.oldValue})),`revert: ${n.message||n.hash.slice(0,8)}`);return oe(this,Dt).set(s.hash,s),gt(this,Yt,s.hash),s}applyExternal(e){if(oe(this,Dt).has(e.hash))return oe(this,Dt).get(e.hash);if(e.parentHash&&!oe(this,Dt).has(e.parentHash))throw new Error(`missing parent ${e.parentHash} — cannot apply ${e.hash}`);const t=new Es(e.parentHash,e.authorId,e.changes,e.message,e.timestamp);return oe(this,Dt).set(e.hash,t),e.parentHash===oe(this,Yt)&&gt(this,Yt,e.hash),t}verify(){for(const e of oe(this,Dt).values()){if(dd(e.parentHash,e.authorId,e.changes,e.timestamp)!==e.hash)return{valid:!1,broken:e.hash};if(e.parentHash&&!oe(this,Dt).has(e.parentHash))return{valid:!1,broken:e.hash,reason:"missing-parent"}}return{valid:!0}}}Dt=new WeakMap,Yt=new WeakMap;const at=Object.freeze({SOLAR:"solar",WIND:"wind",HYDRO:"hydro",MINERAL:"mineral",RARE_EARTH:"rare_earth",BIOLOGICAL:"biological",FISHERY:"fishery",GEOTHERMAL:"geothermal"});zn.OCEAN+"",at.FISHERY+"",at.WIND+"",zn.COAST+"",at.FISHERY+"",at.WIND+"",at.SOLAR+"",zn.DESERT+"",at.SOLAR+"",at.RARE_EARTH+"",at.MINERAL+"",zn.PLAINS+"",at.WIND+"",at.MINERAL+"",at.BIOLOGICAL+"",at.SOLAR+"",zn.FOREST+"",at.BIOLOGICAL+"",at.HYDRO+"",at.WIND+"",zn.MOUNTAIN+"",at.MINERAL+"",at.RARE_EARTH+"",at.GEOTHERMAL+"",at.WIND+"",at.HYDRO+"",zn.ARCTIC+"",at.MINERAL+"",at.WIND+"",zn.JUNGLE+"",at.BIOLOGICAL+"",at.HYDRO+"",at.SOLAR+"",zn.TUNDRA+"",at.MINERAL+"",at.GEOTHERMAL+"",at.WIND+"";(async()=>{const i=await Cy(),e=new By;window._worldHistory=e;function t({peerCount:g}={}){document.querySelectorAll(".ipfs-dot").forEach(v=>{v.className="ipfs-dot green"}),document.querySelectorAll("#ipfs-label").forEach(v=>{v.textContent=`P2P · ${i.shortId}`}),g!==void 0&&document.querySelectorAll("#ipfs-peers").forEach(v=>{v.textContent=g>0?`${g} peer${g!==1?"s":""}`:""})}t({peerCount:0}),It.addEventListener("status",g=>t(g.detail)),It.addEventListener("commit",g=>{try{e.applyExternal(g.detail.commit)}catch{}});const n=document.getElementById("lobby"),s=document.getElementById("loading"),r=document.getElementById("load-fill"),o=document.getElementById("load-text"),a=document.getElementById("hud"),c=document.getElementById("click-to-start"),l=document.getElementById("enter-btn"),h=document.getElementById("username"),u=document.getElementById("room-name");!i.isNew&&i.displayName&&(h.value=i.displayName),u&&(u.value=Iy());const d=document.getElementById("id-fingerprint");d&&(d.textContent=i.isNew?"New identity generated":`Identity · ${i.shortId}`),function(){const v=document.getElementById("lobby-avatar-grid");if(!v)return;const m=parseInt(localStorage.getItem("spaceAvatarId")??"0",10),p=T=>"#"+T.toString(16).padStart(6,"0");Bi.forEach(T=>{const y=p(T.skin),w=p(T.hair),L=p(T.outfit),R=p(T.accent),E=document.createElement("div");E.className="lav-chip"+(T.id===m?" lav-active":""),E.dataset.id=String(T.id),E.title=T.label,E.innerHTML=`<svg viewBox="0 0 60 82" xmlns="http://www.w3.org/2000/svg">
      ...
      </svg>`,E.addEventListener("click",()=>{v.querySelectorAll(".lav-chip").forEach(D=>D.classList.remove("lav-active")),E.classList.add("lav-active"),localStorage.setItem("spaceAvatarId",String(T.id))}),v.appendChild(E)})}(),h==null||h.addEventListener("keydown",g=>{g.key==="Enter"&&f()}),u==null||u.addEventListener("keydown",g=>{g.key==="Enter"&&f()}),l==null||l.addEventListener("click",f);function f(){const g=h.value.trim();if(!g){h.focus(),h.style.borderColor="#f55";return}h.style.borderColor="",i.setName(g),u!=null&&u.value.trim()&&Dy(u.value.trim()),window._spaceUsername=g,n.style.display="none",s.classList.add("visible");const{scene:v,camera:m,renderer:p,onShipLoaded:T}=_v((y,w)=>{r.style.width=y+"%",o.textContent=w});T(()=>{var ue;s.classList.remove("visible"),a.classList.add("visible"),c.classList.remove("hidden");const{meshes:y,screens:w}=vv(v),{openScreen:L,isOpen:R}=Jv(),E=parseInt(localStorage.getItem("spaceAvatarId")??"0",10),D=new lx(K=>x==null?void 0:x.navigate(K)),M=document.getElementById("presence-panel");M&&M.classList.add("pp-visible"),D.setSelf(g,E,"OUTSIDE","available");const x=Zv(v,m,p,K=>{ky(K),D.updateSelfZone(K)},K=>{It.setAvatar(K),D.setSelf(g,K,D._self.zone,P)});let P="available";const Y=document.getElementById("status-btn"),Z=document.getElementById("status-menu");Y&&Z&&(Ac.forEach(K=>{const X="#"+K.color.toString(16).padStart(6,"0"),le=document.createElement("div");le.className="sm-opt"+(K.id===P?" sm-active":""),le.dataset.status=K.id,le.innerHTML=`<span class="sm-dot" style="background:${X};box-shadow:0 0 4px ${X}40"></span>${K.label}`,le.addEventListener("click",Me=>{Me.stopPropagation(),P=K.id,Y.innerHTML=`<span class="sm-dot" style="background:${X};box-shadow:0 0 4px ${X}40;display:inline-block;vertical-align:middle;width:8px;height:8px;border-radius:50%;margin-right:5px"></span>${K.label.replace(/^\S+\s/,"")}`,x.setStatus(K.id),D.updateSelfStatus(K.id),It.setStatus(K.id),Z.querySelectorAll(".sm-opt").forEach(ye=>ye.classList.toggle("sm-active",ye.dataset.status===K.id)),Z.classList.remove("sm-open")}),Z.appendChild(le)}),Y.addEventListener("click",K=>{K.stopPropagation(),Z.classList.toggle("sm-open")}),document.addEventListener("click",()=>Z.classList.remove("sm-open"))),document.querySelectorAll(".vtbtn").forEach(K=>{K.addEventListener("click",X=>{X.stopPropagation(),ie(),x.setView(K.dataset.view),K.dataset.view==="first"&&document.pointerLockElement!==p.domElement&&p.domElement.requestPointerLock()})});let ee=!1;function ie(){ee||(ee=!0,c.classList.add("hidden"))}document.addEventListener("pointerlockchange",()=>{document.pointerLockElement===p.domElement&&ie()}),c.addEventListener("click",ie);const te=new Set(["KeyW","KeyA","KeyS","KeyD"]),z=new Set([...te,"ArrowUp","ArrowDown","ArrowLeft","ArrowRight"]);document.addEventListener("keydown",K=>{z.has(K.code)&&(ie(),te.has(K.code)&&x.getMode()==="first"&&document.pointerLockElement!==p.domElement&&p.domElement.requestPointerLock())});const V=new Q_,he=new Ee,O=new ri(new U(0,1,0),0),k=new U;p.domElement.addEventListener("click",K=>{if(R()||document.pointerLockElement===p.domElement||x.isDragMoved())return;ie(),he.x=K.clientX/window.innerWidth*2-1,he.y=-(K.clientY/window.innerHeight)*2+1,V.setFromCamera(he,m);const X=V.intersectObjects(y);if(X.length>0){L(X[0].object.userData.screen);return}V.ray.intersectPlane(O,k)&&x.navigate({x:Math.max(-65,Math.min(65,k.x)),z:Math.max(-65,Math.min(65,k.z))})});const se=new Map,ge=new Map;It.addEventListener("peer:join",K=>{const{peerId:X,username:le,presetId:Me}=K.detail;if(ge.set(X,le),se.has(X))return;const ye=Me??zy(X),de=Ou(le,ye);v.add(de),se.set(X,de),$h(a,se.size+1),D.addPeer(X,le,ye),x.peerJoin(X,le)}),It.addEventListener("peer:move",K=>{const{peerId:X,pos:le}=K.detail,Me=se.get(X);if(D.movePeer(X,le.x,le.z),Me){const ye=Me.position.clone();if(Me.position.lerp(new U(le.x,le.y??0,le.z),.6),le.ry!==void 0){let de=le.ry-Me.rotation.y;for(;de>Math.PI;)de-=Math.PI*2;for(;de<-Math.PI;)de+=Math.PI*2;Me.rotation.y+=de*.25}ye.distanceTo(Me.position)>.008&&(Me.userData.isMoving=!0,clearTimeout(Me.userData._stopTimer),Me.userData._stopTimer=setTimeout(()=>{Me.userData.isMoving=!1},180))}x.peerMove(X,le.x,le.z,ge.get(X)??X.slice(-4))}),It.addEventListener("peer:leave",K=>{const X=se.get(K.detail.peerId);X&&(v.remove(X),se.delete(K.detail.peerId),$h(a,se.size+1)),ae.removePeer(K.detail.peerId),D.removePeer(K.detail.peerId),x.peerLeave(K.detail.peerId),ge.delete(K.detail.peerId)}),It.addEventListener("peer:avatar",K=>{const{peerId:X,presetId:le}=K.detail,Me=se.get(X),ye=ge.get(X)??X.slice(-4);Me&&Bu(Me,ye,le),D.updatePeerPreset(X,le)}),It.addEventListener("peer:status",K=>{const{peerId:X,status:le}=K.detail,Me=se.get(X);Me&&Fu(Me,le),D.updatePeerStatus(X,le)});let $=performance.now();(function K(){requestAnimationFrame(K);const X=performance.now(),le=Math.min((X-$)/1e3,.1);$=X,se.forEach(Me=>ku(Me,Me.userData.isMoving??!1,le))})(),It.start(g,E,P),window._sync=It;const ae=new ox,me=document.getElementById("voice-btn"),xe=({active:K,muted:X}={})=>{me&&(K?X?(me.textContent="🔇 Muted",me.className="hud-side-btn voice-muted"):(me.textContent="🎙 Live",me.className="hud-side-btn voice-active"):(me.textContent="🎙 Voice",me.className="hud-side-btn"))};ae.onStateChange(xe),xe({active:!1,muted:!1}),me&&me.addEventListener("click",async K=>{if(K.stopPropagation(),ae.active)ae.toggleMute();else if(me.textContent="⏳ Connecting…",!await ae.start(It)){me.textContent="🚫 No mic";return}}),setInterval(()=>{const K=x.getPosition(),X=x.getRotation();It.move(K.x,K.y,K.z,X.y),ae.update(K,se)},50);const Pe=document.getElementById("chat-toggle"),De=document.getElementById("chat-panel"),Ve=document.getElementById("chat-input"),F=document.getElementById("chat-send"),ze=document.getElementById("chat-messages"),ke=document.getElementById("chat-badge");let et=0;Pe.addEventListener("click",K=>{K.stopPropagation();const X=!De.classList.contains("open");De.classList.toggle("open",X),Pe.classList.toggle("open",X),X&&(et=0,ke.textContent="",ke.classList.remove("visible"),Ve.focus())});function Re(){const K=Ve.value.trim();K&&(It.sendChat(K),Ve.value="")}F.addEventListener("click",K=>{K.stopPropagation(),Re()}),Ve.addEventListener("keydown",K=>{K.key==="Enter"&&Re()}),De.addEventListener("click",K=>K.stopPropagation());function qe({from:K,username:X,text:le,ts:Me}){const ye=K===It.id,de=new Date(Me).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),Ae=document.createElement("div");Ae.className="chat-msg",Ae.innerHTML=`
          <div class="chat-msg-meta">
            <span class="chat-msg-name${ye?" self":""}">${X}</span>
            <span class="chat-msg-time">${de}</span>
          </div>
          <div class="chat-msg-body">${le.replace(/</g,"&lt;")}</div>
        `,ze.appendChild(Ae),ze.scrollTop=ze.scrollHeight,!De.classList.contains("open")&&!ye&&(et++,ke.textContent=et>9?"9+":et,ke.classList.add("visible"))}function Ge(K){const X=document.createElement("div");X.className="chat-system",X.textContent=K,ze.appendChild(X),ze.scrollTop=ze.scrollHeight}const Oe=new Map;It.addEventListener("chat",K=>qe(K.detail)),It.addEventListener("peer:join",K=>{Oe.set(K.detail.peerId,K.detail.username),Ge(`${K.detail.username} joined`)}),It.addEventListener("peer:leave",K=>{const X=Oe.get(K.detail.peerId)??"Someone";Oe.delete(K.detail.peerId),Ge(`${X} left`)});const B=new ex,S=new nx,_=new Qv(g);B.createReality(_),S.setNode(g,gs.PUBLIC),(ue=document.getElementById("nm-open-btn"))==null||ue.addEventListener("click",K=>{K.stopPropagation(),sx(B,S,g)});const A=document.getElementById("screen-hint"),N=document.getElementById("screen-hint-name");let G=null,q=null;document.addEventListener("keydown",K=>{if(K.code==="KeyE"&&G&&!R()&&L(G),K.code==="KeyF"&&q){const X=q.def.id,le=X==="main-left"||X==="main-right",Me=Hn(le?"main-left":X);le&&Hn("main-right"),Q(q.def.label,Me)}});function Q(K,X){let le=document.getElementById("door-action-hint");le||(le=document.createElement("div"),le.id="door-action-hint",le.style.cssText=`
          ...
          `,document.body.appendChild(le)),le.textContent=`${K} ${X?"opened":"closed"}`,le.style.opacity="1",clearTimeout(le._t),le._t=setTimeout(()=>{le.style.opacity="0"},1500)}const re=new Set;setInterval(()=>{var de;if(R())return;const K=x.getPosition();let X=null,le=4;w.forEach(Ae=>{const Fe=K.x-Ae.position.x,We=K.z-Ae.position.z,I=Math.sqrt(Fe*Fe+We*We);I<le&&(le=I,X=Ae)}),G=X,A&&(A.style.display=X?"flex":"none",X&&N&&(N.textContent=X.label)),zr.forEach(Ae=>{const Fe=K.x-Ae.hinge.x,We=K.z-Ae.hinge.z,I=Math.sqrt(Fe*Fe+We*We),_e=Ae.id;I<2.2&&!ds(_e)?(Hn(_e),re.add(_e),_e==="main-left"&&(ds("main-right")||Hn("main-right"),re.add("main-right")),_e==="main-right"&&(ds("main-left")||Hn("main-left"),re.add("main-left"))):I>3.5&&re.has(_e)&&ds(_e)&&(Hn(_e),re.delete(_e),_e==="main-left"&&(ds("main-right")&&Hn("main-right"),re.delete("main-right")),_e==="main-right"&&(ds("main-left")&&Hn("main-left"),re.delete("main-left")))});const Me=Hu(K,2.8);q=Me;const ye=document.getElementById("door-proximity-hint");if(ye)if(Me&&!X){const Ae=(de=Me.state)!=null&&de.open?"Close":"Open";ye.style.display="flex",ye.querySelector("#door-hint-name").textContent=`${Ae} ${Me.def.label}`}else ye.style.display="none"},150)})}})();function zy(i){let e=0;for(let t=0;t<i.length;t++)e=e*31+i.charCodeAt(t)|0;return Math.abs(e)%Bi.length}function $h(i,e){var n;const t=(n=i==null?void 0:i.querySelector)==null?void 0:n.call(i,"#online-count");t&&(t.textContent=`● ${e} aboard`)}const Kh={OUTSIDE:{color:"#88cc66",desc:"Outside the building"},LOBBY:{color:"#ffffff",desc:"Reception & Entrance"},OPS:{color:"#ffaa44",desc:"Operations & Technical Support"},FUN:{color:"#44ffaa",desc:"Chill, Social & Games"},DESIGN:{color:"#ff6ba0",desc:"UI/UX, Design & 3D"},ENGINEERING:{color:"#44aaff",desc:"Development & Engineering"},"":{color:"#ffffff",desc:""}};function ky(i){const e=document.getElementById("zone-name"),t=document.getElementById("zone-desc"),n=Kh[i]||Kh[""];e&&(e.textContent=i,e.style.color=n.color),t&&(t.textContent=n.desc),document.querySelectorAll(".map-zone").forEach(s=>{s.classList.toggle("active",s.dataset.zone===i)})}
