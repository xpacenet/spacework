...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ki,depthTest:!1,depthWrite:!1})}function Wh(){return new Zi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ec(),fragmentShader:`
		...
		`,blending:ki,depthTest:!1,depthWrite:!1})}function Xh(){return new Zi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ec(),fragmentShader:`
		...
		`,blending:ki,depthTest:!1,depthWrite:!1})}function Ec(){return`
	...
	`}function S0(s){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Gl||l===Vl,h=l===Ar||l===Rr;if(c||h){let u=t.get(a);const d=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return e===null&&(e=new Gh(s)),u=c?e.fromEquirectangular(a,u):e.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),u.texture;if(u!==void 0)return u.texture;{const f=a.image;return c&&f&&f.height>0||h&&f&&i(f)?(e===null&&(e=new Gh(s)),u=c?e.fromEquirectangular(a):e.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function i(a){let l=0;const c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function M0(s){const t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return t[n]=i,i}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const i=e(n);return i===null&&xc("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function E0(s,t,e,n){const i={},r=new WeakMap;function o(u){const d=u.target;d.index!==null&&t.remove(d.index);for(const g in d.attributes)t.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let m=0,p=_.length;m<p;m++)t.remove(_[m])}d.removeEventListener("dispose",o),delete i[d.id];const f=r.get(d);f&&(t.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function a(u,d){return i[d.id]===!0||(d.addEventListener("dispose",o),i[d.id]=!0,e.memory.geometries++),d}function l(u){const d=u.attributes;for(const g in d)t.update(d[g],s.ARRAY_BUFFER);const f=u.morphAttributes;for(const g in f){const _=f[g];for(let m=0,p=_.length;m<p;m++)t.update(_[m],s.ARRAY_BUFFER)}}function c(u){const d=[],f=u.index,g=u.attributes.position;let _=0;if(f!==null){const w=f.array;_=f.version;for(let x=0,M=w.length;x<M;x+=3){const U=w[x+0],A=w[x+1],T=w[x+2];d.push(U,A,A,T,T,U)}}else if(g!==void 0){const w=g.array;_=g.version;for(let x=0,M=w.length/3-1;x<M;x+=3){const U=x+0,A=x+1,T=x+2;d.push(U,A,A,T,T,U)}}else return;const m=new(ju(d)?sd:id)(d,1);m.version=_;const p=r.get(u);p&&t.remove(p),r.set(u,m)}function h(u){const d=r.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&c(u)}else c(u);return r.get(u)}return{get:a,update:l,getWireframeAttribute:h}}function w0(s,t,e){let n;function i(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function l(d,f){s.drawElements(n,f,r,d*o),e.update(f,n,1)}function c(d,f,g){g!==0&&(s.drawElementsInstanced(n,f,r,d*o,g),e.update(f,n,g))}function h(d,f,g){if(g===0)return;const _=t.get("WEBGL_multi_draw");if(_===null)for(let m=0;m<g;m++)this.render(d[m]/o,f[m]);else{_.multiDrawElementsWEBGL(n,f,0,r,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];e.update(m,n,1)}}function u(d,f,g,_){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)c(d[p]/o,f[p],_[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,_,0,g);let p=0;for(let w=0;w<g;w++)p+=f[w];for(let w=0;w<_.length;w++)e.update(p,n,_[w])}}this.setMode=i,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function b0(s){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case s.TRIANGLES:e.triangles+=a*(r/3);break;case s.LINES:e.lines+=a*(r/2);break;case s.LINE_STRIP:e.lines+=a*(r-1);break;case s.LINE_LOOP:e.lines+=a*r;break;case s.POINTS:e.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n}}function T0(s,t,e){const n=new WeakMap,i=new be;function r(o,a,l){const c=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(a);if(d===void 0||d.count!==u){let b=function(){T.dispose(),n.delete(a),a.removeEventListener("dispose",b)};d!==void 0&&d.texture.dispose();const f=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,_=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],p=a.morphAttributes.normal||[],w=a.morphAttributes.color||[];let x=0;f===!0&&(x=1),g===!0&&(x=2),_===!0&&(x=3);let M=a.attributes.position.count*x,U=1;M>t.maxTextureSize&&(U=Math.ceil(M/t.maxTextureSize),M=t.maxTextureSize);const A=new Float32Array(M*U*4*u),T=new td(A,M,U,u);T.type=zi,T.needsUpdate=!0;const O=x*4;for(let y=0;y<u;y++){const P=m[y],D=p[y],F=w[y],B=M*U*4*y;for(let j=0;j<P.count;j++){const V=j*O;f===!0&&(i.fromBufferAttribute(P,j),A[B+V+0]=i.x,A[B+V+1]=i.y,A[B+V+2]=i.z,A[B+V+3]=0),g===!0&&(i.fromBufferAttribute(D,j),A[B+V+4]=i.x,A[B+V+5]=i.y,A[B+V+6]=i.z,A[B+V+7]=0),_===!0&&(i.fromBufferAttribute(F,j),A[B+V+8]=i.x,A[B+V+9]=i.y,A[B+V+10]=i.z,A[B+V+11]=F.itemSize===4?i.w:1)}}d={count:u,texture:T,size:new yt(M,U)},n.set(a,d),a.addEventListener("dispose",b)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(s,"morphTexture",o.morphTexture,e);else{let f=0;for(let _=0;_<c.length;_++)f+=c[_];const g=a.morphTargetsRelative?1:1-f;l.getUniforms().setValue(s,"morphTargetBaseInfluence",g),l.getUniforms().setValue(s,"morphTargetInfluences",c)}l.getUniforms().setValue(s,"morphTargetsTexture",d.texture,e),l.getUniforms().setValue(s,"morphTargetsTextureSize",d.size)}return{update:r}}function A0(s,t,e,n){let i=new WeakMap;function r(l){const c=n.render.frame,h=l.geometry,u=t.get(l,h);if(i.get(u)!==c&&(t.update(u),i.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==c&&(e.update(l.instanceMatrix,s.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,s.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;i.get(d)!==c&&(d.update(),i.set(d,c))}return u}function o(){i=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:r,dispose:o}}class hd extends on{constructor(t,e,n,i,r,o,a,l,c,h=ir){if(h!==ir&&h!==Lr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===ir&&(n=Cr),n===void 0&&h===Lr&&(n=Pr),super(null,i,r,o,a,l,h,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:bn,this.minFilter=l!==void 0?l:bn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const ud=new on,dd=new hd(1,1);dd.compareFunction=Ju;const fd=new td,pd=new fp,md=new ad,Zh=[],Yh=[],qh=new Float32Array(16),$h=new Float32Array(9),Kh=new Float32Array(4);function Or(s,t,e){const n=s[0];if(n<=0||n>0)return s;const i=t*e;let r=Zh[i];if(r===void 0&&(r=new Float32Array(i),Zh[i]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,s[o].toArray(r,a)}return r}function ze(s,t){if(s.length!==t.length)return!1;for(let e=0,n=s.length;e<n;e++)if(s[e]!==t[e])return!1;return!0}function ke(s,t){for(let e=0,n=t.length;e<n;e++)s[e]=t[e]}function Wa(s,t){let e=Yh[t];e===void 0&&(e=new Int32Array(t),Yh[t]=e);for(let n=0;n!==t;++n)e[n]=s.allocateTextureUnit();return e}function R0(s,t){const e=this.cache;e[0]!==t&&(s.uniform1f(this.addr,t),e[0]=t)}function C0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(s.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ze(e,t))return;s.uniform2fv(this.addr,t),ke(e,t)}}function P0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(s.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(s.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(ze(e,t))return;s.uniform3fv(this.addr,t),ke(e,t)}}function L0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(s.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ze(e,t))return;s.uniform4fv(this.addr,t),ke(e,t)}}function I0(s,t){const e=this.cache,n=t.elements;if(n===void 0){if(ze(e,t))return;s.uniformMatrix2fv(this.addr,!1,t),ke(e,t)}else{if(ze(e,n))return;Kh.set(n),s.uniformMatrix2fv(this.addr,!1,Kh),ke(e,n)}}function D0(s,t){const e=this.cache,n=t.elements;if(n===void 0){if(ze(e,t))return;s.uniformMatrix3fv(this.addr,!1,t),ke(e,t)}else{if(ze(e,n))return;$h.set(n),s.uniformMatrix3fv(this.addr,!1,$h),ke(e,n)}}function N0(s,t){const e=this.cache,n=t.elements;if(n===void 0){if(ze(e,t))return;s.uniformMatrix4fv(this.addr,!1,t),ke(e,t)}else{if(ze(e,n))return;qh.set(n),s.uniformMatrix4fv(this.addr,!1,qh),ke(e,n)}}function U0(s,t){const e=this.cache;e[0]!==t&&(s.uniform1i(this.addr,t),e[0]=t)}function O0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(s.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ze(e,t))return;s.uniform2iv(this.addr,t),ke(e,t)}}function F0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(s.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ze(e,t))return;s.uniform3iv(this.addr,t),ke(e,t)}}function B0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(s.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ze(e,t))return;s.uniform4iv(this.addr,t),ke(e,t)}}function z0(s,t){const e=this.cache;e[0]!==t&&(s.uniform1ui(this.addr,t),e[0]=t)}function k0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(s.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ze(e,t))return;s.uniform2uiv(this.addr,t),ke(e,t)}}function H0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(s.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ze(e,t))return;s.uniform3uiv(this.addr,t),ke(e,t)}}function G0(s,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(s.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ze(e,t))return;s.uniform4uiv(this.addr,t),ke(e,t)}}function V0(s,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);const r=this.type===s.SAMPLER_2D_SHADOW?dd:ud;e.setTexture2D(t||r,i)}function W0(s,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||pd,i)}function X0(s,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||md,i)}function Z0(s,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||fd,i)}function Y0(s){switch(s){case 5126:return R0;case 35664:return C0;case 35665:return P0;case 35666:return L0;case 35674:return I0;case 35675:return D0;case 35676:return N0;case 5124:case 35670:return U0;case 35667:case 35671:return O0;case 35668:case 35672:return F0;case 35669:case 35673:return B0;case 5125:return z0;case 36294:return k0;case 36295:return H0;case 36296:return G0;case 35678:case 36198:case 36298:case 36306:case 35682:return V0;case 35679:case 36299:case 36307:return W0;case 35680:case 36300:case 36308:case 36293:return X0;case 36289:case 36303:case 36311:case 36292:return Z0}}function q0(s,t){s.uniform1fv(this.addr,t)}function $0(s,t){const e=Or(t,this.size,2);s.uniform2fv(this.addr,e)}function K0(s,t){const e=Or(t,this.size,3);s.uniform3fv(this.addr,e)}function J0(s,t){const e=Or(t,this.size,4);s.uniform4fv(this.addr,e)}function j0(s,t){const e=Or(t,this.size,4);s.uniformMatrix2fv(this.addr,!1,e)}function Q0(s,t){const e=Or(t,this.size,9);s.uniformMatrix3fv(this.addr,!1,e)}function t_(s,t){const e=Or(t,this.size,16);s.uniformMatrix4fv(this.addr,!1,e)}function e_(s,t){s.uniform1iv(this.addr,t)}function n_(s,t){s.uniform2iv(this.addr,t)}function i_(s,t){s.uniform3iv(this.addr,t)}function s_(s,t){s.uniform4iv(this.addr,t)}function r_(s,t){s.uniform1uiv(this.addr,t)}function o_(s,t){s.uniform2uiv(this.addr,t)}function a_(s,t){s.uniform3uiv(this.addr,t)}function l_(s,t){s.uniform4uiv(this.addr,t)}function c_(s,t,e){const n=this.cache,i=t.length,r=Wa(e,i);ze(n,r)||(s.uniform1iv(this.addr,r),ke(n,r));for(let o=0;o!==i;++o)e.setTexture2D(t[o]||ud,r[o])}function h_(s,t,e){const n=this.cache,i=t.length,r=Wa(e,i);ze(n,r)||(s.uniform1iv(this.addr,r),ke(n,r));for(let o=0;o!==i;++o)e.setTexture3D(t[o]||pd,r[o])}function u_(s,t,e){const n=this.cache,i=t.length,r=Wa(e,i);ze(n,r)||(s.uniform1iv(this.addr,r),ke(n,r));for(let o=0;o!==i;++o)e.setTextureCube(t[o]||md,r[o])}function d_(s,t,e){const n=this.cache,i=t.length,r=Wa(e,i);ze(n,r)||(s.uniform1iv(this.addr,r),ke(n,r));for(let o=0;o!==i;++o)e.setTexture2DArray(t[o]||fd,r[o])}function f_(s){switch(s){case 5126:return q0;case 35664:return $0;case 35665:return K0;case 35666:return J0;case 35674:return j0;case 35675:return Q0;case 35676:return t_;case 5124:case 35670:return e_;case 35667:case 35671:return n_;case 35668:case 35672:return i_;case 35669:case 35673:return s_;case 5125:return r_;case 36294:return o_;case 36295:return a_;case 36296:return l_;case 35678:case 36198:case 36298:case 36306:case 35682:return c_;case 35679:case 36299:case 36307:return h_;case 35680:case 36300:case 36308:case 36293:return u_;case 36289:case 36303:case 36311:case 36292:return d_}}class p_{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Y0(e.type)}}class m_{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=f_(e.type)}}class g_{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let r=0,o=i.length;r!==o;++r){const a=i[r];a.setValue(t,e[a.id],n)}}}const Rl=/(\w+)(\])?(\[|\.)?/g;function Jh(s,t){s.seq.push(t),s.map[t.id]=t}function __(s,t,e){const n=s.name,i=n.length;for(Rl.lastIndex=0;;){const r=Rl.exec(n),o=Rl.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===i){Jh(e,c===void 0?new p_(a,s,t):new m_(a,s,t));break}else{let u=e.map[a];u===void 0&&(u=new g_(a),Jh(e,u)),e=u}}}class Ma{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=t.getActiveUniform(e,i),o=t.getUniformLocation(e,r.name);__(r,o,this)}}setValue(t,e,n,i){const r=this.map[e];r!==void 0&&r.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let r=0,o=e.length;r!==o;++r){const a=e[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(t,l.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,r=t.length;i!==r;++i){const o=t[i];o.id in e&&n.push(o)}return n}}function jh(s,t,e){const n=s.createShader(t);return s.shaderSource(n,e),s.compileShader(n),n}const v_=37297;let x_=0;function y_(s,t){const e=s.split(`
`),n=[],i=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=i;o<r;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}function S_(s){const t=he.getPrimaries(he.workingColorSpace),e=he.getPrimaries(s);let n;switch(t===e?n="":t===Ca&&e===Ra?n="LinearDisplayP3ToLinearSRGB":t===Ra&&e===Ca&&(n="LinearSRGBToLinearDisplayP3"),s){case Ki:case Va:return[n,"LinearTransferOETF"];case kn:case vc:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",s),[n,"LinearTransferOETF"]}}function Qh(s,t,e){const n=s.getShaderParameter(t,s.COMPILE_STATUS),i=s.getShaderInfoLog(t).trim();if(n&&i==="")return"";const r=/ERROR: 0:(\d+)/.exec(i);if(r){const o=parseInt(r[1]);return e.toUpperCase()+`

`+i+`

`+y_(s.getShaderSource(t),o)}else return i}function M_(s,t){const e=S_(t);return`vec4 ${s}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function E_(s,t){let e;switch(t){case If:e="Linear";break;case Df:e="Reinhard";break;case Nf:e="OptimizedCineon";break;case Gu:e="ACESFilmic";break;case Of:e="AgX";break;case Ff:e="Neutral";break;case Uf:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+s+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function w_(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Kr).join(`
`)}function b_(s){const t=[];for(const e in s){const n=s[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function T_(s,t){const e={},n=s.getProgramParameter(t,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(t,i),o=r.name;let a=1;r.type===s.FLOAT_MAT2&&(a=2),r.type===s.FLOAT_MAT3&&(a=3),r.type===s.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:s.getAttribLocation(t,o),locationSize:a}}return e}function Kr(s){return s!==""}function tu(s,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function eu(s,t){return s.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const A_=/^[ \t]*#include +<([\w\d./]+)>/gm;function ql(s){return s.replace(A_,C_)}const R_=new Map;function C_(s,t){let e=qt[t];if(e===void 0){const n=R_.get(t);if(n!==void 0)e=qt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return ql(e)}const P_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function nu(s){return s.replace(P_,L_)}function L_(s,t,e,n){let i="";for(let r=parseInt(t);r<parseInt(e);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function iu(s){let t=`precision ${s.precision} float;
...
#define LOW_PRECISION`),t}function I_(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===zu?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===ku?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===ii&&(t="SHADOWMAP_TYPE_VSM"),t}function D_(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Ar:case Rr:t="ENVMAP_TYPE_CUBE";break;case Ha:t="ENVMAP_TYPE_CUBE_UV";break}return t}function N_(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Rr:t="ENVMAP_MODE_REFRACTION";break}return t}function U_(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Hu:t="ENVMAP_BLENDING_MULTIPLY";break;case Pf:t="ENVMAP_BLENDING_MIX";break;case Lf:t="ENVMAP_BLENDING_ADD";break}return t}function O_(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function F_(s,t,e,n){const i=s.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=I_(e),c=D_(e),h=N_(e),u=U_(e),d=O_(e),f=w_(e),g=b_(r),_=i.createProgram();let m,p,w=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
    ...
    `,t}_render(){const t=this._el.querySelector("#pp-list"),e=this._el.querySelector("#pp-count");if(!t)return;const n=1+this._peers.size;e.textContent=n;const i=[];i.push(this._row({username:this._self.username||"You",presetId:this._self.presetId,zone:this._self.zone,status:this._self.status,isSelf:!0}));const r=[...this._peers.entries()].sort((o,a)=>{const l=o[1].zone,c=a[1].zone;return l!==c?l.localeCompare(c):o[1].username.localeCompare(a[1].username)});r.forEach(([o,a])=>{i.push(this._row({username:a.username,presetId:a.presetId,zone:a.zone,status:a.status,isSelf:!1,onClick:()=>{var l;return(l=this._onNavigate)==null?void 0:l.call(this,{x:a.x,z:a.z})}}))}),t.innerHTML=i.join(""),t.querySelectorAll(".pp-row[data-idx]").forEach(o=>{const a=parseInt(o.dataset.idx,10),l=r[a];l&&o.addEventListener("click",()=>{var c;return(c=this._onNavigate)==null?void 0:c.call(this,{x:l[1].x,z:l[1].z})})})}_row({username:t,presetId:e,zone:n,status:i="available",isSelf:r,onClick:o}){const l="#"+(vs[e]??vs[0]).outfit.toString(16).padStart(6,"0"),c=Lu[i]??Lu.available,h=Hx[n]??"#888",u=Gx[n]??n;return`
      <div class="pp-row ${r?"pp-self":"pp-peer"}"
        ...
        <span class="pp-name">${Wx(t)}${r?' <span class="pp-you">(you)</span>':""}</span>
        <span class="pp-zone" style="color:${h}">${u}</span>
        ${r?"":'<span class="pp-go" title="Walk to this person">→</span>'}
      </div>
    `}}function Wx(s){return s.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var hs,oo,us,ds,or,ao,lo,co,Dr,Ud,Od;class Xx{constructor(){tt(this,Dr);tt(this,hs,null);tt(this,oo,"");tt(this,us,new Map);tt(this,ds,!1);tt(this,or,!1);tt(this,ao,[]);tt(this,lo,0);tt(this,co,null)}onOpen(t){st(this,co,t)}async connect(t){return st(this,oo,t),new Promise((e,n)=>{const i=new WebSocket(t);st(this,hs,i);const r=setTimeout(()=>n(new Error("xpacenode connect timeout")),1e4);i.onopen=()=>{var a;clearTimeout(r),st(this,ds,!0),st(this,lo,0),v(this,ao).splice(0).forEach(l=>i.send(l)),(a=v(this,co))==null||a.call(this),e()},i.onmessage=({data:o})=>{try{const a=JSON.parse(o);ht(this,Dr,Ud).call(this,a)}catch{}},i.onerror=o=>{clearTimeout(r),n(o)},i.onclose=()=>{st(this,ds,!1),ht(this,Dr,Od).call(this)}})}send(t){var n;const e=JSON.stringify(t);v(this,ds)&&((n=v(this,hs))==null?void 0:n.readyState)===WebSocket.OPEN?v(this,hs).send(e):v(this,ao).push(e)}on(t,e){v(this,us).has(t)||v(this,us).set(t,[]),v(this,us).get(t).push(e)}close(){var t;st(this,or,!0),st(this,ds,!1),(t=v(this,hs))==null||t.close()}}hs=new WeakMap,oo=new WeakMap,us=new WeakMap,ds=new WeakMap,or=new WeakMap,ao=new WeakMap,lo=new WeakMap,co=new WeakMap,Dr=new WeakSet,Ud=function(t){const e=v(this,us).get(t.t);e==null||e.forEach(n=>n(t))},Od=function(){if(v(this,or))return;const t=Math.min(1e3*2**ys(this,lo)._++,3e4);console.warn(`[xpacesync] xpacenode disconnected — reconnecting in ${t}ms`),setTimeout(()=>{v(this,or)||this.connect(v(this,oo)).catch(()=>{})},t)};var xe,li,ar,fs,lr,ho,uo,fo,cr,po,qi,ec,nc;class Zx extends EventTarget{constructor(e,n=[]){super();tt(this,qi);tt(this,xe);tt(this,li,null);tt(this,ar,!1);tt(this,fs,!1);tt(this,lr,!1);tt(this,ho,null);tt(this,uo,null);tt(this,fo,[]);tt(this,cr,!1);tt(this,po,async()=>{if(!v(this,fs)&&v(this,xe).signalingState==="stable")try{st(this,fs,!0),await v(this,xe).setLocalDescription(),this.dispatchEvent(new CustomEvent("signal",{detail:{type:"offer",sdp:v(this,xe).localDescription.sdp}}))}catch(e){console.warn("[RTCPeer] negotiate error",e)}finally{st(this,fs,!1)}});st(this,ar,e),st(this,xe,new RTCPeerConnection({iceServers:n})),e||(st(this,li,v(this,xe).createDataChannel("xpacesync",{ordered:!0})),ht(this,qi,ec).call(this,v(this,li))),v(this,xe).ondatachannel=({channel:i})=>{st(this,li,i),ht(this,qi,ec).call(this,i)},v(this,xe).onicecandidate=({candidate:i})=>{i&&this.dispatchEvent(new CustomEvent("signal",{detail:{type:"ice",candidate:i.toJSON()}}))},v(this,xe).onnegotiationneeded=v(this,po),v(this,xe).ontrack=({track:i,streams:r})=>{var a;const o=r[0]??new MediaStream([i]);(a=v(this,uo))==null||a.call(this,i,o)},v(this,xe).onconnectionstatechange=()=>{v(this,xe).connectionState==="failed"&&this.dispatchEvent(new CustomEvent("failed"))}}async handleSignal({type:e,sdp:n,candidate:i}){try{if(e==="offer"){const r=v(this,xe).signalingState==="have-local-offer",o=v(this,fs)||r;if(st(this,lr,!v(this,ar)&&o),v(this,lr))return;await v(this,xe).setRemoteDescription({type:"offer",sdp:n}),st(this,cr,!0),await v(this,xe).setLocalDescription(),this.dispatchEvent(new CustomEvent("signal",{detail:{type:"answer",sdp:v(this,xe).localDescription.sdp}})),await ht(this,qi,nc).call(this),v(this,ar)&&r&&setTimeout(v(this,po),200)}else if(e==="answer")v(this,xe).signalingState==="have-local-offer"&&(await v(this,xe).setRemoteDescription({type:"answer",sdp:n}),st(this,cr,!0),await ht(this,qi,nc).call(this));else if(e==="ice")if(!v(this,cr))v(this,fo).push(i);else try{await v(this,xe).addIceCandidate(i)}catch(r){v(this,lr)||console.warn("[RTCPeer] addIceCandidate",r)}}catch(r){console.warn("[RTCPeer] handleSignal",e,r)}}send(e){var n;((n=v(this,li))==null?void 0:n.readyState)==="open"&&v(this,li).send(JSON.stringify(e))}addTrack(e,n){try{v(this,xe).addTrack(e,n)}catch{}}onMessage(e){st(this,ho,e)}onTrack(e){st(this,uo,e)}get pc(){return v(this,xe)}get connected(){var e;return((e=v(this,li))==null?void 0:e.readyState)==="open"}close(){try{v(this,xe).close()}catch{}}}xe=new WeakMap,li=new WeakMap,ar=new WeakMap,fs=new WeakMap,lr=new WeakMap,ho=new WeakMap,uo=new WeakMap,fo=new WeakMap,cr=new WeakMap,po=new WeakMap,qi=new WeakSet,ec=function(e){e.onopen=()=>this.dispatchEvent(new CustomEvent("open")),e.onclose=()=>this.dispatchEvent(new CustomEvent("close")),e.onmessage=({data:n})=>{var i;try{(i=v(this,ho))==null||i.call(this,JSON.parse(n))}catch{}}},nc=async function(){const e=v(this,fo).splice(0);for(const n of e)try{await v(this,xe).addIceCandidate(n)}catch{}};const Yx=[{urls:"stun:stun.l.google.com:19302"},{urls:"stun:stun1.l.google.com:19302"}];var tn,en,ci,hi,mo,hr,go,ur,_o,vo,xo,Tn,Fd,ic,Bd,sc;class qx extends EventTarget{constructor({selfId:e,iceServers:n,introPayload:i}={}){super();tt(this,Tn);tt(this,tn,null);tt(this,en,new Map);tt(this,ci,"");tt(this,hi,"");tt(this,mo,"");tt(this,hr,Yx);tt(this,go,null);tt(this,ur,null);tt(this,_o,[]);tt(this,vo,null);tt(this,xo,!1);if(!e)throw new Error("PeerMesh requires selfId");st(this,ci,e),n&&(st(this,hr,n),st(this,xo,!0)),st(this,ur,i??(()=>({})))}get selfId(){return v(this,ci)}get roomId(){return v(this,hi)}get nodeUrl(){return v(this,mo)}get peerIds(){return[...v(this,en).entries()].filter(([,e])=>e.peer.connected).map(([e])=>e)}async join(e,n){st(this,hi,n),st(this,mo,e),st(this,tn,new Xx),v(this,tn).onOpen(()=>ht(this,Tn,Bd).call(this)),v(this,tn).on("welcome",i=>{v(this,xo)||Array.isArray(i.iceServers)&&i.iceServers.length>0&&st(this,hr,i.iceServers)}),v(this,tn).on("peer_join",async i=>{const{peerId:r,t:o,roomId:a,...l}=i;r!==v(this,ci)&&(this.dispatchEvent(new CustomEvent("peer:join",{detail:{peerId:r,announced:l}})),await ht(this,Tn,sc).call(this,r))}),v(this,tn).on("peer_leave",i=>ht(this,Tn,ic).call(this,i.peerId)),v(this,tn).on("signal",async i=>{var a;const{from:r,payload:o}=i;!r||!o||(await ht(this,Tn,sc).call(this,r),await((a=v(this,en).get(r))==null?void 0:a.peer.handleSignal(o)))}),await v(this,tn).connect(e),st(this,go,setInterval(()=>{v(this,tn).send({t:"hb",roomId:v(this,hi)})},3e4))}leave(){var e,n;clearInterval(v(this,go)),(e=v(this,tn))==null||e.send({t:"leave",roomId:v(this,hi)}),(n=v(this,tn))==null||n.close();for(const{peer:i}of v(this,en).values())i.close();v(this,en).clear(),st(this,tn,null)}send(e,n){const i=v(this,en).get(e);return i!=null&&i.peer.connected?(i.peer.send(n),!0):!1}getPeerConnections(){const e={};for(const[n,{peer:i}]of v(this,en))e[n]=i.pc;return e}broadcast(e){for(const{peer:n}of v(this,en).values())n.send(e)}addTrack(e,n){v(this,_o).push({track:e,stream:n});for(const{peer:i}of v(this,en).values())i.addTrack(e,n)}onTrack(e){st(this,vo,e)}}tn=new WeakMap,en=new WeakMap,ci=new WeakMap,hi=new WeakMap,mo=new WeakMap,hr=new WeakMap,go=new WeakMap,ur=new WeakMap,_o=new WeakMap,vo=new WeakMap,xo=new WeakMap,Tn=new WeakSet,Fd=async function(e,n){const i=new Zx(n,v(this,hr)),r={peer:i,hasBeenOpen:!1};v(this,en).set(e,r),i.addEventListener("signal",({detail:o})=>{var a;(a=v(this,tn))==null||a.send({t:"signal",roomId:v(this,hi),to:e,payload:o})}),i.onMessage(o=>{if((o==null?void 0:o.__xpacesync)==="intro"){const{__xpacesync:a,from:l,...c}=o;this.dispatchEvent(new CustomEvent("peer:intro",{detail:{peerId:e,announced:c}}));return}this.dispatchEvent(new CustomEvent("message",{detail:{from:e,payload:o}}))}),i.onTrack((o,a)=>{var l;return(l=v(this,vo))==null?void 0:l.call(this,o,a,e)}),i.addEventListener("open",()=>{r.hasBeenOpen=!0,i.send({__xpacesync:"intro",from:v(this,ci),...v(this,ur).call(this)}),this.dispatchEvent(new CustomEvent("peer:open",{detail:{peerId:e}}))}),i.addEventListener("failed",()=>ht(this,Tn,ic).call(this,e));for(const{track:o,stream:a}of v(this,_o))i.addTrack(o,a);return i},ic=function(e){const n=v(this,en).get(e);n&&(n.peer.close(),v(this,en).delete(e),this.dispatchEvent(new CustomEvent("peer:leave",{detail:{peerId:e}})))},Bd=function(){v(this,tn).send({t:"hello",roomId:v(this,hi),peerId:v(this,ci),...v(this,ur).call(this)})},sc=async function(e){const n=v(this,en).get(e);if(n){if(!(n.hasBeenOpen&&!n.peer.connected))return;n.peer.close(),v(this,en).delete(e)}const i=v(this,ci)<e;await ht(this,Tn,Fd).call(this,e,i)};const Iu=Object.freeze({persist:!1,transport:"mesh",queueOnFail:!1});var ps;class zd{constructor(){tt(this,ps,new Map)}register(t,e={}){if(!t)throw new Error("MessageRegistry.register requires a type name");return v(this,ps).set(t,{...Iu,...e}),this}get(t){return v(this,ps).get(t)??Iu}has(t){return v(this,ps).has(t)}types(){return[...v(this,ps).keys()]}}ps=new WeakMap;const $x="xpacesync",Kx=1,Pi="messages";function Jx(s){return new Promise((t,e)=>{const n=indexedDB.open(s,Kx);n.onupgradeneeded=()=>{const i=n.result;i.objectStoreNames.contains(Pi)||i.createObjectStore(Pi,{keyPath:"id",autoIncrement:!0}).createIndex("by_room_type",["roomId","type"])},n.onsuccess=()=>t(n.result),n.onerror=()=>e(n.error)})}var yo,So,dr,Ea;class jx{constructor({dbName:t=$x}={}){tt(this,dr);tt(this,yo,null);tt(this,So);st(this,So,t)}async append(t,e,n){const i=await ht(this,dr,Ea).call(this);return new Promise((r,o)=>{const a=i.transaction(Pi,"readwrite");a.objectStore(Pi).add({roomId:t,type:e,entry:n,ts:Date.now()}),a.oncomplete=()=>r(),a.onerror=()=>o(a.error)})}async replay(t,e,{since:n=0}={}){const i=await ht(this,dr,Ea).call(this);return new Promise((r,o)=>{const c=i.transaction(Pi,"readonly").objectStore(Pi).index("by_room_type"),h=IDBKeyRange.only([t,e]),u=[],d=c.openCursor(h);d.onsuccess=()=>{const f=d.result;if(!f)return r(u);f.value.ts>n&&u.push(f.value.entry),f.continue()},d.onerror=()=>o(d.error)})}async clearRoom(t){const e=await ht(this,dr,Ea).call(this);return new Promise((n,i)=>{const a=e.transaction(Pi,"readwrite").objectStore(Pi).openCursor();a.onsuccess=()=>{const l=a.result;if(!l)return n();l.value.roomId===t&&l.delete(),l.continue()},a.onerror=()=>i(a.error)})}}yo=new WeakMap,So=new WeakMap,dr=new WeakSet,Ea=function(){return v(this,yo)??st(this,yo,Jx(v(this,So))),v(this,yo)};const Qx="xpacesync-outbound",ty=1,Li="queued",ey=24*60*60*1e3;function ny(s){return new Promise((t,e)=>{const n=indexedDB.open(s,ty);n.onupgradeneeded=()=>{const i=n.result;i.objectStoreNames.contains(Li)||i.createObjectStore(Li,{keyPath:"id",autoIncrement:!0}).createIndex("by_room","roomId")},n.onsuccess=()=>t(n.result),n.onerror=()=>e(n.error)})}var Mo,Eo,wo,vi,wa,rc;class iy{constructor({dbName:t=Qx,maxAgeMs:e=ey}={}){tt(this,vi);tt(this,Mo,null);tt(this,Eo);tt(this,wo);st(this,Eo,t),st(this,wo,e)}async enqueue(t,e){const n=await ht(this,vi,wa).call(this);await new Promise((i,r)=>{const o=n.transaction(Li,"readwrite");o.objectStore(Li).add({roomId:t,message:e,ts:Date.now()}),o.oncomplete=()=>i(),o.onerror=()=>r(o.error)}),await ht(this,vi,rc).call(this,t)}async peek(t){await ht(this,vi,rc).call(this,t);const e=await ht(this,vi,wa).call(this);return new Promise((n,i)=>{const a=e.transaction(Li,"readonly").objectStore(Li).index("by_room").getAll(IDBKeyRange.only(t));a.onsuccess=()=>n(a.result.map(l=>l.message)),a.onerror=()=>i(a.error)})}}Mo=new WeakMap,Eo=new WeakMap,wo=new WeakMap,vi=new WeakSet,wa=function(){return v(this,Mo)??st(this,Mo,ny(v(this,Eo))),v(this,Mo)},rc=async function(t){const e=await ht(this,vi,wa).call(this),n=Date.now()-v(this,wo);return new Promise((i,r)=>{const l=e.transaction(Li,"readwrite").objectStore(Li).index("by_room").openCursor(IDBKeyRange.only(t));l.onsuccess=()=>{const c=l.result;if(!c)return i();c.value.ts<n&&c.delete(),c.continue()},l.onerror=()=>r(l.error)})};var Be,Ni,Ui,fr,ui,Oa,kd;class sy{constructor(t,{registry:e,log:n,queue:i}={}){tt(this,Oa);tt(this,Be);tt(this,Ni);tt(this,Ui);tt(this,fr);tt(this,ui,new Map);st(this,Be,t),st(this,Ni,e??new zd),st(this,Ui,n??new jx),st(this,fr,i??new iy),v(this,Be).addEventListener("message",({detail:r})=>{const{from:o,payload:a}=r;ht(this,Oa,kd).call(this,o,a)}),v(this,Be).addEventListener("peer:open",({detail:{peerId:r}})=>{v(this,fr).peek(v(this,Be).roomId).then(o=>{for(const a of o)v(this,Be).send(r,a)})})}get registry(){return v(this,Ni)}get mesh(){return v(this,Be)}send(t,e){const n=v(this,Ni).get(t),i={type:t,payload:e,meta:{from:v(this,Be).selfId,ts:Date.now()}};return v(this,Be).broadcast(i),n.persist&&v(this,Ui).append(v(this,Be).roomId,t,i),n.queueOnFail&&v(this,Be).peerIds.length===0&&v(this,fr).enqueue(v(this,Be).roomId,i),i}sendTo(t,e,n){const i=v(this,Ni).get(e),r={type:e,payload:n,meta:{from:v(this,Be).selfId,ts:Date.now()}};return v(this,Be).send(t,r),i.persist&&v(this,Ui).append(v(this,Be).roomId,e,r),r}on(t,e){return v(this,ui).has(t)||v(this,ui).set(t,[]),v(this,ui).get(t).push(e),()=>{v(this,ui).set(t,v(this,ui).get(t).filter(n=>n!==e))}}async history(t,e){return v(this,Ui).replay(v(this,Be).roomId,t,e)}}Be=new WeakMap,Ni=new WeakMap,Ui=new WeakMap,fr=new WeakMap,ui=new WeakMap,Oa=new WeakSet,kd=function(t,e){var a;const{type:n,payload:i,meta:r}=e??{};if(!n)return;v(this,Ni).get(n).persist&&v(this,Ui).append(v(this,Be).roomId,n,e),(a=v(this,ui).get(n))==null||a.forEach(l=>l({from:t,payload:i,meta:r}))};const oc="sw_id_v1",ac=s=>Array.from(s).map(t=>t.toString(16).padStart(2,"0")).join(""),Du=s=>{const t=s.replace(/-/g,"+").replace(/_/g,"/"),e=atob(t);return Uint8Array.from(e,n=>n.charCodeAt(0))};class Nu{constructor(t,e,n,i){this.peerId=t,this.displayName=e,this.isNew=i,this._priv=n}get shortId(){return this.peerId.slice(-8)}setName(t){this.displayName=t,Hd()}async sign(t){const e=new TextEncoder().encode(t),n=await crypto.subtle.sign({name:"Ed25519"},this._priv,e);return ac(new Uint8Array(n))}}let oi=null,to=null;function Hd(){if(!(!oi||!to))try{localStorage.setItem(oc,JSON.stringify({privJwk:to,displayName:oi.displayName}))}catch{}}async function ry(){if(oi)return oi;const s=localStorage.getItem(oc);if(s)try{const{privJwk:n,displayName:i}=JSON.parse(s),r=await crypto.subtle.importKey("jwk",n,{name:"Ed25519"},!1,["sign"]),o=ac(Du(n.x));return to=n,oi=new Nu(o,i||"",r,!1),oi}catch{localStorage.removeItem(oc)}const t=await crypto.subtle.generateKey({name:"Ed25519"},!0,["sign","verify"]);to=await crypto.subtle.exportKey("jwk",t.privateKey);const e=ac(Du(to.x));return oi=new Nu(e,"",t.privateKey,!0),Hd(),oi}function Uc(){return oi}const lc="xn_",Gd="xn_known_peers";async function Vd(s){const t=new TextEncoder().encode(s),e=await crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(e)).map(n=>n.toString(16).padStart(2,"0")).join("")}async function eo(s,t=""){return Vd(s.toLowerCase().trim()+":"+t.trim())}function oy(s){return btoa(s).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"")}function ay(s){const t=s.length%4,e=t?s+"=".repeat(4-t):s;return atob(e.replace(/-/g,"+").replace(/_/g,"/"))}async function Oc({roomId:s,lockCode:t="",node:e}={}){if(!(s!=null&&s.trim()))throw new Error("roomId is required");const n=await eo(s,t),i=Zd(n),r={r:s.trim(),h:n};e&&(r.n=e),i.length&&(r.p=i.slice(0,8));const o=oy(JSON.stringify(r));return{link:`${window.location.origin+window.location.pathname}#${lc}${o}`,roomHash:n}}async function Wd(){const s=window.location.hash.slice(1);if(s.startsWith(lc))try{const e=JSON.parse(ay(s.slice(lc.length))),n=e.r||"main",i=e.h||await eo(n);return{type:"link",roomId:n,roomHash:i,node:e.n||null,peers:e.p||[]}}catch{console.warn("[roomLink] failed to decode link — falling back to main")}if(s){const e=s.trim().toLowerCase(),n=await eo(e);return{type:"plain",roomId:e,roomHash:n,node:null,peers:[]}}return{type:"default",roomId:"main",roomHash:await eo("main"),node:null,peers:[]}}function Fc(){try{return JSON.parse(localStorage.getItem(Gd)||"{}")}catch{return{}}}function Xd(s){try{localStorage.setItem(Gd,JSON.stringify(s))}catch{}}function Zd(s){return Fc()[s]||[]}function Bc(s,t){const e=Fc(),n=e[s]||[];n.includes(t)||(n.unshift(t),n.length>20&&(n.length=20),e[s]=n,Xd(e))}function ly(s,t){const e=Fc(),n=e[s];if(!n)return;const i=n.indexOf(t);i!==-1&&(n.splice(i,1),e[s]=n,Xd(e))}function Yd(s){const t=s.trim().toLowerCase().replace(/[^a-z0-9-]/g,"-").replace(/-{2,}/g,"-").replace(/^-+|-+$/g,"")||"main";window.location.hash=t}const cc=Object.freeze(Object.defineProperty({__proto__:null,createRoomLink:Oc,deriveRoomHash:eo,forgetPeer:ly,getKnownPeers:Zd,parseCurrentLink:Wd,recordPeer:Bc,setRoomNameInUrl:Yd,sha256hex:Vd},Symbol.toStringTag,{value:"Module"}));var ms,gs,Oi;class cy extends EventTarget{constructor(){super(...arguments);tt(this,ms,[]);tt(this,gs,null);tt(this,Oi,!1)}push(e,n="pending",i=""){const r=`s${Date.now()}-${Math.random().toString(36).slice(2,6)}`,o={id:r,text:e,status:n,detail:i,ts:Date.now()};return v(this,ms).push(o),this.dispatchEvent(new CustomEvent("step",{detail:{...o,action:"add"}})),r}update(e,n,i=""){const r=v(this,ms).find(o=>o.id===e);r&&(r.status=n,i!==""&&(r.detail=i),this.dispatchEvent(new CustomEvent("step",{detail:{...r,action:"update"}})))}ok(e,n=""){this.update(e,"ok",n)}fail(e,n=""){this.update(e,"fail",n)}warn(e,n=""){this.update(e,"warn",n)}info(e,n=""){return this.push(e,"info",n)}startFirstTimer(e=12e3){st(this,Oi,!1),clearTimeout(v(this,gs)),st(this,gs,setTimeout(()=>{v(this,Oi)||(this.push("You're the first here — your device is the anchor","host","Share your invite link to let others find you"),this.dispatchEvent(new CustomEvent("first-in-room")))},e))}peerJoined(e){st(this,Oi,!0),clearTimeout(v(this,gs)),this.info(`${e||"Someone"} joined`)}get steps(){return[...v(this,ms)]}get hasHost(){return v(this,Oi)===!1}clear(){st(this,ms,[]),clearTimeout(v(this,gs)),st(this,Oi,!1),this.dispatchEvent(new CustomEvent("clear"))}}ms=new WeakMap,gs=new WeakMap,Oi=new WeakMap;const ce=new cy,Uu=6e4,hy=20;var Ye,In,Xn,hc,Jr;class uy extends EventTarget{constructor(){super(...arguments);tt(this,Xn);tt(this,Ye,new Map);tt(this,In,new Map)}get hotSize(){return v(this,Ye).size}getPeer(e){return v(this,Ye).get(e)}getSnapshot(){const e={};for(const[n,i]of v(this,Ye)){const{ttlTimer:r,...o}=i;e[n]=o}return e}upsertPeer(e,n){const i=v(this,Ye).get(e),r=n.v??0,o=(i==null?void 0:i.v)??-1;if(r<=o)return!1;i!=null&&i.ttlTimer&&clearTimeout(i.ttlTimer);const a=setTimeout(()=>ht(this,Xn,hc).call(this,e),Uu),l={username:"",presetId:0,status:"available",pos:void 0,...i??{},...n,peerId:e,v:r,ttlTimer:a};return v(this,Ye).set(e,l),ht(this,Xn,Jr).call(this,"peer:updated",{peerId:e,entry:l}),!0}patchPeer(e,n){const i=v(this,Ye).get(e);i&&Object.assign(i,n)}updatePos(e,n){const i=v(this,Ye).get(e);i&&(i.pos=n)}heartbeat(e){const n=v(this,Ye).get(e);n&&(clearTimeout(n.ttlTimer),n.ttlTimer=setTimeout(()=>ht(this,Xn,hc).call(this,e),Uu))}removePeer(e){const n=v(this,Ye).get(e);n&&(clearTimeout(n.ttlTimer),v(this,Ye).delete(e),ht(this,Xn,Jr).call(this,"peer:removed",{peerId:e}))}clearHot(){for(const e of v(this,Ye).values())clearTimeout(e.ttlTimer);v(this,Ye).clear()}updateColdRoom(e,n){if(!v(this,In).has(e)&&v(this,In).size>=hy){const i=v(this,In).keys().next().value;v(this,In).delete(i)}v(this,In).set(e,{roomHash:e,peerCount:n,lastSeen:Date.now()}),ht(this,Xn,Jr).call(this,"cold:updated",{roomHash:e,peerCount:n})}pruneCold(e=6e5){const n=Date.now()-e;for(const[i,r]of v(this,In))r.lastSeen<n&&v(this,In).delete(i)}getColdRooms(){return[...v(this,In).values()]}}Ye=new WeakMap,In=new WeakMap,Xn=new WeakSet,hc=function(e){v(this,Ye).has(e)&&(v(this,Ye).delete(e),ht(this,Xn,Jr).call(this,"peer:expired",{peerId:e}))},Jr=function(e,n){this.dispatchEvent(new CustomEvent(e,{detail:n}))};const Fe=new uy,dy=50,fy=5;var Mn,pr,$i,uc,dc;class py{constructor(){tt(this,$i);tt(this,Mn,[]);tt(this,pr,!1)}schedule(t,e=""){v(this,Mn).length>=dy&&v(this,Mn).shift(),v(this,Mn).push({task:t,label:e}),ht(this,$i,uc).call(this)}get queueSize(){return v(this,Mn).length}clear(){v(this,Mn).length=0}}Mn=new WeakMap,pr=new WeakMap,$i=new WeakSet,uc=function(){v(this,pr)||v(this,Mn).length===0||(st(this,pr,!0),typeof requestIdleCallback=="function"?requestIdleCallback(t=>ht(this,$i,dc).call(this,t),{timeout:2e3}):setTimeout(()=>ht(this,$i,dc).call(this,null),100))},dc=function(t){for(st(this,pr,!1);v(this,Mn).length>0&&!(t&&!t.didTimeout&&t.timeRemaining()<fy);){const{task:e,label:n}=v(this,Mn).shift();try{e()}catch(i){console.warn(`[IdleScheduler] task "${n}" threw:`,i)}}v(this,Mn).length>0&&ht(this,$i,uc).call(this)};const fc=new py;function qd(s){if(s)return s;const t=new URLSearchParams(window.location.search).get("node");return t||"wss://xpacenode.spacevilla.xyz"}function $r(s){Yd(s)}var We,ye,mr,gr,_r,Fi,Bi,di,fi,vr,bo,pi,To,Ao,$e,pc,yn;class my{constructor(t,e=0,n="available"){tt(this,$e);tt(this,We,null);tt(this,ye,null);tt(this,mr,"");tt(this,gr,0);tt(this,_r,"available");tt(this,Fi,"");tt(this,Bi,"main");tt(this,di,"");tt(this,fi,[]);tt(this,vr,null);tt(this,bo,[]);tt(this,pi,{});tt(this,To,null);tt(this,Ao,0);st(this,mr,t),st(this,gr,e),st(this,_r,n)}async start(){const t=ce.push("Reading link…"),e=await Wd();if(st(this,Fi,e.roomHash),st(this,Bi,e.roomId),st(this,fi,e.peers??[]),e.type==="link"?(ce.ok(t,`Invite link decoded → room: ${v(this,Bi)}`),ce.info("Room address is hashed — connection is private"),e.node&&ce.info("Preferred node found in link",e.node)):e.type==="plain"?ce.ok(t,`Room: ${v(this,Bi)}`):ce.ok(t,"Using default room"),v(this,fi).length){const r=e.type==="link"?"invite link":"previous session";ce.info(`${v(this,fi).length} known peer${v(this,fi).length>1?"s":""} from ${r}`,"Will reconnect directly if they are online")}if(st(this,di,qd(e.node)),!v(this,di))throw ce.info("No xpacenode — trying public DHT route"),Object.assign(new Error("NO_NODE"),{roomHash:v(this,Fi),roomName:v(this,Bi),linkType:e.type,knownPeers:v(this,fi)});st(this,We,new qx({selfId:ht(this,$e,pc).call(this),introPayload:()=>({username:v(this,mr),presetId:v(this,gr),status:v(this,_r)})}));const n=new zd().register("chat",{persist:!0,queueOnFail:!0}).register("move",{persist:!1}).register("avatar",{persist:!1}).register("status",{persist:!1}).register("talking",{persist:!1}).register("hb",{persist:!1}).register("state_req",{persist:!1}).register("state",{persist:!1}).register("delta",{persist:!1});st(this,ye,new sy(v(this,We),{registry:n})),v(this,We).addEventListener("peer:join",({detail:{peerId:r,announced:o}})=>{const a=o.username??"",l=v(this,fi).includes(r);ce.peerJoined(a||r.slice(0,10)),l&&ce.info(`✓ ${a||r.slice(0,10)} — known peer (reconnected)`),ht(this,$e,yn).call(this,"HELLO",{from:r,username:a,presetId:o.presetId??0,status:o.status??"available"})}),v(this,We).addEventListener("peer:leave",({detail:{peerId:r}})=>{ht(this,$e,yn).call(this,"PEER_LEAVE",{from:r})}),v(this,We).addEventListener("peer:intro",({detail:{peerId:r,announced:o}})=>{ht(this,$e,yn).call(this,"HELLO",{from:r,username:o.username??"",presetId:o.presetId??0,status:o.status??"available"})}),v(this,We).addEventListener("peer:open",({detail:{peerId:r}})=>{v(this,ye).sendTo(r,"state_req",{}),Bc(v(this,Fi),r)}),v(this,We).onTrack((r,o,a)=>{v(this,vr)?v(this,vr).call(this,r,o,a,a):v(this,bo).push({track:r,stream:o,identityId:a,nostrPubkey:a})}),v(this,ye).on("chat",({from:r,payload:o})=>{ht(this,$e,yn).call(this,"CHAT",{from:r,username:o.username,text:o.text,ts:o.ts})}),v(this,ye).on("move",({from:r,payload:o})=>{ht(this,$e,yn).call(this,"MOVE",{from:r,pos:o.pos})}),v(this,ye).on("avatar",({from:r,payload:o})=>{ht(this,$e,yn).call(this,"AVATAR_CHANGE",{from:r,presetId:o.presetId}),Fe.patchPeer(r,{presetId:o.presetId})}),v(this,ye).on("status",({from:r,payload:o})=>{ht(this,$e,yn).call(this,"STATUS_CHANGE",{from:r,status:o.status}),Fe.patchPeer(r,{status:o.status})}),v(this,ye).on("talking",({from:r,payload:o})=>{ht(this,$e,yn).call(this,"PEER_TALKING",{from:r,talking:!!o.talking})}),v(this,ye).on("hb",({from:r})=>Fe.heartbeat(r)),v(this,ye).on("state_req",({from:r})=>{v(this,ye).sendTo(r,"state",{peers:Fe.getSnapshot()})}),v(this,ye).on("state",({payload:r})=>{const o=ht(this,$e,pc).call(this),a=r.peers??{};for(const[l,c]of Object.entries(a)){if(l===o)continue;Fe.upsertPeer(l,c)&&!v(this,We).peerIds.includes(l)&&ht(this,$e,yn).call(this,"HELLO",{from:l,username:c.username??"",presetId:c.presetId??0,status:c.status??"available"})}}),v(this,ye).on("delta",({from:r,payload:o})=>{Fe.upsertPeer(r,o)&&!v(this,We).peerIds.includes(r)&&ht(this,$e,yn).call(this,"HELLO",{from:r,username:o.username??"",presetId:o.presetId??0,status:o.status??"available"})});const i=ce.push("Connecting to xpacenode…","pending",v(this,di));ce.info("Searching for peers in room…"),ce.startFirstTimer(12e3);try{await v(this,We).join(v(this,di),v(this,Fi)),ce.ok(i,v(this,di))}catch(r){throw ce.fail(i,"xpacenode unreachable — trying public DHT route"),r}v(this,ye).history("chat").then(r=>{setTimeout(()=>{for(const o of r)ht(this,$e,yn).call(this,"CHAT",{from:o.meta.from,username:o.payload.username,text:o.payload.text,ts:o.payload.ts})},0)}),st(this,To,setInterval(()=>v(this,ye).send("hb",{}),3e4)),fc.schedule(()=>Fe.pruneCold(),"prune-cold-rooms")}stop(){var t;clearInterval(v(this,To)),(t=v(this,We))==null||t.leave(),st(this,We,null),st(this,ye,null)}move(t,e,n,i=0){v(this,ye).send("move",{pos:{x:t,y:e,z:n,ry:i}})}chat(t){v(this,ye).send("chat",{username:v(this,mr),text:t,ts:Date.now()})}setAvatar(t){st(this,gr,t),v(this,ye).send("avatar",{presetId:t}),v(this,ye).send("delta",{presetId:t,v:++ys(this,Ao)._})}setStatus(t){st(this,_r,t),v(this,ye).send("status",{status:t}),v(this,ye).send("delta",{status:t,v:++ys(this,Ao)._})}broadcastTalking(t){v(this,ye).send("talking",{talking:!!t})}addVoiceTrack(t,e){v(this,We).addTrack(t,e)}onVoiceTrack(t){st(this,vr,t);const e=v(this,bo).splice(0);for(const{track:n,stream:i,identityId:r,nostrPubkey:o}of e)n.readyState!=="ended"&&t(n,i,r,o);for(const[n,i]of Object.entries(v(this,We).getPeerConnections()))for(const r of i.getReceivers()){const o=r.track;!o||o.kind!=="audio"||o.readyState==="ended"||t(o,new MediaStream([o]),n,n)}}wireToIdentityId(t){return t}get roomName(){return v(this,Bi)}get roomHash(){return v(this,Fi)}get nodeUrl(){return v(this,di)}getPeers(){return v(this,We).getPeerConnections()}on(t,e){return v(this,pi)[t]||(v(this,pi)[t]=[]),v(this,pi)[t].push(e),()=>{v(this,pi)[t]=v(this,pi)[t].filter(n=>n!==e)}}}We=new WeakMap,ye=new WeakMap,mr=new WeakMap,gr=new WeakMap,_r=new WeakMap,Fi=new WeakMap,Bi=new WeakMap,di=new WeakMap,fi=new WeakMap,vr=new WeakMap,bo=new WeakMap,pi=new WeakMap,To=new WeakMap,Ao=new WeakMap,$e=new WeakSet,pc=function(){var t;return((t=Uc())==null?void 0:t.peerId)??"unknown"},yn=function(t,e){var n;(n=v(this,pi)[t])==null||n.forEach(i=>i(e))};function gy(s){const t=new URLSearchParams(window.location.search).get("nodeApi");return t||"https://xpacenode.spacevilla.xyz"}async function _y(s){if(!qd())return s([]),()=>{};const e=gy();if(!e)return s([]),()=>{};let n=!1;const i=9e4,r=new Map,o=async()=>{if(!n)try{const h=await(await fetch(`${e}/rooms`,{signal:AbortSignal.timeout(5e3)})).json(),u=Date.now();for(const d of h.rooms??[])r.set(d.roomId,{count:d.count,usernames:d.usernames??[],lastSeen:u});for(const[d,f]of r)u-f.lastSeen>i&&r.delete(d);a()}catch{}},a=()=>{const c=[...r.entries()].map(([h,u])=>({roomId:h,roomName:h,count:u.count})).sort((h,u)=>u.count-h.count);s(c)};await o();const l=setInterval(o,3e4);return()=>{n=!0,clearInterval(l)}}const vy=[{urls:"stun:stun.l.google.com:19302"},{urls:"stun:stun1.l.google.com:19302"},{urls:"turn:openrelay.metered.ca:80",username:"openrelayproject",credential:"openrelayproject"},{urls:"turn:openrelay.metered.ca:80?transport=tcp",username:"openrelayproject",credential:"openrelayproject"}];var De,mi,xr,yr,Sr,Mr,Ro,gc,Hn,Fa,Er,Co,Po,Lo,Io,Do,No,Uo,Ba,Oo,za,ka,wr,Fo,Bo,br,Pe,ri,Pn;class Ou{constructor(t,e=0,n="available"){tt(this,Pe);tt(this,De,null);tt(this,mi,{});tt(this,xr,"");tt(this,yr,0);tt(this,Sr,"available");tt(this,Mr,"");tt(this,Ro,"main");tt(this,gc,null);tt(this,Hn,new Map);tt(this,Fa,[]);tt(this,Er,null);tt(this,Co,[]);tt(this,Po,null);tt(this,Lo,null);tt(this,Io,null);tt(this,Do,null);tt(this,No,null);tt(this,Uo,null);tt(this,Ba,null);tt(this,Oo,null);tt(this,za,null);tt(this,ka,null);tt(this,wr,null);tt(this,Fo,[]);tt(this,Bo,0);tt(this,br,null);st(this,xr,t),st(this,yr,e),st(this,Sr,n)}async start(t,e,n="default",i=[]){st(this,Mr,t),st(this,Ro,e),st(this,Fo,i),n==="link"&&ce.info("Invite link decoded — using hashed room address"),i.length&&ce.info(`${i.length} known peer${i.length>1?"s":""} cached`,"Will recognise them when they appear on DHT");const r=ce.push("Trying public DHT route (BitTorrent)…");st(this,De,Qd({appId:"xpacenet-v3",rtcConfig:{iceServers:vy}},t));const[o,a]=v(this,De).makeAction("intro"),[l,c]=v(this,De).makeAction("move"),[h,u]=v(this,De).makeAction("chat"),[d,f]=v(this,De).makeAction("avatar"),[g,_]=v(this,De).makeAction("status"),[m,p]=v(this,De).makeAction("talking"),[w,x]=v(this,De).makeAction("bye"),[M,U]=v(this,De).makeAction("hb"),[A,T]=v(this,De).makeAction("stateReq"),[O,b]=v(this,De).makeAction("state"),[y,P]=v(this,De).makeAction("delta");st(this,Po,l),st(this,Lo,h),st(this,Io,d),st(this,Do,g),st(this,No,m),st(this,Uo,w),st(this,Ba,o),st(this,Oo,M),st(this,za,A),st(this,ka,O),st(this,wr,y),v(this,De).onPeerJoin(D=>{if(D===ht(this,Pe,ri).call(this))return;const F=v(this,Fo).includes(D);ce.peerJoined(D.slice(0,10)),F&&ce.info("✓ Known peer reconnected via DHT"),o({identityId:ht(this,Pe,ri).call(this),username:v(this,xr),presetId:v(this,yr),status:v(this,Sr)},[D]),A({identityId:ht(this,Pe,ri).call(this)},[D]),v(this,Hn).has(D)||(v(this,Hn).set(D,{peerId:D,username:"",presetId:0,status:"available"}),Bc(v(this,Mr),D))}),v(this,De).onPeerLeave(D=>{v(this,Hn).delete(D),ht(this,Pe,Pn).call(this,"PEER_LEAVE",{from:D})}),a(({identityId:D,username:F,presetId:B=0,status:j="available"},V)=>{const nt=D??V;v(this,Hn).set(nt,{peerId:nt,username:F,presetId:B,status:j}),ce.info(`Connected to ${F||nt.slice(0,10)}`),ht(this,Pe,Pn).call(this,"HELLO",{from:nt,username:F,presetId:B,status:j})}),c(({pos:D},F)=>ht(this,Pe,Pn).call(this,"MOVE",{from:F,pos:D})),u((D,F)=>ht(this,Pe,Pn).call(this,"CHAT",{from:F,username:D.username,text:D.text,ts:D.ts})),p(({talking:D},F)=>ht(this,Pe,Pn).call(this,"PEER_TALKING",{from:F,talking:!!D})),x((D,F)=>ht(this,Pe,Pn).call(this,"PEER_LEAVE",{from:F})),f(({presetId:D},F)=>{ht(this,Pe,Pn).call(this,"AVATAR_CHANGE",{from:F,presetId:D}),Fe.patchPeer(F,{presetId:D})}),_(({status:D},F)=>{ht(this,Pe,Pn).call(this,"STATUS_CHANGE",{from:F,status:D}),Fe.patchPeer(F,{status:D})}),U((D,F)=>{Fe.heartbeat(F)}),T((D,F)=>{const B=Fe.getSnapshot();O({identityId:ht(this,Pe,ri).call(this),peers:B},[F])}),b(({peers:D={}},F)=>{const B=ht(this,Pe,ri).call(this);for(const[j,V]of Object.entries(D)){if(j===B)continue;Fe.upsertPeer(j,V)&&!v(this,Hn).has(j)&&ht(this,Pe,Pn).call(this,"HELLO",{from:j,username:V.username??"",presetId:V.presetId??0,status:V.status??"available"})}}),P((D,F)=>{Fe.upsertPeer(F,D)&&!v(this,Hn).has(F)&&ht(this,Pe,Pn).call(this,"HELLO",{from:F,username:D.username??"",presetId:D.presetId??0,status:D.status??"available"})}),v(this,De).onPeerStream((D,F)=>{const B=D.getAudioTracks()[0];B&&(v(this,Er)?v(this,Er).call(this,B,D,F,F):v(this,Co).push({track:B,stream:D,identityId:F,nostrPubkey:F}))}),st(this,br,setInterval(()=>{var D;(D=v(this,Oo))==null||D.call(this,{identityId:ht(this,Pe,ri).call(this)})},3e4)),fc.schedule(()=>Fe.pruneCold(),"prune-cold-rooms"),ce.ok(r,"DHT ready — searching for peers"),ce.info("Searching for peers in room…"),ce.startFirstTimer(15e3)}stop(){var t,e;clearInterval(v(this,br)),st(this,br,null),(t=v(this,Uo))==null||t.call(this),(e=v(this,De))==null||e.leave(),st(this,De,null),v(this,Hn).clear(),fc.clear()}move(t,e,n,i=0){var r;(r=v(this,Po))==null||r.call(this,{pos:{x:t,y:e,z:n,ry:i}})}chat(t){var e;(e=v(this,Lo))==null||e.call(this,{username:v(this,xr),text:t,ts:Date.now()})}setAvatar(t){var e,n;st(this,yr,t),(e=v(this,Io))==null||e.call(this,{presetId:t}),(n=v(this,wr))==null||n.call(this,{identityId:ht(this,Pe,ri).call(this),presetId:t,v:++ys(this,Bo)._})}setStatus(t){var e,n;st(this,Sr,t),(e=v(this,Do))==null||e.call(this,{status:t}),(n=v(this,wr))==null||n.call(this,{identityId:ht(this,Pe,ri).call(this),status:t,v:++ys(this,Bo)._})}broadcastTalking(t){var e;(e=v(this,No))==null||e.call(this,{talking:!!t})}addVoiceTrack(t,e){var n;v(this,Fa).push({track:t,stream:e}),(n=v(this,De))==null||n.addStream(e)}onVoiceTrack(t){st(this,Er,t);const e=v(this,Co).splice(0);for(const{track:n,stream:i,identityId:r,nostrPubkey:o}of e)n.readyState!=="ended"&&t(n,i,r,o)}wireToIdentityId(t){return t}getPeers(){return{}}on(t,e){return v(this,mi)[t]||(v(this,mi)[t]=[]),v(this,mi)[t].push(e),()=>{v(this,mi)[t]=v(this,mi)[t].filter(n=>n!==e)}}get roomName(){return v(this,Ro)}get roomHash(){return v(this,Mr)}get nodeUrl(){return null}}De=new WeakMap,mi=new WeakMap,xr=new WeakMap,yr=new WeakMap,Sr=new WeakMap,Mr=new WeakMap,Ro=new WeakMap,gc=new WeakMap,Hn=new WeakMap,Fa=new WeakMap,Er=new WeakMap,Co=new WeakMap,Po=new WeakMap,Lo=new WeakMap,Io=new WeakMap,Do=new WeakMap,No=new WeakMap,Uo=new WeakMap,Ba=new WeakMap,Oo=new WeakMap,za=new WeakMap,ka=new WeakMap,wr=new WeakMap,Fo=new WeakMap,Bo=new WeakMap,br=new WeakMap,Pe=new WeakSet,ri=function(){var t;return((t=Uc())==null?void 0:t.peerId)??"unknown"},Pn=function(t,e){var n;(n=v(this,mi)[t])==null||n.forEach(i=>i(e))};var qe,an,Tr,zo,ko,Ho,Ne,$d,Kd,mc,Sn;class xy extends EventTarget{constructor(){super(...arguments);tt(this,Ne);tt(this,qe,null);tt(this,an,new Map);tt(this,Tr,!1);tt(this,zo,"");tt(this,ko,0);tt(this,Ho,"available")}get id(){var e;return((e=Uc())==null?void 0:e.peerId)??""}get peers(){return[...v(this,an).values()]}get peerCount(){return v(this,an).size}get roomName(){var e;return((e=v(this,qe))==null?void 0:e.roomName)??"main"}get nodeUrl(){var e;return((e=v(this,qe))==null?void 0:e.nodeUrl)??null}async start(e,n=0,i="available"){if(v(this,Tr))return;st(this,Tr,!0),st(this,zo,e),st(this,ko,n),st(this,Ho,i);let r;try{r=new my(e,n,i),await r.start()}catch(o){if((o==null?void 0:o.message)==="NO_NODE")r=new Ou(e,n,i),await r.start(o.roomHash,o.roomName,o.linkType,o.knownPeers??[]);else{ce.info("xpacenode unreachable — falling back to public DHT route");const{parseCurrentLink:a,getKnownPeers:l}=await zl(async()=>{const{parseCurrentLink:u,getKnownPeers:d}=await Promise.resolve().then(()=>cc);return{parseCurrentLink:u,getKnownPeers:d}},void 0,import.meta.url),c=await a(),h=l(c.roomHash);r=new Ou(e,n,i),await r.start(c.roomHash,c.roomId,c.type,h)}}st(this,qe,r),ht(this,Ne,$d).call(this),ht(this,Ne,Sn).call(this,"status",{peerCount:v(this,an).size})}stop(){var e;(e=v(this,qe))==null||e.stop(),st(this,qe,null),v(this,an).clear(),st(this,Tr,!1),Fe.clearHot()}move(e,n,i,r=0){var o;(o=v(this,qe))==null||o.move(e,n,i,r)}setAvatar(e){var n;st(this,ko,e),(n=v(this,qe))==null||n.setAvatar(e)}setStatus(e){var n;st(this,Ho,e),(n=v(this,qe))==null||n.setStatus(e)}sendChat(e){var i;if(!e.trim())return;const n=Date.now();ht(this,Ne,Sn).call(this,"chat",{from:this.id,username:v(this,zo),text:e,ts:n}),(i=v(this,qe))==null||i.chat(e)}addVoiceTrack(e,n){var i;(i=v(this,qe))==null||i.addVoiceTrack(e,n)}onVoiceTrack(e){var n;(n=v(this,qe))==null||n.onVoiceTrack(e)}wireToIdentityId(e){var n;return(n=v(this,qe))==null?void 0:n.wireToIdentityId(e)}broadcastTalking(e){var n;(n=v(this,qe))==null||n.broadcastTalking(e)}}qe=new WeakMap,an=new WeakMap,Tr=new WeakMap,zo=new WeakMap,ko=new WeakMap,Ho=new WeakMap,Ne=new WeakSet,$d=function(){const e=v(this,qe);e.on("HELLO",({from:n,username:i,presetId:r=0,status:o="available"})=>{v(this,an).has(n)||(ht(this,Ne,Kd).call(this,n,i,r,o),Fe.upsertPeer(n,{username:i,presetId:r,status:o,v:0}))}),e.on("PEER_LEAVE",({from:n})=>{ht(this,Ne,mc).call(this,n),Fe.removePeer(n)}),e.on("MOVE",({from:n,pos:i})=>{ht(this,Ne,Sn).call(this,"peer:move",{peerId:n,pos:i}),Fe.updatePos(n,i)}),e.on("AVATAR_CHANGE",({from:n,presetId:i})=>{ht(this,Ne,Sn).call(this,"peer:avatar",{peerId:n,presetId:i})}),e.on("STATUS_CHANGE",({from:n,status:i})=>{ht(this,Ne,Sn).call(this,"peer:status",{peerId:n,status:i})}),e.on("PEER_TALKING",({from:n,talking:i})=>{ht(this,Ne,Sn).call(this,"peer:talking",{peerId:n,talking:i})}),e.on("CHAT",({from:n,username:i,text:r,ts:o})=>{ht(this,Ne,Sn).call(this,"chat",{from:n,username:i,text:r,ts:o})}),Fe.addEventListener("peer:expired",({detail:{peerId:n}})=>{v(this,an).has(n)&&ht(this,Ne,mc).call(this,n)})},Kd=function(e,n,i,r){v(this,an).set(e,{peerId:e,username:n,presetId:i,status:r}),ht(this,Ne,Sn).call(this,"peer:join",{peerId:e,username:n,presetId:i,status:r}),ht(this,Ne,Sn).call(this,"status",{peerCount:v(this,an).size})},mc=function(e){v(this,an).has(e)&&(v(this,an).delete(e),ht(this,Ne,Sn).call(this,"peer:leave",{peerId:e}),ht(this,Ne,Sn).call(this,"status",{peerCount:v(this,an).size}))},Sn=function(e,n){this.dispatchEvent(new CustomEvent(e,{detail:n}))};const le=new xy,ni=Object.freeze({OCEAN:"ocean",COAST:"coast",DESERT:"desert",PLAINS:"plains",FOREST:"forest",MOUNTAIN:"mountain",ARCTIC:"arctic",JUNGLE:"jungle",TUNDRA:"tundra"});function Sa(s){let t=5381;for(let e=0;e<s.length;e++)t=Math.imul(t,33)^s.charCodeAt(e);return(t>>>0).toString(16).padStart(8,"0")}function Jd(s,t,e,n){const i=JSON.stringify({parentHash:s,authorId:t,changes:e,timestamp:n});let r=Sa(i),o=Sa(r+i.slice(0,32)),a=Sa(o+i.slice(-32)),l=Sa(a+t);return r+o+a+l}class er{constructor(t,e,n,i="",r=Date.now()){this.parentHash=t,this.authorId=e,this.changes=Object.freeze([...n]),this.message=i,this.timestamp=r,this.hash=Jd(t,e,n,r)}buildRevert(t,e=Date.now()){const n=this.changes.map(i=>({cellId:i.cellId,key:i.key,oldValue:i.newValue,newValue:i.oldValue}));return new er(this.hash,t,n,`revert: ${this.message||this.hash.slice(0,8)}`,e)}toJSON(){return{hash:this.hash,parentHash:this.parentHash,authorId:this.authorId,message:this.message,timestamp:this.timestamp,changes:this.changes}}}const yy="universe",Sy="genesis: the universe begins";var Xe,ln;class My{constructor(){tt(this,Xe,new Map);tt(this,ln,null);this._genesis()}_genesis(){const t=new er(null,yy,[],Sy,0);v(this,Xe).set(t.hash,t),st(this,ln,t.hash)}get head(){return v(this,ln)}get length(){return v(this,Xe).size}getCommit(t){return v(this,Xe).get(t)??null}headCommit(){return v(this,Xe).get(v(this,ln))}log(t=1/0){const e=[];let n=v(this,ln);for(;n&&e.length<t;){const i=v(this,Xe).get(n);if(!i)break;e.push(i),n=i.parentHash}return e}stateAt(t){const e=[];let n=t;for(;n;){const r=v(this,Xe).get(n);if(!r)break;e.unshift(r),n=r.parentHash}const i=new Map;for(const r of e)for(const{cellId:o,key:a,newValue:l}of r.changes)i.set(`${o}:${a}`,l);return i}currentState(){return this.stateAt(v(this,ln))}diff(t,e){const n=this.stateAt(t),i=this.stateAt(e),r=[],o=new Set([...n.keys(),...i.keys()]);for(const a of o){const l=n.get(a)??null,c=i.get(a)??null;if(l!==c){const[h,u]=a.split(":");r.push({cellId:h,key:u,before:l,after:c})}}return r}commit(t,e,n=""){if(!Array.isArray(e)||e.length===0)throw new Error("commit requires at least one change");for(const r of e)if(!r.cellId||!r.key)throw new Error("each change must have cellId and key");const i=new er(v(this,ln),t,e,n);return v(this,Xe).set(i.hash,i),st(this,ln,i.hash),i}revert(t,e){const n=v(this,Xe).get(t);if(!n)throw new Error(`commit ${t} not found`);if(n.changes.length===0)throw new Error("cannot revert empty commit");n.buildRevert(e);const i=new er(v(this,ln),e,[...n.changes].map(r=>({cellId:r.cellId,key:r.key,oldValue:r.newValue,newValue:r.oldValue})),`revert: ${n.message||n.hash.slice(0,8)}`);return v(this,Xe).set(i.hash,i),st(this,ln,i.hash),i}applyExternal(t){if(v(this,Xe).has(t.hash))return v(this,Xe).get(t.hash);if(t.parentHash&&!v(this,Xe).has(t.parentHash))throw new Error(`missing parent ${t.parentHash} — cannot apply ${t.hash}`);const e=new er(t.parentHash,t.authorId,t.changes,t.message,t.timestamp);return v(this,Xe).set(t.hash,e),t.parentHash===v(this,ln)&&st(this,ln,t.hash),e}verify(){for(const t of v(this,Xe).values()){if(Jd(t.parentHash,t.authorId,t.changes,t.timestamp)!==t.hash)return{valid:!1,broken:t.hash};if(t.parentHash&&!v(this,Xe).has(t.parentHash))return{valid:!1,broken:t.hash,reason:"missing-parent"}}return{valid:!0}}}Xe=new WeakMap,ln=new WeakMap;const fe=Object.freeze({SOLAR:"solar",WIND:"wind",HYDRO:"hydro",MINERAL:"mineral",RARE_EARTH:"rare_earth",BIOLOGICAL:"biological",FISHERY:"fishery",GEOTHERMAL:"geothermal"});ni.OCEAN+"",fe.FISHERY+"",fe.WIND+"",ni.COAST+"",fe.FISHERY+"",fe.WIND+"",fe.SOLAR+"",ni.DESERT+"",fe.SOLAR+"",fe.RARE_EARTH+"",fe.MINERAL+"",ni.PLAINS+"",fe.WIND+"",fe.MINERAL+"",fe.BIOLOGICAL+"",fe.SOLAR+"",ni.FOREST+"",fe.BIOLOGICAL+"",fe.HYDRO+"",fe.WIND+"",ni.MOUNTAIN+"",fe.MINERAL+"",fe.RARE_EARTH+"",fe.GEOTHERMAL+"",fe.WIND+"",fe.HYDRO+"",ni.ARCTIC+"",fe.MINERAL+"",fe.WIND+"",ni.JUNGLE+"",fe.BIOLOGICAL+"",fe.HYDRO+"",fe.SOLAR+"",ni.TUNDRA+"",fe.MINERAL+"",fe.GEOTHERMAL+"",fe.WIND+"";(()=>{var u;const s=document.getElementById("conn-log"),t=document.getElementById("conn-log-body"),e=document.getElementById("conn-log-title"),n=document.getElementById("conn-log-toggle"),i=document.getElementById("conn-log-dismiss");if(!s)return;const r={pending:"⏳",ok:"✅",fail:"❌",warn:"⚠️",info:"·",host:"🏠"},o=new Map,a=()=>s.classList.remove("hidden"),l=()=>s.classList.add("hidden");ce.addEventListener("step",({detail:d})=>{if(a(),d.action==="add"){const g=document.createElement("div");g.className=`cl-step ${d.status}`,g.innerHTML=`
      ...
      `,f.addEventListener("click",async()=>{try{const{link:g}=await Oc({roomId:le.roomName,node:le.nodeUrl??void 0});await navigator.clipboard.writeText(g),f.textContent="✅ Copied!",setTimeout(()=>{f.textContent="🔗 Copy invite link"},2e3)}catch{}}),t.after(f)}});let h=null;le.addEventListener("peer:join",()=>{var d;e.textContent="⬡ Connected",s.style.borderColor="",(d=document.getElementById("cl-host-share"))==null||d.remove(),clearTimeout(h),h=setTimeout(l,6e3)})})();(async()=>{const s=await ry(),t=new My;window._worldHistory=t;let e=!1;function n({peerCount:w}={}){document.querySelectorAll(".ipfs-dot").forEach(M=>{M.className="ipfs-dot green"}),document.querySelectorAll(".ipfs-label").forEach(M=>{M.textContent=`P2P · ${s.shortId}`});const x=document.getElementById("ipfs-tier");if(x&&e){const M=!!le.nodeUrl;x.textContent=M?"xpacenode":"DHT fallback (slow)",x.className=M?"tier-node":"tier-fallback",x.title=M?`Connected via ${le.nodeUrl}`:"xpacenode was unreachable — using public BitTorrent-tracker signaling instead"}w!==void 0&&document.querySelectorAll("#ipfs-peers").forEach(M=>{w>0?(M.textContent=`${w} peer${w!==1?"s":""}`,M.style.color="rgba(120,255,160,0.7)"):e?(M.textContent="· searching…",M.style.color="rgba(255,200,80,0.7)"):M.textContent=""})}n({peerCount:0}),le.addEventListener("status",w=>n(w.detail)),le.addEventListener("commit",w=>{try{t.applyExternal(w.detail.commit)}catch{}});const i=document.getElementById("lobby"),r=document.getElementById("loading"),o=document.getElementById("load-fill"),a=document.getElementById("load-text"),l=document.getElementById("hud"),c=document.getElementById("click-to-start"),h=document.getElementById("enter-btn"),u=document.getElementById("username"),d=document.getElementById("room-name");!s.isNew&&s.displayName&&(u.value=s.displayName),(async()=>{const{parseCurrentLink:w}=await zl(async()=>{const{parseCurrentLink:P}=await Promise.resolve().then(()=>cc);return{parseCurrentLink:P}},void 0,import.meta.url),x=await w(),M=document.getElementById("lobby-invited"),U=document.getElementById("lobby-invited-room"),A=document.getElementById("lobby-default"),T=document.getElementById("lobby-create-row"),O=document.getElementById("lobby-room-row"),b=document.getElementById("create-btn"),y=document.getElementById("join-named-btn");x.type==="link"?(U.textContent=x.roomId,M.style.display="block",A.style.display="none",O.style.display="none",T.style.display="none",h.style.display="block",h.textContent="Join Room →"):x.type==="plain"?(d&&(d.value=x.roomId),$r(x.roomId),A.style.display="none",T.style.display="none",h.style.display="block",h.textContent=`Enter ${x.roomId} →`):(M.style.display="none",T.style.display="none",O.style.display="none",h.style.display="block",h.textContent="Enter main →",$r("main")),b==null||b.addEventListener("click",async()=>{const P=u.value.trim();if(!P){u.focus(),u.style.borderColor="#f55";return}u.style.borderColor="";const D=(d==null?void 0:d.value.trim())||`room-${Math.random().toString(36).slice(2,7)}`;$r(D);try{const{createRoomLink:F}=await zl(async()=>{const{createRoomLink:V}=await Promise.resolve().then(()=>cc);return{createRoomLink:V}},void 0,import.meta.url),{link:B}=await F({roomId:D});if(await navigator.clipboard.writeText(B).then(()=>!0).catch(()=>!1)){const V=b.textContent;b.textContent="✅ Link copied!",b.disabled=!0,setTimeout(()=>{b.textContent=V,b.disabled=!1},1800)}else{const V=document.createElement("div");V.style.cssText=`
          ...
          `,V.textContent=B,V.title="Click to select all",V.addEventListener("click",()=>{const nt=document.createRange();nt.selectNodeContents(V);const J=window.getSelection();J.removeAllRanges(),J.addRange(nt)}),b.parentElement.insertBefore(V,b.nextSibling),setTimeout(()=>V.remove(),2e4)}}catch{}p(P)}),y==null||y.addEventListener("click",()=>{const P=u.value.trim();if(!P){u.focus(),u.style.borderColor="#f55";return}u.style.borderColor="";const D=(d==null?void 0:d.value.trim())||"main";$r(D),p(P)}),h==null||h.addEventListener("click",()=>{const P=u.value.trim();if(!P){u.focus(),u.style.borderColor="#f55";return}u.style.borderColor="",p(P)})})();const f=document.getElementById("id-fingerprint");f&&(f.textContent=s.isNew?"New identity generated":`Identity · ${s.shortId}`),function(){const x=document.getElementById("lobby-avatar-grid");if(!x)return;const M=parseInt(localStorage.getItem("spaceAvatarId")??"0",10),U=A=>"#"+A.toString(16).padStart(6,"0");vs.forEach(A=>{const T=U(A.skin),O=U(A.hair),b=U(A.outfit),y=U(A.accent),P=document.createElement("div");P.className="lav-chip"+(A.id===M?" lav-active":""),P.dataset.id=String(A.id),P.title=A.label,P.innerHTML=`<svg viewBox="0 0 60 82" xmlns="http://www.w3.org/2000/svg">
        ...
        `,Xt.appendChild(Ee),Xt.scrollTop=Xt.scrollHeight,!Gt.classList.contains("open")&&!ve){ge++;const Bn=ge>9?"9+":String(ge);Wt.textContent=Bn,Wt.classList.add("visible"),C&&(C.textContent=Bn,C.classList.add("visible"))}}function rt(X){const xt=document.createElement("div");xt.className="chat-system",xt.textContent=X,Xt.appendChild(xt),Xt.scrollTop=Xt.scrollHeight}const Lt=new Map;le.addEventListener("chat",X=>ot(X.detail)),le.addEventListener("peer:join",X=>{Lt.set(X.detail.peerId,X.detail.username),rt(`${X.detail.username} joined`)}),le.addEventListener("peer:leave",X=>{const xt=Lt.get(X.detail.peerId)??"Someone";Lt.delete(X.detail.peerId),rt(`${xt} left`)});const pt=new Ux,mt=new Fx,Yt=new Nx(w);pt.createReality(Yt),mt.setNode(w,$s.PUBLIC),(ie=document.getElementById("nm-open-btn"))==null||ie.addEventListener("click",X=>{X.stopPropagation(),Cu(pt,mt,w)}),(hn=document.getElementById("leave-room-btn"))==null||hn.addEventListener("click",()=>{le.stop(),history.replaceState(null,"",window.location.pathname+window.location.search),window.location.reload()});const at=document.getElementById("invite-modal"),Tt=document.getElementById("invite-lock-input"),Kt=document.getElementById("invite-link-box"),Ut=document.getElementById("invite-link-text"),vt=document.getElementById("invite-room-name"),Dt=document.getElementById("invite-generate-btn"),kt=document.getElementById("invite-copy-btn"),_e=document.getElementById("invite-close-btn");let N="";const St=()=>{vt.textContent=`Room: ${le.roomName}`,Tt.value="",Kt.style.display="none",kt.style.display="none",Dt.style.display="",Dt.textContent="Generate link",at.style.display="flex",setTimeout(()=>Tt.focus(),50)};(un=document.getElementById("invite-btn"))==null||un.addEventListener("click",X=>{X.stopPropagation(),St()}),_e==null||_e.addEventListener("click",()=>{at.style.display="none"}),at==null||at.addEventListener("click",X=>{X.target===at&&(at.style.display="none")}),Dt==null||Dt.addEventListener("click",async()=>{Dt.textContent="Generating…",Dt.disabled=!0;try{const{link:X}=await Oc({roomId:le.roomName,lockCode:Tt.value.trim(),node:le.nodeUrl??void 0});N=X,Ut.textContent=X,Kt.style.display="block",kt.style.display="",Dt.style.display="none",navigator.clipboard.writeText(X).catch(()=>{})}catch(X){console.error("[invite] link generation failed",X),Dt.textContent="Generate link"}finally{Dt.disabled=!1}}),kt==null||kt.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(N);const X=kt.textContent;kt.textContent="✅ Copied!",setTimeout(()=>{kt.textContent=X},2e3)}catch{prompt("Copy this link:",N)}}),Ut==null||Ut.addEventListener("click",()=>kt==null?void 0:kt.click()),Tt==null||Tt.addEventListener("keydown",X=>{X.key==="Enter"&&(Dt==null||Dt.click())}),(Fn=document.getElementById("mb-avatar-btn"))==null||Fn.addEventListener("click",()=>{var X;return(X=document.getElementById("avatar-btn"))==null?void 0:X.click()}),(xs=document.getElementById("mb-nm-btn"))==null||xs.addEventListener("click",X=>{X.stopPropagation(),Cu(pt,mt,w)}),(Br=document.getElementById("mb-voice-btn"))==null||Br.addEventListener("click",X=>{X.stopPropagation(),$==null||$.click()}),(zr=document.getElementById("mb-status-btn"))==null||zr.addEventListener("click",X=>{X.stopPropagation(),V==null||V.click()}),K.onStateChange(({active:X,muted:xt}={})=>{const Et=document.getElementById("mb-voice-btn");Et&&(X?xt?(Et.innerHTML="🔇",Et.className="mb-btn mb-voice-active",Et.style.color="#ff6b6b"):(Et.innerHTML="🎙",Et.className="mb-btn mb-voice-active",Et.style.color=""):(Et.innerHTML="🎙",Et.className="mb-btn"))});const Q=document.getElementById("screen-hint"),et=document.getElementById("screen-hint-name");let ct=null,Ot=null;document.addEventListener("keydown",X=>{if(X.code==="KeyE"&&ct&&!y()&&b(ct),X.code==="KeyF"&&Ot){const xt=Ot.def.id,Et=xt==="main-left"||xt==="main-right",jt=si(Et?"main-left":xt);Et&&si("main-right"),ne(Ot.def.label,jt)}});function ne(X,xt){let Et=document.getElementById("door-action-hint");Et||(Et=document.createElement("div"),Et.id="door-action-hint",Et.style.cssText=`
          ...
          `,document.body.appendChild(Et)),Et.textContent=`${X} ${xt?"opened":"closed"}`,Et.style.opacity="1",clearTimeout(Et._t),Et._t=setTimeout(()=>{Et.style.opacity="0"},1500)}const oe=new Set;setInterval(()=>{var He;if(y())return;const X=B.getPosition();let xt=null,Et=4;O.forEach(Ee=>{const Bn=X.x-Ee.position.x,E=X.z-Ee.position.z,z=Math.sqrt(Bn*Bn+E*E);z<Et&&(Et=z,xt=Ee)}),ct=xt,Q&&(Q.style.display=xt?"flex":"none",xt&&et&&(et.textContent=xt.label)),Wo.forEach(Ee=>{const Bn=X.x-Ee.hinge.x,E=X.z-Ee.hinge.z,z=Math.sqrt(Bn*Bn+E*E),G=Ee.id;z<2.2&&!Zs(G)?(si(G),oe.add(G),G==="main-left"&&(Zs("main-right")||si("main-right"),oe.add("main-right")),G==="main-right"&&(Zs("main-left")||si("main-left"),oe.add("main-left"))):z>3.5&&oe.has(G)&&Zs(G)&&(si(G),oe.delete(G),G==="main-left"&&(Zs("main-right")&&si("main-right"),oe.delete("main-right")),G==="main-right"&&(Zs("main-left")&&si("main-left"),oe.delete("main-left")))});const jt=Pd(X,2.8);Ot=jt;const ve=document.getElementById("door-proximity-hint");if(ve)if(jt&&!xt){const Ee=(He=jt.state)!=null&&He.open?"Close":"Open";ve.style.display="flex",ve.querySelector("#door-hint-name").textContent=`${Ee} ${jt.def.label}`}else ve.style.display="none"},150)})}})();function Ey(s){let t=0;for(let e=0;e<s.length;e++)t=t*31+s.charCodeAt(e)|0;return Math.abs(t)%vs.length}function Fu(s,t){var n;const e=(n=s==null?void 0:s.querySelector)==null?void 0:n.call(s,"#online-count");e&&(e.textContent=`● ${t} aboard`)}const Bu={OUTSIDE:{color:"#88cc66",desc:"Outside the building"},LOBBY:{color:"#ffffff",desc:"Reception & Entrance"},OPS:{color:"#ffaa44",desc:"Operations & Technical Support"},FUN:{color:"#44ffaa",desc:"Chill, Social & Games"},DESIGN:{color:"#ff6ba0",desc:"UI/UX, Design & 3D"},ENGINEERING:{color:"#44aaff",desc:"Development & Engineering"},"":{color:"#ffffff",desc:""}};function wy(s){const t=document.getElementById("zone-name"),e=document.getElementById("zone-desc"),n=Bu[s]||Bu[""];t&&(t.textContent=s,t.style.color=n.color),e&&(e.textContent=n.desc),document.querySelectorAll(".map-zone").forEach(i=>{i.classList.toggle("active",i.dataset.zone===s)})}
